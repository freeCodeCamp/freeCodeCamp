...
exports.submitTypes = exports.viewTypes = exports.hasNoTests = exports.isCodeAllyPractice = exports.isFinalProject = exports.challengeTypes = void 0;
const html = 0;
const js = 1;
const backend = 2;
const zipline = 3;
...
const isFinalProject = (challengeType) => {
    ...
    return (challengeType === frontEndProject ||
...
exports.isFinalProject = isFinalProject;
const isCodeAllyPractice = (challengeType) => {
    // TODO: remove the type check once everything is converted to TS
    if (typeof challengeType !== 'number')
        throw Error('challengeType must be a number');
    return challengeType === codeAllyPractice;
};
exports.isCodeAllyPractice = isCodeAllyPractice;
const hasNoTests = (challengeType) => challengeType === multipleChoice ||
    challengeType === theOdinProject ||
    challengeType === video;
exports.hasNoTests = hasNoTests;
