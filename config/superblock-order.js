...
exports.getNotAuditedSuperBlocks = exports.getAuditedSuperBlocks = exports.getLearnSuperBlocks = exports.superBlockOrder = exports.defaultSuperBlockOrder = exports.numberOfSuperBlocksOnLanding = exports.orderedSuperBlockStates = exports.SuperBlockStates = exports.TranslationStates = exports.CurriculumMaps = void 0;
...
})(TranslationStates = exports.TranslationStates || (exports.TranslationStates = {}));
...
})(SuperBlockStates = exports.SuperBlockStates || (exports.SuperBlockStates = {}));
    ...
    [i18n_1.Languages.English]: {
        ...
        [CurriculumMaps.Learn]: {
            [TranslationStates.Audited]: {
                ...
                [SuperBlockStates.Legacy]: [certification_settings_1.SuperBlocks.RespWebDesign]
            },
    ...
    [i18n_1.Languages.Portuguese]: {
        ...
        [CurriculumMaps.Learn]: {
            [TranslationStates.Audited]: {
                ...
                [SuperBlockStates.New]: [],
                [SuperBlockStates.Upcoming]: [certification_settings_1.SuperBlocks.TheOdinProject],
                [SuperBlockStates.Legacy]: [certification_settings_1.SuperBlocks.RespWebDesign]
            },
            [TranslationStates.NotAudited]: {
                [SuperBlockStates.Current]: [],
...
function shouldShowSuperblocks({ superBlockState, showNewCurriculum = 'false', showUpcomingChanges = 'false' }) {
...
function getLearnSuperBlocks({ language = 'english', showNewCurriculum = 'false', showUpcomingChanges = 'false' }) {
    ...
    Object.values(TranslationStates).forEach(translationState => {
        Object.values(SuperBlockStates).forEach(superBlockState => {
            if (shouldShowSuperblocks({
                superBlockState,
                showNewCurriculum,
                showUpcomingChanges
            })) {
                learnSuperBlocks.push(...exports.superBlockOrder[language][CurriculumMaps.Learn][translationState][superBlockState]);
            }
        });
    });
...
function getAuditedSuperBlocks({ language = 'english', showNewCurriculum = 'false', showUpcomingChanges = 'false' }) {
    ...
    Object.values(SuperBlockStates).forEach(superBlockState => {
        if (shouldShowSuperblocks({
            ...
            auditedSuperBlocks.push(...exports.superBlockOrder[language][CurriculumMaps.Learn][TranslationStates.Audited][superBlockState]);
        }
    });
    return auditedSuperBlocks;
}
exports.getAuditedSuperBlocks = getAuditedSuperBlocks;
function getNotAuditedSuperBlocks({ language = 'english', showNewCurriculum = 'false', showUpcomingChanges = 'false' }) {
    ...
    Object.values(SuperBlockStates).forEach(superBlockState => {
        if (shouldShowSuperblocks({
            ...
            notAuditedSuperBlocks.push(...exports.superBlockOrder[language][CurriculumMaps.Learn][TranslationStates.NotAudited][superBlockState]);
        }
    });
