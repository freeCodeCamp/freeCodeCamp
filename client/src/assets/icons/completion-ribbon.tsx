  ...
  return (
    ...
    >
      {isClaimed && (
        <>
          <path
            d='M24.5 36.3418L34.4851 28L44.5957 42.0113L36.0658 41.0151L33.1106 49.353L24.5 36.3418Z'
            fill='var(--secondary-color)'
          />
          <path
            d='M9.11059 29L19.5957 36.3418L10.9851 49.353L8.85418 41.0821L-4.67677e-07 42.0113L9.11059 29Z'
            fill='var(--secondary-color)'
          />
        </>
      )}
