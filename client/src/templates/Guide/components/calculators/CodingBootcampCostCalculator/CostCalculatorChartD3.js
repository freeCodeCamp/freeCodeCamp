  ...
  rect
    ...
    .on('mouseover', function(d) {
      ...
      component
        ...
        .style('left', (((box.left + (box.width / 2)) - componentPos.left - (tooltip[0][0].offsetWidth / 2)) + 'px'))
        .style('top', ((box.top - componentPos.top - tooltip[0][0].offsetHeight - 10) + 'px'));
    })
