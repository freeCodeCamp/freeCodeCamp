...
describe('scene-helpers', () => {
  describe('buildTranscript', () => {
    ...
    it('should handle Chinese characters in dialogue', () => {
      const commands: SceneCommand[] = [
        {
          character: 'Naomi',
          startTime: 0,
      ...
      const result = buildTranscript(commands);
      expect(result).toBe('\n<strong>Naomi</strong>: 你好，世界！\n');
    });

    it('should handle mixed English and Chinese dialogue', () => {
      const commands: SceneCommand[] = [
        {
          character: 'Naomi',
          startTime: 0,
      ...
      const result = buildTranscript(commands);
      expect(result).toBe(
        '\n<strong>Naomi</strong>: Hello! 你好！\n' +
          '\n<strong>Quincy</strong>: 欢迎来到 freeCodeCamp!\n'
      );
    });

    it('should handle Chinese punctuation in dialogue', () => {
      const commands: SceneCommand[] = [
        {
          character: 'Naomi',
          startTime: 0,
      ...
      const result = buildTranscript(commands);
      expect(result).toBe('\n<strong>Naomi</strong>: 什么？不可能！\n');
    });

    it('should handle conversation with multiple Chinese sentences', () => {
      const commands: SceneCommand[] = [
        {
          character: 'Quincy',
          startTime: 0,
      ...
      const result = buildTranscript(commands);
      expect(result).toBe(
        '\n<strong>Quincy</strong>: 欢迎学习编程。\n' +
          '\n<strong>Naomi</strong>: 谢谢！我很兴奋。\n' +
          '\n<strong>Quincy</strong>: 让我们开始吧！\n'
      );
    });
  });
});
