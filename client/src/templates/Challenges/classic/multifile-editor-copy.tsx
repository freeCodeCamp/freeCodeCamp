...
interface CopyOfMultifileEditorProps {
  canFocus?: boolean;
  ...
  usesCopyOfMultifileEditor: boolean;
  visibleEditors: {
    indexhtml?: boolean;
    indexjsx?: boolean;
    stylescss?: boolean;
...
const CopyOfMultifileEditor = (props: CopyOfMultifileEditorProps) => {
  const {
    challengeFiles,
    containerRef,
    description,
              ...
              return (
                ...
                >
                  <Editor
                    ...
                    title={title}
                    usesMultifileEditor={usesCopyOfMultifileEditor}
...
CopyOfMultifileEditor.displayName = 'CopyOfMultifileEditor';

export default connect(mapStateToProps)(CopyOfMultifileEditor);
