...
const AboutPage = () => {
    return ( <
        ...
        We also encourage you to join a study group in your city so you can code in -person with other people. <
        /p> <
        ...
        p >
        Yes.Every year, thousands of people who join the freeCodeCamp community get their first software developer job.If you 're
        curious, you can { ' ' } <
        ...
        p >
        If you add up all the people who use our learning platform, read our { ' ' } <
        Link to = 'https://medium.freecodecamp.org' >
        Medium publication <
        /Link>, watch our { ' ' } <
        Link to = 'https://youtube.com/freecodecamp' > YouTube channel < /Link>, and post on { ' ' } <
        Link external = { true }
        to = '/forum' >
        our forum <
        /Link>, each month we help millions of people learn about coding and technology. <
        /p> <
        ...
        /p> <
        h4 > Is freeCodeCamp a replacement
        for a 4 - year degree ? < /h4> <
        p >
        ...
        /p> <
        h4 > Do I have to use CodePen
        for the front end projects ? < /h4> <
        p >
        ...
        freeCodeCamp community in 2014. He is now just one of thousands of active contributors. <
        /p> <
        h4 >
        ...
        /h4> <
        p >
        Yes.Many high school, college, and adult ed programs incorporate freeCodeCamp into their coursework.We 're open source, so no
        ...
        or challenges.The solutions to all of these challenges are already all over the internet. <
        /p> <
        h4 >
        ...
        /h4> <
        p >
        Yes.freeCodeCamp is open source(BSD - 3 license), and most non - sensitive freeCodeCamp data is publicly available.But you must make it clear that you don 't represent freeCodeCamp itself,
        ...
        /Link>
        .And
        if you want a mobile app designed specifically
        for learning to code, we recommend Grasshopper.It 's free and designed by a
        ...
        p >
        We 're a small donor-supported nonprofit. We'
        ve hired several prominent contributors from within the freeCodeCamp community, but you 're much more likely to get a job at{'
        '} <
        ...
        for using the freeCodeCamp.org platform ?
        <
        /h4> <
        p >
        Here are { ' ' } <
