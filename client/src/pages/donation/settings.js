...
import DonateServicebotEmbed from '../../components/Donation/DonateServicebotEmbed';
...
export class DonationSettingsPage extends Component {
  ...
  renderDonationEmailsList() {
    ...
    if (!donationEmails || donationEmails.length === 0) {
      return (
        <p>
          Some of the data associated with your donation is currently
          unavailable. Do not worry, you can contact team@freeCodeCamp.org to
          get your user account updated.
        </p>
      );
    }
