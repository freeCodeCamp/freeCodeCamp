...
const IndexPage = () => (
  <Layout disableSettings={true} landingPage={true}>
    ...
    <Grid className='text-center'>
      <Row>
        <h1 className='big-heading'>After Grasshopper, welcome to freeCodeCamp!</h1>
        <Col>
          <p className='large-p'>
          Congratulations, you already have an early experience in programming thanks to the 
          application Grasshopper! Continue your studies with freeCodeCamp. You will create 
          beautiful projects, get certifications and it's free!
          </p>
        </Col>
        <Spacer />
        <Col md={4} sm={12}>
