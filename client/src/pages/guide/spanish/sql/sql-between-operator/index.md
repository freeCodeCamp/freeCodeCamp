...
Se seleccionan aquellas filas que tienen un valor mayor que el valor mínimo y menor que el valor máximo.
...
Aquí hay un ejemplo usando la tabla de fondos de campaña y la cláusula `HAVING`. Esto devolverá filas donde la suma de las donaciones para un candidato es de entre $ 3 millones y $ 18 millones, según la cláusula `HAVING` en la parte de `GROUP BY` del comando. Más sobre este tipo de agregación en la guía `Cláusula SQL - Having`.
