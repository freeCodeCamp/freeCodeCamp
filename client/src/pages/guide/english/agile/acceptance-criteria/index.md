...
If the team is following Test Driven Development (TDD), it may provide a framework for the automated tests.
The Acceptance Criteria will be the beginnings to write test plan for QA team.
...
Acceptance criteria can be viewed as an instrument to protect Delivery Team. When the Delivery Team commits to a fixed set of stories in the Sprint planning they commit to fixed set of acceptance criteria as well. This helps to avoid scope creep.
