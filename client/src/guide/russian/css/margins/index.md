...
Значения маржи устанавливаются с использованием длин или процентов или `auto` или `inherit` ключевого слова и могут принимать нулевые или отрицательные значения. Начальная, или по умолчанию, значение для всех свойств полей равно 0. В то время как вы можете использовать `inherit` ключевое слово , но оно не может быть использовано вместе со значением длины.
