...
С помощью следующих команд вы будете иметь и без знака apk, чтобы вы могли установить и поделиться с коллегами для целей тестирования. Просто помните, что этот апк не готов загрузить в App Store или в производство. Вы найдете свой новый apk в _android / app / build / output / apk / app-debug.apk_
