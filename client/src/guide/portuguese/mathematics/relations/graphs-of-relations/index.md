...
localeTitle: Gráficos de Relações
---
## Gráficos de Relações

Este é um esboço. [Ajude nossa comunidade a expandi-lo](https://github.com/freecodecamp/guides/tree/master/src/pages/mathematics/relations/graphs-of-relations/index.md) .
