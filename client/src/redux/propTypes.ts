...
import { types as flashTypes } from '../components/Flash/redux';
...
// Examples of future TS with Redux
export enum ActionTypes {
  createFlashMessage = flashTypes.createFlashMessage
}
...
export type ReducerPayloadType = {
  type: ActionTypes.createFlashMessage;
  payload: FlashMessageType;
};

export type ActionGenericType<T> = (payload: T) => ReducerPayloadType;
