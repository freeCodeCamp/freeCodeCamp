      ...
      <Row>
        ...
        <Col lg={8} lgOffset={2} sm={10} smOffset={1} xs={12}>
          <h1
            ...
            data-playwright-label='landing-big-heading-1'
          >
            {t('landing.big-heading-1')}
          </h1>
          <p
            className='big-heading'
            data-playwright-label='landing-big-heading-2'
          >
            {t('landing.big-heading-2')}
          </p>
          <p
            className='big-heading'
            data-playwright-label='landing-big-heading-3'
          >
            {t('landing.big-heading-3')}
          </p>
          <p data-playwright-label='landing-h2-heading'>
