...
const InternetSettings = ({
  ...
  return (
    <Modal onClose={onClose} open={open} size='large'>
      <Modal.Header>{t('profile.edit-internet-presence')}</Modal.Header>
      <Modal.Body alignment='left'>
        <FullWidthRow>
          ...
          >
            <div role='group' aria-label={t('profile.internet-presence')}>
              <FormGroup
            ...
            >
              {t('buttons.save')}{' '}
              <span className='sr-only'>{t('profile.internet-presence')}</span>
            </BlockSaveButton>
          </form>
        </FullWidthRow>
      </Modal.Body>
