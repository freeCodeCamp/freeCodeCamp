...
class TypingLayout extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <div className={`typing-layout ${landingPage ? 'landing-page' : ''}`}>
...
TypingLayout.displayName = 'TypingLayout';
TypingLayout.propTypes = propTypes;
