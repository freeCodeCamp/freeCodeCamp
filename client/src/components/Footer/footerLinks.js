...
export default [
  ...
  [
    ...
    { to: '/news/best-javascript-tutorial/', text: 'JavaScript Tutorial' },
    { to: '/news/best-react-javascript-tutorial/', text: 'React Tutorial' },
    ...
    { to: '/news/best-angular-tutorial-angularjs/', text: 'Angular Tutorial' },
  ...
  [
    ...
    { to: '/news/linux-example-bash-command-line/', text: 'Linux Example' },
    ...
    { to: '/news/the-best-bootstrap-examples/', text: 'Bootstrap Example' },
  ...
  [
    ...
    {
      to:
        '/news/11-things-i-learned-reading-the-css-grid-specification-fb3983aa5e0/',
      text: 'CSS Grid Guide'
    },
