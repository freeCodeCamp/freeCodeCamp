...
class UsernameSettings extends Component<UsernameProps, UsernameState> {
  ...
  renderAlerts(
    ...
    if (!validating && error) {
      ...
      return (
        <FullWidthRow>
          <Alert bsStyle='danger' closeLabel={t('Close Alert')}>
    ...
    if (!validating && !isValidUsername) {
      return (
        <FullWidthRow>
          <Alert bsStyle='warning' closeLabel={t('Close Alert')}>
    ...
    if (validating) {
      return (
        <FullWidthRow>
          <Alert bsStyle='info' closeLabel={t('Close Alert')}>
    ...
    if (!validating && isValidUsername && this.state.isUserNew) {
      return (
        <FullWidthRow>
          <Alert bsStyle='success' closeLabel={t('Close Alert')}>
