...
import { isColdStored, getColdStorage, saveToColdStorage } from './cold-reload';
...
const {
  ...
  document,
  ga,
  __fcc__: { data: ssrState = {}, csrf: { token: csrfToken } = {} }
} = window;
const epicOptions = {
  isDev,
  window,
...
const defaultState = isColdStored() ? getColdStorage() : ssrState;
