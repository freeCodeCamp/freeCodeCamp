...
const glitchReg = /glitch\.(com|me)/gi;
const throwIfGlitchDetected = cond([
  [
    testHTMLJS,
    function({ contents }) {
      if (glitchReg.test(contents)) {
        throw new Error('Glitch.com or Glitch.com should not be in the code');
      }
    }
  ],
  passToNext
