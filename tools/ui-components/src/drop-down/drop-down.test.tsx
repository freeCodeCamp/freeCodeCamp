...
describe('<DropDownButton>', () => {
  ...
  it('should render button with direction to up', () => {
    ...
    expect(unorderedList).toHaveClass(
      'shadow-lg bg-foreground-primary text-background-primary text-center ring-1 ring-black ring-opacity-5 focus:outline-transparent origin-top-right absolute py-1 z-10 transform -translate-y-full top-0'
    );
  });
