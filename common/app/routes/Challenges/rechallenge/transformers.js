...
function loopProtectHit(line) {
  var err =
    'Exiting potential infinite loop at line ' +
    line +
...
const addLoopProtect = _.partial(vinyl.transformContents, contents => {
...
export const addLoopProtectHtmlJsJsx = _.cond([
  [
    _.overEvery(
      testHTMLJS,
      _.partial(vinyl.testContents, contents =>
...
export const replaceNBSP = _.cond([
  [
    testHTMLJS,
    _.partial(vinyl.transformContents, contents =>
...
export const babelTransformer = _.cond([
  [
    testJS$JSX,
    _.flow(
      _.partial(vinyl.transformHeadTailAndContents, babelTransformCode),
