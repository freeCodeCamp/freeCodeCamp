...
import { createErrorObservable, challengeSelector } from '../../../redux';
  ...
  return (
    Observable.of(document)
      ...
      .flatMapLatest(() => {
        ...
        const buildAndFrameMain = actions
          ::ofType(
          ...
          .filter(
            () =>
              !codeLockedSelector(getState()) && showPreviewSelector(getState())
          )
          .flatMapLatest(() =>
  ...
  return (
    Observable.of(document)
      ...
      .flatMapLatest(() => {
        ...
        const buildAndFrameChallenge = actions
