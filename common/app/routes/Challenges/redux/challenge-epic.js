...
export function challengeUpdatedEpic(actions, { getState }) {
  return (
    actions
      ...
      //  if the challenge isn't loaded in the current state, this will be an
      // empty object. We wait instead for the fetchChallenge.complete to
    ...
    try {
      ...
      if (nextChallenge.isLocked) {
        return Observable.of(
          makeToast({
            message:
              'The next challenge has not been unlocked. ' +
