...
import { addNS, createTypes } from 'berkeleys-redux-utils';

import { createPoly, setContent } from '../../utils/polyvinyl.js';

const ns = 'files';

export const types = createTypes(['updateFile', 'createFiles'], ns);
...
export default addNS(ns, function reducer(state = {}, action) {
