...
*   [Функциональный свет JS](https://github.com/getify/Functional-Light-JS)
    ...
    Эта книга предназначена для того, чтобы быть полезным компаньоном для тех, кто хочет (повторно) обнаружить множество аспектов JavaScript. С самого начала программирования до интерфейсной и внутренней веб-разработки, многие темы охватываются простым и доступным способом. Никаких предварительных знаний не требуется!
