...
JavaScript однопоточный, что означает, что два бита скрипта не могут работать одновременно; они должны следовать один за другим. Promise - это объект, который представляет собой возможное завершение (или отказ) асинхронной операции и ее итоговое значение.
