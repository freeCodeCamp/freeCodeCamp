...
*   [Получи помощь в Git](#get-help-in-git)
*   [Источники](#sources)
...
**Каталог Git** (расположенный в `YOUR-PROJECT-PATH/.git/` ) - это место, где Git хранит все необходимое для точной отслеживания проекта. Это включает метаданные и базу данных объектов, которая включает сжатые версии файлов проекта.
