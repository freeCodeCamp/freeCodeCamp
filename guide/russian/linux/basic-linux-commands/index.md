...
10.  **щелкните правой кнопкой мыши** - скопируйте и вставьте
...
12. **cat** - вывод содержимого файла.
*   Отличное от "less" тем, что просто выводит текст файла в окне терминала целиком без возможности манипуляций с ним (например, перемещения вверх-вниз).
