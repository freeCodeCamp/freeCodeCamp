...
По соглашению, getters начинаются с get, за которым следует имя переменной с заглавной буквы. Стартеры начинаются с set, за которым следует имя переменной c заглавной буквы.
...
Метод getter возвращает значение переменной. Метод setter принимает параметр и присваивает его переменной.

Как только геттер и сеттер были определены, мы можем использовать их в методе Main:
