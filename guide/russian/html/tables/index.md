...
Таблица HTML определяется с помощью тега ```<table>```.

Каждая строка таблицы определяется с помощью тега ```<tr>```. Внутри строки могут быть заголовки таблиц или данные таблицы.
