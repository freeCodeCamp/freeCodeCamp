...
Роль доступности в [веб-]разработке заключается в понимании перспективы и потребностей пользователя, а также в знание того, что Интернет и приложения являются решениеми для людей с ограниченными возможностями.

В наши дни все новые и новые технологии изобретаются, чтобы облегчить жизнь разработчиков, а также пользователей. В какой степени это хорошо - это дискуссия для другого времени, на данный момент достаточно сказать, что панель инструментов разработчика, в особенности веб-разработчика, так же постоянно меняется, как и так называемые «темные искусства», согласно нашему другу Снейп.

Одним из инструментов в этой панели должена быть доступность. Это инструмент, который в идеале должен использоваться на одном из первых шагов написания любой формы веб-контента. Однако этот инструмент часто не так хорошо представлен в наборе инструментов большинства разработчиков. Это может быть связано как с простым случаем, когда он [разработчик] не знает о их существовании, так и с экстремальной ситуацией, когда он не заботится об этом.

В моей жизни как пользователю, а затем разработчику, который пользуется доступностью в любом виде контента, я видел обе стороны этого спектра. Если вы читаете эту статью, я предполагаю, что вы находитесь в одной из следующих категорий:
