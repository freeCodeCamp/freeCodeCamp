...
## Итак, что же такое доступность?

Термин "доступность" сам по себе иногда немного вводит в заблуждение. Его иногда еще называют инклюзивным дизайном.

Если ваш сайт находится в Интернете, доступный любому, у кого есть веб-браузер, в некотором смысле можно сказать, что веб-сайт доступен для всех с помощью веб-браузера.
...
*   Если вы выделяете важную часть вашего сайта определенным цветом, узнает ли об этом слепой человек?
*   Если вы добавляете на свой сайт изображения, которые передают важную информацию, как об этом может узнать слепой или слабовидящий человек?
*   Если вы хотите использовать приложение с клавиатурой или MouthStick, будет ли это возможно и предсказуемо?
*   Реагирует ли ваше приложение на ориентацию устройства, и что, если пользователь не может физически изменить его?
*   Если кому-то требуется больше времени для заполнения формы, позволяет ли это ваще приложение?
*   Ваше приложение все еще работает (прогрессивное повышение), предполагая, что JavaScript не загружается вовремя?
*   Если ваш сайт очень ресурсоемкий, сможет ли кто-то с медленным или непостоянным доступом в интернет читать ваш контент?

Здесь открывается доступность. Доступность в основном сделает ваш контент дружественным, а так же легко доступным для максимально возможного количества людей. Это включает людей, которые являются глухими, слабовидящими, слепыми, страдающими дислексией, немыми, на медленном соединении, дальтониками, страдающими эпилепсией, умственной усталостью, возрастом, физическими ограничениями и т. Д.
