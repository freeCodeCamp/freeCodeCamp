...
Это свойство может использоваться для изображений, видео или любых других носителей. Его также можно использовать с свойством `object-position` чтобы получить больше контроля над отображением носителя.
...
Также есть полипол для неподдерживаемого браузера (в основном IE). https://github.com/anselmh/object-fit
