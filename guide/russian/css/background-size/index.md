...
Свойство background-size определяет размер фоновых изображений. Вы можете установить длину или процент, при этом первое значение будет шириной, а второе - высотой. Вы также можете использовать одно из следующих пяти значений:
