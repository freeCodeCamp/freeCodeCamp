...
Чтобы понять различия между каждым типом коллекции, когда использовать каждый из них и как конвертировать их между собой, может потребоваться проверить другие типы коллекции и напомнить себе, что делает их особенными.
