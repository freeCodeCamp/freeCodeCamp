...
Amazon Web Services, или кратко AWS, является дочерней компанией Amazon.com, которая предоставляет платформы облачных вычислений по требованию для отдельных лиц, компаний и правительств на основе платной подписки с возможностью бесплатного доступа на 12 месяцев. Он наряду с Microsoft Azure и облачной платформой Google считается одним из трех основных поставщиков публичных облаков.
