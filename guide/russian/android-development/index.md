...
Ознакомьтесь с руководствами в этой папке, чтобы узнать о 4 [основных компонентах](core-components/index.md), составляющих Android приложение, и о том, как вы можете приступить к работе, начав с простого приложения, с последующим углублением в более сложные темы, такие как фрагменты и систему сборки Gradle. Затем ознакомьтесь с руководством по спецификациям материального дизайна, чтобы узнать, как сделать ваши приложения красивыми и удобными для пользователя.
