...
Android приложения могут стать отличным и интересным способом окунуться в мир программирования. Официально программисты могут использовать Java, Kotlin или C ++ для разработки для Android, и хотя, не смотря на ограничения некоторых API, используя инструменты, разработчики могут писать код на большом количестве языков, включая JavaScript, C или ассемблер. Возможности бесконечны.

От простых игр и служебных приложений до полномасштабных музыкальных плееров: существует множество возможностей, чтобы создать что-то значимое под Android. Сообщество разработчиков Android широко распространено, а документацию и ресурсы легко найти в интернете, поэтому вы сможете решить любые проблемы, с которыми столкнётесь.

Конечно, существует определенная кривая обучения: перед тем как использовать Android фреймворки, необходимо изучить основные компоненты, составляющие приложение, но как только вы их освоите, то остальное придет естественным образом.

Кривая обучения, используемая в Android, имеет относительно меньший наклон по сравнению с изучением других технологий, таких как NodeJS. Также относительно легко понять и внести вклад в проект AOSP, поддерживаемый Google. Проект можно найти [здесь](https://source.android.com/)
