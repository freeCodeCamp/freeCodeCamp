...
Все содержимое каталога остается неизменным. Единственные атрибутом каталога, который изменяется, является имя каталога. Таким образом, команда mv действует намного быстрее по сравнению с командой cp.
