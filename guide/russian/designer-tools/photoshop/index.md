...
Adobe Photoshop представляет собой растровое (пиксельное) программное обеспечение для редактирования изображений, которое используется широким расположением создателей контента для создания и редактирования графики / фотографии. Разработчики или дизайнеры обычно используют Photoshop для создания или изменения активов и фотографий для веб-сайтов. Некоторые разработчики также используют фотошоп для дизайна веб-сайтов и макетов, но все чаще используются другие инструменты, такие как Adobe Experience Design и Sketch. Adobe Photoshop доступен как для Windows, так и для Mac, но в настоящее время это не Linux.

Обычная вещь, которую разработчик может делать в фотошопе, - это изменение размера и разрешения пикселей (72 точек на дюйм для Интернета) изображения для правильного использования в Интернете и изменения изображений для получения прозрачных фонов (с использованием типов файлов .gif и .png). Общепринятой практикой является уменьшение размера изображения, которое должно быть самым большим, которое необходимо будет использовать на веб-сайте. Это уменьшает пространство сервера и время загрузки, а Photoshop - это инструмент для достижения этого.
...
*   Photoshop использует пиксели. Убедитесь, что вы создали достаточно большие активы, поскольку масштабирование больше невозможно без деградации.
*   Загружаемые файлы доступны для Windows и Mac через подписки Adobe.
*   Становление менее часто используется для макетов веб-сайтов / пользовательского интерфейса.
...
*   Создание [стилей стиля](http://styletil.es/)
...
Photoshop создает растровые изображения, что означает, что вы можете видеть пиксели на изображении, если вы приближаетесь близко.

С другой стороны, Illustrator создает векторную графику. Векторная графика может быть изменена в любую форму без какой-либо пикселизации.
