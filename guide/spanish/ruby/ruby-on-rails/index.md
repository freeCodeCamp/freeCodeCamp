...
4.  Ejecutar el servidor de rails y ver si todo fue en consecuencia también es rápido:
...
| ----------- | ------- |  
| app / | Contiene los controladores, modelos, vistas, ayudantes, correos, canales, trabajos y activos para su aplicación. Te centrarás en esta carpeta por el resto de esta guía. |  
...
| public / | La única carpeta vista por el mundo tal como es. Contiene archivos estáticos y activos compilados. |  
