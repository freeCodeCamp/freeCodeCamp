...
Generalmente, puede _declarar_ (es decir, crear) variables según la siguiente sintaxis: < _tipo de datos_ > <nombre de _variable_ >;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwNjg5OTUyMiwtMjM2MTI0ODQwLDE1Nz
