...
4.  La clase String posee un nombre de método `length()` ombre de método `length()` , mientras que las matrices tienen una longitud de nombre de atributo.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4MzgzODk4MywtMTQ4NzYxNDE0LDgyMD
