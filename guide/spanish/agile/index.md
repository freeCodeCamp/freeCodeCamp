...
Agile hace hincapié en preguntar a los usuarios finales qué es lo que quieren, y en mostrarles con frecuencia demostraciones del producto a medida que se desarrolla. Esto contrasta con el enfoque de "Cascada", desarrollo basado en especificaciones, y lo que los profesionales de Agile denominan "Gran diseño por adelantado". En estos enfoques, las características se planifican y presupuestan antes de que comience el desarrollo.
...
Hay muchos tipos diferentes de metologías ágiles, incluyendo Scrum y Programación Extrema.
