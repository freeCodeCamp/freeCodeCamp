...
Sprint Review es una de las reuniones clave de Scrum (junto con Sprint Planning, Daily Stand Up, Retrospective y Grooming).

Al final del Sprint, el equipo Scrum organiza una sesión "Invite the World" para mostrar lo que se acaba de completar y aceptar. Los invitados son el Equipo Scrum, las partes interesadas, los gerentes, los usuarios; Cualquier persona interesada en el proyecto.

Mantener estas sesiones cada Sprint es importante. Puede ser un cambio de mentalidad; mostrando trabajo incompleto a sus gerentes y partes interesadas. Pero en el concepto de "Fail Fast", hay un valor increíble en obtener retroalimentación temprana sobre su trabajo incremental. Su equipo puede corregir el curso si es necesario, minimizando el trabajo perdido.

Dado que el Propietario del producto (PO) a menudo se presenta en la Revisión de Sprint, el Scrum Master generalmente capturará los comentarios, tal vez facilitará las discusiones, y luego trabajará con el PO para agregar nuevas Historias de usuarios al Backlog y darles prioridad.

La agenda también puede incluir una revisión del Backlog (incluido el valor y la prioridad), analizando lo que está programado para la siguiente iteración o dos, y lo que se puede eliminar del Backlog.
