...
> se debe escribir un caso de prueba para su código incluso antes de escribir el código
...
[Introducción de Agile Data a TDD](http://agiledata.org/essays/tdd.html) 

Wiki sobre [TDD](https://en.wikipedia.org/wiki/Test-driven_development)

Martin Fowler: [está muerto el TDD?](https://martinfowler.com/articles/is-tdd-dead/) (Una serie de conversaciones grabadas sobre el tema).
