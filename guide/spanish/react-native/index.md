...
2.  [Expo](https://expo.io) - Mejor para crear prototipos de una aplicación o si se trata de una etapa anterior. Con Expo, incluso puede crear una aplicación rápida con las funciones de arrastrar y soltar desde snack.expo.io en el navegador.
1. [Ignite CLI](https://github.com/infinitered/ignite) - Permite a los desarrolladores crear fácilmente una nueva aplicación React Native con complementos. Ignite CLI también permite a los desarrolladores configurar fácilmente las mejores prácticas.
