...
La mayoría de las CPU modernas utilizan una arquitectura de 64 bits, lo que significa que utilizan direcciones de memoria de 64 bits. Las CPU más antiguas utilizaban arquitecturas de 32 bits, 16 bits e incluso de 8 bits. El número más grande que puede almacenar una CPU de 64 bits es 18,446,744,073,709,552,000. Una CPU necesita direcciones de memoria para obtener valores específicos de la RAM. Si llamamos a la longitud de las direcciones de memoria n, 2 ^ n es la cantidad de celdas de memoria que una CPU puede dirigir.
