...
Es util para configurar los parametros de la interfaz de redes

2.- traceroute

Muestra la ruta que los paquetes de datos utilizan para llegar al destino.
El IP destino es un parametro necesario para este comando

3.- dig

Se utiliza para saber el nombre de los servidores DNS

4.- telnet

Utiliza el protocolo telnet y es util para establecer una conexion entre dos servidores o hosts
