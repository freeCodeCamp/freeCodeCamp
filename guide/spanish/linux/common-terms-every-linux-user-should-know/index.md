...
*   **Distro:** es una palabra abreviada para 'distribución'; y una distribución es una marca particular de sistema operativo GNU / Linux, como Redhat, Fedora, Ubuntu y Debian. Cada distribución complementa al sistema operativo GNU / Linux con un conjunto de software particular que varía en función del objetivo perseguido.
    
*   **Shell:** este es el programa que lee la entrada del comando y ejecuta los comandos especificados. El signo de dólar (\`$ ') que precede al cursor se denomina indicador de shell; le indica que el sistema está listo y esperando entradas en forma de comandos. GNU / Linux soporta numerosos tipos de shell como puedan ser, `bash`, 'sh', `zsh`, `ksh`, etc, aunque la shell por defecto suele ser `bash`.
