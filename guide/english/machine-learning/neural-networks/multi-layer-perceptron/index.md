...
Multi Layer Perceptron is a type of feed-forward neural network, consisting of many naurons. The layer is essentially dicided into three parts: the Input Layer, the Hidden Layers and the Output Layer. Here is an image of a simple MLP:
