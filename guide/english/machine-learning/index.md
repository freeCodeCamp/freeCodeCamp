...
Machine learning is exactly like how a human being learns. For example, if a human wants to learn how to play poker, it will first learn the rules. Then it will try to get experience by playing the game. This experience is nothing but a huge data set for a machine by using which it can make intelligent decisions regrding the proposed problem.
