...
2. Divide training set into input object (features) and output object (classes or values)
...
5. Run the algorithm on the training set and use the model for predictions
