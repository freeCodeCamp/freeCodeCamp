...
### Problem
Decision trees by themselves are prone to **overfitting**. This means that the tree becomes overtuned to the features of the training data that it has difficulty making decisions for data it has never seen before.
