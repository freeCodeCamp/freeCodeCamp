...
### Popularly Used Libraries
			...
			*Pattern, comes with various NLP tools (PoS tagging, n-Grams, sentiment analysis, WordNet), 
                         machine learning capabilities (vector space models, clustering, classification).  
