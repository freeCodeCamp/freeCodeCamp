...
To resolve problems that game frameworks had, tools like libGDX and OpenGL were developed. They helped game development to be a lot faster and easier, providing lots of pre-made functions and features. However, understanding the framework and entry into the industry were still difficult for those coming from non-programmer backgrounds, a common case in the game development scene.
