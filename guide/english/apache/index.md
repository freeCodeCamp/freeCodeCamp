...
Notable features include server-side scripting, authentication mechanism and database support, and the ability to support multiple programming languages.
