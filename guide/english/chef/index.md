...
<p>The client will check in every now and again to make sure that no changes have occurred, and nothing needs to change. If it does, then the client will deal with it. Patches and updates can be rolled out over your entire infrastructure by changing the recipe. There is no need to interact with each machine individually.</p>
