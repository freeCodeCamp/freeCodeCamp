...
<p>There is a Chef server which stores each of these cookbooks.  As a new chef client node checks in with the server, recipes are sent to tell the node how to configure itself.</p>
