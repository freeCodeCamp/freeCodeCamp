...
1. Set the distance value for initial vertex to zero, and all other vertices in the graph to
   infinity. This is done because for any real number number x, (x < ") is true (step 3).
...
4. Once all neighbors of current have been considered, mark current as finalized.1 A
