...
You can also clone a project from github by using the command `git init` followed by the link. An example of a link is `https://github.com/example/example.git` 
