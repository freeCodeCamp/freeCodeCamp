...
Only members of the Development team are required to attend the Daily Stand-up. Typically, the Scrum Master and Product Owners will also attend, but they are not required. Scrum Master may facilitate the stand-up meeting as needed.   The Product Owners and any management that may attend can listen only. 
