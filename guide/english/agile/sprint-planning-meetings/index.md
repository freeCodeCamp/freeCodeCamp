...
### Main part
It is of high value for the team to split the meeting into two parts by asking these two questions: 
* **What** should the team plan for the upcoming Sprint? 
* **How** should the team (roughly) tackle the items planned?

#### What
In the What phase, the team starts with the top of the ordered Product Backlog. The team estimates the effort required for the items and forecasts what they can move into the Sprint Backlog. If needed they could ask/discuss items with the PO, who has to be in attendance for this meeting. 

#### How
In the How phase, the team briefly discusses every picked Sprint Backlog item with the focus on how they will tackle it. SM helps the team not to deep dive into discussion and implementation details. It is very likely and good if more questions for the PO are asked or refinements to the items or backlog is done by the team. 
