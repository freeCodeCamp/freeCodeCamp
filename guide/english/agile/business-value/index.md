...
Like the development team uses story points for effort, the business partners, users, and stakeholders can use story points to assess business value. Using a relative story pointing exercise, they can choose a story that they all agree is of average importance, then compare the remaining stories to determine their value (lower, higher, the same). 
