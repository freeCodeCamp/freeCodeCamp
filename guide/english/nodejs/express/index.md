...
We can confirm that Express has correctly been installed in two ways. First, there will be new section in `package.json` file named `dependencies` under which our Express exists:
