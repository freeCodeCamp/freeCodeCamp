...
std::vector.empty(); // Returns whether the vector is empty (i.e. whether its size is 0)
std::vector.resize(n); // Change size of vector to n
std::vector.capacity(); // returns capacity of vector
```
