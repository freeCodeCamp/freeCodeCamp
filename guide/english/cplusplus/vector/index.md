...
#### Time Complexity of std::sort() Function

The time complexity for std::sort() is O(N log N) in the best,
average, and worst case.

The sorting algorithm used in std::sort() is Introsort, which is a hybrid sorting algorithm; it uses multiple sorting algorithms.
