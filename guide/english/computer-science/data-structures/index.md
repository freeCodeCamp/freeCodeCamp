...
Data structures are ways of collecting and organising data in such a way that we can perform operations on these data effectively. Data structures are about rendering data elements in terms of some relationship, for better organization and storage. For example, we have data player's name "Virat" and age 26. Here "Virat" is of String data type and 26 is of integer data type.
...
In computer memory, i.e RAM, different data structures are created like stack, queue, linklist, heaps, etc. according to the requirements of the program to use the memory efficiently. 
