...
Visual Design deals not only with how applications look to the user, but the way the interaction feels as well. It can be seen as the digital equivalent of graphic design. And as such, visual design should also strive to follow Dieter Rams' well-known principles of good design.
