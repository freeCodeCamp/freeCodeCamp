...
Modern computers come equipped with either and internal built in or an external form of GPU, A GPU is similar to a Processor or CPU, It carries out and performs arithmetic, logical, control and input/output (I/O) operations specified by the instructions, but are specifically catered towards graphical workloads, It is a CPU dedicated for the graphic intensive sets of instructions thus the name GPU.
