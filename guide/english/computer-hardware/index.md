...
### Storage (SSD or HDD)
The Solid State Drive (SSD) or Hard Disk Drive (HDD) are used to store information on the computer. It retains the memory even after loss of power. Solid State Drives are often used to load operating systems since they are a great deal faster than a traditional Hard Disk Drive. 
