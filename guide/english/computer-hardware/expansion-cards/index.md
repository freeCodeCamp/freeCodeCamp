...
* Storage - There also some few Storage Solutions as expansion cards available, delivering amazing data transfer rates in a 0.5 - 3 GB/s are. They are mostly in the high tier price range, which makes them unattractive for most consumers (ex. Intel Optane 900P)
