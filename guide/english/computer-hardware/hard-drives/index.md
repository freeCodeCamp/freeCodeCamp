...
Solid state drives use integrated circuits to store data. Therefore, an SSD has no moving parts like the HDD. This makes them less prone to physical shocks, run silently, and have faster read/write times thanks to not needing to locate the data physically.
...
Hard drives come in various storage capacities. As of October 2018 the largest HDD is 15TB (by [Western Digital](https://www.zdnet.com/article/worlds-biggest-hard-drive-meet-western-digitals-15tb-monster/), and as of February 2018 the largest SSD is 30TB by [Samsung](https://www.theverge.com/circuitbreaker/2018/2/20/17031256/worlds-largest-ssd-drive-samsung-30-terabyte-pm1643). Typical computers come with 256GB (256 million bytes) to 1TB or more of internal storage in HDDs or SSDs. Laptops usually use Solid State Drives because they are faster, lighter, and contain no moving parts, making them less likely to fail due to impact. 
