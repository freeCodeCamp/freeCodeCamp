...
All the declared members must be implemented in the inherited class, otherwise will have an compile error.
as a convention we will mark interface with the letter I at the beginning (IMyInterface || IUserOptions).
