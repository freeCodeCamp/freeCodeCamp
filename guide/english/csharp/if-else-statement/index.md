...
The If-Else statement executes a block of code depending on whether your precondition is fullfilled or not. It requires a boolean expression to set the condition, so there must be a comparison.
