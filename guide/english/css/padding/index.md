...
## Common Pitfalls
Do note, while padding and margins are similar in 'adding spaces between elements' context. Padding is included into the element dimensions, while margins are excluded from the element dimensions.
