...
```
**my-notes: when you go to developer mode (CTRL+SHIFT+I) you can see a preview to what you want to do with the padding online and than to move it to the code  you write.
