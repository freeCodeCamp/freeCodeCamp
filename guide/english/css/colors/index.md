...
### HEX
Its recommended to set color to hex instead of just color name, use backgroung: fefefe; istead of background:white;
this is because, different browsers at different point has a way they display a color, but when it is hex, it is same accross all browsers
