...
Another suggestion for beginners is the W3C's [Starting with HTML + CSS](https://www.w3.org/Style/Examples/011/firstcss) which teaches how to create a style sheet.

The site [CSS Zen Garden](http://www.csszengarden.com/) is a great example how the same html can be styled using css many different ways to look totally unique!
