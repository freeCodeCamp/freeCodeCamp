...
ID should be avoided when styling if possible. As it has high specificity and it can be overriden only if you write inline styles, or add styles into ```<style>```. The weight of ID overrides the class selectors and type selectors.
