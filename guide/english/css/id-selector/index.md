...
ID should be avoided when styling if possible. As it has high specificity and it can only be overriden with inline styles, or by adding styles into ```<style>```. The weight of ID override class selectors and type selectors.
