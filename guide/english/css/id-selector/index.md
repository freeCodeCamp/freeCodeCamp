...
ID should be avoided when styling if possible. As it has high specificity and it can be overriden only if you use inline styles, or add styles into ```<style>```. The weight of IDs override class selectors and type selectors.
