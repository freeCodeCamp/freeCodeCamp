...
The opacity property specifies the opacity/transparency (how see through an element is), that is, the degree to which the content behind the element is visible.
