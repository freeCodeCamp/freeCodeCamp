...
.class-name{
 ...
 ```
The example above sets the background to be black with 50% opacity. The last value of an rgba value is the alpha value. An alpha value of 1.0 (1 for short) equals 100%, 0.5 (.5 for short) equals 50% and 0.0 (0 for short) equals 0%. We use this method to add transparency to an element without affecting the content inside.
