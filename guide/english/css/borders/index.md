...
### Border: All in One
While it is nice that CSS allows a web developer to be very specific in creating a customized border, sometimes its easier to create a uniform border all in single line of CSS code.
