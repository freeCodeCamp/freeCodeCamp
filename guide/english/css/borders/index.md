...
Our personal favorite CSS attribute, allows you to completely customize the borders that appear around HTML elements. With HTML, it used to be impossible to place a border around an element, except for on a table. CSS Borders lets you create crisp, customized border styles with very little work, compared to the antiquated methods of HTML.
