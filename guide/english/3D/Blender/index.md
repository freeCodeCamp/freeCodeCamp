...
The Blender software is a cross-platform program that runs on Windows, Linux and Mac. Blender is supported by The Blender Foundation, which is made up by a worldwide community. Developers, animators, scientists, experts and even hobbyists empower the software's development by constantly maintaining, fixing and making new features for a suitable and more responsive user experience.
