...
no one can be 100% that their data is secure.There are also hardware hacks, i.e. holes in hardware that people with malicious intent can abuse, some great recent examples of this are the Meltdown and Spectre which accidentally allow websites access to memory that they shouldn't have access to. 
