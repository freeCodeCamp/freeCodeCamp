...
* Has an intuitive understanding of human psychology
* Is charming and persuasive
* Is patient and observant
* Is adept at predicting human behavior based on exploiting the human need to be helpful, curious, greedy and vain
...
See "More Information" for a link to test your phishing knowledge and see if you can tell the difference between a real email and a phishing email.
...
The steps that an individual can take to protect themselves from these attacks include:
* Avoid sharing sensitive data at all, if possible.
* If you must share, verify the source before giving them sensitive data.
* Be aware of random emails or phone calls claiming to be friends, family, coworkers, institutions, etc.
* Be aware of people in real life asking for information they shouldn't necessarily require.
