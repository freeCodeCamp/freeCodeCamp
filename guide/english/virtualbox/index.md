...
VirtualBox is an free open source program from Oracle, for enterprise as well as home use. It allows users to virtually install many operating systems on virtual drives, including Windows, BSD, Linux, Solaris, etc. 
