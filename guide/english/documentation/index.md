...
Code documentation is a way developers write their code to create the best possible versions of their functions. Code documentation lets the newbie to get comfortable with the customs of the particular module, functions etc for a particular programming language. It is always recommended to go with the documentation before debugging your code, this helps you to debug effectively.

For example, if you happen to pass along your code to an absolute beginner, they should be able to follow along through comments and appropriate variable names. Structuring the code in a spaced, readable manner helps too. 
...
*[Wikipedia article](https://en.wikipedia.org/wiki/Software_documentation)
