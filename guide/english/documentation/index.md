...
Code documentation is a way that developers write their code in order to create the best versions of their functions as possible. Code Documentation helps the newbie to become comfortable with the customs of the particular module, the functions etc, for a particular programming language. It is always recommended to go with the documentation before debugging your code, this helps you to debug effectively.

For example, if you happen to pass along your code to an absolute beginner, they should be able to follow your code through the comments, and appropriate variable names and that means structuring the code in a spaced, readable manner. 
