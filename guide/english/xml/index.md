...
## Extensible Markup Language (XML)
 ...
 ## Syntax of XML
  XML syntax refers to the rules that determine how an XML application can be written. The XML syntax is very straight forward, which makes XML very easy to learn.
...
The main difference between XML and HTML is that XML was designed to organize raw data and nothing more, whereas HTML not only organizes data, but also visually presents it via text, images, animation, and so on.

Also unlike HTML, XML does not use predefined tags; it uses user-defined tags instead.

Consider the following benefits of XML: 
...
And its main achievement was that it became a W3C Recommendation as early as February 1998.
