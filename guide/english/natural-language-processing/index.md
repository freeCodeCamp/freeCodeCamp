...
It has always been our dream to make machines understand our language. Ever since Chomsky came up with Context free grammars, linguists have been thinking how to understand context dependent grammars. It is thus only natural that an academic disciple had evolved around this topic.

## How Natural Language Processing works

Earlier, NLP employed rule based approach, i.e. all the rules were hard coded(Eg writing grammar). Yet this wasn't very effective to the variations in the language models. Currently, NLP processes carry on using Artificial Intelligence. They often rely on Deep Learning. This way the machine can focus on most common cases. Otherwise this wouldn't be easy with hand-written rules . These can  only be made accurate by increasing the complexity of the rules. Nowadays the model learns through the analysis of large corpora of typical real-world examples. This method requires enormous amount of labelled data , which is a big hurdle for NLP.
