...
## How Natural Language Processing works
Early on, NLP employed a rule-based approach, i.e. all the rules were hardcoded (E.g. writing grammar). However, this wasn't very effective due to the variations in the language models.
...
- SEMANTIC ANALYSIS:A mapping is made between syntatic structures and  objects in the task domain
- DISCOURSE INTEGRATION: Meaning of a sentence may depend on the sentence that precedes it and may influence the meaning of the sentence that follows it.
