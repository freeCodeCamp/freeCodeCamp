...
This line is only executed if you run your script as an executable. For example, when you type `./scriptname.extension`, it will look at the top line to find out the interpreter. If you run the script as `bash scriptname.sh`, the first line is ignored. 
