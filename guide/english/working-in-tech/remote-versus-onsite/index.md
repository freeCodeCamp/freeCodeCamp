...
Because in-person communication occurs less frequently (if at all), remote teams often rely more on communication software like [Slack](https://slack.com/) (this replaced HipChat for those unfamiliar) and [Skype](https://www.skype.com/).
