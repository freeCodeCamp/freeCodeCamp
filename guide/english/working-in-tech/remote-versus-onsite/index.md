...
Because in-person communication occurs less frequently (if at all), remote teams often rely more on communication software like [Slack](https://slack.com/) and [Skype](https://www.skype.com/) and collaboration software like [Trello](https://trello.com/) and [Jira] (https://www.atlassian.com/software/jira).
