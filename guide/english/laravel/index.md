...
Laravel Dump Server, introduced in Laravel 5.7, allows you to inspect the data by dumping it to the console or a html file instead of its default behavior of dumping the collected data to the browser.
