...
15. **sudo** - run command at root
- Use 'sudo' before any command to run that command at the root level (the most powerful level). This can be especially useful when you don't have the privileges to use commands. Stands for 'super user do'.
