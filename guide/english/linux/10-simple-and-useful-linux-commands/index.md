...
12. `top` Commands
This command displays and shows updated process information. Use to determine what processes are running, how much memory is being used, if swap memory is being used and how much CPU a process is using.
