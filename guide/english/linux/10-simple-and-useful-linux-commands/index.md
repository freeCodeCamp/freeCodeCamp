...
Here are the list of commands frequently used by adminstrators. This is not a complete list, but it’s a compact list of commands to refer to when needed. 
