...
1. `shutdown` Use shut down to turn off the power and shutdown the system. Example: `shutdown -h now` shuts down system immediately. `shutdown -h +5` shuts down system after five minutes.
