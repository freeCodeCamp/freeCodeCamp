...
commands to copy file or folders
for folders
cp -r /url/folders /url/destination

for file
cp /url/file /url/destination

for all files
cp /url/* /url/destination

for selective files
cp /url/file1 /url/file2 /url/destination
