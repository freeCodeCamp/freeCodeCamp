...
Ubuntu - The derivative of the stable Debian system, Ubuntu thrives in the easy to use and up to date environment.
Mint - Based on Ubuntu and Debian, this OS has great features like Ubuntu's PPA compatibility, the apt package manager. The base mint distribution remind of Windows, this can be a nice characteristic for users coming from Windows. 
