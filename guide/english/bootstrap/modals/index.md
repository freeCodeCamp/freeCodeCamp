  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        This is the Modal Body your content will go here.
      </div>
...
h) `.fade` class to add animations of fade when model pops-up or closes.
  
  
#### More Information : 

If you want to explore ****Bootstrap 4.1 Latest**** :
<a href='https://getbootstrap.com/docs/4.1/components/modal/' target='_blank' rel='nofollow'>Bootstrap Modal v4.1</a>
