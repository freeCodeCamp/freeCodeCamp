...
* Cards are bordered boxes with a small amount of padding around the content inside them, which can be used to conveniently display a specific set of information.
...
### Cards Overlay
----
* To apply an image to the background of the card and displaying text on top of it, you need to use the class ```.card-img-overlay``` for the content you wish to display over the image, instead of using the ```.card-body``` class.
