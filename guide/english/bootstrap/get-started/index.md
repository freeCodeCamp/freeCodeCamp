...
---
## Get Started
Bootstrap is a free and open source framework developed by Twitter.  It provides a variety of templates for use with front-end web development. Using Bootstrap makes it easy to design a fully responsive website and is a framework worth learning.

#### What is a responsive website
A responsive website is a website that resizes and rearranges the items on the page depending on the size of your browser. With a responsive website, you can see the changes occur in real time if you resize your browser.  Bootstrap makes your website responsive for you.
