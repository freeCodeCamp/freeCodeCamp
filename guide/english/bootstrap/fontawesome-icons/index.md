...
Bootstrap (from version 4 onwards) has dropped Glyphicon icons font in their latest release. 
...
A complete list of icons provided by fontawesome is available [here](http://fontawesome.io/cheatsheet/)

`.fa fa-align-left` This is the fontawesome align left icon.

<span class="fa fa-align-left" aria-hidden="true"></span>

`.fa fa-heart` This is the fontawesome heart icon.
