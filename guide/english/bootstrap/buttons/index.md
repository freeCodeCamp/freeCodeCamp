...
`.btn` This is bootstrap's basic button. It is a prerequisite if you want other bootstrap buttons to work properly. Try writing other bootstrap buttons without it and watch what happens. 
