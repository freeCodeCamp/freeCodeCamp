...
Example for Techniques to solve the problem of Web Accessibility for people who are visually impaired: Using `alt` attribute inside HTML5 `<img>` tags. So that `alt` text can be read through screen-reader. 
