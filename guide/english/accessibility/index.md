...
Where WAI tackles the semantics of html to more easily nagivate the [DOM Tree](https://www.w3.org/TR/WD-DOM/introduction.html), ARIA attempts to make web apps, especially those developed with javascript and
