...
Cryptocurrency is a subset of digital currency which acts as a medium of exchange and unit of account. It is known as cryptocurrency because of the utilization of cryptography in securing its transactions. There are various cryptocurrencies including LiteCoin, Dash, Ethereum, Ripple, and the currently most popular Bitcoin. It facilitates trustless and anonymous transactions since it does not involve any third party - there is no central bank. 

Unlike traditional currency, cryptocurrency can be exchanged as fractions of a unit. For example, transactions can amount to 0.00007 BTC or even lower.
