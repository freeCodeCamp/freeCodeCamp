...
Angular(versions 2.x and up) is a Typescript-based open-source framework to develop front-end web applications. Angular has the following features: generics, static-typing, and also some ES6 features.
