...
```
To comment out multiple lines or a large portion of code with single line comments, select all of the code, hold the command key, and then press the / forward slash key.
