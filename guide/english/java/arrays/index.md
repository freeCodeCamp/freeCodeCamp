...
An Array is a simple data structure used to store a collection of similar data types. 
Arrays always start with an index of 0 and are instantiated to a set number of elements. 
