...
# ArrayList
  ...
  ArrayList is a class that is used to create dynamic arrays. It is slower than regular arrays but allows for a lot of manipulations. It can be initialized to have a specific size or it will have a default size of 10 units. 
