...
Functions are also known as methods.They solve the problem of data redundancy very well.A piece of code that is repeated in the source file can be avoided using functions.
## An Example
