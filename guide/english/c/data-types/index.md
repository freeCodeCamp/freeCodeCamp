...
Size of a variable type can change according to harware architecture. We can use the sizeof() operator to check the size of a variable. See the following C program for the usage of the various data types:
