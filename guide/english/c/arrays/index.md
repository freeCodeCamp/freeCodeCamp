...
## Arrays in C
Arrays are homogeneous collection of elements i.e., they contain variables of the **same type**. You can access a variable stored in the array with its *index*.
