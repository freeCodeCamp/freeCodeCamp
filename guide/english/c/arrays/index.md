...
## Arrays in C
Arrays are containers with a given size. The Elements in Array are Stored in CONTINUOUS Memory Location. They are LINEAR DATA STRUCTURE. They contain variables of the **same type**. You can access a variable stored in the array with its *index*.
