...
```
## Address Calulation
In C, elements of an array are stored in row major order. Consider an array ```int A[3][3]```. It will be stored in the following manner: 

![alt text](https://github.com/ayush163/Common/blob/master/LICENSE.md/git.PNG)

```Address of A[i][j] = Base Address + (Size of data type)*[i*(No. of columns) + j]```
