 ...
 * The execution of a C program starts from the main() function.main() function is also called the driver function of the program invoked    by the operating sytem. 
