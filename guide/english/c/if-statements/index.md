...
Within the parenthesis of the if statement is something new, too: `n == 3`. This is a comparison between `n` and the number 3. `==` is a comparison operator, and is one of several comparison operators in C.
