...
* Structs can be copied or assigned but you can not compare them.  For example, the c compiler does not provide the facility to compare structs but you can always write your own comparison function! 
