...
---
# Pointers in C
pointers are powerful features of c and (C++) programming that differentiates it from other popular programming languages like: java and python.These are used in C program to acess the memory and manipulate the address.
#
```
type *var-name;
```
