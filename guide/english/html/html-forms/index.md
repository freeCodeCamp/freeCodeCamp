...
#HTML Form connectivity with Flask(Python Framework):
You have to write
<form action="{{url_for("login")}}" method="post">
in the form you have designed and you have to make a app.route("/login",methods=["POST"])
 AND code inside that according to your requirements.
