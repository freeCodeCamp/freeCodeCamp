...
HyperText Markup Language (HTML) is a markup language used to construct online documents and for creating web pages and web applications. A markup language like HTML allows us to 1) create links to other documents, 2) structure the content in our document, and 3) ascribe context and meaning to the content of our document.
