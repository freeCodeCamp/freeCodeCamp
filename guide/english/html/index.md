...
HTML5 Introduces a host of semantic elements. Though we discussed that HTML has helped in providing meaning to our document, it wasn't until HTML5s' introduction of [semantic elements](#) that its' potential was realized.
