...
HTML5 is the latest version, or specification, of HTML. <a href='https://www.w3.org/' target='_blank' rel='nofollow'>The World Wide Web Consortium (W3C)</a> is the organization responsible for developing standards for the World Wide Web, including those for HTML. As web pages and web applications grow more complex, W3C  updates HTML's standards.
