...
Before HTML5, in order to play a video in a webpage you needed to use a plugin, like Adobe Flash Player. With the introduction of HTML5, you can now place it directly into the page itself.
