...
## JavaScript
JavaScript is the most widely used scripting language on Earth and has the largest library ecosystem of any programming language.

By definition, Javascript is a high-level interpreted language. Meaning it's abstracted from the computer, easy to use, and a user 
doesn't need to compile in order to execute as it is interpreted at  runtime.

JavaScript is the core language of the web, and is the only programming language that can run in all major web browsers.
