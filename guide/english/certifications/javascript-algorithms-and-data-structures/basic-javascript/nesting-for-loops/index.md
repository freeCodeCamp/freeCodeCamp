...
<ul>
  <li><a href="https://guide.freecodecamp.org/certifications/javascript-algorithms-and-data-structures/basic-javascript/nest-one-array-within-another-array" target="_blank">Nest One Array Within Another Array</a></li>
  <li><a href="https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/iterate-through-an-array-with-a-for-loop" target="_blank">Iterate Through An Array With A For Loop</a></li>
  <li><a href="https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/accessing-nested-arrays" target="_blank">Accessing Nested Arrays</a></li>
</ul>
...
```
:rocket: <strong><a href="https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/nesting-for-loops/" target="_blank">Run Code</a></strong>
...
See :point_right: <a href="http://forum.freecodecamp.com/t/algorithm-article-template/14272" target="_blank">Wiki Challenge Solution Template</a> for reference.
