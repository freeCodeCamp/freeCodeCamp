...
---
## Lambda Expressions
Lambda Expressions are ideally used when we have something simple to be done and we are more interested in quickly getting the job done rather than formally naming the function. Lambda expressions are a short, concise way to declare small and anonymous functions (it is not necessary to provide a name for lambda functions).
