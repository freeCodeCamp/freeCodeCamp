...
<a href='https://www.python.org' target='_blank' rel='nofollow'>Python</a> is a general purpose programming language which is dynamically typed, <a href = 'https://en.wikipedia.org/wiki/Interpreted_language' >interpreted</a>, and known for its easy readability with great design principles.
