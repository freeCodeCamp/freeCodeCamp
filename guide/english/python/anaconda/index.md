...
Check out the [Conda cheat sheet](https://conda.io/docs/user-guide/cheatsheet.html)
For a single-page summary of the most important information about using conda.
