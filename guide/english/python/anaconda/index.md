...
title: Anaconda
---
**Anaconda** is a package manager, environment manager and Python distribution software with a collection of numerous packages. Anaconda is platform-agnostic, so you can use it whether you are operating through Windows, macOS or Linux.
Anaconda easily creates, saves, loads and switches between environments on your system. It was initially created for Python programmers, while currently it can package and distribute software for any language.
Anaconda; as a package manager helps you find and install packages. If you need a package that requires a different version of Python, you do not need to switch to a different environment manager,since it is also an environment manager. With just a few commands, you can set up a totally separate environment to run that different version of Python, while continuing to run your usual version of Python in your normal environment.
