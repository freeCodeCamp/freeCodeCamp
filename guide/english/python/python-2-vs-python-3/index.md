...
This article uses Python 3 to set up the web-frameworks in your development environment. But before that, you need to ensure you have Python 3 and know how to use it!</br>
To install modules for python 2, you can make use of:

    pip2 install <module-name>
To install modules for python 3, you can make use of:
