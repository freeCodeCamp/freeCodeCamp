...
The Blender software is cross-platform, and runs on Windows, Linux and Mac. Blender is supported by The Blender Foundation, a community from around the world, consisting of developers, animators, scientists, experts, and even hobbyists.  The foundation empowers software development by constantly maintaining, fixing and making new features for a suitable and more responsive user experience.
