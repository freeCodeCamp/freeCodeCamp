...
> 宣告首次发布比特币，这是一种新的电子现金系统，它使用点对点网络来防止双重支出。它完全是去中心化的，没有服务器或中央权限。
> 
> \- Satoshi Nakamoto，2009年1月9日，在SourceForge上宣告发布比特币。

加密货币是数字货币的一个子集，它作为双方之间的交换媒介。它被称为加密货币，因为利用密码术来保护其交易。例如，有各种加密货币，包括LiteCoin，Dash，以太坊，Ripple，以及目前最流行的比特币。这是进行无信任和匿名交易的完美方式，因为它不涉及任何第三方。
