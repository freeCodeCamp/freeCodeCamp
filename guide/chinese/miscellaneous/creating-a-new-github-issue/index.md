...
2.  **有一个有用的标题**
    ...
    *   保持标题相对较短，描述是为了进一步的信息。一个例子是缩短长的Challenge名称，因此您可能不想`Test case bug in 'Challenge: Check Radio Buttons and Checkboxes by Default'`中编写`Test case bug in 'Radio Buttons' Challenge` ，您可能希望`Test case bug in 'Radio Buttons' Challenge`编写`Test case bug in 'Radio Buttons' Challenge` 。
