...
但是，随着越来越多的大型项目开始使用JavaScript，使代码更容易编写和更易于维护的过程变得越来越困难。

这是微软早期认识到的一个问题，他们提出了TypeScript的解决方案，并于2012年10月1日发布了第一个版本。
...
Playground具有内置的自动完成功能，可以直接查看发出的JavaScript。
