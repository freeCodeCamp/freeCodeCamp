...
localeTitle: دليل قالب خوارزمية Freecodecamp Challenge
---
> هذا هو النموذج الذي يجب اتباعه عند كتابة حلول خوارزمية جديدة أو إضافة محتوى ، تأكد دائمًا من تنفيذ أحدث إصدار من هذا القالب على طلب السحب

# الخوارزمية [أضف الاسم هنا\]](https://forum.freecodecamp.com/images/emoji/emoji_one/triangular_flag_on_post.png?v=3 ":triangular_flag_on_post:")
...
اشرح ما يتم طرحه ، بطريقة سهلة الفهم والتفصيلية.

#### روابط ذات صلة

*   [رابط العنوان 1](http://example.com)
*   [رابط العنوان 2](http://example.com)
...
![:rocket:](https://forum.freecodecamp.com/images/emoji/emoji_one/rocket.png?v=3 ":صاروخ:") [تشغيل الكود](https://repl.it/URL-HERE)
