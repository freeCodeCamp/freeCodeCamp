---
title: Bug Bounties
localeTitle: علة المكافآت
---
## علة المكافآت

Bounties Bug هي البرامج التي يتم إعدادها من قبل الشركات لتشجيع الناس على التحقق من منتجاتهم من نقاط الضعف. في المقابل ، تقدم هذه الشركات جوائز نقدية للثغرات المكتشفة.
