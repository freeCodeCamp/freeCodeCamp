...
localeTitle: Calculadora de números complexos
---
## Calculadora de números complexos

Este é um esboço. [Ajude nossa comunidade a expandi-lo](https://github.com/freecodecamp/guides/tree/master/src/pages/tools/calculators/complex-number-calculator/index.md) .
