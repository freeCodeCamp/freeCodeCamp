...
localeTitle: OTP Concurrency
---
## OTP Concurrency

Este é um esboço. [Ajude nossa comunidade a expandi-lo](https://github.com/freecodecamp/guides/tree/master/src/pages/elixir/otp-concurrency/index.md) .
