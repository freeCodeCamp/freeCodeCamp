...
localeTitle: Operações em Funções
---
## Operações em Funções

Este é um esboço. [Ajude nossa comunidade a expandi-lo](https://github.com/freecodecamp/guides/tree/master/src/pages/mathematics/operations-on-functions/index.md) .
