...
localeTitle: Representação gráfica de funções trigonométricas
---
## Representação gráfica de funções trigonométricas

Este é um esboço. [Ajude nossa comunidade a expandi-lo](https://github.com/freecodecamp/guides/tree/master/src/pages/mathematics/graphing-trigonometric-functions/index.md) .
