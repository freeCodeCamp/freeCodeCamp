...
localeTitle: Introdução à substituição trigonométrica
---
## Introdução à substituição trigonométrica

Este é um esboço. [Ajude nossa comunidade a expandi-lo](https://github.com/freecodecamp/guides/tree/master/src/pages/mathematics/introduction-to-trigonometric-substitution/index.md) .
