...
localeTitle: Sistemas de Equações com Substituição
---
## Sistemas de Equações com Substituição

Este é um esboço. [Ajude nossa comunidade a expandi-lo](https://github.com/freecodecamp/guides/tree/master/src/pages/mathematics/systems-of-equations-with-substitution/index.md) .
