...
localeTitle: Funções Definidas Recursivamente
---
## Funções Definidas Recursivamente

Este é um esboço. [Ajude nossa comunidade a expandi-lo](https://github.com/freecodecamp/guides/tree/master/src/pages/mathematics/functions/recursively-defined-functions/index.md) .
