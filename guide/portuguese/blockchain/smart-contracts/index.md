...
Transações em um blockchain são um contrato muito básico - Uma parte envia recursos para outra. No blockchain Ethereum, as transações podem suportar qualquer tipo de lógica. Eles têm o expressivo poder de uma máquina Turing-Complete - o que significa que podem ser passos para uma tarefa que um computador pode fazer.
