...
localeTitle: Problema de Monty Hall
---
## Problema de Monty Hall

O Problema de Monty Hall é um enigma sobre a probabilidade em homenagem ao apresentador do programa dos anos 70, baseado em Let's Make a Deal. Esse problema em particular é um paradoxo verídico. Isso significa que há uma solução que parece contra-intuitiva, mas que se provou verdadeira.

O problema define da seguinte maneira; Você está em um game show e há 3 portas, cada uma com um prêmio diferente por trás delas. Atrás de uma das três portas há um carro. Os outros dois têm cabras. Você deve escolher uma das 3 portas para selecionar como seu prêmio. Digamos que você escolha a porta 1, mas antes que a porta se abra, Monty decide abrir a porta 2, que revela uma cabra. Ele agora pergunta se você gostaria de escolher a porta 3. Você deve escolher a Porta 3 acima da sua escolha original? Isso importa mesmo?
...
[Problema Monty Hall - Numberfile](https://www.youtube.com/watch?time_continue=1&v=4Lb-6rxZxx0)

[21 Kevin Spacey Problema Monty Hall](https://www.youtube.com/watch?v=YReov4c3taI)

#### Mais Informações:

*   Artigo do problema de Monty Hall: [Wikipedia](https://en.wikipedia.org/wiki/Monty_Hall_problem)