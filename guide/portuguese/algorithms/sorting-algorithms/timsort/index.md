...
O Timsort é um algoritmo de classificação rápida que trabalha na complexidade estável de O (N log (N))
...
O Tim Sort tem uma Complexidade estável de O (N log (N)) e compara muito bem com o Quicksort. Um comaprison de complexidades pode ser encontrado neste [gráfico](https://cdn-images-1.medium.com/max/1600/1*1CkG3c4mZGswDShAV9eHbQ.png)
...
*   [Youtube: Uma explicação visual do Quicksort](https://www.youtube.com/watch?v=jVXsjswWo44)
