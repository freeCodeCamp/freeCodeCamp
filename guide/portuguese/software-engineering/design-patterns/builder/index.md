---
title: Builder
localeTitle: Construtor
---
O construtor é um padrão de design que pode abstrair e desacoplar a criação de um objeto muito complexo.

## Construtor em Python

Aqui está um exemplo de implementação do Builder Pattern no Python3.
