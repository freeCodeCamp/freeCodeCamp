...
1. Відкрийте термінал / командний рядок / оболонку в каталозі своїх проектів
...
    `` `md
    виправити / оновити-виклики - реагувати
    fix / update-guide-for-html-css
    виправлення / виправлення платформи-помилки-входу
    feat / add-guide-article-for-JavaScript
    перекласти / додати-іспанську-basic-html
    `` `
