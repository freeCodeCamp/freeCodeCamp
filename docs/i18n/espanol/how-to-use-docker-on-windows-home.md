...
Una vez que estés contento de que Docker está funcionando, clona el repositorio freeCodeCamp en un directorio dentro de `C:\Users`. Estos directorios child compartidos dándole acceso a Docker a los directorios locales que necesita durante la instalación.
