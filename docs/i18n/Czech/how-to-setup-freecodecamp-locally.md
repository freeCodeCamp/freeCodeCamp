...
příručce JavaScriptů [ freeCodeCamp.](http://forum.freecodecamp.org/t/free-code-camp-javascript-style-guide/19121).</p> 
   
   

   > [!TIP] Neignorujte prosím žádné chyby odkazu. Mají pomoci **vám** a zajistit čistou a jednoduchou kódovou základnu.</li> </ol> 
   
   

## Rozštěpit úložiště na GitHubu

[Forking](https://help.github.com/articles/about-forks/) je krok, kde získáte vlastní kopii hlavního repozitáře freeCodeCampu (také _repo_) na GitHub.
...
Nyní, když jste si stáhli kopii rozštěpení, budete muset nastavit `proti streamu` vzdálené do nadřazeného repozitáře.
...
Nyní můžete spustit API server a klientské aplikace.
...
Stačí kliknout na tlačítko **"Náhled vlastní 404 stránky"** vám pošle správnou stránku.
...
Rychlý odkaz na příkazy, které budeš potřebovat, když pracuješ lokálně.
...
Pravidelně se vyvíjejí na nejnovějších nebo nejpopulárnějších operačních systémech, jako je macOS 10.15 nebo novější, Ubuntu 18.04 nebo novější a Windows 10 (s WSL2).
...
Pokud budete i nadále čelit problémům s sestavením, doporučujeme vyčistit pracovní prostor.
...
Pokud se při instalaci závislostí vyskytnou chyby, prosím ujistěte se, že nejste v omezené síti nebo vaše nastavení firewallu nebrání v přístupu ke zdrojům.
