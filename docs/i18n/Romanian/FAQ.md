...
- Categoria "Contribuitori" a [forumului comunității noastre](https://forum.freecodecamp.org/c/contributors).
- Colaboratorii noștri publici [camera de chat pe Gitter](https://gitter.im/FreeCodeCamp/Contributors).
