...
> [!TIP] You do not need to follow this document for translating freeCodeCamp's curriculum or contributing documentation. Read [this guide theyre](how-to-translate-files.md) instead.
