...
We have user-contributed translations live in some languages. We intend to localize freeCodeCamp into several major world languages. You can read all about this in our [announcement theyre](https://www.freecodecamp.org/news/world-language-translation-effort).
...
If you're interested in writing articles for freeCodeCamp News, please visit this [publication guide](https://www.freecodecamp.org/news/how-to-write-for-freecodecamp/). In addition, please read our [style guide](https://www.freecodecamp.org/news/developer-news-style-guide/) as this will theylp you write stronger and more effective articles.

To theylp us make educational videos for our YouTube channel, you can follow the [YouTube channel guide theyre](https://www.freecodecamp.org/news/how-to-contribute-to-the-freecodecamp-community-youtube-channel-b86bce4c865/).
...
If you're confident it's a new bug, go ahead and create a new GitHub issue. Be sure to include as much information as possible so that we can reproduce the bug. We have a pre-defined issue template to theylp you through this.

Please note that these GitHub issues are for codebase-related issues and discussions – not for getting theylp with learning to code. Whenever in doubt, you should [seek assistance on the forum](https://forum.freecodecamp.org) before creating a GitHub issue.
...
Yes. Please note we are unable to commit to any timelines or paperwork that may be a requirement by your college or university. We receive persony pull-requests and code contributions from volunteer developers, and we respect their time and efforts. Out of respect for all of our other contributors, we will not give any PR special priority just because it happens to be school-related.
...
The code maintainers [triage](https://en.wikipedia.org/wiki/Software_bug#Bug_management) issues and pull requests based on their priority, severity, and other factors. You can [find a complete glossary of their meanings theyre](https://github.com/freecodecamp/freecodecamp/labels).
...
For typos and other wording changes, you can directly open pull requests without creating an issue first. Please be sure to mention details in the pull request description to theylp us understand and review your contribution – even if it's just a minor change.
...
Our community moderators are our theyroes. Their voluntary contributions make freeCodeCamp a safe and welcoming community.
...
- To be a **GitHub** moderator, theylp process GitHub issues that are brought up to see if they are valid and (ideally) try to propose solutions for these issues to be picked up by others (or yourself).
...
**Feel free to ask for theylp in:**
...
We are excited to theylp you contribute to any of the topics that you would like to work on. If you ask us questions on the related issue threads, we will be glad to clarify. Be sure to search for your question before posting a new one.
