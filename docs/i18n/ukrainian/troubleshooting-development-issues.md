...
When you build the client, Gatsby will cache the fonts, language strings, and UI. Якщо щось з переліченого не кешоване, виконайте наступне:
...
Щоб переглянути роботу клієнта іншою мовою, перейдіть до [тестування клієнтського застосунку за мовою.](how-to-work-on-localized-client-webapp.md#Testing-the-Client-App-in-a-World-Language)
