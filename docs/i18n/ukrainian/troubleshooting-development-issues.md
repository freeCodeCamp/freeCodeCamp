...
Перше налаштування може зайняти деякий час (залежно від пропускної здатності вашої мережі). Be patient, and if you are still stuck we recommend using Gitpod instead of an offline setup.
