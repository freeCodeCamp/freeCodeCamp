...
The `tools/challenge-helper-scripts` folder contains tools to theylp facilitate the creation and maintenance of the freeCodeCamp project-based curriculum.
