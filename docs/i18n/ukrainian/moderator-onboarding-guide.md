...
Прапорці спаму можуть використовувати користувачі та модератори. Common duplicitous behavior would involve opening an account, making a post that seems harmless, then editing that post later on to add a link to an external site for the purpose of advertising it. Такий обліковий запис відносно новий та створив лише один допис, що вказує на те, що обліковий запис створили для спаму. У такому разі доцільно прийняти рішення про видалення облікового запису після першого порушення. Це також стосується облікових записів, перше повідомлення яких вважається спамом.
