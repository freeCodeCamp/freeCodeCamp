...
Enter the step number that you want to add. For example, if you want to add `step-12`, put `12` as the step number. Then, click the `Insert Step` button to add the step. The following steps will be re-ordered.
