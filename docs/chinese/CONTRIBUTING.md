...
如果您对改进这些编码的挑战感兴趣，请参阅[如何编辑编码挑战]（/ docs / how-to-work-on-coding-challenges.md）。

###翻译指南文章和编码挑战

您可以帮助我们翻译我们的指南文章和编码挑战至您所说的语言。目前我们已翻译版本有：
...
对此项目作出贡献的需求是的是对于API，ES6语法的了解和许多的好奇心。
...
请注意，任何寻求编码帮助挑战的问题都将被关闭。问题跟踪器仅限于使用于与代码库相关的问题和讨论。如果您有疑问，您应该[在论坛上寻求帮助]（https://www.freecodecamp.org/forum），然后再进行报告。

**如何报告安全问题？**

请不要因安全问题而创建GitHub问题。相反，请发送电子邮件至`security @ freecodecamp.org`，我们会立即调查。

**我的疑问没有在这些文档中。我如何能得到帮助？**
...
我们很高兴能帮助您为您为您想付出的任何主题做出贡献。请确保在发布新查询之前搜索您的查询，有礼貌和耐心。我们的社区志愿者和主持人随时为您提供指导。
