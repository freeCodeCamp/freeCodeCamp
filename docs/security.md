...
3. While we do not offer any bounties or swags at the moment, we'll be happy to list your name in our [Hall of Fame](https://github.com/freeCodeCamp/freeCodeCamp/blob/main/docs/security-hall-of-fame.md) list, provided the reports are not low-effort.
