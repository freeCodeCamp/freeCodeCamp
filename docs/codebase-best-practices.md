...
- Don't use `!important` in `font-family`: RTL layout is uses different fonts compared to the LTR layout, when you add `!important` in the `font-family` property it affects the RTL layout too.
