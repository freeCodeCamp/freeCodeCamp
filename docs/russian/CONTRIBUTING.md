...
#### [Как работать над статьями руководства](/docs/russian/how-to-work-on-guide-articles.md)
...
#### [Как работать над задачами по кодингу](/docs/russian/how-to-work-on-coding-challenges.md)
...
#### [Как настроить freeCodeCamp локально.](/docs/russian/how-to-setup-freecodecamp-locally.md)
