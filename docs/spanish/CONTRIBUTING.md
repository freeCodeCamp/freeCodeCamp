...
Somos estrictos respecto al cumplimiento de nuestro ["Código de conducta"](https://www.freecodecamp.org/code-of-conduct). Tómate un momento para leerlo. No es muy largo.
...
1. [Contribuir a este código fuente abierto.](#contribute-to-this-open-source-codebase)
...
Tenemos un gran código base abierto que consiste en miles de [desafíos de codificación](https://www.freecodecamp.org/learn) y [artículos de guía](https://www.freecodecamp.org/guide). Estos desafíos y artículos conforman el contenido de aprendizaje disponible en la plataforma de aprendizaje de freeCodeCamp.org.
...
Los artículos de guía te ayudan a comprender rápidamente un concepto de tecnología. Éstas son explicaciones breves y sencillas que puedes leer antes de ir a recursos más profundos.
...
Agradecemos tu ayuda al escribir estos artículos. No tienes que ser un experto en un tema para escribir sobre él; toda esta Guía es de fuente abierta, por lo que incluso si cometes un error, otro colaborador lo corregirá.

Para obtener ayuda, busca un `esbozo de artículo` en nuestro [sitio web de la Guía](https://www.freecodecamp.org/guide), escribe el artículo y luego abre una solicitud para reemplazar el esbozo con tu artículo. Una solicitud o [pull request](https://help.github.com/articles/about-pull-requests/) es la forma en que sugerirás los cambios. Esto permite a otros conocer tus cambios, revisarlos y adoptarlos.
...
Si te gutaría ayudar a mejorar los artículos de guía, aquí encontrarás [cómo trabajar en los artículos de guía.](/docs/spanish/how-to-work-on-guide-articles.md)
...
Puedes ayudar a expandirlos y a hacer que su redacción sea más clara. Puedes actualizar las historias de usuario para explicar mejor el concepto e incluso eliminar aquellas redundantes. También puedes mejorar las pruebas (tests) en los desafíos, para que prueben de forma más precisa el código de las personas.

Si estás interesado en mejorar estos desafíos de codificación, aquí tienes [cómo trabajar en desafíos de codificación.](/docs/spanish/how-to-work-on-coding-challenges.md)
