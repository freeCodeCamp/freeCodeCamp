...
We have live user-contributed translations in some languages. We intend to localize freeCodeCamp into several major world languages. You can read all about this in our [announcement here](https://www.freecodecamp.org/news/help-translate-freecodecamp-language/).
...
If you think you've found a bug, first read ["How to Report a Bug"](https://www.freecodecamp.org/news/how-to-report-a-bug-to-freecodecamp/) article and follow its instructions.
...
We request that you plan ahead and work on code contributions with this in mind.
...
Please create an issue if you want to discuss bigger aspects of the codebase or curriculum.
...
2. In the case of multiple contributors opening a pull request for the same issue at around the same time, we will give priority to the pull request that best addresses the issue. Some of the things we consider are:
   - Did you include tests?
   - Did you cover all of the use cases?
   - Did you ensure all tests passed, and confirm everything worked locally?
3. Finally, we give priority to pull requests that follow our recommended guidelines.
...
- To be a **Discord/Chat** moderator, you must be an active participant in 
  our chat and engage in positive interactions with others, as well as 
  learn and practice how to deal with potential conflicts that may arise.
- To be a **Forum** moderator, similar to a chat moderator, you must have an active
  presence, engage with other forum posters, support others in their
  learning journeys, and even give feedback when asked. Take a look at
