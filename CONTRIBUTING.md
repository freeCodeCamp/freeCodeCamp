...
1. [Contribute to this open source codebase](#contribute-to-this-open-source-codebase). Help edit [guide articles](https://guide.freecodecamp.org/), [coding challenges](https://learn.freecodecamp.org/), or fix bugs on the learning platform.
