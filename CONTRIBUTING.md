...
1. Open a Terminal / Command Line / Bash Shell in your projects directory (_IE: `/mean/`_)
...
##### (make sure to replace `yourUsername` with yout GitHub Username)
...
Before you start working, you will need to create a seperate branch specific to the issue / feature you're working on. You will push your work to this branch.
...
Now navigate your browser to [http://localhost:3000](http://localhost:3000) If the app loads, congratulations – you're all set. Otherwise, let us know by opening a GitHub issue and with your error.
...
To do this, see [Rebasing](http://forum.freecodecamp.com/t/how-to-use-git-rebase/13226).
