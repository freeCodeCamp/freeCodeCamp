...
module.exports = function(app) {
  ...
  function unsubscribeIdFinder(id) {
    /*
      unsubscribeId's set during the migration are shaped differently to new users

      migrated: {
        unsubscribeId: ObjectId(String)
      },
      newUser: {
    ...
    */
    return function findObjectIdOrString() {
      // `this` here is the User document
      return this.unsubscribeId === id || this.unsubscribeId === ObjectId(id);
    };
  }
