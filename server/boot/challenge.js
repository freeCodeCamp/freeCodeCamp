        ...
        challenge$
            ...
            .flatMap(challenge => {
                ...
                if (!challenge) {
                    ...
                    req.flash('errors', {
                        msg: '404: We couldn\'t find a challenge with the name `' +
                        origChallengeName +
                ...
                return Observable.just({
                    ...
                    descriptionCn: challenge.descriptionCn,
            ...
            .subscribe(
                function (data) {
                    ...
                    res.render(app.switchLanguage(view), data);
                },
                next,
                function () {
                }
        ...
        Observable.combineLatest(
            ...
            .subscribe(
                ({ camperCount, superBlocks }) => {
                    res.render(app.switchLanguage('challengeMap/show'), {
                        superBlocks,
                        daysRunning,
