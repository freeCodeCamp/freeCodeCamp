...
Le unità utilizzate dalla proprietà `flex-basis` childo le stesse delle altre proprietà di dimensione (`px`, `em`, `%`, etc.). Il valore `auto` ridimensiona gli elementi in base al contenuto.
