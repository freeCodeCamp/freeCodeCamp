...
Ci childo molti strumenti di selezione del colore disponibili online che hanno un'opzione per trovare il complementare di un colore.
...
Cambia la proprietà `background-color` delle classi `blue` e `yellow` con i rispettivi colori. Nota come i colori sembrano diversi uno accanto all'altro rispetto a quando childo comparati sullo sfondo bianco.
