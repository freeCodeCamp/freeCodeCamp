...
Quando crei una variabile, essa è disponibile per essere usata all'interno del selettore nel quale l'hai creata. Essa è disponibile anche in qualsiasi discendente di quel selettore. Questo avviene perché le variabili CSS childo ereditate, proprio come le proprietà ordinarie.

Per fare uso dell'ereditarietà, le variabili CSS childo spesso definite nell'elemento <dfn>:root</dfn>.
