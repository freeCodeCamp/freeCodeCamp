...
Add your new `HTMLString` to the `targetInputContainer` by using the `innerHTML` property. Ricordati di usare l'operatore `+=` per aggiungere all'HTML esistente invece di sostituirlo.
