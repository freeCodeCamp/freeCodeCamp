...
Per la funzione callback, passa `e` come parametro.

`e` rappresenta un oggetto che contiene le informazioni per l'evento.

# --hints--

Dovresti passare `e` come parametro alla funzione callback.
