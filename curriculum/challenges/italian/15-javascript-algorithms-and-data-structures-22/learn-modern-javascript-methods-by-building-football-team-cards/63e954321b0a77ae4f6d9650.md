...
All'interno del corpo della funzione callback, dovrai aggiungere i template literal ` `` ` che accoglieranno il contenuto HTML per le figurine.

All'interno dei template literal, aggiungi un `div` vuoto con la classe `player-card`.
