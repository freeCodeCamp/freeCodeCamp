...
La tua proprietà `isWorldCupWinner` dovrebbe essere booleana.
...
Il tuo valore `headCoach` dovrebbe essere un oggetto.
...
Il tuo valore `headCoach` dovrebbe essere un oggetto vuoto.
