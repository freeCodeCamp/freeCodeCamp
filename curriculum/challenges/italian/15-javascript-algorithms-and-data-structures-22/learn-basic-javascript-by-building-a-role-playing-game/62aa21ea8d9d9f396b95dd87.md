...
In ogni attacco, dovrebbe esserci la possibilità che l'arma del giocatore si rompa. At the end of the `attack` function, add an empty `if` statement with the condition `Math.random() <= .1`.
