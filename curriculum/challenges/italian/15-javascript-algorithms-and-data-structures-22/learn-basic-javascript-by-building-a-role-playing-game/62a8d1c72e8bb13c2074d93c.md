...
The `currentWeaponIndex` variable is the index of the `weapons` array, but array indexing starts at zero. L'indice dell'ultimo elemento in un array è inferiore della lunghezza dell'array di uno.
