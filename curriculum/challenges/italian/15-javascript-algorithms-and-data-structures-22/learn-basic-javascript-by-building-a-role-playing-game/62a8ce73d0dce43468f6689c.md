...
Puoi inserire variabili in una stringa con l'<dfn>operatore di concatenazione</dfn> `+`. Update the `"You now have a new weapon."` string to say `"You now have a "` and the name of the new weapon. Ricordati di terminare la frase con un punto.
