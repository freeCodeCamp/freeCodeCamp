...
Nota che c'è già una variabile `currentWeapon` altrove nel tuo codice. Since this new `currentWeapon` variable will be inside an `if` statement, it will be scoped only to that block of code.
