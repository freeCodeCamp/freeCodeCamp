...
Ora che hai un oggetto per la location `cave`, aggiorna la funzione `goCave` in modo che chiami `update` e passale la nuova location `cave`. Ricorda che questo è il terzo elemento dell'array `locations`.
