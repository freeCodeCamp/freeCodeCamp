...
Puoi accedere alle proprietà in JavaScript in un paio di modi diversi. Il primo è con la <dfn>dot notation</dfn> (notazione con punto). Here is an example of using dot notation to set the `onclick` property of a button to a function reference.
