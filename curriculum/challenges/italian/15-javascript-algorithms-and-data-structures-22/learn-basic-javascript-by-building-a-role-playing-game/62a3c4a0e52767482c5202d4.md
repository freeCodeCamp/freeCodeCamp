...
Dovresti impostare la proprietà `onclick` di `button2` sulla variabile `goCave`.
...
Dovresti impostare la proprietà `onclick` di `button3` sulla variabile `fightDragon`.
