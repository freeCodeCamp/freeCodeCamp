...
JavaScript interagisce con l'HTML usando il <dfn>Document Object Model</dfn>, o DOM. Il DOM è un albero di oggetti che rappresenta l'HTML. You can access the HTML using the `document` object, which represents your entire HTML document.
