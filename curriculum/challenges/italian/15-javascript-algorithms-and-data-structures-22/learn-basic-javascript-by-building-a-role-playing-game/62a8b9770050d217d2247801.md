...
`location["button text"]` è un array con tre elementi. Change the `button1.innerText` assignment to be `location["button text"][0]` which represents the first element of the array.
