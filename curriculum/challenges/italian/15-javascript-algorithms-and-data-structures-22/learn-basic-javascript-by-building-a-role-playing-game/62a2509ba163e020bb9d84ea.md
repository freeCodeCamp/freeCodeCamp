...
Ora puoi iniziare a scrivere il tuo JavaScript. Inizia creando un elemento `script`. Questo elemento è usato per caricare JavaScript nel file HTML. Dovresti usare un tag di apertura `<script>` e uno di chiusura `</script>`.
