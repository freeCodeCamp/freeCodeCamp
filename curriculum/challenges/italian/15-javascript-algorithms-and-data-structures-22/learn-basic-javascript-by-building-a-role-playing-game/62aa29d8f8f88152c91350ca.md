...
Adesso aggiungi un'espressione `else`. Inside, add `Wrong! You lose 10 health!` to the end of `text.innerText`. Sottrai `10` da `health` e aggiorna `healthText.innerText`.
