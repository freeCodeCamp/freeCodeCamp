...
Ora assegna al `textContent` della variabile `showHideCartSpan` il risultato di un'espressione ternaria che controlla se `isCartShowing` è vero. If it is, set the `textContent` to `"Hide"`, otherwise set it to `"Show"`.
