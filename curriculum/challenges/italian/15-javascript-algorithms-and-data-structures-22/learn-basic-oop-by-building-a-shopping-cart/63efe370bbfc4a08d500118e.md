...
Per risolvere questo problema, puoi usare l'operatore `||` per impostare il valore a `0` se non esiste. Wrap your right-hand `totalCountPerProduct[dessert.id]` in parentheses, and add `|| 0` to the end of the expression.
