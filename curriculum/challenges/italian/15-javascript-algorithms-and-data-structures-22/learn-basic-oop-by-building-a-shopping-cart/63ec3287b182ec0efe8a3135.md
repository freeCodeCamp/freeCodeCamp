...
Il secondo oggetto nell'array `products` dovrebbe avere una proprietà `name` impostata su `French Macaron`.
...
Il secondo oggetto nell'array `products` dovrebbe avere una proprietà `category` impostata su `Macaron`.
...
Il settimo oggetto nell'array `products` dovrebbe avere una proprietà `name` impostata su `Chocolate Macarons (4 Pack)`.
...
Il settimo oggetto nell'array `products` dovrebbe avere una proprietà `category` impostata su `Macaron`.
...
L'undicesimo oggetto nell'array `products` dovrebbe avere una proprietà `name` impostata su `Vanilla Macarons (5 Pack)`.
...
L'undicesimo oggetto nell'array `products` dovrebbe avere una proprietà `category` impostata su `Macaron`.
