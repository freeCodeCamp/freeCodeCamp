...
Il secondo oggetto nell'array `products` dovrebbe avere una proprietà `name` impostata su `French Macaroon`.
...
Il secondo oggetto nell'array `products` dovrebbe avere una proprietà `category` impostata su `Macaroon`.
...
Il settimo oggetto nell'array `products` dovrebbe avere una proprietà `name` impostata su `Chocolate Macaroons (4 Pack)`.
...
Il settimo oggetto nell'array `products` dovrebbe avere una proprietà `category` impostata su `Macaroon`.
...
L'undicesimo oggetto nell'array `products` dovrebbe avere una proprietà `name` impostata su `Vanilla Macaroons (5 Pack)`.
...
L'undicesimo oggetto nell'array `products` dovrebbe avere una proprietà `category` impostata su `Macaroon`.
