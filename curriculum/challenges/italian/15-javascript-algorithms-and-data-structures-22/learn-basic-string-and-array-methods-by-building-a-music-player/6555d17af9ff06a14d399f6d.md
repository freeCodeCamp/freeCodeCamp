...
You should assign the `#player-song-title` element to the variable `playingSong`. Non dimenticare di utilizzare `const` per dichiarare la variabile.
...
You should assign the `#player-song-artist` element to the variable `songArtist`. Non dimenticare di utilizzare `const` per dichiarare la variabile.
