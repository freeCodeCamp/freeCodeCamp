...
L'espressione truthy dell'operatore ternario dovrebbe impostare la proprietà `textContent` dell'elemento `result` su `Oh no! This looks like a spam message.`.
