...
Declare a `currValue` variable and assign it the value at `array[i]`. Quindi, dichiara una variabile `j` e assegnale `i - 1`. La variabile `j` dovrebbe essere riassegnabile.
