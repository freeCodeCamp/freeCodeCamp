...
Una volta che il loop `for` è terminato, devi restituire l'array. Una volta fatto ciò, dovresti essere in grado di veder cambiare l'`Output` quando clicchi di nuovo sul pulsante `Sort`.

# --hints--

Dovresti restituire con `return` l'`array`.
