...
Dopo il loop while, devi inserire il valore corrente. Ricorda che il loop termina quando `j` è oltre i limiti dell'array o quando il valore a `j` è minore del valore corrente.

Usa l'operatore di assegnazione per inserire il valore corrente all'indice corretto.
