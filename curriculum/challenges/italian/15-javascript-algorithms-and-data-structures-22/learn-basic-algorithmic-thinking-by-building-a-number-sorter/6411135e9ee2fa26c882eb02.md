...
In ogni iterazione del loop `while`, viene trovato un elemento che è più grande del valore attuale. Devi spostare questo elemento a destra per fare spazio al valore attuale.
