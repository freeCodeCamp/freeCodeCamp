...
You can quickly get all cells from your page by getting the `#container` element by its `id` and accessing the `children` property of the result. Passala alla chiamata `evalFormula()` come secondo parametro.
