...
Dichiara una funzione `elemValue` che richiede un parametro `num`. La funzione dovrebbe essere vuota.

# --hints--

Dovresti dichiarare una variabile `elemValue` dopo la funzione `rangeFromString()`.
