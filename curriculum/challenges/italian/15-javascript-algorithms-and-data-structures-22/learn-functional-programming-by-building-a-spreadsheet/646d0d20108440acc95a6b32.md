...
Nella funzione `elemValue` hai esplicitamente dichiarato una funzione chiamata `inner` e l'hai restituita. Tuttavia, poiché stai usando la sintassi freccia, puoi restituire una funzione implicitamente. Ad esempio:
...
La funzione `elemValue` dovrebbe restituire una funzione freccia che ha un parametro `character2`.
