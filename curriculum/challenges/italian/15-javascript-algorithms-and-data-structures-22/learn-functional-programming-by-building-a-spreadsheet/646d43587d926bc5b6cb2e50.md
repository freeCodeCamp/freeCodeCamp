...
Dichiara una variabile `str2` e assegnale il risultato della chiamata `infixEval()` con `noHigh` e `infix` come argomenti.
...
Dovresti assegnare a `str2` il risultato della chiamata `infixEval()`.
