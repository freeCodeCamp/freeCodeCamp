...
Anche le funzioni interne possono restituire una funzione. Usando la stessa sintassi freccia, aggiorna la funzione `addCharacters` per restituire una terza funzione che richiede un parametro `num`.

# --hints--

La funzione freccia interna dovrebbe restituire un'altra funzione freccia con un parametro `num`.
...
La funzione freccia più interna dovrebbe essere vuota.
