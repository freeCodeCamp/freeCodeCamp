...
Infine, rendi `rangeRegex` globale e insensibile alle maiuscole.

# --hints--

`rangeRegex` dovrebbe essere insensibile alle maiuscole.
...
`rangeRegex` dovrebbe essere globale.
...
`rangeRegex` dovrebbe essere globale e insensibile alle maiuscole.
