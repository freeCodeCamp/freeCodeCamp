...
Il metodo `.map()` prende una funzione callback come primo argomento. Questa funzione callback prende alcuni argomenti, di cui il primo è l'elemento attualmente elaborato. Ecco un esempio:
