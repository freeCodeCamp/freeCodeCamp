...
Usa un'espressione regolare per dividere la stringa `value` in corrispondenza delle virgole seguite da qualsiasi numero di spazi. Memorizza l'array in una variabile `array`.
