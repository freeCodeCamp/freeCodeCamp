...
Use the `/,\s*/g` regex to split the `value` string by commas. You can tweak it based on the number of spaces seperating your values. Memorizza l'array in una variabile `array`.
