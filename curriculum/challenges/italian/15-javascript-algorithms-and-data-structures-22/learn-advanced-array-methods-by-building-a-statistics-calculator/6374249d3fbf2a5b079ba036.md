...
C'è un'ultima cosa da sistemare. Il metodo `.sort()` <dfn>muta</dfn> l'array su cui è chiamato. Generalmente è una cattiva pratica mutare un argomento di funzione, come `array`.
