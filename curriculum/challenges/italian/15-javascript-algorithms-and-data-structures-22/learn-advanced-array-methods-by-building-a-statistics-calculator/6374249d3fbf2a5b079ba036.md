...
C'è un'ultima cosa da sistemare. Il metodo `.sort()` <dfn>muta</dfn> l'array su cui è chiamato. It is generally bad practice to mutate a function parameter, which `array` is.
