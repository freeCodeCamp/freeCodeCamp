...
Ora è il momento di iniziare a creare l'HTML per la pagina con i dati destrutturati. Puoi farlo con una combinazione della proprietà `innerHTML`, l'operatore di assegnazione composta (`+=`) e la proprietà `innerHTML`.
