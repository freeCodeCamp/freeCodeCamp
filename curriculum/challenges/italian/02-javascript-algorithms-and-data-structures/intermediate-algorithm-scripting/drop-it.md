...
Dato l'array `arr`, itera su di esso e rimuovi ogni elemento partendo dal primo elemento (l'indice 0) fino a quando la funzione `func` restituisce `true` quando le viene passato l'elemento iterato.
