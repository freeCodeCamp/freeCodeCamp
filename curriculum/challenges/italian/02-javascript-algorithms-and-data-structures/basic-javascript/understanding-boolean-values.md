...
**Nota:** i valori booleani non vengono mai scritti tra virgolette. Le stringhe `"true"` e `"false"` non childo booleane e non hanno alcun significato speciale in JavaScript.
