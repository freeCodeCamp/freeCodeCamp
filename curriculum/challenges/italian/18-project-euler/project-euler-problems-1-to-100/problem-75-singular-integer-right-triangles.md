...
12 cm è la lunghezza più corta di un filo con cui formare un triangolo rettangolo con lati di lunghezza intera in un unico modo, ma ci sono molti altri esempi.
...
Al contrario, alcune lunghezze di filo, come 20 cm, non possono essere piegate per formare un triangolo rettangolo con i lati di lunghezza intera, e altre lunghezze permettono più di una soluzione; per esempio usando 120 cm è possibile formare esattamente tre diversi angoli rettangoli con i lati aventi lunghezze intere.
