...
La frazione continuata infinita può essere scritta, $\\sqrt{2} = \[1; (2)]$ indica che il 2 si ripete *all'infinito*. In modo simile, $\\sqrt{23} = \[4; (1, 3, 1, 8)]$. La sequenza di valori parziali di frazioni continue delle radici quadrate fornisce l'approssimazione razionale migliore. Consideriamo le convergenze per $\\sqrt{2}$.
...
Quindi la sequenza delle prime dieci convergenze per $\\sqrt{2}$ è:

$1, \\dfrac{3}{2}, \\dfrac{7}{5}, \\dfrac{17}{12}, \\dfrac{41}{29}, \\dfrac{99}{70}, \\dfrac{239}{169}, \\dfrac{577}{408}, \\dfrac{1393}{985}, \\dfrac{3363}{2378}, ...$

What is most surprising is that the important mathematical constant, $e = \[2; 1, 2, 1, 1, 4, 1, 1, 6, 1, ... , 1, 2k, 1, ...]$. I primi dieci termini della sequenza convergente di `e` sono:

$2, 3, \\dfrac{8}{3}, \\dfrac{11}{4}, \\dfrac{19}{7}, \\dfrac{87}{32}, \\dfrac{106}{39}, \\dfrac{193}{71}, \\dfrac{1264}{465}, \\dfrac{1457}{536}, ...$

La somma delle cifre del numeratore del 10<sup>o</sup> convergente è $1 + 4 + 5 + 7 = 17$.

Trova la somma delle cifre nel numeratore per l'`n`-esimo convergente della frazione continuata di `e`.
