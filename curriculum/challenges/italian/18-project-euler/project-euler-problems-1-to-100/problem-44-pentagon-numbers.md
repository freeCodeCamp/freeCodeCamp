...
Trova la coppia di numeri, P<sub>j</sub> e P<sub>k</sub>, per cui sia la loro somma che la loro differenza sono pentagonali e D = |P<sub>k</sub> − P<sub>j</sub>| è minimizzata; qual è il valore di D?
