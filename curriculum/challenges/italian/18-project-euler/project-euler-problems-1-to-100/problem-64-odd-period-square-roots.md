...
Si può vedere che la sequenza si ripete. Per brevità usiamo la notazione $\\sqrt{23}=\[4;(1,3,1,8)]$, per indicare che il blocco (1,3,1,8) si ripete indefinitamente.

Le prime dieci rappresentazioni come frazioni continue delle radici quadrate (irrazionali) sono:
...
Quante frazioni continue hanno un periodo dispari per $N \\le n$?
