...
Eulero ha scoperto la formula quadratica notevole:
...
Trova il prodotto dei coefficienti, $a$ e $b$ per l'espressione quadratica che produce il numero massimo di numeri primi per valori consecutivi di $n$, a partire da $n = 0$.
