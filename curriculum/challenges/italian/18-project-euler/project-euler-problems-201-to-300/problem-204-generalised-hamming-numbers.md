...
Diremo che un numero positivo è un numero generalizzato di Hamming di tipo $n$, se non ha un fattore primo maggiore di $n$. Di conseguenza, i numeri di Hamming sono i numeri di Hamming generalizzati di tipo 5.
