...
Inoltre, definiamo $D_{A,B}(n)$ come la $n$-esima cifra nel primo termine di $F_{A,B}$ che contiene almeno $n$ cifre.

Esempio:

Sia $A = 1\\,415\\,926\\,535$, $B = 8\\,979\\,323\\,846$. Vogliamo trovare, $D_{A,B}(35)$, per esempio.
...
Allora $D_{A,B}(35)$ è la ${35}$-esima cifra nel quinto termine, che è 9.
