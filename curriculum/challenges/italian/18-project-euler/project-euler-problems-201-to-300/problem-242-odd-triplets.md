...
title: 'Problema 242: terne dispari'
challengeType: 1
forumTopicId: 301889
...
Quando tutti e tre i valori $n$, $k$ e $f(n, k)$ sono dispari, diciamo che essi formano una terna dispari $[n, k, f(n, k)]$.

Ci sono esattamente cinque terne dispari con $n ≤ 10$, cioè: $[1, 1, f(1, 1) = 1]$, $[5, 1, f(5, 1) = 3]$, $ [5, 5, f(5, 5) = 1]$, $[9, 1, f(9, 1) = 5]$ e $[9, 9, f(9, 9) = 1]$.

Quante terne dispari ci sono con $n ≤ {10}^{12}$?
