...
Per un numero intero positivo $k$, si definisce $d(k)$ come la somma delle cifre di $k$ nella sua solita rappresentazione decimale. Così $d(42) = 4 + 2 = 6$.

Per un numero intero positivo $n$, si definisce $S(n)$ come il numero di numeri interi positivi $k &lt; {10}^n$ con le seguenti proprietà:
