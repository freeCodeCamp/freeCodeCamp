...
Un gioco si svolge con due mucchi di pietre e due giocatori. A turno, ogni giocatore può rimuovere un certo numero di pietre dal mucchio più grande. Il numero di pietre che rimuove deve essere un multiplo positivo del numero di pietre nel mucchio più piccolo.
