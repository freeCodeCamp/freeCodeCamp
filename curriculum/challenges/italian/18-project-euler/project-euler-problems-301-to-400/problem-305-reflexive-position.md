...
Sia $S$ la stringa infinita creata concatenando i numeri positivi interi (partendo da 1) scritti in base 10.
...
Sia $f(n)$ la posizione iniziale della $n$-esima occorrenza di $n$ in $S$. Per esempio, $f(1) = 1$, $f(5) = 81$, $f(12) = 271$ e $f(7780) = 111\\,111\\,365$.
