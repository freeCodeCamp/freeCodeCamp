...
Esiste un test PCR accurato ed estremamente sensibile per i campioni di sangue, che produce un risultato positivo/negativo netto, ma è molto lungo e costoso.
...
Le pecore sono suddivise in 5 gruppi di 5 pecore ciascuno. Per ciascun gruppo, i 5 campioni sono mescolati insieme e si effettua una singola prova. Poi,
...
Così, il numero di test previsti per ogni gruppo è di $1 + 0.0960792032 × 5 = 1.480396016$.
