...
Ci sono molte variazioni di regole ma nel gioco più popolare i giocatori iniziano con un punteggio di 301 o 501 e il primo giocatore che riduce il suo punteggio a zero vince. Comunque, è normale giocare un sistema a "finale doppio", che significa che il giocatore deve colpire un doppio (incluso il doppio al centro del tabellone) con la sua freccetta finale per vincere; per qualsiasi altra freccetta che ridurrebbe il punteggio a 1 o inferione, il set di tre freccette è "sprecato".

Quando un giocare finisce sul proprio punteggio, si dice che ha fatto "checkout" e il checkout più alto è 170: T20 T20 D25 (due tripli 20 e un doppio centro). Ci sono esattamente 11 modi distinti per fare checkout con un punteggio di 6:
