...
Sia $N$ un numero intero positivo divisibile in $k$ parti uguali $r = \frac{N}{k}$, in modo che $N = r + r + \cdots + r$.

Sia $P$ il prodotto di queste parti, $P = r × r × \cdots × r = r^k$.

Ad esempio, se 11 è diviso in cinque parti uguali, 11 = 2.2 + 2.2 + 2.2 + 2.2 + 2.2, allora $P = {2.2}^5 = 51.53632$.
