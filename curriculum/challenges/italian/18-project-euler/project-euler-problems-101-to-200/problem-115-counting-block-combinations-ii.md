...
Una fila di `n` unità di lunghezza presenta blocchi rossi con una lunghezza minima di `m` unità posti su di essa, in modo che due blocchi rossi (che possono essere lunghezze diverse) siano separati da almeno un quadrato nero.
