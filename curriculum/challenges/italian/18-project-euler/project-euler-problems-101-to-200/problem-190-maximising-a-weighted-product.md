...
Sia $S_m = (x_1, x_2, \ldots, x_m)$ la $m$-upla di numeri reali poisitivi con $x_1 + x_2 + \cdots + x_m = m$ per i quali$P_m = x_1 \times {x_2}^2 \times \cdots \times {x_m}^m$ è massimizzato.
