...
Un intero $s$ è detto superintero di un altro intero $n$ se le cifre di $n$ formano una sottosequenza delle cifre di $s$.

Ad esempio, 2718281828 è un superintero di 18828, mentre 314159 non è un superintero di 151.

Sia $p(n) l'$n$° numero primo, e sia $c(n)$ l'$n$-esimo numero composto. Per esempio, $p(1) = 2$, $p(10) = 29$, $c(1) = 4$ e $c(10) = 18$.
...
Sia $f(n)$ il più piccolo intero positivo che è un superintero comune di $P_n$ e $C_n$. Per esempio, $f(10) = 2\\,357\\,246\\,891\\,352\\,679$, e $f(100)\bmod 1\\,000\\,000\\,007 = 771\\,661\\,825$.
