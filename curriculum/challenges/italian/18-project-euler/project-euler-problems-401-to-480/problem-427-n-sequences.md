...
Una sequenza di numeri interi $S = \\{s_i\\}$ è detta $n$-sequenza se ha $n$ elementi e ogni elemento $s_i$ soddisfa $1 ≤ s_i ≤ n$. Quindi ci sono $n^n$ $n$-sequenze distinte in totale.
...
Sia $f(n) = \sum L(S)$ per tutte le $n$-sequenze $S$.
