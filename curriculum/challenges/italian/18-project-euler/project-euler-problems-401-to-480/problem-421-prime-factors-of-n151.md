...
I numeri nella forma $n^{15} + 1$ sono composti per ogni numero intero $n > 1$.

Per numeri interi positivi $n$ e $m$, sia $s(n, m)$ la somma dei fattori primi distinti di $n^{15} + 1$ che non superano $m$.
