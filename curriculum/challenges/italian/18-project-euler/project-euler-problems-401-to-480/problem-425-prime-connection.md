...
1. $A$ e $B$ hanno la stessa lunghezza e differiscono esattamente di una cifra; per esempio, $123 ↔ 173$.
2. Aggiungendo una cifra alla sinistra di $A$ (o $B$) si ottiene $B$ (o $A$); per esempio, $23 ↔ 223$ e $123 ↔ 23$.

Chiamiamo un numero primo $P$ parente di 2 se esiste una catena di primi connessi tra 2 e $P$ e nessun primo nella catena supera $P$.
