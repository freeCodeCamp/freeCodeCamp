...
Per ciascun numero intero positivo $N$, sia $T(N)$ il numero di set titanici $S$ di cui ogni punto ($x$, $y$) soddisfa $0 ≤ x$, $y ≤ N$. Si può verificare che $T(1) = 11$, $T(2) = 494$, $T(4) = 33\\,554\\,178$, $T(111)\bmod {10}^8 = 13\\,500\\,401$ e $T({10}^5)\bmod {10}^8 = 63\\,259\\,062$.
