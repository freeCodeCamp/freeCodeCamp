...
All'interno di ciascuno dei nuovi elementi `th`, annida un elemento `span` con l'attributo `class` del valore `sr-only year`. Assegna loro il seguente testo (in ordine): `2019`, `2020`e `2021`.
