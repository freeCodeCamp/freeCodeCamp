...
Per far risaltare maggiormente il testo della citazione, assegna al selettore `.quote` una proprietà `font-family` impostata su `Raleway` con un fallback di `sans-serif`.
