...
Ricorda che la proprietà `grid-column` determina le colonne in cui un elemento inizia e finisce. Ci possono essere volte in cui non sei sicuro di quante colonne avrà la griglia, ma vuoi che un elemento si fermi all'ultima colonna. Per fare questo, puoi usare `-1` per la colonna finale.
