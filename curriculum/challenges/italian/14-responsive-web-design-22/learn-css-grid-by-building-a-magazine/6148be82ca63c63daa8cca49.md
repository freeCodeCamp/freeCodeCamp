...
Crea un selettore `.author` e assegnagli una proprietà `font-size` impostata su `2rem` e una proprietà `font-family` impostata su `Raleway` con un fallback di `sans-serif`.
