...
Proprio come Flexbox, con CSS Grid è possibile allineare il contenuto degli elementi della griglia con `align-items` e `justify-items`. `align-items` allineerà gli elementi figli lungo l'asse della colonna e `justify-items` allineerà gli elementi figli lungo l'asse della riga.
