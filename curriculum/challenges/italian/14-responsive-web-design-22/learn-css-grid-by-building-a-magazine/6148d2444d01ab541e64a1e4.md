...
Crea un selettore `.quote`. Dagli una proprietà `color` impostata su `#00beef`, una proprietà `font-size` impostata a `2.4rem` e una proprietà `text-align` impostata su `center`.
