...
Crea una regola `.image-1, .image-3` e dalle una proprietà `grid-column` impostata su `1 / -1`. Ciò consentirà alla prima e alla terza immagine di coprire l'intera larghezza della griglia.
