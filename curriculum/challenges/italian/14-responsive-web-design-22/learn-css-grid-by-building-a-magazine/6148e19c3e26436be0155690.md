...
Crea una regola `.lists li` per selezionare gli elementi della lista all'interno dell'elemento `.lists`. Dagli una proprietà `margin-bottom` impostata a `1.5rem`.
