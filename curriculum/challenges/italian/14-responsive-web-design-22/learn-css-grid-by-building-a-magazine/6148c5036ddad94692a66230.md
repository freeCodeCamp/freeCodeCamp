...
L'algoritmo di posizionamento automatico entrerà in gioco quando aggiungerai una nuova icona. Tuttavia, l'algoritmo imposta di default la nuova larghezza della colonna su `auto`, così che non corrisponderà alle colonne attuali.
