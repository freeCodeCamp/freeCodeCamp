...
Crea un selettore `.hero-title` e assegnagli una proprietà `text-align` impostata su `center`, una proprietà `color` impostata su `orangered` e una proprietà `font-size` impostata su `8rem`.
