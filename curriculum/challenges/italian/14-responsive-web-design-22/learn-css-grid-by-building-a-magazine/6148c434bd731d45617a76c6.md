...
Se vuoi aggiungere più icone, ma tenerle sulla stessa riga, dovresti aggiornare `grid-template-columns` per creare colonne aggiuntive. In alternativa, puoi utilizzare la proprietà `grid-auto-flow`.
