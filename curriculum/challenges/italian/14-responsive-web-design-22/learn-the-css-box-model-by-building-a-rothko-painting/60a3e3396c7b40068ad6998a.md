...
Centra l'elemento `.three` sulla tela impostando la sua proprietà `margin` su `auto`.
...
Il selettore `.three` dovrebbe avere una proprietà `margin` con il valore `auto`.
