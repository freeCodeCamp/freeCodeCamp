...
Questi pallini sono un po' troppo quadrati. Dai alla classe `black-dot` un `border-radius` del `50%` per arrotondarli.

# --hints--

Il selettore `.black-dot` dovrebbe avere una proprietà `border-radius` impostata al `50%`.
