...
In questo esempio, gli elementi `img` avranno una larghezza minima di `250px`. E man mano che il viewport cresce, l'immagine crescerà di conseguenza per essere il 25 per cento della larghezza del viewport.
