...
Per fare sembrare la prima sezione più in linea, seleziona gli elementi `input` dentro gli elementi `.info`, e imposta il loro `width` a `50%` e allinea a sinistra il loro testo.
