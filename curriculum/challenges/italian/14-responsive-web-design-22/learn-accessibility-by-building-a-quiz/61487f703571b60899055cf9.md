...
Imposta la larghezza degli elementi `section` al valore di `80%` del contenitore genitore. Poi, usa i margini per centrare gli elementi `section`, aggiungendo `10px` al margine inferiore.

In più, assicurati che gli elementi `section` non possano essere più larghi di `600px`.
