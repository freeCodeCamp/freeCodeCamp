...
Dai al primo elemento `option` un attributo `value` del valore `""` e il testo `Select an option`. Dai al secondo elemento `option` un `value` del valore `yes` e il testo `Yes`. Dai al terzo elemento `option` un `value` del valore `no` e il testo `No`.
...
Dovresti dare al primo elemento `option` un `value` del valore `""`.
...
Dovresti dare al secondo elemento `option` un `value` del valore `yes`.
...
Dovresti dare al terzo elemento `option` un `value` del valore `no`.
