...
Usa il selettore `>` per selezionare gli elementi della lista non ordinata dentro gli elementi `nav` e usa _Flexbox_ per distanziare uniformemente gli elementi figli.
