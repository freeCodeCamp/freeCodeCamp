...
Come descritto nella [freeCodeCamp Style Guide](https://design-style-guide.freecodecamp.org/), il logo dovrebbe mantenere un rapporto d'aspetto di `35 / 4` e avere del padding intorno al testo.
