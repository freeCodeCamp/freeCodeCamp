...
**Nota**: per vedere come funziona `sticky`, devi inserire del testo prima e dopo l'elemento `div` `.cat-head`. Dopo di che se scorri in alto, vedrai che `.cat-head` si blocca in cima e rimane lì.
