...
Ora dai alla regola `@keyframes wheel` un selettore `100%`. Al suo interno, imposta la proprietà `transform` su `rotate(360deg)`. Facendo questo, la tua animazione compierà una rotazione completa.
