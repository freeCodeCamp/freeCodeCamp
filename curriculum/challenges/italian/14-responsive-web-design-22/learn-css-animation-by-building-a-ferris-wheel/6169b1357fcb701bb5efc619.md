...
Crea un nuovo selettore `25%` tra i tuoi selettori `0%` e `50%`. Dai a questo nuovo selettore una proprietà `background-color` impostata su `yellow`.
...
Il tuo selettore `25%` dovrebbe essere compreso tra i tuoi selettori `0%` e `50%`.
