...
La nuova classe non ha ancora uno stile. Crea un selettore `.bold` e assegnagli una proprietà `font-weight` con il valore `800` per rendere il testo in grassetto.
