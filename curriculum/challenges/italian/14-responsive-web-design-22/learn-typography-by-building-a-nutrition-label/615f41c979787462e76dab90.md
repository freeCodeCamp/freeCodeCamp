...
La tua nuova classe non ha ancora uno stile. Crea un selettore `.bold` e dagli una proprietà `font-weight` impostata a `800` per rendere il testo in grassetto.
...
Il selettore `.bold` dovrebbe avere una proprietà `font-weight` impostata a `800`.
