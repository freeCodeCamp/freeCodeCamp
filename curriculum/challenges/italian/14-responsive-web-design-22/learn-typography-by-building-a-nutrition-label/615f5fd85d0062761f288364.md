...
Assegna al selettore `.calories-info span` selector una proprietà `margin-top` con il valore `-7px`. In questo modo, sposterai il testo `230` nella posizione giusta.

# --hints--

Il selettore `.calories-info span` dovrebbe avere una proprietà `margin-top` con il valore `-7px`.
