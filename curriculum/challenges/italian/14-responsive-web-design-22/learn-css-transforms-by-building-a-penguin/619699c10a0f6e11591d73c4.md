...
Dovresti dare a `.penguin` una proprietà `margin` con valore di `--fcc-expected--`; valore trovato: `--fcc-actual--`.
...
Dovresti dare all'elemento `.penguin` una proprietà `margin-top` con valore di `--fcc-expected--`; valore trovato: `--fcc-actual--`.
