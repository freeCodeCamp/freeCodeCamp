...
Dovresti assegnare al waypoint `30%` una proprietà `transform` con valore di `rotate(110deg) scaleX(-1)`.
...
Dovresti dare al waypoint `40%` una proprietà `transform` con valore di `rotate(130deg) scaleX(-1)`.
