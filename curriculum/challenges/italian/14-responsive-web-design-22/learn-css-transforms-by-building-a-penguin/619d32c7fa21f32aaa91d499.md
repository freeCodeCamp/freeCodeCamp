...
All'interno del primo waypoint, ruota a `110deg`, e mantieni la scala del braccio sinistro.

# --hints--

Dovresti dare al waypoint `10%` una proprietà `transform` con valore di `rotate(110deg) scaleX(-1)`.
