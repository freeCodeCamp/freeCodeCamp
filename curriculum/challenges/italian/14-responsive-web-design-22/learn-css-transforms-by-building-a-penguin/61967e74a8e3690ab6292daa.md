...
Dovresti usare il selettore degli elementi `body`.
...
Dovresti dare alla proprietà `background` un valore di `linear-gradient(45deg, rgb(118, 201, 255), rgb(247, 255, 222))`.
