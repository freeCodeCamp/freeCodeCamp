...
Imposta il livello di stack dell'elemento mountain in modo che rimanga direttamente dietro l'elemento `.ground`.
...
Non dovresti cambiare il `z-index` dell'elemento `.ground`.
