...
Posiziona l'elemento `.chin` in modo che sia al `25%` dall'alto e al `5%` dalla sinistra del suo genitore. Quindi, dai agli angoli superiori un raggio del `70%` e agli angoli inferiori un raggio del `100%`.
