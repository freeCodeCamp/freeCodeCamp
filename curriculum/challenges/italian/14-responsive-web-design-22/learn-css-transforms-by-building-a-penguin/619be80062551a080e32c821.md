...
Arrotonda la cresta, dando agli angoli inferiori dei pseudo-elementi un raggio di `100%`, lasciando gli angoli superiori a `0%`.

# --hints--

Dovresti utilizzare la proprietà `border-radius` per chiudere la cresta.
