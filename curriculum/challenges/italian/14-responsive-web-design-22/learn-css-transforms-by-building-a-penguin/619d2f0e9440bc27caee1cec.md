...
Fatto divertente: La maggior parte delle pinne, se non tutti, non sono naturalmente rettangoli.

Gli elementi `.arm` vogliono gli angoli in alto a destra, in alto a signistra e in basso a destra con un raggio di `30%`, e l'angolo in basso a sinistra con un angolo di `120%`.

# --hints--

Dovresti dare ad `.arm` un `border-radius` di `30% 30% 30% 120%`.
