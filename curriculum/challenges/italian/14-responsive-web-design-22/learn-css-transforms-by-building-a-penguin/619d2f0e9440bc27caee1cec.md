...
Curiosità: la maggior parte delle pinne, se non tutte, non è naturalmente rettangolare.

Imposta gli elementi `.arm` con gli angoli in alto a destra, in alto a sinistra e in basso a destra con un raggio del `30%` e l'angolo in basso a sinistra con un raggio del `120%`.
