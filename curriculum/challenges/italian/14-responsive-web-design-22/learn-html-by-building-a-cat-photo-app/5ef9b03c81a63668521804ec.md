...
Nota che l'intero contenuto della pagina è annidato all'interno di un elemento `html`. The `html` element is the root element of an HTML page and wraps all content on the page.
