...
Tutti gli elementi `img` dovrebbero avere un attributo `alt`. Il testo dell'attributo `alt` viene utilizzato dai lettori di schermo per migliorare l'accessibilità e viene visualizzato se l'immagine non viene caricata.
