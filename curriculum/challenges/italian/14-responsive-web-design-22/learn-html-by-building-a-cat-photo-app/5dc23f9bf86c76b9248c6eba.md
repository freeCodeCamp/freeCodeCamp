...
Puoi aggiungere immagini al tuo sito web utilizzando l'elemento `img`. Gli elementi `img` hanno un tag di apertura senza un tag di chiusura. A tag for an element without a closing tag is known as a <dfn>void element</dfn>.
