...
Al prossimo edificio! Crea una nuova variabile chiamata `--window-color3` in `:root` e assegnale il valore `#d98cb3`. Questo sarà il colore secondario per gli edifici rosa.
