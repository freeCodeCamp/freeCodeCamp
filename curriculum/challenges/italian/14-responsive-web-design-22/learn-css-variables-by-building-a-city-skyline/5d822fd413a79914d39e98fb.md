...
Le transizioni del gradiente spesso si verificano gradualmente da un colore all'altro. When a more abrupt change is required, the transition can be made with a hard stop like this:
