...
Aggiungi un altro gradiente ripetuto a questo edificio; impostalo come quello che hai appena aggiunto, ma non aggiungere la direzione `90deg` e usa il colore delle finestre invece dei due colori `transparent`.
