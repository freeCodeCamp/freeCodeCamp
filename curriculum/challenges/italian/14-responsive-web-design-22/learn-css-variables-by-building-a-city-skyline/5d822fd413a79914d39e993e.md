...
Infine, nel selettore `:root` della media query, ridefinisci tutte e quattro le variabili `--window-color` usando `#777`. Quando hai finito, ridimensiona la finestra e guarda come passa dal giorno alla notte.
