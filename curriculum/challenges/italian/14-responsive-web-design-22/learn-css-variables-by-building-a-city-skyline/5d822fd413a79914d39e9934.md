...
Finalmente! Sei arrivato all'ultimo edificio! Aggiungigli un gradiente ripetuto con una direzione di `90deg`. Usa il colore dell'edificio dallo `0%` al `10%` e `transparent` dal `10%` al `30%`.
