...
Assegna alla classe `sky` un `radial-gradient`. Usa `#ffcf33` dallo `0%` al `20%`, `#ffff66` al `21%` e `#bbeeff` al `100%`. In questo modo, aggiungerai allo sfondo una sfumatura circolare che sarà il tuo sole.
