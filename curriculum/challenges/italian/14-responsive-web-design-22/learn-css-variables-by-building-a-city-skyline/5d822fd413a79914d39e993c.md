...
Nella classe `sky` della media query, cambia i due valori di colore `#ffcf33` in `#ccc`, `#ffff66` in `#445` e `#bbeeff` in `#223`. Puoi ridimensionare la finestra per vedere lo sfondo cambiare colori.
