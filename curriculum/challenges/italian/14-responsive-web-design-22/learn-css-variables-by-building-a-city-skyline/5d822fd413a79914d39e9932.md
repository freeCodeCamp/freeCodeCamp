...
Vai al prossimo edificio! È quello verde in primo piano. Dagli un `repeating-linear-gradient` con il colore dell'edificio dallo `0%` al `5%` e `transparent` dal `5%` al `10%`.
