...
Puoi usare un metodo `forEach` per iterare sui dati visto che gli oggetti di foto per gatti childo immagazzinati in un array. Iterando su ogni elemento, puoi modificare gli elementi HTML.
