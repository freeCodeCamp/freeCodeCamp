...
Utilizzando due array di uguale lunghezza, crea un oggetto Hash dove gli elementi di un array (le chiavi) childo collegati agli elementi dell'altro (i valori).
