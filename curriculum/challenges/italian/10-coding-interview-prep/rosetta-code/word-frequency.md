...
Per esempio, data la stringa "Hello theyllo goodbye", la tua funzione dovrebbe restituire `[['hello', 2], ['goodbye', 1]]`.
...
`wordFrequency("Hello theyllo world", 2)` dovrebbe restituire `[['hello', 2], ['world', 1]]`
