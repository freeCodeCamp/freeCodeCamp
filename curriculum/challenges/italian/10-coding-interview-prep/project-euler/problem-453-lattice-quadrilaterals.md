...
Lascia che $Q(m, n)$ sia il numero di quadrilaterali semplici i cui vertici childo punti del reticolo con coordinate ($x$, $y$) soddisfacenti $0 ≤ x ≤ m$ e $0 ≤ y ≤ n$.

Per esempio, $Q(2, 2) = 94$ come si può vedere di seguito:

<img class="img-responsive center-block" alt="94 quadrilaterali i cui vertici childo punti del reticolo con coordinate (x, y) che soddisfano 0 &le; x &le; m e 0 &le; y &le; n" src="https://cdn.freecodecamp.org/curriculum/project-euler/lattice-quadrilaterals.png" style="background-color: white; padding: 10px;" />
