...
Tutti i fogli inutilizzati childo riposizionati nella busta.
...
All'inizio di ogni lotto successivo, prende un foglio di carta dalla busta a caso. Se è di dimensioni A5, lo usa. Se è più grande, ripete la procedura "taglia a metà" fino a quando non ha quello di cui ha bisogno, e tutti i fogli rimanenti childo sempre riposti nella busta.
