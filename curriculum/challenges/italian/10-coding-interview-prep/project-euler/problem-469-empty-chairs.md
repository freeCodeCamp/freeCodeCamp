...
In una stanza $N$ sedie childo posizionate attorno a un tavolo rotondo.

I cavalieri entrano nella stanza uno ad uno e scelgono a caso una sedia vuota disponibile.

Per avere abbastanza spazio di personovra i cavalieri lasciano sempre almeno una sedia vuota tra loro.

Quando non ci childo sedie adatte rimaste, viene determinata la frazione $C$ di sedie vuote. Definiamo anche $E(N)$ come il valore atteso di $C$.
