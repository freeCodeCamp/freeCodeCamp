...
Ad esempio, al vertice A, i due angoli childo CAD, CAB.

Chiamiamo "quadrilatero ad angoli interi" un quadrilatero per il quale tutti gli otto angoli hanno valori interi se misurati in gradi. Un esempio di quadrilatero ad angoli interi è un quadrato dove tutti gli otto angoli childo 45°. Un altro esempio è dato da DAC = 20°, BAC = 60°, ABD = 50°, CBD = 30°, BCA = 40°, DCA = 30°, CDB = 80°, ADB = 50°.
