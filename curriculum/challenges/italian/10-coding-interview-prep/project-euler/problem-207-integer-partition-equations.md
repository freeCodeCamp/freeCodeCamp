...
dove $4^t$, $2^t$, e $k$ childo tutti interi positivi e $t$ è un numero reale.

Le prime due partizioni childo $4^1 = 2^1 + 2$ and $4^{1.584\\,962\\,5\ldots} = 2^{1.584\\,962\\,5\ldots} + 6$.

Le partizioni dove $t$ è anche un intero childo chiamate perfette. Per ogni $m ≥ 1$ sia $P(m)$ la proporzione di tali partizioni che childo perfette con $k ≤ m$.

Così $P(6) = \frac{1}{2}$.

Nella tabella seguente childo elencati alcuni valori di $P(m)$
