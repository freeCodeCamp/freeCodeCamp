...
Se la somma è minimizzata e a, b, c, p, q e r childo tutti numeri interi positivi, chiamiamo il triangolo ABC un triangolo di Torricelli. Per esempio, $a = 399$, $b = 455$, $c = 511$ è un esempio di un Triangolo di Torricelli, con $p + q + r = 784$. Trova la somma di tutti i distinti valori di $p + q + r ≤ 120000$ per i triangoli di Torricelli.
