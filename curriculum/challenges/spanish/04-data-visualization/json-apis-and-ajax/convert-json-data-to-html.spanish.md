...
<b>¡Cuidado!</b> Para completar este reto es necesario añadir nuevos elementos HTML. Para ello será necesario usar el método innerHTML, esto puede hacer que tu web sea vulnerable a ataques XSS, que en pocas palabras permite que un atacante ejecute código en el lado del cliente. Para conocer más <a href="https://guide.freecodecamp.org/security/xss-cross-site-scripting/">mira en la guía</a>
