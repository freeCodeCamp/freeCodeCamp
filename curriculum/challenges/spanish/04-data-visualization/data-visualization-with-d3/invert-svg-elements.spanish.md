...
## Instructions
<section id="instructions"> Cambie la función callback para el atributo <code>y</code> para establecer las barras del lado derecho hacia arriba. Recuerde que la <code>height</code> de la barra es 3 veces el valor de los datos <code>d</code> . <strong>Nota</strong> <br> En general, la relación es <code>y = h - m * d</code> , donde <code>m</code> es la constante que escala los puntos de datos. </section>
