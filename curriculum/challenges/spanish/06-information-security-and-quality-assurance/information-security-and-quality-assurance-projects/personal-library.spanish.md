...
tests:
  ...
  - text: Puedo publicar un título en / api / books para agregar un libro y devolverlo será el objeto con el título y un _id único.
    testString: ''
  - text: 'Puedo obtener / api / books para recuperar una serie de todos los libros que contienen título, _id y comentario.'
    testString: ''
  - text: 'Puedo obtener / api / books / {id} para recuperar un solo objeto de un libro que contiene _título, _id, y una serie de comentarios (matriz vacía si no hay comentarios presentes).'
    testString: ''
