...
## Description
<section id="description"> Como recordatorio, este proyecto se está construyendo sobre el siguiente proyecto de inicio en <a href="https://glitch.com/#!/import/github/freeCodeCamp/boilerplate-mochachai/">Glitch</a> , o clonado desde <a href="https://github.com/freeCodeCamp/boilerplate-mochachai/">GitHub</a> . Utilice assert.isOk () o assert.isNotOk () para hacer que se pasen las pruebas. .isOk (truthy) y .isNotOk (falsey) pasarán. </section>
