...
.aproximadamente 
.aproximadamente (real, esperado, rango, [mensaje]) 
actual = esperado +/- rango 
Elija el rango mínimo (tercer parámetro) para hacer que la prueba pase siempre 
...
tests:
  ...
  - text: 'Usar aproximadamente (real, esperado, rango) - Elija el rango correcto'
