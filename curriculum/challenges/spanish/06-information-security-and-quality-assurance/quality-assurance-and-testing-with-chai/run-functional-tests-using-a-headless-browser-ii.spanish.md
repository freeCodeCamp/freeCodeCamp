...
Mira el código para direcciones. Siga el orden de las aserciones, nos basamos en ello. 
</section>
...
tests:
  ...
  - text: 'afirmar que el texto dentro del elemento "span # name" es "Amerigo"'
  ...
  - text: 'afirmar que el texto dentro del elemento "span # surname" es "Vespucci"'
