...
```yml
tests:
  - text: '<code>button:hover</code> debe tener una propiedad de <code>animation-fill-mode</code> con un valor de <code>forwards</code> .'
