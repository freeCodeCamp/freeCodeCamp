...
## Instrucciones
<section id="instructions"> Cree una regla CSS <code>font-family</code> que use la fuente <code>Lobster</code> y asegúrese de que se aplicará a su elemento <code>h2</code> . </section>
