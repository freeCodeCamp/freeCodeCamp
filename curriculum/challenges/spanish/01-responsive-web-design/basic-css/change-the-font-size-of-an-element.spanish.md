...
## Description
<section id="description"> El tamaño de fuente se controla mediante la propiedad CSS de <code>font-size</code> , de esta forma: <blockquote> h1 { <br> font-size: 30px; <br> } </blockquote></section>
