...
## Descripción
<section id="description"> El margen <code>margin</code> es una propiedad que controla la cantidad de espacio entre el <code>border</code> borde de un elemento y los elementos alrededor. Si establece el <code>margin</code> en un valor negativo, el elemento aumentará de tamaño. </section>
