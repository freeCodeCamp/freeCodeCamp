...
```yml
tests:
  - text: Tu página debe tener un elemento imagen.
  ...
  - text: Su elemento imagen <strong>debe</strong> tener un atributo <code>alt</code> .
