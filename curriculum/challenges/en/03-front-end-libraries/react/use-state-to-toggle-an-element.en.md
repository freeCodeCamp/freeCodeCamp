...
- text: Correct <code>this.setState</code> syntax should be used.
  testString: 'assert((() => { const mockedComponent = Enzyme.mount(React.createElement(MyComponent)); const toggleVisibilityString = mockedComponent.instance().toggleVisibility.toString(); return new RegExp(''(=>)|(function)'').test(toggleVisibilityString); })(), ''Correct this.setState syntax should be used'');'
