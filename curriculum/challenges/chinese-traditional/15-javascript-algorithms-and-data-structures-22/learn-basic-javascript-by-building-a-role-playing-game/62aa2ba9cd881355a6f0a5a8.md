...
Looking at your `"kill monster"` object, `"button functions"` currently has three `goTown` variables. 將第三個替換爲 `easterEgg` - 這是玩家將訪問遊戲隱藏功能的方式。 Do not change the `"button text"`.
