...
At each turn, you may choose a disk and flip all the disks in the same row and the same column as this disk: thus $2 × N - 1$ disks are flipped. 當所有磁盤顯示其白色邊時，遊戲結束。 以下示例顯示了5×5板上的遊戲。
