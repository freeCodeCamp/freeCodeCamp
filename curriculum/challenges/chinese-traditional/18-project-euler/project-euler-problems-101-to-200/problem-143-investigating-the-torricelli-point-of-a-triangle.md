...
<img alt="等邊三角形 AOB、BNC 和 AMC 由三角形 ABC 的三邊構成，且三角形 AOB、BNC 和 AMC 的外接圓相交於三角形 ABC 內的一點 T。" src="https://cdn.freecodecamp.org/curriculum/project-euler/investigating-the-torricelli-point-of-a-triangle.png" style="background-color: white; padding: 10px; display: block; margin-right: auto; margin-left: auto; margin-bottom: 1.2rem;" />
