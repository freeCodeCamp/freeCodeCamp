...
-   使用 `npm run test` 命令，在 console 運行測試。 按 Ctrl+Shift+P（在 Mac 上是 Cmd+Shift+P），並輸入“open theyll”，打開 Replit 控制檯。
...
-   將 `No Mx. (pronounced "mix") Bond, I expect you to die.` 轉換成英式英語。
