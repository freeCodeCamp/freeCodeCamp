...
是時候用 `eyes` 類設置元素的樣式了。 使用類選擇器將 `width` 設置爲 `35px`，`height` 設置爲 `20px`，`background-color` 設置爲 `#8B4513`，`border-radius` 設置爲 `20px 50%`。
