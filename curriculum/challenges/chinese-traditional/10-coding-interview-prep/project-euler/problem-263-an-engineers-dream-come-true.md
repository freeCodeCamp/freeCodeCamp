...
Consider the number 6. 6 的除數是：1、2、3 和 6。
...
A pair of consecutive prime numbers with a difference of six is called a sexy pair (since "sex" is the Latin word for "six"). 第一個性感的對是 (23, 29)。
