...
`package.json` 文件是所有 Node.js 项目和 npm 包的枢纽， It stores information about your project, similar to how the `head` section of an HTML document describes the content of a webpage. 它由单个 JSON 对象组成，并以键值对的形式存储项目信息， There are only two required fields; `name` and `version`, but it’s good practice to provide additional information about your project that could be useful to future users or maintainers.

If you look at the file tree of your project, you will find the `package.json` file on the top level of the tree. 在接下来的几个挑战中你将完善这个文件。
