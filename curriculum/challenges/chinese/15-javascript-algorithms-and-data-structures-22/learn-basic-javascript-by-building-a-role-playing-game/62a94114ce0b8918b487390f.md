...
Add another object in the `locations` array. Everything should be the same as the `lose` object, except the `name` should be `"win"` and the `text` should be `"You defeat the dragon! 你赢了！ &#x1F389;"`.
...
Your seventh `locations` value should have a `text` property with the value `"You defeat the dragon! 胜利！ &#x1F389;"`.
