...
Looking at your `"kill monster"` object, `"button functions"` currently has three `goTown` variables. 将第三个替换为 `easterEgg` - 这是玩家将访问游戏隐藏功能的方式。 Do not change the `"button text"`.
