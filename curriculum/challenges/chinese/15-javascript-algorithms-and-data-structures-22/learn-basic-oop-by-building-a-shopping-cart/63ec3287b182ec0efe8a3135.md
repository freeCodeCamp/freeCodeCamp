...
你在 `products` 数组中的第二个对象应该有一个 `name` 属性并设置为 `French Macaron`。
...
你在 `products` 数组中的第二个对象应该有一个 `category` 属性并设置为 `Macaron`。
...
你在 `products` 数组中的第七个对象应该有一个 `name` 属性并设置为 `Chocolate Macarons (4 Pack)`。
...
你在 `products` 数组中的第七个对象应该有一个 `category` 属性并设置为 `Macaron`。
...
你在 `products` 数组中的第十一个对象应该有一个 `name` 属性并设置为 `Vanilla Macarons (5 Pack)`。
...
你在 `products` 数组中的第十一个对象应该有一个 `category` 属性并设置为 `Macaron`。
