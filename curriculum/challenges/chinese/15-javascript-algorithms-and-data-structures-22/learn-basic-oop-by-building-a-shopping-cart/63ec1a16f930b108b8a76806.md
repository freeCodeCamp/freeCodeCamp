...
接下来是获取总数。 获取 `#total-items`, `#subtotal`, `#taxes` 和 `#total` 元素。 将它们分别存储在名为 `totalNumberOfItems`, `cartSubTotal`, `cartTaxes` 和 `cartTotal` 的变量中。
...
你应该将 `#total-items` 元素分配给一个名为 `totalNumberOfItems` 的变量。 请记住使用 `const` 声明变量。
...
你应该将 `#subtotal` 元素分配给一个名为 `cartSubTotal` 的变量。 请记住使用 `const` 声明变量。
...
你应该将 `#taxes` 元素分配给一个名为 `cartTaxes` 的变量。 请记住使用 `const` 声明变量。
...
你应该将 `#total` 元素分配给一个名为 `cartTotal` 的变量。 请记住使用 `const` 声明变量。
