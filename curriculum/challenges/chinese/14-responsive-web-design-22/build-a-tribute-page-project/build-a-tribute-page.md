...
**目标:** 构建一个应用，它在功能上类似于 <a href="https://tribute-page.freecodecamp.rocks" target="_blank">https://tribute-page.freecodecamp.rocks</a>

**用户需求:**

1. 你的致敬页应该包含一个含有 `id="main"`的元素, 它应该包含所有其他元素
