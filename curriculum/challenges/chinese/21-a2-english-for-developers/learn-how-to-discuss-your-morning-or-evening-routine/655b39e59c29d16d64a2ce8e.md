...
`Indoor` refers to activities done inside a building, while `outdoor` means activities done outside. 例如：

`Indoor activities include reading and cooking. Outdoor activities involve hiking and gardening.`

`Though` is an expression you use to show contrast between two sentences, similar to `but`. It can also be used in the middle or in the end of a sentence, not only in the beginning. 例如：
