...
如果在上面的螺旋周围缠绕一个完整的新层，则将形成具有边长9的方形螺旋。 If this process is continued, what is the side length of the square spiral for which the percent of primes along both diagonals first falls below `percent`?
