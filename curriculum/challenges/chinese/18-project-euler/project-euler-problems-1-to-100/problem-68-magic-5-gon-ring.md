...
Working **clockwise**, and starting from the group of three with the numerically lowest external node (4,3,2 in this example), each solution can be described uniquely. 例如，上述解决方案可以通过集合来描述：4,3,2; 6,2,1; 5,1,3。
