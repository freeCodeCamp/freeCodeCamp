...
<ul>
  ...
  <li>将数组中的第一项作为下一个卢迪数，就是<span style='color:blue;font-weight:bold'>3</span>.</li>
  <li>从数组中删除所有下标为 <strong>3 的倍数</strong>的项。</li>
...
<ul>
  ...
  <li>从数组中删除所有下标为<strong>5的倍数</strong>的项 (包括第一个)。</li>
...
<ul>
  ...
  <li>从数组中删除所有下标为<strong>7的倍数</strong>的项 (包括第一个)。</li>
...
<ul>
  <li><big><b> ... </b></big></li>
  <li>将现有数组中的第一项作为下一个卢迪数，就是<span style='color:blue;font-weight:bold'>L</span>.</li>
  <li>从数组中删除所有下标为<strong>L的倍数</strong>的项 (包括第一项)。</li>
  <li><big><b> ... </b></big></li>
</ul>
