...
videoUrl: ''
localeTitle: Understand Where an Object’s Prototype Comes From
---
...
tests:
  - text: <code>Dog.prototype</code>应该是<code>beagle</code>的<code>原型</code>。
    testString: assert(/Dog\.prototype\.isPrototypeOf\(beagle\)/.test(code), '<code>Dog.prototype</code>应该是<code>beagle</code>的<code>原型</code>。');
