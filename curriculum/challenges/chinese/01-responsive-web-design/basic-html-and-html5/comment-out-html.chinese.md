...
tests:
  - text: 注释掉<code>h1</code>元素，这样它就从网页上消失了。
    testString: assert(($("h1").length === 0), '注释掉<code>h1</code>元素，这样它就从网页上消失了。');
  - text: <code>h2</code>元素保持原样，这样网页上还能看到它。
    testString: assert(($("h2").length > 0), '<code>h2</code>元素保持原样，这样网页上还能看到它。');
  - text: 注释掉<code>p</code>元素，这样它就从网页上消失了。
    testString: assert(($("p").length === 0), '注释掉<code>p</code>元素，这样它就从网页上消失了。');
  ...
  - text: 不要更改<code>h1</code>元素、<code>h2</code> 元素、<code>p</code>元素的顺序。
    testString: assert((code.match(/<([a-z0-9]){1,2}>/g)[0]==="<h1>" && code.match(/<([a-z0-9]){1,2}>/g)[1]==="<h2>" && code.match(/<([a-z0-9]){1,2}>/g)[2]==="<p>") , '不要更改<code>h1</code>元素、<code>h2</code>元素、<code>p</code>元素的顺序。');
