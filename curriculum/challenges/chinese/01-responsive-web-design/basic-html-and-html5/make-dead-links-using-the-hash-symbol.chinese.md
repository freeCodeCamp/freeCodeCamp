...
videoUrl: ''
localeTitle: Make Dead Links Using the Hash Symbol
---
...
tests:
  - text: "锚点的<code>href</code>属性应为 '#'。"
    testString: assert($("a").attr("href") === "#", '锚点的<code>href</code>属性应为 "#"。');
