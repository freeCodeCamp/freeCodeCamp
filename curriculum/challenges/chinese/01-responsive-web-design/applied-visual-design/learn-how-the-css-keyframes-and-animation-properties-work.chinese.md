...
videoUrl: ''
localeTitle: Learn How the CSS @keyframes and animation Properties Work
---
...
<section id='challengeSeed'>
    ...
    <div id='html-seed'>
```html
<style>,  div {,    height: 40px;,    width: 70%;,    background: black;,    margin: 50px auto;,    border-radius: 5px;,  },,  #rect {,    ,    ,  },  ,  ,  ,  ,</style>,<div id="rect"></div>
```
