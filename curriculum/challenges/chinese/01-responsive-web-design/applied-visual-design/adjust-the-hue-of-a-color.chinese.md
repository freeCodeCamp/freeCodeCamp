...
videoUrl: ''
localeTitle: Adjust the Hue of a Color
---
...
<section id='challengeSeed'>
    ...
    <div id='html-seed'>
```html
<style>,  body {,    background-color: #FFFFFF;,  },  ,  .green {,    background-color: #000000;,  },  ,  .cyan {,    background-color: #000000;,  },  ,  .blue {,    background-color: #000000;,  },  ,  div {,    display: inline-block;,    height: 100px;,    width: 100px;,  },</style>,  ,<div class="green"></div>,<div class="cyan"></div>,<div class="blue"></div>
```
