...
videoUrl: ''
localeTitle: Learn about Tertiary Colors
---
...
<section id='challengeSeed'>
    ...
    <div id='html-seed'>
```html
<style>,  body {,    background-color: #FFFFFF;,  },  ,  .orange {,    background-color: #000000;,  },  ,  .cyan {,    background-color: #000000;,  },  ,  .raspberry {,    background-color: #000000;,  },  ,  div {,    height: 100px;,    width: 100px;,    margin-bottom: 5px;,  },</style>,  ,<div class="orange"></div>,<div class="cyan"></div>,<div class="raspberry"></div>
```
