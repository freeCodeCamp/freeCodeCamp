...
challengeType: 0
videoUrl: ''
localeTitle: 使用row-gap创建行间隙
---

## Description

<section id="description">您可以使用<code>row-gap</code>在<code>row-gap</code>之间添加间隙，方法与在上一个挑战中的列之间添加间隙的方式相同。 </section>
...
```yml
tests:
  - text: <code>container</code>类应该具有值为<code>5px</code>的<code>row-gap</code>属性。
