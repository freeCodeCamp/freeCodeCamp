...
## Description
<section id="description">色盲的形式有很多种，这些范围可以是从对特定波长的光的灵敏度低到根本无法看到颜色。最常见的形式是对于绿色不敏感。例如，如果前景色和背景色是两种相似的绿色，则色盲者可能无法辨别它们的不同。相似的颜色可以看作是色轮上的邻居，在传达重要信息时应该避免这种组合。 <strong>注意</strong> <br>一些在线的颜色挑选工具利用视觉模拟来呈現不同类型的色盲類型所看見的颜色之間有何不同。除了在线对比度检查计算器外，这些都是很好的资源。 </section>
