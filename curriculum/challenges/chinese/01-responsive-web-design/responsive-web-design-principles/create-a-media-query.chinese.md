...
videoUrl: ''
localeTitle: Create a Media Query
---
...
增加一个设备的高度小于或等于 800px 时，<code>p</code> 标签的 <code>font-size</code> 为 12px 的媒体查询。
</section>
