...
videoUrl: ''
localeTitle: Responsively Style Radio Buttons
---
...
tests:
  - text: 把所有的单选按钮放置于具有 <code>row</code> class 的 <code>div</code> 元素中。
    testString: 'assert($("div.row:has(input[type=\"radio\"])").length > 0, "把所有的单选按钮放置于具有 <code>row</code> class 的 <code>div</code> 元素中。");'
  - text: 每一个单选按钮应该嵌套于 <code>div</code> 元素之中，该 <code>div</code> 元素的 class 属性为 <code>col-xs-6</code>。
    testString: 'assert($("div.col-xs-6:has(input[type=\"radio\"])").length > 1, "每一个单选按钮应该嵌套于 <code>div</code> 元素之中，该 <code>div</code> 元素的 class 属性为 <code>col-xs-6</code>。");'
