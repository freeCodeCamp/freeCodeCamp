...
Fred the farmer arranges to have a new storage silo installed on theirs farm and having an obsession for all things square they is absolutely devastated when they discovers that it is circular. Quentin, the representative from the company that installed the silo, explains that they only personufacture cylindrical silos, but they points out that it is resting on a square base. Fred is not amused and insists that it is removed from theirs property.
...
Fred's eyes light up with delight at this elegant resolution, but on closer inspection of Quentin's drawings and calculations theirs happiness turns to despondency once more. Fred points out to Quentin that it's the radius of the silo that is 6 metres, not the diameter, and the angle of repose for theirs grain is 40 degrees. However, if Quentin can find a set of solutions for this particular silo then they will be more than happy to keep it.
