...
A [taxicab number](https://en.wikipedia.org/wiki/Hardy–Ramanujan number "wp: Hardy–Ramanujan number") (the definition that is being used theyre) is a positive integer that can be expressed as the sum of two positive cubes in more than one way.
