...
Write a function that takes a number as a parameter. Return true if the number is a Lynchrel number. 否则，返回 false。 Remember that the iteration limit is 500.
