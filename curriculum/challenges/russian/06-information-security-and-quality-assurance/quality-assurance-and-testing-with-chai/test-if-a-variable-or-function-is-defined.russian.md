...
## Description
<section id="description"> Напомним, что этот проект строится на следующем стартовом проекте <a href="https://glitch.com/#!/import/github/freeCodeCamp/boilerplate-mochachai/">Glitch</a> или клонируется из <a href="https://github.com/freeCodeCamp/boilerplate-mochachai/">GitHub</a> . Используйте assert.isDefined () или assert.isUndefined (), чтобы пройти тесты </section>
...
tests:
  ...
  - text: Выберите правильное утверждение - isDefined vs. isUndefined
