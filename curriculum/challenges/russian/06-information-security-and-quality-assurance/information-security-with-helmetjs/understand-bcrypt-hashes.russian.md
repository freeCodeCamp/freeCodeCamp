...
Чтобы начать использовать BCrypt, добавьте его как зависимость в ваш проект и укажите его как 'bcrypt' на вашем сервере.
Отправьте свою страницу, когда вы думаете, что вы поняли это правильно.
</section>
...
```yml
tests:
  - текст: BCrypt является зависимостью
  ...
  - текст: BCrypt был должным образом необходим
