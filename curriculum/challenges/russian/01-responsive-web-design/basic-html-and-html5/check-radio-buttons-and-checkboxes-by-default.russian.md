...
## Instructions
<section id="instructions"> Установите первый из ваших <code>radio buttons</code> и первый из ваших <code>checkboxes</code> чтобы оба были <code>checked</code> по умолчанию. </section>
