...
forumTopicId: 301118
localeTitle: Добавление промежутков быстрее с gap
---

## Description

<section id='description'>
<code>gap</code> - это сокращенное свойство для <code>row-gap</code> и <code>column-gap</code> из двух предыдущих упражнений, которое более удобно в использовании. Если <code>gap</code> имеет одно значение, это создаст разрыв между всеми строками и столбцами. Однако, если есть два значения, он будет использовать первое, чтобы установить разрыв между строками, и второе значение - между столбцами.
</section>

## Instructions

<section id='instructions'>
Используйте <code>gap</code> чтобы задать <code>10px</code> промежуток между строками и <code>20px</code> промежуток между столбцами.
</section>
