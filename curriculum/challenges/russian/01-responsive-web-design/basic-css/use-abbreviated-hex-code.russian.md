...
challengeType: 0
videoUrl: ''
localeTitle: Использовать сокращенный шестнадцатеричный код
---

## Description
<section id="description"> Многие люди чувствуют себя подавленными возможностями более 16 миллионов цветов. И очень сложно запомнить шестнадцатеричный код. К счастью, вы можете сократить его. Например, шестнадцатеричный код красного цвета <code>#FF0000</code> можно сократить до <code>#F00</code> . Эта сокращенная форма дает одну цифру для красного, одну цифру для зеленого и одну цифру для синего. Это уменьшает общее количество возможных цветов примерно до 4000. Но браузеры будут интерпретировать <code>#FF0000</code> и <code>#F00</code> как точно такой же цвет. </section>
