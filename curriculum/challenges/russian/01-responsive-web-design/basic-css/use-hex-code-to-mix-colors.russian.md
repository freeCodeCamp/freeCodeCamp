...
## Description
<section id="description"> Для представления цветов в шестнадцатиричных кодах используют 6 шестнадцатеричных цифр, две для красного (R), две для зеленого (G) и две для синего (B) компонента. Изменяя значения каждого из этих трех чистых цветов (красного, зеленого и синего), мы можем создать более 16 миллионов других цветов! Например, оранжевый - это чистый красный, смешанный с каким-то зеленым и отсутствие синего цвета. В шестнадцатеричном коде это означает, что это <code>#FFA500</code> . Цифра <code>0</code> является наименьшим числом в шестнадцатеричном коде и представляет полное отсутствие цвета. Цифра <code>F</code> является наивысшим числом в шестнадцатеричном коде и представляет максимально возможную яркость. </section>
