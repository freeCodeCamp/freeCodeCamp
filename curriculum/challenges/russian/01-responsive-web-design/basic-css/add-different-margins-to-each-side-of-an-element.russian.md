...
challengeType: 0
videoUrl: ''
localeTitle: Добавление разных марджинов с разных сторон элемента
---

## Description
<section id="description"> Иногда вам нужно настроить элемент таким образом, чтобы он имел разные <code>margin</code>'ы на каждой из сторон. CSS позволяет вам контролировать <code>margin</code>'ы всех четырех отдельных сторонах элемента при помощи свойств <code>margin-top</code> , <code>margin-right</code> , <code>margin-bottom</code> и <code>margin-left</code> . </section>

## Instructions
<section id="instructions"> Задайте синей коробке <code>margin</code>'ы <code>40px</code> на ее верхней и левой стороне, а на нижней и правой стороне задайте марджины <code>20px</code>. </section>
