...
Выравняйте текст тега <code>h4</code>, в котором говорится «Google», по центру. Затем выравняйте тег абзаца, который содержит информацию о том, как Google был основан.
</section>
