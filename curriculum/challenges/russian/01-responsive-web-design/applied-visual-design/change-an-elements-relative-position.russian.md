...
Измените <code>position</code> <code>h2</code> на <code>relative</code> и используйте смещение CSS, чтобы переместить его на 15 пикселей от <code>top</code> где он находится в нормальном положении. Обратите внимание, что нет никакого влияния на позиции окружающих элементов <code>h1</code> и <code>p</code>.
</section>
