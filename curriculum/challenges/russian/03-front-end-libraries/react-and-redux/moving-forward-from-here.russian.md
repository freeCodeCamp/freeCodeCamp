...
```yml
tests:
  - text: Сообщение <code>Now I know React and Redux!</code> должен быть зарегистрирован на консоли.
