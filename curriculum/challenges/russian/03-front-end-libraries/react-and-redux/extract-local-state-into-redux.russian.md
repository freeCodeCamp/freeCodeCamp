...
tests:
  ...
  - text: 'Состояние компонента <code>Presentational</code> должно содержать одно свойство, <code>input</code> , которое инициализируется пустой строкой.'
  ...
  - text: Ввод в элемент <code>input</code> должен обновить состояние компонента <code>Presentational</code> .
  ...
  - text: При <code>submitMessage</code> на <code>Presentational</code> компоненте необходимо обновить хранилище Redux и очистить ввод в локальном состоянии.
  ...
  - text: <code>Presentational</code> компонент должен отображать <code>messages</code> из магазина Redux.
