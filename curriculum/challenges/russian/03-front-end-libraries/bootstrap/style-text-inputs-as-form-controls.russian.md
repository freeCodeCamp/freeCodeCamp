...
## Description
<section id="description"> Вы можете добавить значок шрифта FA <code>fa-paper-plane</code> Font Awesome, добавив в элемент <code>button</code> отправки <code>&lt;i class=&quot;fa fa-paper-plane&quot;&gt;&lt;/i&gt;</code> . Введите поле ввода текста в <code>form-control</code> класса управления <code>form-control</code> . Отправьте кнопку отправки формы в классы <code>btn btn-primary</code> . Также дайте этой кнопке значок Font Awesome для <code>fa-paper-plane</code> . Все текстовые элементы <code>&lt;input&gt;</code> , <code>&lt;textarea&gt;</code> и <code>&lt;select&gt;</code> с классом <code>.form-control</code> имеют ширину 100%. </section>
...
tests:
  ...
  - text: <code>input</code> текст в форме <code>form-control</code> .
  ...
  - text: 'Убедитесь, что у каждого из ваших элементов <code>i</code> есть закрывающий тег.'
