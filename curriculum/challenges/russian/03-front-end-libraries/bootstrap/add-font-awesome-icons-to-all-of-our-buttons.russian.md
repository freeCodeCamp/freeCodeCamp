...
Font Awesome - это удобная библиотека иконок. Эти иконки являются векторной графикой, хранящейся в файле формата <code>.svg</code>. Иконки обрабатываются так же, как шрифты. Вы можете указать их размер с помощью пикселей, и они будут принимать размер шрифта своих родительских элементов HTML.
</section>

## Instructions
<section id='instructions'>
Используйте Font Awesome, чтобы добавить иконку <code>info-circle</code> в вашу информационную кнопку и иконку <code>trash</code> на вашу кнопку удаления. 
