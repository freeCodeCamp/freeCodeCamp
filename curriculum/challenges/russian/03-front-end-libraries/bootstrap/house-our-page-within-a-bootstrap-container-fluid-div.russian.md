...
Теперь давайте убедимся, что все содержимое вашей страницы мобильно реагирует. Давайте вложим ваш элемент <code>h3</code> элемент <code>div</code> с <code>container-fluid</code> класса.
</section>
