...
У Bootstrap есть свои стили для элементов <code>button</code> , которые выглядят намного лучше, чем простые HTML-версии. Создайте новый элемент <code>button</code> под фотографией большого котенка. Дайте ему <code>btn</code> и <code>btn-default</code> , а также текст «Like».
</section>
