...
Так же, как мы обозначили наши колодцы, мы хотим наметить наши кнопки. Дайте каждому из ваших элементов <code>button</code> текст, соответствующий его селектору <code>id</code> .
</section>
