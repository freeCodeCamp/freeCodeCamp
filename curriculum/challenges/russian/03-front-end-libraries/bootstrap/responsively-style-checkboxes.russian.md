...
## Description
<section id="description"> Вы также можете использовать классы <code>col-xs-*</code> Bootstrap в элементах <code>form</code> ! Таким образом, наши флажки будут равномерно распределены по всей странице, независимо от ширины разрешения экрана. Установите все три своих флажка в элементе <code>&lt;div class=&quot;row&quot;&gt;</code> . Затем вставьте каждый из них в элемент <code>&lt;div class=&quot;col-xs-4&quot;&gt;</code> . </section>
...
```yml
tests:
  - text: Установите все свои флажки внутри одного <code>div</code> с помощью <code>row</code> класса.
  ...
  - text: Установите каждый из своих флажков в свой собственный <code>div</code> с классом <code>col-xs-4</code> .
