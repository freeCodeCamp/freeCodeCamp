...
Сначала эти анимации были классными, но теперь они становятся отвлекающими. Удалите все три из этих функций jQuery из функции <code>document ready function</code> , но не оставляйте свою <code>document ready function</code> неповрежденной.
</section>
