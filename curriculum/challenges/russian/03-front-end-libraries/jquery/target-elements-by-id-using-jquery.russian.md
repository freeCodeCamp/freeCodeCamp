...
```yml
tests:
  - text: Выберите элемент <code>button</code> с <code>id</code> <code>target3</code> и используйте <code>addClass()</code> jQuery <code>addClass()</code> чтобы присвоить ей класс <code>animated</code> .
  ...
  - text: <code>target3</code> элемент с идентификатором <code>target3</code> и используйте <code>addClass()</code> jQuery <code>addClass()</code> чтобы присвоить ему класс <code>fadeOut</code> .
