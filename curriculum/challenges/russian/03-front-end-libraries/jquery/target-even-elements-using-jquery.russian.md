...
```yml
tests:
  - text: 'Все <code>target</code> элементы, которые jQuery считает равными, должны дрожать.'
  ...
  - text: 'Вы должны использовать <code>:even</code> селектор для изменения этих элементов.'
