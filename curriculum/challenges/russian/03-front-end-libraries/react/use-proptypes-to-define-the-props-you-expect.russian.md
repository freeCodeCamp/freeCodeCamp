...
tests:
  ...
  - text: Элемент <code>Items</code> должен отображать.
  ...
  - text: 'Компонент « <code>Items</code> должен включать проверку <code>propTypes</code> которая требует, чтобы <code>quantity</code> было <code>number</code> .'
