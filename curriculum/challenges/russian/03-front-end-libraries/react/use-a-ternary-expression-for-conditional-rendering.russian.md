...
tests:
  ...
  - text: 'Когда компонент <code>CheckUserAge</code> сначала отображается в DOM, внутренний текст <code>button</code> должен быть Submit.'
  ...
  - text: 'Когда во <code>input</code> элемент вводится число менее 18, и <code>button</code> нажата, внутренний текст <code>button</code> должен быть прочитан « <code>You Shall Not Pass</code> .'
  ...
  - text: 'Когда число больше или равно 18, вводится в <code>input</code> элемент и <code>button</code> нажата, то <code>button</code> «s внутренний текст должен прочитать <code>You May Enter</code> .'
  ...
  - text: 'Как только число будет отправлено, и значение <code>input</code> снова будет изменено, <code>button</code> должна вернуться к чтению <code>Submit</code> .'
  ...
  - text: В вашем коде не должно быть никаких операторов <code>if/else</code> .
