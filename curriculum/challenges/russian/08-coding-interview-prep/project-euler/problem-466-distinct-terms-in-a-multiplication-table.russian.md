...
## Description
<section id="description"> Пусть P (m, n) - число различных членов в таблице умножения m × n. <p> Например, таблица умножения 3 × 4 выглядит следующим образом: </p><p> × 12341 12342 24683 36912 </p><p> Существует 8 различных терминов {1,2,3,4,6,8,9,12}, поэтому P (3,4) = 8. </p><p> Вам дается следующее: P (64,64) = 1263, P (12,345) = 1998 и P (32,1015) = 13826382602124302. </p><p> Найдите P (64, 1016). </p></section>
