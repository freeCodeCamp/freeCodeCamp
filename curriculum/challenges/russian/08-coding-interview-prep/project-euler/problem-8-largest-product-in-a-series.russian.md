...
```yml
tests:
  - text: <code>largestProductinaSeries(4)</code> должен вернуть 5832.
    testString: 'assert.strictEqual(largestProductinaSeries(4), 5832, "<code>largestProductinaSeries(4)</code> should return 5832.");'
  - text: <code>largestProductinaSeries(13)</code> должен вернуть 23514624000.
