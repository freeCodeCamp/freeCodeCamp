...
```yml
tests:
  - text: <code>myHouse</code> должен иметь атрибут <code>numBedrooms</code> установленный в число.
  ...
  - text: 'Обязательно убедитесь, что <code>myHouse</code> является экземпляром <code>House</code> используя оператор <code>instanceof</code> .'
