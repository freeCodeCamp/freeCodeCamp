...
`How’s the BLANK side BLANK BLANK?`
...
These two words together is used to ask about the progress or development of something. The first word is ended with `-ing`.
