...
Lisa argues that disagreement in excess can make decisions take longer.
...
The phrase `too much + noun` is used to indicate an excessive amount of something, which is often seen as negative. In this case, `too much disagreement` means an excessive level of disagreement that could slow progress. For example:
