...
After Bob asks about the number of participants, Lisa picks up on his possible interest and asks if he wants to `join`. 

The word `join` means becoming part of something, like attending an event or participating in a group. Pay attention to how Lisa responds to Bob's curiosity and asks if he wants to be part of the event.
