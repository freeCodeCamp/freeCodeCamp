...
To find out what Brian wants to know, pay attention to the part where he asks, `Attendance is mandatory, right?` The word `mandatory` means something that must be done. Listen closely to this question, as Brian is asking whether everyone has to attend the training.
