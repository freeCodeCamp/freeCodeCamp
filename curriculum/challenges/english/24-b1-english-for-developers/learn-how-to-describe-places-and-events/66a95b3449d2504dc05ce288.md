...
Bob is asking if the app has a potential name. The word `potential` refers to something that is possible but not certain yet. 

To find the correct answer, focus on the answer that talks about the app's name instead of its progress. 
