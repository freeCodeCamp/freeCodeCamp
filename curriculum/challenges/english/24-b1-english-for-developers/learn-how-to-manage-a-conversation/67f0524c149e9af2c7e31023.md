...
`The team is working on the integration of the new payment system into the app.` – This means they are combining the new system with the existing app so they function together.  
