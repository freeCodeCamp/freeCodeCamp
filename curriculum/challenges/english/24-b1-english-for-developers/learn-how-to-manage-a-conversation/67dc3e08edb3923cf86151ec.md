...
The word `that` in `Yes, that's right.` is used to refer to something previously mentioned by the other speaker. It acts as a pronoun replacing the entire idea of what James said. For example:
