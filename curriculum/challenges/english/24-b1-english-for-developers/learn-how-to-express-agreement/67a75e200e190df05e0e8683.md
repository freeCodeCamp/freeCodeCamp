...
The phrase `good idea` is used to express agreement or approval of a suggestion. It is commonly used in discussions to acknowledge a helpful proposal. For example:

When your team leader says `Let's set up a shared document for tracking progress`, you can say `Good idea. That will help everyone stay updated.` This means you agree that having a shared document will improve communication.
