...
`BLANK BLANK. I'll start working on that and BLANK you know when it's ready.`
...
This is the past tense of `get`. It's often used informally to show that you've understood a request or idea.
...
This refers to the task or idea you have understood.
