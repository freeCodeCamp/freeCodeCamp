...
The phrase `by the way` is used to smoothly introduce a new but related topic in a conversation. It helps transition from one point to another. For example:
