...
Linda supports Bob’s timeline by saying `I think that's doable,` which means she believes it is achievable. She then proposes a plan: starting with `design sketches` and moving on to `wireframes.` This shows she agrees and has a clear next step in mind.
