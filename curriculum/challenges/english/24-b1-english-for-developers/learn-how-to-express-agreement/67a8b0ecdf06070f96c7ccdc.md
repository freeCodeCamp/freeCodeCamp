...
The phrase `keep you updated` means to continue providing the latest information or status about something. For example:  

`I'll keep you updated on the project status.` – This means I will inform you regularly about the progress or changes in the project.
