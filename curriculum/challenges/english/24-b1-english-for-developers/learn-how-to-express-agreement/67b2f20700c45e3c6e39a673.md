...
`Speeding up` refers to improving the speed or efficiency of something. Sarah talks about making the app run faster by increasing the speed of the database queries.
