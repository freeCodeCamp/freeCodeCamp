...
`The IT team checked the system logs to find out why the server crashed.` - In this example, `logs` are used to track and record system activity, helping the team understand what caused the server failure.
