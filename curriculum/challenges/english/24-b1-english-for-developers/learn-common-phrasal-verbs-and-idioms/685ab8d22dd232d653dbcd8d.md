...
After the `Agenda Highlights` list, Sophie includes how the process to register to the webinar should be. Read the last lines of the invite to be able to answer to this question correctly.
