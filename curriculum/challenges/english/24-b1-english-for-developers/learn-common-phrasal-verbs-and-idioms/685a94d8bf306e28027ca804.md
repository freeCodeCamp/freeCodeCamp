...
`Invite` is a short form for `invitation`, which is a request or offer for someone to attend an event or take part in an activity. It can be formal or informal and can be sent by letter, email, text, or verbally. `Invite` is often used informally to refer to a request for someone to attend an event. For example:
