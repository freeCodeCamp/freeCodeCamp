...
This refers to a small window or message that appears on the screen and usually needs a response. It's a composite word, so don't forget to add the hyphen.
