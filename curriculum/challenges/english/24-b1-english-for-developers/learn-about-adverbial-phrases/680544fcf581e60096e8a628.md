...
The structure `as` + adjective + `as` is used to compare or emphasize the degree of something. It is useful when setting goals or describing ideal conditions. By `as productive as possible`, for instance, Bob means the meetings should reach the highest level of productivity they can. Another example:
