...
`To be good for something` means to be suitable or appropriate for a specific purpose or situation. In this context, it means the servers are performing well enough to handle the current level of usage or demand. For example:
