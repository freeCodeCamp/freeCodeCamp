...
`As` in this context means at the same time or while. Sophie is saying that they will increase the number of users at the same time as they fix any problems that come up. For example:
