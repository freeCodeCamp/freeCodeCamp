...
`Detailed` means including a lot of specific information, often in a clear and organized way. In this sentence, Bob is referring to meetings that go into depth about topics, rather than giving just a quick overview. For example:
