...
`To be enough` means to be sufficient or adequate to meet a requirement or need. In this case, Bob believes that a quick status check will be sufficient for the daily meetings, and detailed updates are not necessary. For example:
