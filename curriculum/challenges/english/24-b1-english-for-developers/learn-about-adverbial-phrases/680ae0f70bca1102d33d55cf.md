...
`To go up` means to increase or rise in number, level, or amount. It is a phrasal verb often used in business, prices, statistics, or performance discussions. In this sentence, `went` is the `Simple Past` form of the irregular verb `go`. Other examples:
