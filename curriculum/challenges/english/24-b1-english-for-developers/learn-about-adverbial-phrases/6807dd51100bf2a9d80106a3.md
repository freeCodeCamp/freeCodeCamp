...
`As we're moving into the testing phase, we need to prepare the test cases.` – This means we are starting the testing phase and that is the reason why we need to get ready.
