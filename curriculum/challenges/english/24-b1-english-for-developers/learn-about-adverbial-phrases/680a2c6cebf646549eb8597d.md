...
`Our servers are good for our current BLANK, but this new feature might make them BLANK.`
...
This is the comparative form of `slow`. Here, it implies the servers' performance at the moment might be better.
...
`Slower` is the comparative form of `slow`, used to compare the speed of two things. In the sentence, the comparison is implied — Sophie is saying the servers might become slower than they are now. Another example:
