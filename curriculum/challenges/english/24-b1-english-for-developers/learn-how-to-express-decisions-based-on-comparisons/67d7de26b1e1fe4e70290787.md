...
Sarah explains that `outsourcing` can `lead to communication issues`, which might `delay the project`. This means that working with an external team could cause misunderstandings or difficulties in coordination, potentially slowing down progress.  
