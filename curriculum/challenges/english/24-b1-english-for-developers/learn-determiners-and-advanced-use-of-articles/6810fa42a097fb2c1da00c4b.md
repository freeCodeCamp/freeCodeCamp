...
<!-- (Audio) Jake: I'll arrange for a test project within them next month. -->
...
`I'll BLANK a test project within them next month.`
...
```json
{
  ...
  "commands": [
    ...
    },
    {
      ...
      "finishTime": 4.28,
      "dialogue": {
        "text": "I'll arrange for a test project within them next month.",
        "align": "center"
      }
    },
    {
