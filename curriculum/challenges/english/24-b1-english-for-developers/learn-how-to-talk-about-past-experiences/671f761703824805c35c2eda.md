...
The phrase created by using `get` followed by an adjective describes a change of state or becoming a certain way. For example, `get excited` means to become enthusiastic or thrilled. Example: `They always get excited when a new Python update is released.` (this means they are always filled with enthusiasm when a new Python update comes up)

Another example: `He got tired after working on the project all night.` (this means he wasn't tired before, but he is tired now, after a whole night of working on the project) 
