...
Mark is asking Lisa if she knows what might be causing the issue. He is seeking help to understand the reason behind the random behavior of the system, not asking if the problem is random or how to fix it.
