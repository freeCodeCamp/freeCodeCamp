...
`Maria: They're already BLANK in extra hours.`  
...
This verb means dedicating effort or time to something. Use the verb in the `-ing` form.

# --explanation--

The phrase `to put in` with time expressions means to spend or dedicate time and effort to a task. For example:
