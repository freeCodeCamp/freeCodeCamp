...
`Bob: Wouldn't that make a BLANK?`  
...
This word means an impact or change in a situation.  

# --explanation--

The phrase `to make a difference` means to have an effect or create a positive impact on a situation. For example:
