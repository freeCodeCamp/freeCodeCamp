...
`Bob: True, but we could try working BLANK BLANK extra hours just for this project.`  
...
This word means a greater amount of something.

# --explanation--

The phrase `even more` is used to emphasize an increase beyond what is already mentioned. It makes the comparison stronger. For example:
