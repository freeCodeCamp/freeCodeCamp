...
The word `earlier` generally means something happens before a scheduled or expected time. Here, `earlier` means finishing the project before the original deadline. For example:
