...
In this sentence,`which makes it hard to meet the new deadline` gives an additional detail about the fact that the team does not have enough resources. For example:
