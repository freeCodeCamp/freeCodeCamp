...
This adjective means paying attention to avoid mistakes or problems.  
...
This verb means to exhaust someone or make them too tired to continue working.  

# --explanation--

When using an adjective followed by an infinitive, the negative form is made by adding `not to` before the verb. For example:

- Affirmative: `She was happy to help with the project.`

- Negative: `He was careful not to forget the deadline.` - This means he made sure he remembered it.

The phrase `to burn out` means to become extremely tired or exhausted from too much work. For example:
