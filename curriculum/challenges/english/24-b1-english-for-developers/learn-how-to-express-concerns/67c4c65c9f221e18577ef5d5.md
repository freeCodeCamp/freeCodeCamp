...
`Maria: We should consider the BLANK impact on the team's BLANK and productivity.`  
...
This phrase refers to something that happens or lasts over an extended period.  
...
This word refers to the confidence, motivation, and overall attitude of a team or group.  

# --explanation--

The phrase `long-term` describes something that happens or has effects over a long period. For example:

`Investing in employee training has long-term benefits for the company.` - This means the benefits will last for a long time.

The word `morale` refers to the confidence, motivation, and enthusiasm of a person or group. For example:
