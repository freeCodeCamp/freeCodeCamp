...
- **Person A:** `Could you send the report by tomorrow?` - Person A is asking for a report to be handed in on the following day.

- **Person B:** `Sure. I can do that.` - This means the speaker agrees to do it, not just that they are capable of doing it.
