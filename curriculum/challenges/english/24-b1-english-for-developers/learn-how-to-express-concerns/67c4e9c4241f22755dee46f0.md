...
`Bob: We might need to BLANK with what we have for now.`  
...
This verb means to continue using or following something instead of changing it.  

# --explanation--

The phrase `to stick with something` means to continue using or following a particular option, plan, or decision instead of making a change. For example:
