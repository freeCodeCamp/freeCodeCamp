...
After talking to Bob, Maria sends the team an email with the updates and asks them to have their meeting on the following day two hours earlier, so they could talk about the client's request. Read it and answer the question below.
...
Maria doesn't about canceling tasks. She doesn't talk about reducing working hours, either.
