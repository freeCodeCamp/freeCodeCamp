...
In this step, we'll use the filter function, a built-in Python function that allows us to create a new iterator from elements of an existing iterable (like a list) for which a specified function returns True.
