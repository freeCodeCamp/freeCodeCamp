...
The Tower of Hanoi puzzle can be solved in $2^n - 1$ moves, where n is the number of disks. Create a variable named `number_of_moves` and assign it the total number of moves.
