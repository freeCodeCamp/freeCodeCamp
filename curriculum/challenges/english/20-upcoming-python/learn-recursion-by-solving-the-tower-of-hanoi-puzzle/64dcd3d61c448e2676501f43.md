...
When the remainder of the move number divided by 3 is equal to 2, the movement is allowed between `A` and `B`, that is, between the source and the auxiliary rods.
