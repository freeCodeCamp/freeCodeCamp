...
When `forward` is `False`, the disk has to be displaced in the opposite direction. Write an `else` clause for that. Print the move and change the content of the lists accordingly.
...
You should print the move inside your `else` clause.
