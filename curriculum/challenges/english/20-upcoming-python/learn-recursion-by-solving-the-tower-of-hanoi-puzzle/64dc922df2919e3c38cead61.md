...
At the top of your code, create a variable named `NUMBER_OF_DISKS` to store the number of disks and give it the value of `3`. Then, substitute the first argument passed in to the `range` function with your new variable.
