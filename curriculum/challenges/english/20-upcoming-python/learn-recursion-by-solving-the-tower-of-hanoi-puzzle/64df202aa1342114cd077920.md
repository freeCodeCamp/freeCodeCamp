...
You should have `print(f'Move {i + 1} allowed between {source} and {auxiliary}')` within the `else` block.
...
You should have `# make_allowed_move(source, auxiliary)` within the `else` block.
