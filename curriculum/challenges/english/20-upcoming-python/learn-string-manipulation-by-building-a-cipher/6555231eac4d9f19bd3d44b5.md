...
The `pass` keyword can be used as a placeholder for future code. It has a null effect but can save you from errors you would get in case of incomplete code:
