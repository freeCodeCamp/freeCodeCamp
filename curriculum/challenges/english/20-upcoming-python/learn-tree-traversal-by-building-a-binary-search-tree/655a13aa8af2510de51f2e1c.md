...
The `insert` method will be called by the user. Other than the `self` parameter, it will need a `key` parameter. This parameter will be the key value to insert into the binary search tree.
