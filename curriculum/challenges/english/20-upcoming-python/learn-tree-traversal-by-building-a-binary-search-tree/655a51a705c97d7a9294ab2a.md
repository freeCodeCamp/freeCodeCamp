...
For now, define the `_min_value` method that takes `self` and `node` as the parameters.

# --hints--

You should define the `_min_value` method with `self` and `node` as the parameters.
