...
To change that to print a useful value, create another method named `__str__` in the `TreeNode` class. It takes a single argument `self`.

# --hints--

You should create a method `__str__` that takes a single argument `self`. Remember to use `pass`.
