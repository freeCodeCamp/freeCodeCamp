...
The inorder_traversal method is responsible for performing an in-order traversal of the binary search tree and returning the keys of the nodes in sorted order.
...
You should define an `inorder_traversal` method that takes `self` as the parameter.
