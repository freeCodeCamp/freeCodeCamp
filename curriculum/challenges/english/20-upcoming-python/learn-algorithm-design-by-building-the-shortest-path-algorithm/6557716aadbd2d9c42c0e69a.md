...
`my_graph["A"]` should be a list containing the connected nodes.
...
`my_graph["B"]` should be a list containing the connected nodes.
...
`my_graph["C"]` should be a list containing the connected nodes.
...
`my_graph["D"]` should be a list containing the connected nodes.
