...
Inside a character class, you can combine multiple ranges by indicating one range after another without any additional character. For example: `[a-d3-6]` is the combination of `[a-d]` and `[3-6]`.
...
You should complete your fourth pattern.
