...
Modify your function declaration adding `nums`, `special_chars`, `uppercase`, and `lowercase` in this order after the existent `length` parameter.

# --hints--

Your function should accept `length`, `nums`, `special_chars`, `uppercase`, and `lowercase` as the parameters. The order matters.
