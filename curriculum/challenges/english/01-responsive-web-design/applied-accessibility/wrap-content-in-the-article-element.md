...
Camper Cat used `article` tags to wrap the posts on theirs blog page, but they forgot to use them around the top one. Change the `div` tag to use an `article` tag instead.
