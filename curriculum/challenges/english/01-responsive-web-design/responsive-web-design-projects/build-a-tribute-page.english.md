...
<strong>User Story #3:</strong> I should see a <code>figure</code> element with a corresponding <code>id="img-figure"</code>.
<strong>User Story #4:</strong> Within the <code>img-figure</code> element, I should see an <code>img</code> element with a corresponding <code>id="image"</code>.
<strong>User Story #5:</strong> Within the <code>img-figure</code> element, I should see an <code>figcaption</code> element with a corresponding <code>id="img-caption"</code> that contains textual content describing the image shown in <code>img-figure</code>.
