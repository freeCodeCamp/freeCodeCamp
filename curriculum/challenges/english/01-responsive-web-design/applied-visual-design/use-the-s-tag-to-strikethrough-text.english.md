...
Wrap the <code>s</code> tag around "Google" that is inside the <code>h4</code> tag, and then add beside it the word "Alphabet", which should not have the strikethrough formatting.
</section>
