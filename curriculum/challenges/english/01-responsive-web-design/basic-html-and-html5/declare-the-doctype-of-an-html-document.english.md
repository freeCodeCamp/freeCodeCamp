...
The <code>!</code> and uppercase <code>DOCTYPE</code> is important, especially for older browsers.The <code>DOCTYPE</code> and <code>html</code> parts are not case sensitive, but if you don’t use uppercase <code> DOCTYPE </code> in an XHTML document, the XML parser will return a syntax error, note that XHTML are is out of the FreeCodeCamp syllabus right now and you need not worry about this.
