...
tests:
  ...
  - text: The <code>body</code> element should wrap around both the <code>h1</code>and <code>p</code> elements.
    testString: assert(code.match(/<head>\s*?<title>\s*?.*?\s*?<\/title>\s*?<\/head>\s*<body>\s*?(.*\s*)*?<\/body>/gi), 'The <code>body</code> element should wrap around both the <code>h1</code>and <code>p</code> elements');		
  - text: The <code>body</code> element should wrap around both the <code>h1</code> and <code>p</code> elements.
