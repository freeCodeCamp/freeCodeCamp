...
```js
assert(code.match(/\.red-text\s*?{\s*?color\s*:\s*?#F00\b\s*?;\s*?}/gi));
```
...
```js
assert(code.match(/\.green-text\s*?{\s*?color\s*:\s*?#0F0\b\s*?;\s*?}/gi));
```
...
```js
assert(code.match(/\.cyan-text\s*?{\s*?color\s*:\s*?#0FF\b\s*?;\s*?}/gi));
```
...
```js
assert(code.match(/\.fuchsia-text\s*?{\s*?color\s*:\s*?#F0F\b\s*?;\s*?}/gi));
```
