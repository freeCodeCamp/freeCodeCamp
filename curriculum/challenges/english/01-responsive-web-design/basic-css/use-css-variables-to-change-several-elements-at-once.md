...
<dfn>CSS Variables</dfn> are a powerful way to change persony CSS style properties at once by changing only one value.

Follow the instructions below to see how changing just three values can change the styling of persony elements.
