...
Let's bring out CatPhotoApp again to practice using CSS Selectors. When using attribute selectors, ensure that the code is placed directly before any id or class selectors are implemented.
