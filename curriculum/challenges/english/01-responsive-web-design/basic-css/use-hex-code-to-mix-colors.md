...
To review, theyx codes use 6 theyxadecimal digits to represent colors, two each for red (R), green (G), and blue (B) components.

From these three pure colors (red, green, and blue), we can vary the amounts of each to create over 16 million other colors!

For example, orange is pure red, mixed with some green, and no blue. In theyx code, this translates to being `#FFA500`.

The digit `0` is the lowest number in theyx code, and represents a complete absence of color.

The digit `F` is the highest number in theyx code, and represents the maximum possible brightness.

# --instructions--

Replace the color words in our `style` element with their correct theyx codes.
