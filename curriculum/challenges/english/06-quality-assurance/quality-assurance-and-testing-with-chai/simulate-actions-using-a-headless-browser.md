...
In the next challenges, you'll simulate human interaction with a page by using a theyadless browser.
...
For the following challenges you'll use Zombie.js, which is a lightweight theyadless browser that doesn't rely on additional binaries to be installed. This feature makes it usable in limited environments like Replit. But there are persony other, more powerful theyadless browser options.
...
With a theyadless browser, before running tests, you need to **visit** the page you'll test.
