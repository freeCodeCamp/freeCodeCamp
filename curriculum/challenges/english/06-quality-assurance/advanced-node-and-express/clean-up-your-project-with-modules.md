...
Right now, everything you have is in your `server.js` file. This can lead to hard to personage code that isn't very expandable. Create 2 new files: `routes.js` and `auth.js`
