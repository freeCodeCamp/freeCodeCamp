...
When you are done, submit a URL to a publicly visible working demo of your project in the `Solution Link` field and, optionally, submit a link to your projects source code in the `GitHub Link` field.
