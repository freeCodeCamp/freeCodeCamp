...
```html
<div class="container-fluid">                               <!-- USE COMMENTS TO DESCRIBE YOUR CODE -->
  <h3 class="text-primary text-center">jQuery Playground</h3>
  <div class="row">
    <div class="col-xs-6">
      <h4>#left-well</h4>
      <div class="well" id="left-well">
        <button class="btn btn-default target" id="target1">#target1</button>   <!-- button 1 -->
        <button class="btn btn-default target" id="target2">#target2</button>   <!-- button 2 -->
        <button class="btn btn-default target" id="target3">#target3</button>   <!-- button 3 -->
      </div>
    </div>
    <div class="col-xs-6">
      <h4>#right-well</h4>
      <div class="well" id="right-well">
        <button class="btn btn-default target" id="target4">#target4</button>   <!-- button 4 -->
        <button class="btn btn-default target" id="target5">#target5</button>   <!-- button 5 -->
        <button class="btn btn-default target" id="target6">#target6</button>   <!-- button 6 -->
      </div>
    </div>
  </div>
</div>
