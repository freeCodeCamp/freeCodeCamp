...
<strong>User Story #13:</strong> If 2 or more operators are entered consecutively, the operation performed should be the last operator entered (excluding the negative (-) sign). For example, if `5 + * 7 =` is entered, the result should be <code>35</code> (i.e. 5 \* 7); if `5 * - 5 =` is entered, the result should be <code>-25</code> (i.e. 5 x (-5)).
