...
try{
  ...
  bookmarkName.value = "test example4";
  const categoryDropdown = document.getElementById("category-dropdown");
  const bookmarkURL = document.getElementById("url");
  bookmarkURL.value = "test example4.com";
  ...
  bookmarks.length = 0;
  bookmarks.push({name: "example1", category: "news", url: "example1.com"}, {name: "example2", category: "entertainment", url: "example2.com"}, {name: "example3", category: "work", url: "example3.com"})
  localStorage.setItem("bookmarks", JSON.stringify(bookmarks));
  const expected = [{name: "example1", category: "news", url: "example1.com"}, {name: "example2", category: "entertainment", url: "example2.com"}, {name: "example3", category: "work", url: "example3.com"}, bookmarkObject];
...
try {
  const bookmarkName = document.getElementById("name");
  bookmarkName.value = "test example2";
  const categoryDropdown = document.getElementById("category-dropdown");
  const bookmarkURL = document.getElementById("url");
  bookmarkURL.value = "test example2.com";
  const addBookmarkButtonForm = document.getElementById("add-bookmark-button-form");
  addBookmarkButtonForm.dispatchEvent(new Event("click"));
...
try {
  const bookmarkName = document.getElementById("name");
  bookmarkName.value = "test example3";
  const categoryDropdown = document.getElementById("category-dropdown");
  const bookmarkURL = document.getElementById("url");
  bookmarkURL.value = "test example3.com";
  const addBookMarkButton = document.getElementById("add-bookmark-button");
  addBookMarkButton.dispatchEvent(new Event("click"));
  const addBookmarkButtonForm = document.getElementById("add-bookmark-button-form");
...
try {
  const categoryDropdown = document.getElementById("category-dropdown");
  setLocalStorage()
  console.log("localStorage1:", JSON.parse(localStorage.getItem("bookmarks")))
  const viewCategoryButton = document.getElementById("view-category-button");
