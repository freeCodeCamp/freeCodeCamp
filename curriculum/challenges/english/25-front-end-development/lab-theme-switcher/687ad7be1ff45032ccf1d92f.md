...
// Reset aria-expanded attribute due to earlier button clicks interfering with these tests
...
// // Reset hidden attribute due to earlier button clicks interfering with these tests
