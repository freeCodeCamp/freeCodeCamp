...
1. The anchor elements shouldn't have any default text decoration.
1. You should set the text color of the links to a colour of your choice.
1. When the links are visited, the color should change to another colour of your choice.
1. When the links are hovered over, the color should change to another colour of your choice.
1. When the links are focused, there should be a coloured outline around the link.
1. When the links are clicked, the color should change to another colour of your choice.
