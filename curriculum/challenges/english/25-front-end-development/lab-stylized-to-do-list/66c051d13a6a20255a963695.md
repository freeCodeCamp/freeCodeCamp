...
4. There shouldn't be any list styles applied to the unordered lists.
5. The anchor elements shouldn't have any default text decoration.
6. You should set the text color of the links to a colour of your choice.
7. When the links are visited, the color should change to another colour of your choice.
8. When the links are hovered over, the color should change to another colour of your choice.
9. When the links are focused, there should be a coloured outline around the link.
10. When the links are clicked, the color should change to another colour of your choice.
...
The `a.sub-item-link` links on the page should have no underline by default.

```js
// test can be made flexible
assert(new __helpers.CSSHelp(document).getStyle('a.sub-item-link')?.textDecoration === 'none');
```
