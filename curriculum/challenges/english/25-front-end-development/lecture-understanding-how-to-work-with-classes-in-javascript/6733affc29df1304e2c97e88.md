...
Each individual product will have its own properties and actions but products of the same kind can be created from the same "blueprint".
That's what classes are used for.
...
This method will initialize the properties of the new object.
...
You can then access this property using dot notation, like you can see in this line of code:
