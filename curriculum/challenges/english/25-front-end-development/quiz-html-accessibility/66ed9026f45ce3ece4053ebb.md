...
### Accessibility is the process of making websites visually appealing
...
indicating that an element will receive updates, which enables assistive technology to mention those updates to the user.
...
to notify assistive technologies like screen readers what the purpose of an element is
