...
The styles for the `div` element are starting to come together. But it would be nice if there was some space around the text. 

To apply `padding` to an element using Tailwind CSS, you can use the following pattern: `p-number`. The number represents the pixels you want to apply on all four sides. 
