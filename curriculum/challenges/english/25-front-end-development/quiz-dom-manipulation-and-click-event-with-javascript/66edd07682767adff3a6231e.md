...
Which of the following is the correct way to use the `addEventListener()` method?
...
Which example is NOT a way to trigger a `validate` function when you click on a `button` element?
