...
assert.isTrue(cabinElementStyles?.animationName === "cabins");
assert.isTrue(cabinElementStyles?.animationDuration === "10s");
assert.isTrue(cabinElementStyles?.animationTimingFunction === "ease-in-out");
assert.isTrue(cabinElementStyles?.animationIterationCount === "infinite");
```
