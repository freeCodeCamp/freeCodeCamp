...
Use a for loop and check divisibility in-order of `3`, `5` & `15` with if conditions or switch.
...
Use a for loop and check divisibility in-order of `15`, `5` & `3` with if conditions or switch.
