...
Which of the following is false about Number.prototype.toFixed()?
...
Calling the .toFixed method on a number object with decimal points and no argument will round the number to the nearest ones

#### --answer--

Using .toFixed() without an argument will default add a decimal point followed by a zero
