...
Eliminates need for testing in applications.
...
Improves maintainability by adding type definitions to JavaScript.
...
It warns if a function does not return a value.
