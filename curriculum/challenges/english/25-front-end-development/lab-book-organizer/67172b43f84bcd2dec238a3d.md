...
8. You should sort the books in the `filteredBooks` array according to their `releaseYear` in ascending order. Note: the sort method will sort the array in place. Your original array will be changed. 
