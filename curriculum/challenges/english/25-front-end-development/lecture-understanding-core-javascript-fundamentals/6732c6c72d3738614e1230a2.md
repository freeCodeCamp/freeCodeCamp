...
A popular linter for JavaScript is ESLint. Here is a simple example of what ESLint might flag (errors flagged by ESLint are shown such as variable not declared, unused variable, and missing semicolon).
