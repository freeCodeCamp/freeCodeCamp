...
For array names consider using plural nouns to indicate that the variable contains multiple items. Remember the goal is to make your code as self explanatory as possible.
