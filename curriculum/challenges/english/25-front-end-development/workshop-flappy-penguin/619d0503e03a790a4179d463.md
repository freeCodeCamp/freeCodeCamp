...
```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.chin')?.top, '25%');
```
...
```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.chin')?.left, '5%');
```

You should give `.chin` a `border-radius` of `70% 70% 100% 100%`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.chin')?.borderTopLeftRadius, '70%');
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.chin')?.borderTopRightRadius, '70%');
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.chin')?.borderBottomRightRadius, '100%');
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.chin')?.borderBottomLeftRadius, '100%');
```
