...
if (leftFoot?.transform) {
  assert.strictEqual(leftFoot.getPropVal('transform', true), 'rotate(80deg)');
} else {
  assert.strictEqual(leftFoot.getPropVal('rotate', true), '80deg');
}
```
...
if (rightFoot?.transform) {
  assert.strictEqual(rightFoot.getPropVal('transform', true), 'rotate(-80deg)');
} else {
  assert.strictEqual(rightFoot.getPropVal('rotate', true), '-80deg');
}
```
