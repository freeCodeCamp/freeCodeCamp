...
Here's a basic example of a linear gradient:
...
You can also specify the shape and size of radial gradients:
...
This creates an elliptical gradient starting from the top left corner of the element.
