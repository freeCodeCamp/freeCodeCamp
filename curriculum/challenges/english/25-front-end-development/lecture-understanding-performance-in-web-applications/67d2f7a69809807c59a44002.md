...
What are some common performance measurement tools? Well - if you want to make your website faster and more responsive, you need the right tools to measure and optimize performance. Let's explore some common performance measurement tools and how they help.

// put in a table here?

(Show a slide with this table)
...
Debugging performance in real-time

Lighthouse

Automated site performance audits

WebPageTest

Testing load speed from different locations

PageSpeed Insights

Google's page performance recommendations

RUM Tools

Tracking real-user experience

First up, Chrome DevTools.
...
Lighthouse is an automated tool that checks performance, SEO, and accessibility. To use it, simply open Chrome DevTools and go to the ‘Lighthouse tab'. Next, click ‘Generate Report'. It will give you a score on how fast and optimized your site is—and provide recommendations to improve it. If you want a quick performance audit, Lighthouse is your go-to tool.
