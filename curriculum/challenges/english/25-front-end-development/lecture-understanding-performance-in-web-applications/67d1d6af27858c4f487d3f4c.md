...
It's also very important to provide quick responses and feedback to user interactions. 
...
Another tip is to avoid content reflow and jumping content. For example, when ads or images are being loaded, the website might jump or readjust to make room for these new resources if they don't already have space in the layout. 
