...
What does the `transform-origin` property do in CSS?

#### --distractors--

It defines the size of transformed elements

---

It alters the opacity of transformed elements

---

It adjusts the color of transformed elements

#### --answer--

It changes the position of transformed elements
...
It adjusts the visibility and opacity of an element
