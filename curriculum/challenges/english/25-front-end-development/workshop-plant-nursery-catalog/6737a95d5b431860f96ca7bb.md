...
Now try to add again the `ballerina` object to `catalogSet` inside your function. You'll see that nothing happens, because the object is already stored in your set and duplicate elements are not allowed in sets.
