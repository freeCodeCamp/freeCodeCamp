...
To test it, set the `small` property of `getBallerina` to an integer different from `20`. Then, look at the developer console to check that the value has changed in your catalog.
