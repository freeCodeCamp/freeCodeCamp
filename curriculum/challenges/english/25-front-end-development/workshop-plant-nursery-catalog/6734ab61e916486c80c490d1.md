...
To test it, use the `getBallerina` reference and set the `small` pots to another integer. Then, look at the console to check that the value has changed in your catalog.
