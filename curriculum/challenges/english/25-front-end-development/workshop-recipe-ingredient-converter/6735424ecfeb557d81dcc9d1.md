...
You should make clicking the Convert button trigger `updateResultsList()` by adding a `"submit"` event listener to `recipeForm` that prevents the default behavior.
