...
Start by declaring an empty `conversationTable` object.

# --hints--

You should use `const` to declare a `conversionTable` variable.

```js
assert.match(code, /const\s+conversionTable/);
```
