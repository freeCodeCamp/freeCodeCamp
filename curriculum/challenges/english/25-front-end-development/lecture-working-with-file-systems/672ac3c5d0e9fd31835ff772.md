...
Hoe to create, move, and delete files and folders using the Explorer or Finder?
...
For example, to create a simple plain text file, you can open TextEdit and save your file. I will use text files to show you the process but this works exactly the same for any type of file.
