...
If you have a Mac computer, the default is the Finder. This provides access to local and remote files, supports file previews, and offers a variety of organizational features like tags and Smart Folders.
...
One way to organize your files, is to use what are called tags. To tag a file or folder, you can select the item in the Finder and then right click with your mouse. You will see the "Tags..." option in the dropdown and you can apply a custom colored tag.
...
Whether you're using File Explorer on Windows or Finder on Mac, these applications give you the flexibility to manage your files with features like tags, search, and smart folders.
