...
1. Your body should use the `calc` function to set its height to 100% of the viewport's height minus any padding applied to the top and bottom of the body.
1. You should have at least one `hr` within your flyer.
1. You should the `width` of all `hr` and `section` elements to a percent value relative to its parent.
