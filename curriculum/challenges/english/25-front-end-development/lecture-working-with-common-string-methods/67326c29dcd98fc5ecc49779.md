...
The `replace()` method does not modify the original string. Instead, it returns a new string with the specified changes. This is because strings in JavaScript are immutable.
