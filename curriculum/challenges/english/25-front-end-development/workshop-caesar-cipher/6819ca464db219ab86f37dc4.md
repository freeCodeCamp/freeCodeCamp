...
As you've already verified, the shift passed to encrypt the text should be greater than 1. It cannot exceed `25` (the last index of `alphabet`) though.
...
--fcc-editable-region--
    if shift < 1:
        return 'Shift must be an integer greater than 1.'
--fcc-editable-region--
