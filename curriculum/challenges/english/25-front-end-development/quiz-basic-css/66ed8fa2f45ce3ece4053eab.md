...
Which rule is correct to target `<h1>` inside of a `<div>`?
...
Which rule is correct to target the next sibling of an `<img>`?
...
Which rule is correct to target all siblings of an `<img>`?
