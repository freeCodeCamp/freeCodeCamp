...
You should increment the current value of `left_array_index` by 1 within the `while` loop. Note that the increment should be done after assigning the left part to the sorted array.
