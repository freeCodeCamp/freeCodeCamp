...
Finally, add a `p` element below the `input`, and give it the text `Type to filter the list below:` an `id` of `search-description`. This will provide additional context for screen readers.
