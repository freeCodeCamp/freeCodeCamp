...
Uncontrolled inputs on the other hand are seen more in traditional HTML forms. So, instead of handling the inputs through the use`State hook, uncontrolled inputs in HTML maintain their own internal state with the help of the DOM.
