...
1. You should have a function named `getRandomQuestion` that  takes in the questions array and returns an random question .
...
You should have a function named `getRandomQuestion` that  takes an  questions array and returns an random question object.
