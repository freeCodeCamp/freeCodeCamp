...
//order of parameter in function does not matter example: choice,question / question,choice .
function getResults(param1, param2) {
  // Determine which parameter is the question and which is the choice
  const question = param1.choices ? param1 : param2;
  const choice = param1.choices ? param2 : param1;
