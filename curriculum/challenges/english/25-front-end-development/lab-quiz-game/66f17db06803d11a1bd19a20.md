...
1. Your `getResults` function should take the question object and computer choice as its parameters, in order. 
...
Your `getResults` function should take the question object and computer choice as parameters, in that order.
