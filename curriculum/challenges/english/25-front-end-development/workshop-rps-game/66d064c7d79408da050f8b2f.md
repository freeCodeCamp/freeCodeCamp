...
The next step is to create the variables responsible for keeping track of the player's and computer's scores.
...
You should have variable called `playerScore`.
...
You should have variable called `computerScore`.
