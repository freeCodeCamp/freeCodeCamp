...
How can you check if a `score` attribute exists in a `player` object?
...
To define variables with default values.

---

To define optional methods within an object that may or may not be called.

---

To write more concise code by chaining multiple method calls together in a single statement.

#### --answer--

To access nested object properties without causing errors if a property is undefined or null.
