...
7. The user should not be able to enter or paste more than `50` characters in the `textarea` element. When the character count reaches `50`, the text `Character Count: 50/50` should be displayed in `red`.
...
If character count is greater than or equal to `50`, the user shouldn't be able to enter or paste more characters.
