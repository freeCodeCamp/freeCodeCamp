...
The engine includes features like setTimeout, fetch, and DOM; the runtime only parses and executes code.
...
The engine parses and compiles code, whereas the runtime provides APIs (e.g., Web APIs, I/O) and the event loop
