...
1. You should have a `Category` class that accepts a name as argument.
1. `Category` should have an instance variable `ledger` that is a list, and contains the list of transactions.
