...
Your `getShoppingListMsg` function should accept an array as an argument and return the message `"Current Shopping List: "` followed by the contents of that array. Double check spacing and spelling errors.
