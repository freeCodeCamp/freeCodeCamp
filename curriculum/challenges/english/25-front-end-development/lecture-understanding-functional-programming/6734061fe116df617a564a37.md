...
This is a regular function that takes all arguments at once.
...
This accepts all arguments at once and calls them like functions, which does not follow the definition of a curried function.
