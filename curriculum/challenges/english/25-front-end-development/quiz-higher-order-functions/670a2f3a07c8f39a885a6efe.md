---
id: 670a2f3a07c8f39a885a6efe
title: Higher Order Functions
challengeType: 8
dashedName: higher-order-function-quiz
---
...
let sum = 0;
const forEachRes = numbers.forEach((num) => {return (sum += num)});
const mapRes = numbers.map((num) => {return (sum += num)});
```
