...
As you can see, all of the headings and paragraphs are aligned to the left margin, which makes it easier for the user to read and follow the content.
...
As you can see, the ad is aligned to the right margin which makes it stand out from the rest of the content on the page but doesn't distract the user from the main content.
...
Your eyes are drawn to the "Get started (it's free)" call to action button because it is centered on the page and stands out from the rest of the content.

Justified alignment is when text is aligned to both the left and right margins. This is typically used for descriptive passages or articles.

As you can see, the text is aligned to both the left and right margins, which creates a clean and professional look.

The last type of alignment is vertical alignment, which is used to align elements along a vertical axis.

All of the form inputs like the name, email, and message fields are aligned along a vertical axis which makes it easier for the user to fill out the form.
