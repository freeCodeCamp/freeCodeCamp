...
When you click the `scaryStoryBtn`, the `resultParagraph` should display the scary story `"In the dark woods, a group of friends stumbled upon an old, abandoned cabin. They enter the cabin and awaken something malevolent that had been dormant for centuries."` with a border color of `#ee4b2b`.
...
When you click the `funnyStoryBtn`, the `resultParagraph` should display the funny story with a border color of `#f1be32`.
...
When you click the `adventureStoryBtn`, the `resultParagraph` should display the adventure story with a border color of `#acd157`.
