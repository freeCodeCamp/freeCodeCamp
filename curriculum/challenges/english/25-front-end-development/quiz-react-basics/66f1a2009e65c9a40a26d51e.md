...
What happens if you omit `key` for each item in a list?

#### --distractors--

The application will crash and abruptly stop running entirely.

---

The list will fail to render on the screen.

---

The CSS styles for the list will not apply properly anymore.

#### --answer--

React warns in console and items misbehave during re-rendering.
