...
Within which scope must a list item's `key` be unique?
...
Within the same parent component.

---

Across all lists on the current page.

#### --answer--

Among its direct sibling elements.
