...
Which command is used to install a React project with Vite?
...
Where are all the packages and libraries required by your project stored?
...
Which of these is one of the problems with SPAs?
...
With which command do you run a React project installed with Vite?
...
Which two keywords do you use to export a component?
