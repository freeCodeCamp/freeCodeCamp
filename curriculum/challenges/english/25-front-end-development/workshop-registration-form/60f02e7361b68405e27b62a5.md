...
In this workshop, you will learn how to style forms by creating a registration form.

All of the HTML boilerplate (`DOCTYPE`, `html`, `head`, and `body` elements) have been provided for you.
