...
Also, return a pair of parenthesis with empty string inside the function.

# --hints--

You should create a `Card` functional component. Don't forget to return an empty string inside it.
...
Your `Card` component should have a `name`, `title`, and `bio` prop.
