...
Instead, we will use the `map()` method, a more efficient way to render lists in React.

First, remove all three `Card` components from your `App` component.

# --hints--

You should not have any `Card` components.
