...
2. Outside the function, declare a variable `year` that stores the value of the year to check.
...
5. If the year is a leap year, return `[year] is a leap year.`. Otherwise, return `[year] is not a leap year.`. You will replace `[year]` with the year variable.
