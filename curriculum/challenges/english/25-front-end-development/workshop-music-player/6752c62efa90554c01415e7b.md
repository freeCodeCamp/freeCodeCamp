...
Next, you need to display the current song title and artist in the player display. Create a function named `setPlayerDisplay`. Inside the function, access the `#player-song-title` and `#player-song-artist` elements, responsible for displaying the song title and artist.

Then, set the `textContent` of `#player-song-title` to the current song's title, if defined. Otherwise, set it to an empty string.

Below that, set the `textContent` of `#player-song-artist` to the current song's artist, if defined. Otherwise, set it to empty string. 
...
Your `setPlayerDisplay` function should set the `textContent` of `#player-song-title` to the current song's title, if defined, or to an empty string.
...
Your `setPlayerDisplay` function should set the `textContent` of `#player-song-artist` to the current song's artist, if defined, or to an empty string.
