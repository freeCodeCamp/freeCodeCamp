...
Access the `#player-song-title` and `#player-song-artist` elements, responsible for displaying the song title and artist, and store them into the variables `playingSong` and `songArtist`, respectively.
