...
## Using `typeof` to check the data type of a variable
...
The reason can be traced back to early days of JavaScript, where values like `null` were represented as a special type of object, leading to this unexpected result. Now this has become a part of JavaScript and you should be aware of it.
