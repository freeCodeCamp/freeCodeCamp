...
The button color in contrast with the dark background is too intense and can cause eye strain.

Instead, you should use desaturated colors in dark mode. Desaturated colors are colors that are less intense and have a lower saturation level.

Now, the button color is less intense and more comfortable to look at in dark mode.
...
Instead, consider using a dark gray background with light gray text for a softer contrast.

This example is easier on the eyes and more comfortable to read in dark mode.
