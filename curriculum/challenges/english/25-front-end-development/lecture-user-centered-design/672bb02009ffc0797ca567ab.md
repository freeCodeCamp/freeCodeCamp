...
The goal is to help users understand where they are in the process and how much more they need to do.

Here is an example of a progress indication bar on the Emirates Airlines website:

In this example, when a user selects the time they need to fly, they will be directed to a page of available flights and prices. As they move throughout the booking process, they can see what is left to do.
