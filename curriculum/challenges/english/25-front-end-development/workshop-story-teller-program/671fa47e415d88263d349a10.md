...
Next, you will start working on the `JavaScript`. For that, begin by linking the `script.js` file to the `index.html` file.

# --hints--

You should have a `script` tag with the `src` attribute set to `script.js`.
