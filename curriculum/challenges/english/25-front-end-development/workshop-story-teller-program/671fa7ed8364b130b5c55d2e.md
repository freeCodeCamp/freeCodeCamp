...
Select the `#result` paragraph and store it in a variable called `result`. You will use this variable to display the selected story.

# --hints--

You should select the `#result` paragraph and store it in a variable called `result`.
