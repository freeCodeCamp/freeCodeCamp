...
Add the `displayStory` function to the `click` event listener of the `scaryStoryBtn`, and see the output in the console.

# --hints--

You should add the `displayStory` function to the `click` event listener of the `scaryStoryBtn` and see the output `"You clicked the button"` in the console when you click the `scaryStoryBtn`.
...
// Trigger the button click after setting up the console override
scaryStoryBtn.click();

// Restore the original console.log
console.log = temp;

// Now, the log array should contain the expected message
