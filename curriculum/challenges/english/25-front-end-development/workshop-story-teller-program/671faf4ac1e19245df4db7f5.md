...
Also, set the `result` paragraph's border color to the `borderColor` property of the selected genre.

# --hints--

`displayStory(scary)` should result in the `result` paragraph displaying the scary story with a red border.
