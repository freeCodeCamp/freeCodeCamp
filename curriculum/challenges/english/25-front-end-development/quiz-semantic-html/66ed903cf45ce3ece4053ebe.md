...
Which of the following elements is used correctly to represent content that is no longer accurate or relevant?
...
Which of the following elements is used to represent a container that consists of illustrations and diagrams?
...
What is the main advantage of using semantic HTML elements over presentational elements?

#### --distractors--

They improve website performance by reducing server load.

---

They enable more vibrant color schemes.

---

They reduce the need for external stylesheets.

#### --answer--

They provide meaning and structure to content, enhancing accessibility and SEO.
...
To style text as bold for emphasis.

---

To contain only navigation links.

---

To represent a footer section.


#### --answer--

To define the header of a document or section.

### --question--

#### --text--

What is the significance of using the `section` element in organizing web content?

#### --distractors--

It applies default styles to the content it wraps.

---

It is used solely for layout purposes, without any semantic meaning.

---

It automatically creates a new navigation menu.

#### --answer--

It defines a thematic grouping of content, helping to structure the page logically

### --question--

#### --text--

How does semantic HTML improve search engine optimization (SEO)?

#### --distractors--

By adding hidden keywords to the page.

---

By automatically generating meta tags.

---

By reducing the amount of HTML code on the page.

#### --answer--

By providing a meaningful structure that helps search engines understand the content better.

### --question--

#### --text--

How does the `code` element differ from the `pre` element in representing code?

#### --distractors--

`code` automatically preserves whitespace while `pre` does not.

---

`pre` is used for inline code snippets, whereas `code` is block-level.

---

`code` applies syntax highlighting, unlike `pre`.

#### --answer--

`code` marks a fragment of code inline, while `pre` preserves formatting and whitespace for multi-line code blocks.

### --question--

#### --text--

Which practice is recommended when marking up a foreign phrase within an English text?

#### --distractors--

Wrap the phrase in a `strong` element to denote importance.

---

Use the `i` element without any language attribute.

---

Enclose the phrase in a `span` element with inline styles.

#### --answer--

Use the `i` element with the appropriate lang attribute to indicate that the text is in a different language.

### --question--

#### --text--

What does it mean when an HTML element is considered "non-semantic"?

#### --distractors--

It automatically applies default browser styles.

---

It provides no information about the meaning or purpose of its content.

---

It is only used within forms and interactive elements.

#### --answer--

It means the element does not convey any inherent meaning about its content; it is used solely for grouping or styling.

### --question--

#### --text--

What is the role of the `rt` element within a ruby annotation?

#### --distractors--

It encloses the base text that is being annotated.

---

It provides fallback text if ruby annotations are not supported.

---

It emphasizes the wrapped text.

#### --answer--

It specifies the annotation text (such as pronunciation or meaning) that appears above or below the base text in a ruby annotation.

### --question--

#### --text--

Which of the following represents a proper way of defining a foreign language phrase?

#### --distractors--

```html
  <i lng="fr">je ne sais quoi</i>
```

---

```html
  <i language="fr">je ne sais quoi</i>
```

---

```html
  <i lg="fr">je ne sais quoi</i>
```
...
Which element will be used to display text that has strong importance?
...
Which element is used to annotate spelling errors?
...
Which element would be useful for marking a phrase from another language?
...
What would be a common use case for the `sup` element?

#### --distractors--

To represent a phrase from another language.
...
To represent exponents, superior lettering and ordinal numbers.

### --question--

#### --text--

Why might a developer choose a semantic element over a generic `div` element?

#### --distractors--

Semantic elements load faster than `div` elements.

---

Semantic elements inherently provide meaning, which improves readability and accessibility.

---

Generic `div` elements are not supported on mobile devices.

#### --answer--

Because semantic elements add meaning to the code, making it more understandable for both developers and assistive technologies.

### --question--

#### --text--

What is the purpose of the `footer` element in an HTML document?
...
To group introductory navigation elements.

---

To contain closing or supplementary information about a section or the entire page.

#### --answer--

It defines the footer for a document or section.

### --question--

#### --text--

What is the purpose of the `del` element in semantic HTML?

#### --distractors--

It marks text that should be inserted.

---

It highlights text for emphasis.

---

It underlines text to signal a correction.

#### --answer--

It marks text that has been removed or deleted from the document.

### --question--

#### --text--

Which of the following is a correct way of defining a description list containing one description term with details?

#### --distractors--

```html
  <description-list>
    <description-term>Term</description-term>
...
Which of the following represents a way to mark content that is no longer accurate or relevant?

#### --distractors--

```html
<b>Some irrelevant text</b>
```

---

```html
<i>Some irrelevant text</i>
```

---

```html
<del>Some irrelevant text</del>
```

#### --answer--

```html
<s>Some irrelevant text</s>
```
