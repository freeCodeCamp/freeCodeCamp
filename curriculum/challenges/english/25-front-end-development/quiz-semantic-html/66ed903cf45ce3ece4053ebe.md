...
---
It defines the header of a document or section.
...
#### --distractors--
To represent a date and/or time value.
...
#### --text--
Which element is used to used to represent a section that is quoted from another source?
