...
Which property is used to customize the message shown during validation failure?
...
When the form has at least one invalid input
...
Which actions will make checkValidity() run?
...
To check if all required fields are filled and valid
...
Which actions can be prevented using e.preventDefault()?
...
Which method should you use to handle form data on the submit event in JavaScript?
