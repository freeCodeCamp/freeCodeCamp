...
```js
assert.isNotEmpty(new __helpers.CSSHelp(document).getStyle('tr[class="read"]'));
```
...
```js
assert.isNotEmpty(new __helpers.CSSHelp(document).getStyle('tr[class="to-read"]'));
```
...
```js
assert.isNotEmpty(new __helpers.CSSHelp(document).getStyle('tr[class="in-progress"]'));
```
...
```js
assert.isNotEmpty(new __helpers.CSSHelp(document).getStyle('tr[class="to-read"] span[class="status"]'));
```
...
```js
assert.isNotEmpty(new __helpers.CSSHelp(document).getStyle('tr[class="read"] span[class="status"]'));
```
...
assert.isNotEmpty(selector1 || selector2);
```
...
```js
assert.isNotEmpty(new __helpers.CSSHelp(document).getStyle('span[class^="rate"] > span'));
```
...
assert.isNotEmpty(selector1 || selector2 || selector3 || selector4);
```
...
```js
assert.isNotEmpty(new __helpers.CSSHelp(document).getStyle('span[class~="three"] span'));
```
