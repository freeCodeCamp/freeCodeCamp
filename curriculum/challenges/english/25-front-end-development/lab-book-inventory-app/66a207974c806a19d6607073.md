...
```js
assert.exists(new __helpers.CSSHelp(document).getStyle('span[class~="one"] :first-child'));
```
...
```js
assert.include(new __helpers.CSSHelp(document).getStyle('span[class~="one"] :first-child')?.getPropVal('background-image'), 'linear-gradient(');
```
...
```js
assert.exists(new __helpers.CSSHelp(document).getStyle('span[class~="two"] :nth-child(1), span[class~="two"] :nth-child(2)'));
```
...
```js
assert.include(new __helpers.CSSHelp(document).getStyle('span[class~="two"] :nth-child(1), span[class~="two"] :nth-child(2)')?.getPropVal('background-image'), 'linear-gradient(');
```
