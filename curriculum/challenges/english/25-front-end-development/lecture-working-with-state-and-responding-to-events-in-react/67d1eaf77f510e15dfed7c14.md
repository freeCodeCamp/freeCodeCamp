...
Whenever the state changes, React re-renders the component without reloading the page to reflect those changes in the UI. This reactivity makes your app interactive.
