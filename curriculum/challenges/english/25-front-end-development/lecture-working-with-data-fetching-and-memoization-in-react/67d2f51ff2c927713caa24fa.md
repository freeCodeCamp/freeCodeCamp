...
Now the handleClcik function is not being recreated on every render:
...
This counter also has a timer in state that updates every second. This makes the component re-render every timer the timer changes, making the handleClick function get recreated on every render.
