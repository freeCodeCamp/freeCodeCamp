...
- **Multi line strings**: These types of comments should be used to leave larger notes or to comment out sections of code
...
- **`f-strings`**: `f-strings` is short for formatted string literals. It allows you to handle interpolation and also do some concatenation with a compact and readable syntax:
