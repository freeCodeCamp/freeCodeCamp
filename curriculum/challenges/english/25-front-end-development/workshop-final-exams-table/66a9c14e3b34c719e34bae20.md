...
Here is an of using the `td` element for a sports players table:
...
The first table data element should contain the last name of `Davis`. The second table data element should contain the first name of `Alex`. The third table data element should contain the grade of `54`.
