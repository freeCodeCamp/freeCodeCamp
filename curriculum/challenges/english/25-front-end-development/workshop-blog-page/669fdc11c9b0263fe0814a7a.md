...
You should have an anchor element with the text of `About` inside your first `li` element.
...
You should have an anchor element with the text of `Posts` inside your second `li` element.
...
You should have an anchor element with the text of `Contact` inside your third `li` element.

```js
const anchorElement = document.querySelector("ul li:nth-child(3) a");
