...
As the `User` class is now complete, there are some changes.
We can link the User class to the Email class by...
...
<!-- BEFORE THIS POINT THERE SHOULDNT BE ANY .NAME -->
<!-- add the .name attributes here -->
