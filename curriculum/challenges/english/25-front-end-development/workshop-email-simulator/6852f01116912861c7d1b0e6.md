...
Every class needs a special method called `__init__` (also known as an initializer). This method is automatically called when you create a new object from the class. It's used to set up the initial state of the object by assigning values to its attributes.
