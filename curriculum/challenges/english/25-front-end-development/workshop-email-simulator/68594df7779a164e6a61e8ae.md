...
({
    test: () => 
    {
        assert(runPython(`_Node(_code).is_ordered("my_inbox.receive_email(email_obj)", "my_inbox.receive_email(email_obj2)", "my_inbox.list_emails()", "my_inbox.emails[0].display_full_email()")`))
    }
