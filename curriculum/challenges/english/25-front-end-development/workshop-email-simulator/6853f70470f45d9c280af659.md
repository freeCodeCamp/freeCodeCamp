...
({
    test: () => 
    {
        ...
        assert.isFalse(runPython(`_Node(_code).has_stmt("email_obj = Email(sender='quinn@example.com',receiver='ash@example.com', subject='Meeting Reminder', body='Hi Ash, just reminding you about our meeting at 3 PM today.')")`))
    }
