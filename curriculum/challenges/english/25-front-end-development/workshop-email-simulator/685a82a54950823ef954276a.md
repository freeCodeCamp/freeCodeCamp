...
Create a function called `main` that takes no parameters. Inside this function, using the `User` class, create two users: `Tory` and `Ramy` and assign them to variables `tory` and `ramy`, respectively. 
