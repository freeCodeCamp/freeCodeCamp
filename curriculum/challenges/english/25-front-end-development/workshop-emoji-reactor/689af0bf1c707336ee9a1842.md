...
Inside your event listener replace the `console.log` with a `querySelector` call to find the `.count` element withing the clicked button, and log it's text content.
