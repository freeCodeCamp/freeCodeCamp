...
Now, in the JavaScript file, create an `happyBtn` variable, and using `querySelector` store a reference to the `#happy-btn` element in it.
...
The `happyBtn` variable should hold a refernce to the `#happy-btn` element.
