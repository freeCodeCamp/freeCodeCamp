...
In this workshop you will create an Emoji Reactor App.

Start by creating a `main` element and a `h1` inside it with a `class` of `title` and a text of `How are you feeling today?`.
