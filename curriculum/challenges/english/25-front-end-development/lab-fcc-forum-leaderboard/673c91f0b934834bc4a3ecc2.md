...
1. The avatars function should return a string made by joining img elements, one for each user_id in the posters array. Find the img url by looking up the user_id property in the posters array and find the matching id property in the user array.
