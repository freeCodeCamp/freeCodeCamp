...
```js
// Checks that a <p> tag follows a <h1> tag
const h1Element = document.querySelector('h1');
const pElement = document.querySelector('p');
assert(h1Element && pElement && h1Element.nextElementSibling === pElement)

// Check that <p> element contains text
assert(pElement && pElement.textContext.trim() !== "")
```
...
```js
// Check that a <p> tag directly follows a <h2> tag
const h2Element = document.querySelectorAll('h2')[0];
const pElement = document.querySelector('p');
assert(h2Element && pElement && h2Element.nextElementSibling === pElement)
...
```js
assert(document.querySelectorAll('p')[1].nextElementSibling.tagName === 'UL');
```
