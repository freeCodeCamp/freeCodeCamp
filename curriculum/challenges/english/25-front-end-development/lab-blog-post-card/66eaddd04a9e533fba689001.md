...
challengeType: 14
dashedName: lab-design-a-blog-post-card
demoType: onClick
---
...
2. Within the `blog-post-card` `div`, you should have an image with a valid `alt` text and the class of `post-img`. You can use `https://cdn.freecodecamp.org/curriculum/labs/cover-photo.jpg` for the `src` attribute of your image.
...
Your `.read-more` `a` should have a `Read More` text.
