...
```js
assert.isTrue(document.querySelector('p')?.previousElementSibling.tagName === 'H1');
```
...
```js
assert.isTrue(document.querySelector('ul')?.previousElementSibling.tagName === 'H2');
```
...
```js
assert.isTrue(document.querySelector('ol')?.previousElementSibling.tagName === 'H2');
```
