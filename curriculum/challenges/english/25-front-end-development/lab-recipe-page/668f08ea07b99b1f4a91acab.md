...
```js
assert(document.querySelector('p')?.previousElementSibling.tagName === 'H1');
```
...
```js
assert(document.querySelector('ul')?.previousElementSibling.tagName === 'H2');
```
...
```js
assert(document.querySelector('ol')?.previousElementSibling.tagName === 'H2');
```
