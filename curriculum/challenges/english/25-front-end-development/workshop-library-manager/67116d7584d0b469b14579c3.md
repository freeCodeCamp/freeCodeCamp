...
Create a `getBooksByAuthor` function with a `catalog` and `author` parameters. The function must return an array that contains the books by a particularauthor.
