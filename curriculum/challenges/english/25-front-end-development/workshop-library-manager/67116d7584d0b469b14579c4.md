...
Finally, create a `getTotalPages` function with a single parameter, accepting array with book objects. The function should return the total number of pages in the books from array passed to function.
...
Your `getTotalPages` function should return total number of pages in the books from array passed to it.
