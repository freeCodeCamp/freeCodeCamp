...
Now would be a good time to start working on displaying the book information on the screen. Over the next few steps, you will learn how to work with the `map()` method to achieve this goal.
