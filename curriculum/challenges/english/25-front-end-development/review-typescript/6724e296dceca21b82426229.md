...
This type definition tells TypeScript that the `array` argument must be an array of strings. Then, when you call `getRandomValue` and pass it a number, you get an error called a compiler error.
