...
This refers to how an event "bubbles up" to the parent objects when triggered.
...
It allows for your JavaScript code to run faster.

---

It reduces the JavaScript file size.
