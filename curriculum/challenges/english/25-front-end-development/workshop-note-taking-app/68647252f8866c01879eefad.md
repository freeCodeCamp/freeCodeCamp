...
When the user clicks on the note, makes edits and then clicks outside of the note, you will need a way to get that new edited version. You can accomplish this by using the `blur` event. This event fires when an element loses focus. Here is an example:
