...
```js
assert(runPython(`_Node(_code).find_class('HashTable').has_function('hash')`))
```
...
```js
assert(runPython(`_Node(_code).find_class('HashTable').has_function('add')`))
```
...
```js
assert(runPython(`_Node(_code).find_class('HashTable').has_function('remove')`))
```
...
```js
assert(runPython(`_Node(_code).find_class('HashTable').has_function('lookup')`))
```
