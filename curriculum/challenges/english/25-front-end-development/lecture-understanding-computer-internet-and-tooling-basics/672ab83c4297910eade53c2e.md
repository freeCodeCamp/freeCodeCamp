...
DSL connections use the infrastructure that landline phone services use. Because of the prevalence of this infrastructure, DSL is available in areas that cable might not be. But it is also frequently a slower option.
