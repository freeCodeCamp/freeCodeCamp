...
1. The function should compute numbers in the Fibonacci sequence as needed.
...
1. If the input number requests an alrady computed number, no new computations should happen and the number should be retrieved from the `sequence` array.
