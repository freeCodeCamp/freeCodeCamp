...
```js
assert(new __helpers.CSSHelp(document).getStyle("#roof")?.getPropertyValue("width"));
```

You should target `#roof` and set its `height` property.

```js
assert(new __helpers.CSSHelp(document).getStyle("#roof")?.getPropertyValue("height"));
```

You should target `#roof` and set its `border` property.

```js
assert(new __helpers.CSSHelp(document).getStyle("#roof")?.getPropertyValue("border"));
```

You should target `#roof` and set its `background-color` property.

```js
assert(new __helpers.CSSHelp(document).getStyle("#roof")?.getPropertyValue("background-color"));
```
...
Your `#door` should not be outside the house borders.
...
Your windows should not be outside the house borders.
