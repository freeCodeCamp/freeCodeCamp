...
```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#house")?.getPropertyValue("border"));
```

You should target `#house` and set its `background-color` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#house")?.getPropertyValue("background-color"));
```
...
```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#chimney")?.getPropertyValue("width"));
```

You should target `#chimney` and set its `height` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#chimney")?.getPropertyValue("height"));
```

You should target `#chimney` and set its `border` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#chimney")?.getPropertyValue("border"));
```

You should target `#chimney` and set its `background-color` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#chimney")?.getPropertyValue("background-color"));
```
...
```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#roof")?.getPropertyValue("width"));
```

You should target `#roof` and set its `height` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#roof")?.getPropertyValue("height"));
```

You should target `#roof` and set its `border` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#roof")?.getPropertyValue("border"));
```

You should target `#roof` and set its `background-color` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#roof")?.getPropertyValue("background-color"));
```
...
```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#door")?.getPropertyValue("width"));
```

You should target `#door` and set its `height` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#door")?.getPropertyValue("height"));
```

You should target `#door` and set its `border` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#door")?.getPropertyValue("border"));
```

You should target `#door` and set its `background-color` property.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle("#door")?.getPropertyValue("background-color"));
```
