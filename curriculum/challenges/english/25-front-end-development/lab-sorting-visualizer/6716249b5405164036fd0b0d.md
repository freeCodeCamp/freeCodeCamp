...
Your `highlightCurrentEls` function should set the border of the given element's descendants placed at the given index and at the next one to have a `dashed` style, a `red` color, and a width of your choice.
