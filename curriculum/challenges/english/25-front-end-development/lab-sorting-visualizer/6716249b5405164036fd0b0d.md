...
1. When you click `#generate-btn` the `#array-container` should contain `#starting-array` with generated numbers. Other elements should be removed from `#array-container`.
...
When `#starting-array` already contains generated array, or `#array-container` contains sorted array, clicking the `#generate-btn` should remove other elements in the `#array-container`, leaving only `#starting-array` with newly generated numbers.
