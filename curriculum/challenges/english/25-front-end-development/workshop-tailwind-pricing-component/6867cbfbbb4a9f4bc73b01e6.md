...
The markers of the list items need to be spaced out a bit. So, give each `span` in the list items the class `text-green-700` and `mr-2`.
...
console.log("Span els: ",spanEls)
console.log("Family spans: ",familyPlanSpans)
