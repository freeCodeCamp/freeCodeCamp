...
To begin, give the wrapper `div` for the plan the classes `bg-gray-100`, `ring-1`, `ing-gray-300`, `p-8`, and `rounded-xl`.
...
```js
grid grid-rows-[1fr_auto] gap-6 rounded-xl bg-gray-100 p-8 ring-1 ring-gray-300
```
