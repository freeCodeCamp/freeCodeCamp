...
The next item to style is the price text, including the `span` in it.

Give the `p` element of the price the classes `text-4xl`, `font-bold`,  and `text-gray-900`, and the `span` in it the classes `text-base`, `font-medium`, and `text-gray-500`.
...
The `span` inside you `p` element should have the class `text-base`.
...
The `span` inside you `p` element should have the class `font-medium`.
...
The `span` inside you `p` element should have the class `text-gray-500`.
