...
That will take care of the whole item, including the CTA button. For every other thing apart from it, you also need to arrange them with grid by targeting the inner `div`.
