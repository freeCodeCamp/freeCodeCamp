...
That won't do anything yet. The magic is in the `right-[num]`, `left-[num]`, `top-[num]`, and `bottom-[num]` utility classes. Here's how you can use them:
...
```html
<div class="relative h-48 bg-gray-100">
  <div class="absolute top-0 left-1/2 bg-red-300 p-2">
    This element is positioned near the top and centered horizontally
  </div>
</div>
```

Add the classes `-top-3` and `right-3` to the badge `div`.
