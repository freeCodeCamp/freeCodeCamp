...
Add the `aria-hidden` attribute to the two `span` elements inside each list item of the unordered list to hide it from screen readers since their content is not interactive.
