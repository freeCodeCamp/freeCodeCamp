...
- **CSS frameworks** can: 
  ...
  - Create a uniform visual style across the website
  - Make your design look consistent across multiple browsers
  - Keep your CSS code more organized
...
- **Potential disadvantages of CSS frameworks**:
  - They might conflict with your custom CSS
...
- **Some features provided by CSS preprocessors**:
  - Variables
  - Mixins
  - Nesting
...
- **Potential disadvantages of CSS preprocessors**:
  - Overhead of compiling the CSS rules into standard CSS
...
- **Some features supported by Sass**:
  - Variables
  - Nested CSS rules
  - Modules
  - Mixins
