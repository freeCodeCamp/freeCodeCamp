...
- **`slice()` Method**: This method returns a shallow copy of a portion of the array, starting from a specified index or the entire array. A shallow copy will create a new array using the references of the elements, rather than duplicating off of the original arrays values.
