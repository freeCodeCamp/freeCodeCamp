...
Your `div` element that wraps the anchor tags should the utility class `flex`.
...
Your `div` element that wraps the anchor tags should the utility class `gap-2`.
...
Your `div` element that wraps the anchor tags should the utility class `mt-6`.
