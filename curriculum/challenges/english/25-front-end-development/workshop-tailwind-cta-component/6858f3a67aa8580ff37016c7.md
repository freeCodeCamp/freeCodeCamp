...
If you adjust the width of the freeCodeCamp built-in browser to the width identical to a mobile device again, you will notice the content are always sitting side-by-side. This is not what you want on mobile devices.
...
Your opening `div` element should the utility class `flex-col`.
