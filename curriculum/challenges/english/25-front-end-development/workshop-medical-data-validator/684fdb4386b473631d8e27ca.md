...
Regular expression can contain special sequences consisting in a backslash (`\`) followed by a character. These sequences have a special meaning. For example, `\d` matches a decimal digit.
