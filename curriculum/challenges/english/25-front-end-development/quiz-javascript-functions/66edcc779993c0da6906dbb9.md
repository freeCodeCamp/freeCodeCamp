...
The code inside the function will run and `undefined` will always be returned.
...
The `return` keyword returns `NaN` from the function.

---

The `return` keyword returns `null` from the function.

---

The `return` keyword returns `undefined` from the function.
...
The string `"Hello, developer"` is logged to the console.
...
The string `"Hello, Jessica"` is logged to the console.
