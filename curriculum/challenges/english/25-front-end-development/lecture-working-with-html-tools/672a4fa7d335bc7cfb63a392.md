...
Using an HTML validator benefits not only you and your future code reviews, but also anybody else going through your code, such teammates and open-source contributors.
