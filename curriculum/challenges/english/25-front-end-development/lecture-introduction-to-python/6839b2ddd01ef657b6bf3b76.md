...
How can you replace all occurrences of one or more parts of a string with another in the string?
...
`replace()` method with old and new text

---

`modify()` function with replacement rules
...
`update()` method with a mapping dictionary
