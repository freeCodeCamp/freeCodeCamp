...
```js
assert.exists(document.querySelector('h1').innerText.toLowerCase() === 'catphotoapp');
```
...
assert.exists(collection.indexOf('H1') < collection.indexOf('H2'));
```
