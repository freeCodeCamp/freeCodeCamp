...
You should create a `botName` variable and give it a value.
...
You should create a `botLocation` variable and give it a value.
...
You should create a  `favoriteLanguage` variable and give it a value.
