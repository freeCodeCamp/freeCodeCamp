...
For now, inside the callback, log the string `this is a test` to the console. Then, select different options from your dropdown menu to test that the event listener works correctly.
