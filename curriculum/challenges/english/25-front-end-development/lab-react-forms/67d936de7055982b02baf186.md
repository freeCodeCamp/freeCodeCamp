...
async () => {
  ...
  console.log(abuseState.calls);
  console.log(abuseState.returns);

  const r = spyOn(abuseState.returns, 1);
  ...
  await React.act(async () => {
    console.dir(inp);
    // inp._valueTracker.setValue("John Doe");
    // inp[Object.keys(inp).find((k) => k.startsWith("__reactProps"))].value = "John Doe";
        // inp.value = "John Doe";
        // inp.dispatchEvent(new Event("change", { bubbles: true }));

      // Object.assign(inp, { value: "John Doe" });
      // setNativeValue(inp, "John Doe");
      const ev = new InputEvent("change", { bubbles: true, cancelable: false, target: {value: "John Doe"} });
