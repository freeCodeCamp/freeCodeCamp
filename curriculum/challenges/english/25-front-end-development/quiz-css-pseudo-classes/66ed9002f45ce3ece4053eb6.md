...
It is a CSS rule that creates additional content within an element when needed.

---

It is a property that adjusts an element's size or layout on the page.
...
Which pseudo-class is used to select and style when an element is focused?
...
Which of the following selects the 3rd child in a row?
...
_____ pseudo-class is used for the current active link.
...
It selects the last child element

### --question--

#### --text--

Use ____ to select the second item in a list.
