...
How the space between lines of text is adjusted to improve readability.
...
How the space between specific pairs of characters is adjusted to improve their readability and aesthetics.
