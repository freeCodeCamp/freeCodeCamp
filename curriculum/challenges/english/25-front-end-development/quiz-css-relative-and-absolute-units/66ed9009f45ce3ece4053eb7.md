...
In CSS, how does the `pt` unit compare to the `px` unit on a typical screen with 96 DPI?

#### --distractors--

1 point (`1pt`) equals 1.33 pixels (`1.33px`)

---

1 point (`1pt`) equals 1 pixel (`1px`)

---

1 point (`1pt`) equals 2 pixels (`2px`)

#### --answer--

1 point (`1pt`) equals 0.75 pixels (`0.75px`)
