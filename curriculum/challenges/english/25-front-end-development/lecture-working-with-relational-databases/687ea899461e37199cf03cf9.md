...
Numeric, such as int, float, serial, and decimal.

Date and time, such as timestamp, data, and time.
...
A useful feature available in PostgreSQL is to create a column using the SERIAL keyword:

id SERIAL

Here, an id column is created using SERIAL.
