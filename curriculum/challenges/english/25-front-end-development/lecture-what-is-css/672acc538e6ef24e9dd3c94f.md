...
In this example, we are applying `20` pixels of margin only to the top of each paragraph element.
...
This code example will apply `10` pixels of `margin` equally to all four sides of the paragraph element.
