...
This is a valid unit for specifying width in CSS, and stands for "pixels."
...
This is also a valid unit for setting width, representing a percentage of the containing element.
...
This unit is valid too; it stands for "viewport width," which makes the width responsive to the size of the browser window.
