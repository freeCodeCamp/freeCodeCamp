...
For example, if you set width to `600` pixels and max-width to `500` pixels, the element will be limited to `500` pixels wide. The max-width overrides the wider setting, keeping the element within the specified maximum size.
