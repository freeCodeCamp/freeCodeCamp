...
```js
assert.isTrue(new __helpers.CSSHelp(document).getStyle('.cat-whisker-right-middle'));
```

Your `.cat-whisker-right-middle` selector should have a `position` property set to `absolute`.

```js
assert.lengthOf(new __helpers.CSSHelp(document).getStyle('.cat-whisker-right-middle')?.position, 'absolute');
```

Your `.cat-whisker-right-middle` selector should have a `top` property set to `127px`.

```js
assert.lengthOf(new __helpers.CSSHelp(document).getStyle('.cat-whisker-right-middle')?.top, '127px');
```

Your `.cat-whisker-right-middle` selector should have a `left` property set to `109px`.

```js
assert.lengthOf(new __helpers.CSSHelp(document).getStyle('.cat-whisker-right-middle')?.left, '109px');
```
