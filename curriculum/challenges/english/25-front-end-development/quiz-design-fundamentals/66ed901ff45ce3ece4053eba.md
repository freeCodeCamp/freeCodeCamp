...
What is an example of a bad practice when working with images?

#### --distractors--

Making important images stand out by being larger in size

---

Separating text and images into columns or rows

---

Putting images outside the layout and important ones on their own or full screen

#### --answer--

Placing images in the middle of text paragraphs with very little margin space for separation
