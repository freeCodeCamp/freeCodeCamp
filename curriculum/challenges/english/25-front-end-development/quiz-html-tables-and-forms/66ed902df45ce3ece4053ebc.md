...
What is the DOM inspector used for?
...
Which of the follow is a tool that checks the syntax of HTML code to ensure it is valid?
...
What does it mean for an input to be in a focused state?
