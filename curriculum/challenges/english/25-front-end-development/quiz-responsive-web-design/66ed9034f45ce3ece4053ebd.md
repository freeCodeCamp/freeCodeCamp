...
To target specific devices or screen orientations
...
What does the `@media (hover: hover)` media query check for?

#### --distractors--

It checks if the device supports touchscreens.

---

It checks if the device is in dark mode.

---

It checks if the device's screen size is large enough.

#### --answer--

It checks if the device supports hover functionality.
