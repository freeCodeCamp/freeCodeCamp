...
Specific points used to set the columns and rows for grid or flex layout.
...
To create animations to table layouts.
...
Designing for smaller devices only and ignore the others.
