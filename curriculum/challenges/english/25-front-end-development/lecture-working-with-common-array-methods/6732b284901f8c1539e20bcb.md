...
Think about how ``splice()`` works when the second parameter is omitted or the starting index is incorrect. Some of these options remove more elements than needed, while others don’t target the last two elements correctly.
