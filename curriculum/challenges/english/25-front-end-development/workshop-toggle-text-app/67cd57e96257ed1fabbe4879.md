...
**NOTE**: Some extra code was added below the `handleToggleVisibility` function so you can see the results in the console. You will learn more about the `useEffect` hook in a future workshop. 
