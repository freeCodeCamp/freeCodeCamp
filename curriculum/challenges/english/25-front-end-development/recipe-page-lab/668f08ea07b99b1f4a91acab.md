...
**Objective:** Build an app that is functionally similar to <a href="https://mot01.github.io/html-lab-1/" target="_blank" rel="noopener noreferrer nofollow">https://recipe-page.freecodecamp.rocks</a>. Do not copy the demo project, give it your own personal style. Fulfill the user stories below and get all the tests to pass to complete the lab. 
...
All your `img` elements should have an `alt` attribute describing the image.
