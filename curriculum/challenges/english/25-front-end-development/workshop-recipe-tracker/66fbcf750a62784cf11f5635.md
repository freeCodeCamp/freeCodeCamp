...
You should set the `averageRating` of `recipe1` you accessed to the result of `getAverageRating` with `recipe1.ratings` as its argument.
...
You should set the `totalIngredients` of `recipe1` you accessed to the result of `getTotalIngredients` with `recipe1.ingredients` as its argument.
...
You should set the `difficultyLevel` of `recipe1` you accessed to the result of `getDifficultyLevel` with `recipe1.cookingTime` as its argument.
