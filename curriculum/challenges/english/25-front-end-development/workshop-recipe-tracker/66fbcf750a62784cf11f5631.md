...
Start by creating a `getAverageRating` function that has single parameter, accepting an array with ratings. Inside the function, calculate the average rating from the array passed to the function.
