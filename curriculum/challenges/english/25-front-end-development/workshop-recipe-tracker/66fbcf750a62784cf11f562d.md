...
The array value of your `ingredients` property should have `"Parmesan cheese"`, `"pancetta"`, and `"black pepper"` in it.

```js
assert.deepEqual(recipe1['ingredients'], ["Parmesan cheese", "pancetta", "black pepper"]);
```
