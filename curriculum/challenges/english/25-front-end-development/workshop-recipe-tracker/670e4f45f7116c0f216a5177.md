...
You should set your `recipe1Name` variable to the assessment of the `name` property of `recipe1`.
...
You should set your `recipe2Name` variable to the assessment of the `name` property of `recipe2`.
...
You should set your `recipe1CookingTime` variable to the assessment of the `cookingTime` property of `recipe1`.
...
You should set your `recipe2CookingTime` variable to the assessment of the `cookingTime` property of `recipe2`.
