...
For the last part of the workshop, you will learn how to find index position of substring in a string. A substring is a sequence of characters within a string.
