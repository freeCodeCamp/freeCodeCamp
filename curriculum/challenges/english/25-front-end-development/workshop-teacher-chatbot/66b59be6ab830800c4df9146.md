...
You should use template literal syntax to assign the string `Today, you will learn about strings in JavaScript.` to the `sentence` variable.
...
```js
assert.lengthOf(code.match(/console.log\(.*\)/), 3);
```
