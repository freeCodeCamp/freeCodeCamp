...
Let's learn about APIs and why they’re essential for web development.
...
Web APIs are specifically designed for web applications. 

There are different types of web APIs for client-side JavaScript development.

They are not part of JavaScript itself.

These types of API's are often divided into two main categories: browser APIs and third-party APIs.
...
Browser APIs can be helpful tools for building powerful web applications.They already come builtin into the browser.
