...
Let's learn about the `querySelectorAll()` method.

You can use this method to get a list of all the DOM elements that match a specific CSS selector.

This is how you can call the `querySelectorAll()` method: call it on the document object and pass a string with the CSS selectors as an argument.

```js
document.querySelectorAll(selectors);
```

The argument must be a valid CSS selector string. Otherwise, a SyntaxError exception will be thrown.
...
Since the method will return a collection of nodes, you can assign this collection to a variable and use it in your program to work with the individual elements, like you can see in this example with the general syntax.
...
This is the output. The elements are printed one by one on the console.
