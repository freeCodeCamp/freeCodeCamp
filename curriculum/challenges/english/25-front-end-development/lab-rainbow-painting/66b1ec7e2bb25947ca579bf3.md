...
You should use absolute positioning to center `#green` with respect to its parent.
...
You should target `#cover` and set its position to cover the bottom half of the colored `div` elements.
