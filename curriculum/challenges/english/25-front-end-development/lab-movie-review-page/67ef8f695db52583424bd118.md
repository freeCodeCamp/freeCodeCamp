...
3. Below the `h1` element, you should have an `img` element displaying the movie cover, you can use `https://cdn.freecodecamp.org/curriculum/labs/rise-beyond-2.png` if you would like, and a descriptive `alt` attribute describing the image.
...
assert.isAbove(h2Index, h1Index);
```
