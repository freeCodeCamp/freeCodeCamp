...
1. For values between `2` to `10`, the `card` parameter will be a number. 
1. For all other values, the `card` parameter will be a string. 
...
After the cards `2`, `3`, `4`, `5`, `6` should return the string `5 Bet`.
...
After the cards `7`, `8`, `9` should return the string `0 Hold`.
...
After the cards `10`, `"J"`, `"Q"`, `"K"`, `'A'` should return the string `-5 Hold`.
...
After the cards `3`, `7`, `"Q"`, `8`, `'A'` should return the string `-1 Hold`.
...
After the cards `2`, `"J"`, `9`, `2`, `7` should return the string `1 Bet`.
...
After the cards `2`, `2`, `10` should return the string `1 Bet`.
...
After the cards `3`, `2`, `"A"`, `10`, `'K'` should return the string `-1 Hold`.
