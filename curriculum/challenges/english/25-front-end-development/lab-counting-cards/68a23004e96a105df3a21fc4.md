...
After the cards `2`, `3`, `4`, `5`, `cc(6)` should return the string `5 Bet`.
...
After the cards `7`, `8`, `cc(9)` should return the string `0 Hold`.
...
After the cards `10`, `'J'`, `'Q'`, `'K'`, `cc('A')` should return the string `-5 Hold`.
...
After the cards `3`, `7`, `'Q'`, `8`, `cc('A')` should return the string `-1 Hold`.
...
After the cards `2`, `'J'`, `9`, `2`, `cc(7)` should return the string `1 Bet`.
...
After the cards `2`, `2`, `cc(10)` should return the string `1 Bet`.
...
After the cards `3`, `2`, `'A'`, `10`, `cc('K')` should return the string `-1 Hold`.
