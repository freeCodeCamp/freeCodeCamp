...
You should log to the console "My favorite programming language is (favoriteLanguage)." using concatenation to add the variable to the string. Ensure spaces are included within the string literals (e.g., use "My favorite programming language is " + favoriteLanguage + "." instead of concatenating spaces separately).
