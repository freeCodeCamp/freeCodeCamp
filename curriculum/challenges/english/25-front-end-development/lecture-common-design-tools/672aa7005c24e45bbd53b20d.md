...
Usually the client will write the design brief and it will serve as a working draft.

Sometimes the designer might write one and consult with the client to make sure it meets their needs.
