...
This is how it happend: The algorithm first checked `3` as the middle of the initial list. Since `4` is greater than `3`, the search shifted to the right half. It then examined `5` as the new middle. Because `4` is less than 5, the search moved to the left, ultimately identifying `4` as the middle of the final range.
