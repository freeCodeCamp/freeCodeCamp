...
It provides a complete design system to implement responsive web designs.
...
It provides a set of small, single-purpose utility classes that are assigned directly to HTML elements.
