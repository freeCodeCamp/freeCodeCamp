...
assert.isNotNull(!!firstColumnData.length);
...
assert.exists(root); 
assert.exists(root.getPropVal('--color0'))
```
...
const root = new __helpers.CSSHelp(document).getStyle(':root');
assert.exists(root); 
assert.exists(root.getPropVal('--color1'))
```
...
const root = new __helpers.CSSHelp(document).getStyle(':root');
assert.exists(root); 
assert.exists(root.getPropVal('--color2'))
```
...
const root = new __helpers.CSSHelp(document).getStyle(':root');
assert.exists(root); 
assert.exists(root.getPropVal('--color3'));
```
...
const root = new __helpers.CSSHelp(document).getStyle(':root');
assert.exists(root); 
assert.exists(root.getPropVal('--color4'));
```
...
const root = new __helpers.CSSHelp(document).getStyle(':root');
assert.exists(root); 
assert.exists(root.getPropVal('--color5'));
```
...
const root = new __helpers.CSSHelp(document).getStyle(':root');
assert.exists(root); 
assert.exists(root.getPropVal('--solid-border'));
```
...
const root = new __helpers.CSSHelp(document).getStyle(':root');
assert.exists(root); 
assert.exists(root.getPropVal('--dashed-border'));
```
