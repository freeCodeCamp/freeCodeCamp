...
So, to recap, when should you use an ID versus a class? Classes are best used when you want to apply a set of styles to many elements. If you want to target a specific element, it is best to use an ID because those values need to be unique.
