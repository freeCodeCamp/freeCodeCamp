...
We can also use it in a very basic form without styling, to hold other elements together:
...
So for example, we can create a `div` and put a heading in it, and put a paragraph in it, and now these two elements will be grouped together.
