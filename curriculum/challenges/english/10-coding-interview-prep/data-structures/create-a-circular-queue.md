...
Likewise, the read pointer should advance forward as you dequeue items. When you dequeue an item, that item should be returned and if you cannot dequeue an item you should return `null`.
