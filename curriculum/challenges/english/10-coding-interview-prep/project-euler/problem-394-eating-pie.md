...
While there is at least a given fraction $F$ of pie left, they performs the following procedure:
...
- Going counterclockwise from the initial cut, they takes the first two pie pieces and eats them.

When less than a fraction $F$ of pie remains, they does not repeat this procedure. Instead, they eats all of the remaining pie.
