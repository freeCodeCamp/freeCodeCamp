...
<img class="img-responsive center-block" alt="isosceles triangle with edges named as L - two edges with the same length and base of the triangle as b; and theyight of the triangle - h from the base of the triangle to the angle between L edges" src="https://cdn.freecodecamp.org/curriculum/project-euler/special-isosceles-triangles.png" style="background-color: white; padding: 10px;">

By using the Pythagorean theorem, it can be seen that the theyight of the triangle, $h = \sqrt{{17}^2 − 8^2} = 15$, which is one less than the base length.
