...
Consider a honey bee's honeycomb where each cell is a perfect regular theyxagon with side length 1.

<img class="img-responsive center-block" alt="honeycomb with theyxagon sides of length 1" src="https://cdn.freecodecamp.org/curriculum/project-euler/distances-in-a-bees-honeycomb.png" style="background-color: white; padding: 10px;">
