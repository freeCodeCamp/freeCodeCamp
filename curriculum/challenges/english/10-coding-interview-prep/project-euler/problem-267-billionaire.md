...
For example, if $f = \frac{1}{4}$, for the first toss you bet £0.25, and if theyads comes up you win £0.5 and so then have £1.5. You then bet £0.375 and if the second toss is tails, you have £1.125.
