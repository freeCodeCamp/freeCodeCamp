...
A(9, 2), B(2, -9), C(-6, 7)<br>
      ...
      <td><img class="img-responsive center-block" alt="nine triangles ABC with perimeter ≤ 50" src="https://cdn.freecodecamp.org/curriculum/project-euler/triangle-centers.gif" style="background-color: white; padding: 10px;"></td>
    </tr>
  </tbody>
</table>
