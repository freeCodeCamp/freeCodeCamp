...
- The **functions** will take a <em>string</em> and an <em>array</em> as parameters.
- The **array** has 3 strings representing the 3 rows of the checkerboard. 
- The **output** will be a series of decimal digits. Numbers should be encrypted by inserting the escape character before each digit, then including the digit <em>unencrypted</em>. This should be reversed for decryption.
