...
Gnome sort is a sorting algorithm which is similar to <a href="<https://rosettacode.org/wiki/Insertion sort>"target="_blank" rel="noopener noreferrer nofollow">Insertion sort</a>, except that moving an element to its proper place is accomplished by a series of swaps, as in <a href="<https://rosettacode.org/wiki/Bubble Sort>"target="_blank" rel="noopener noreferrer nofollow">Bubble Sort</a>.
