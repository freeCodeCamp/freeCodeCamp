...
For this task, the Stern-Brocot sequence is to be generated by an algorithm similar to that employed in generating the <a href="https://rosettacode.org/wiki/Fibonacci" target="_blank" rel="noopener noreferrer nofollow">Fibonacci sequence</a>.
