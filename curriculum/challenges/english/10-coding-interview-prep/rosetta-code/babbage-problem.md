...
[Charles Babbage](https://en.wikipedia.org/wiki/Charles_Babbage "wp: Charles_Babbage"), looking ahead to the sorts of problems theirs Analytical Engine would be able to solve, gave this example:
...
He thought the answer might be 99,736, whose square is 9,947,269,696; but they couldn't be certain.
