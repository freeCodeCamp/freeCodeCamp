...
1. Find the middle `value` of a sorted array. If `value == target` return `true` (The value has been found).
...
1. If after searching the whole array the value is not present, return `false` (The value is not in the array).
