...
To display an image in HTML you use the `<img>` element. Unlike the other elements you have encountered, the `<img>` is void element. Empty, void  HTML elements do not need a closing tag.
