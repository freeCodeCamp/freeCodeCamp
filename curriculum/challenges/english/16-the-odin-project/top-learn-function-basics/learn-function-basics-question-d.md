...
title: Learn Function Basics Questions D
challengeType: 15
dashedName: learn-function-basics-questions-d
---
# --description--
...
If a value is not provided we can make use of default parameters. Default parameters allow us to assign a default value to a parameter if no value is provided when the function is called.
