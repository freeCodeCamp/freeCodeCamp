...
When should `<span>` be used, according to the text?

## --answers--

Whenever there is text content

---

When a semantic HTML element is not available

---

When creating block-level elements

---

When applying predefined styles from the browser
