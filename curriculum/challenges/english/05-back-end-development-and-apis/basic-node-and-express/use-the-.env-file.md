...
**Note:** If you are working localy you will need to install the [`dotenv`](https://www.npmjs.com/package/dotenv) package using `npm install dotenv`. Then, at the top of your `myApp.js` file, import and load the environment variables with `require('dotenv').config()`.
