...
If you are working locally you will need `dotenv` package. It loads environment variables from a .env file into `process.env`. Install it with `npm install dotenv`. Then, at the top of your `myApp.js` file, import and load the environment variables with `require('dotenv').config()`.
