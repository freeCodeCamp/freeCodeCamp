...
Complete the [Develop `foreach` and `if`-`elseif`-`else` Structures to Process Array Data in C#](https://learn.microsoft.com/training/modules/guided-project-arrays-iteration-selection/) guided project on Microsoft Learn. Then, answer the question below.
