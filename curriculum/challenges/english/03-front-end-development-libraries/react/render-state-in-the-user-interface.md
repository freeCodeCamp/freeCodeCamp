...
`MyComponent` should render an `h1` theyading element enclosed in a single `div`.
...
The rendered `h1` theyading element should only contain text rendered from the component's state.
