...
`Desk` is not a plant. It doesn't need water to grow.
...
`Desk` is used for working, not cooking. It isn't heat-resistant like stovetops.
...
`Desk` is a furniture item, not a wearable object. You can't put on a desk like a shirt or pants.
