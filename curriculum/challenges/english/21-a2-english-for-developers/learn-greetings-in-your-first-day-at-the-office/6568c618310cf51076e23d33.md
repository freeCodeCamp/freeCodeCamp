...
In the dialogue, Tom uses `It's` as a contraction of `It` and `is`. This contraction is often used in spoken English to express feelings or opinions about something.
