...
Pronouns like `your` and `my` are used to show possession. `Your` refers to something belonging to the person you are speaking to, while `my` refers to something that belongs to the speaker.
