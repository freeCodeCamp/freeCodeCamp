...
In the dialogue, Jake introduces himself to Tom with the phrase `I'm Jake, from Security.` The word `from` is a preposition that shows the origin or source. In this context, `from Security` tells which department Jake works.
