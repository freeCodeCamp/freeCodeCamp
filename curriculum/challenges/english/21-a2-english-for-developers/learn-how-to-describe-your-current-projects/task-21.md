...
`Surely` comes from `sure`, which means to be confident or certain about something. 
...
`Sarah: Pictures can be great to explain things. We are not using pictures, but it's _ fun to work with data like this.`
