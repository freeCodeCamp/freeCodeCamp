...
The simple past tense in English is used for actions or situations that have been completed in the past. It involves changing verbs to show that the action happened before now. In this challenge, you'll practice using the simple past form of verb.

# --fillInTheBlank--

## --sentence--

`Candidate: I _ there for three years. I _ responsible for developing web applications and maintaining the company's database.`
