...
A `bachelor's degree` is an undergraduate academic degree awarded by colleges and universities upon completion of a course of study. In the term `bachelor's degree`, the use of `noun's` (bachelor's) indicates possession or association. This form is commonly used to show that something belongs to or is related to the noun, as in `today's news` or `teacher's guide`.
