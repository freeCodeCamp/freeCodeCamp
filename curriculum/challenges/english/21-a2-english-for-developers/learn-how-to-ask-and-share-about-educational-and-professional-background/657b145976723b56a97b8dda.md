...
The phrase `I was introduced to` uses the simple past tense form `was` of the verb `be`, combined with the past participle `introduced`. This structure, `be verb-ed`, is often used to describe actions that happened to the subject in the past. In this case, `I was introduced to` means the candidate was made familiar with something new (programming languages and principles) during their studies.
