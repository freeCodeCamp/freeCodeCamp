...
<!-- (Audio) Tom: Thanks, Sophie. I'm also using a lot of constants in my project. But what's the difference between variables and constants?
-->
...
`Thanks, Sophie. I'm also using a lot of _ in my project. But _ the _ _ variables and constants?`
...
```json
{
  ...
  "commands": [
    ...
    },
    {
      ...
      "finishTime": 4.66,
      "dialogue": {
        "text": "Thanks, Sophie. I'm also using a lot of constants in my project.",
        "align": "center"
      }
    },
    {
