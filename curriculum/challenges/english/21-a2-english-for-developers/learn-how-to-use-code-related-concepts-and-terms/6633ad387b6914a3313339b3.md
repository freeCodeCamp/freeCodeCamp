...
`I see. _ that means I _ change the values in _ variables, but I _ change the values in these constants.`
...
```json
{
  ...
  "commands": [
    ...
    },
    {
      ...
      "finishTime": 6.54,
      "dialogue": {
        "text": "I see. So that means I can change the values in these variables, but I can't change the values in these constants.",
        "align": "center"
      }
    },
    {
