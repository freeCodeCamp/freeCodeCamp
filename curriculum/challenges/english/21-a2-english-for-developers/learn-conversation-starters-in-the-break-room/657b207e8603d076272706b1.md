...
`Sarah: Many of us enjoy the _____ game night.`
...
Exclude the options that indicate a different frequency of occurrence: one is more frequent, another is less frequent, and the last one happens only once a year.
