...
Tom asks, `Do you enjoy working with her?`. To answer a question that starts with `do`, you can:

- To say `yes`, you can say `Yes, I do` or simply `I do`.

- To say `no`, you can say `No, I don't` or `I don't`.
