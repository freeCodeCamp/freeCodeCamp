...
Phrases like `I really like` + the subject you like, or `I can't wait to` + the activity you want to do, are sentences that show your excitement and interest about something.
