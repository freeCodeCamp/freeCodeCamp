...
`It’s nice to` is used to express a positive sentiment or feeling about something or someone. In this context, it's often used to express a warm welcome or appreciation.

Example: `It’s nice to meet you.` (This expression conveys a friendly and positive sentiment when meeting someone for the first time.)
