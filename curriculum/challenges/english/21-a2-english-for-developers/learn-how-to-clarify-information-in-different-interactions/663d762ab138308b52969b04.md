...
Preceded by `make` or `makes`, it means that something is logical, reasonable, or easy to understand. For example, if someone explains a decision or an idea and you understand the reasoning behind it, you might say "That makes sense".
