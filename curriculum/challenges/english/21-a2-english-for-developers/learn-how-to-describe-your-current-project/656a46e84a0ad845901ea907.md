...
`The journalist conducts interviews for her articles.` (conversation for information)
`They use colorful infographics to explain data.` (visual images for information)
...
Amy: "Yes, I am. I'm experimenting with video interviews and interactive _ to make the content more engaging for our _."
...
`Readers` are the people who read Amy's content.
