...
Brian uses specific expressions in his conversation. `To be out`, in this context, means to be available or published. For example, `The new book is out next week.` means the book will be available then.
