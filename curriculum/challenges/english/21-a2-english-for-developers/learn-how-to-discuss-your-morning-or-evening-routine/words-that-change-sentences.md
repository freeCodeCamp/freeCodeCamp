...
title: Words That Change Sentences
challengeType: 22
dashedName: words-that-change-sentences
...
Adjectives can also change the meaning of the following word by adding details to them.

The word `light` can serve as an adjective to describe something not heavy or not intense. For example:

`Light exercises are good for beginners.`

This means exercises that are not heavy or hard are good for people who are just starting. The word `light` as an adjective tells you what kind of exercises they are.
...
`Sarah: You can start _ involving your kids in _ activities. Go for a _ walk or play a short _ game together when you get home. It's a _ way to have fun and stay active.`
