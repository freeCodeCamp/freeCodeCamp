...
<!-- (Audio) Brian: In the morning and in the evening, I work on a personal coding project. -->
...
```json
{
  ...
  "commands": [
    ...
    },
    {
      ...
      "finishTime": 8.64,
      "dialogue": {
        "text": "In the morning and in the evening, I work on a personal coding project. In the afternoon, I take a break and go for a quick walk in the park.",
        "align": "center"
      }
    },
    {
