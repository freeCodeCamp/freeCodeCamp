...
title: Reflexive Pronoun Who
challengeType: 22
dashedName: reflexive-pronoun-who
...
`Who` can be used as a relative pronoun to introduce a clause that gives more information about a person or people. 

It links a description or action specifically to a person. For example:
...
`Sophie: I have a friend _ does that in her routine. Any other suggestions?`
