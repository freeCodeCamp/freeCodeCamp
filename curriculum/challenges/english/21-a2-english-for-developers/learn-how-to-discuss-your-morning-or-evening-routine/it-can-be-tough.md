...
title: It Can Be Tough
challengeType: 22
dashedName: it-can-be-tough
...
The modal verb `can` is used to express ability, possibility, or to ask permission. It's a versatile verb that's commonly used in everyday conversation.
...
Listen to Sarah's response and focus on the use of `can`.

# --fillInTheBlank--

## --sentence--

`Sarah: I totally understand, Jake. It _ be tough. Let's see if we _ have some ideas that include the kids.`
