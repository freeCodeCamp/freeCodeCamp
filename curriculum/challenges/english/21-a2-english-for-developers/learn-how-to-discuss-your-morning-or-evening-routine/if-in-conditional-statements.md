...
title: If in Conditional Statements
challengeType: 19
dashedName: if-in-conditional-statements
...
Listen to Sarah's statement and understand how she uses `if` to describe her routine.
