...
title: Intro to Idiomatic Expressions
challengeType: 22
dashedName: idiomatic-expressions-intro
...
`A ton of energy` is an idiomatic expression meaning having a lot of energy, similar to saying `loads of energy.` It's like saying `I slept like a rock,` which means sleeping very deeply.
