...
The expression `There's a ... next month` is often used to inform someone about an upcoming event.
...
What is the main information conveyed by the phrase `There's a big convention next month>`?
