...
In this project, you will find approximation of the square root of a given number using the bisection method.
...
Begin by creating a method named `square_root_bisection`. Leave the parameters empty for now.
