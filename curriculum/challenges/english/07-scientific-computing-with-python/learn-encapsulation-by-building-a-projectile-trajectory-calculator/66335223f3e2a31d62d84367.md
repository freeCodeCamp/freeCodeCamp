...
Also, after printing the `coordinates` variable at the end of the code, create a `Graph` instance passing the `coordinates` variable and assign it to a new `graph` variable.
