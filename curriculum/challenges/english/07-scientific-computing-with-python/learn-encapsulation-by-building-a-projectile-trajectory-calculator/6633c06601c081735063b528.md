...
Now to conclude, create a little utility function called `projectile_helper` outside the classes that takes in the desired values for speed, height and angle and prints it to the terminal in sequence, the details of the projectile, the table of coordinates and the graph of the trajectory.
