...
Now to conclude, create a little utility function outside the classes that takes in the desired values for speed, height and angle and print to the terminal in sequence, the details of the projectile, the table of coordinates and the graph of the trajectory.
