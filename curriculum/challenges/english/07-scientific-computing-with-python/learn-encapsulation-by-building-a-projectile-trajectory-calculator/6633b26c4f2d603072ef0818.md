...
It's good practice to give a rapresentation to the class with `__repr__` special method. Remember that the method should return the code needed to instanziate the instance as a string.
