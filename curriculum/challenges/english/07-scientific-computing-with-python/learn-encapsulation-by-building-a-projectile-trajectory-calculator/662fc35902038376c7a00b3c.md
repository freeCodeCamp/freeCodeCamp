...
Once you have the getters, you can write the setters, which set the value of a private property.
Following example for last step, a setter is written as:
...
Same as the getter, a setter is not called like a method but used like a property:
...
For this step you will have to write the setters for the three private properties. Remember that for the angle the value is received in degrees but saved internally in radians.
