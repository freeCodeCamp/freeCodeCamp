...
At this point you are ready to create the string representation. Start by creating an instance of the Projectile. Below class definition, create a `ball` variable and assign it a call to `Projectile` using `10, 3, 45` as arguments. Then print the `ball` variable.
