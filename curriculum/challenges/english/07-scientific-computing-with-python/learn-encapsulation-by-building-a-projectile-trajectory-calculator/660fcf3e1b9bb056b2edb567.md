...
At this point you are ready to create the string representation. Start by creating an instance of the `Projectile` class. Below class definition, create a `ball` variable and assign it a call to `Projectile` using `10, 3, 45` as arguments. Then print the `ball` variable.

Define a `__str__` method within class, to give your instance a proper string representation, and make it return a string with the following format:
...
The string representation of `ball` should be correct.
