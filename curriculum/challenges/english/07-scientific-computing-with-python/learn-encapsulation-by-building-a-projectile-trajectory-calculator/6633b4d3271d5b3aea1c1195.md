...
Create a method `create_trajectory`, at the bottom of the editor replace the last `print` with `print(graph.create_trajectory())`.

As first step of this new function, make a local copy of the coordinates but where all the values are rounded to integers. Save this new version of the coordinates in a variable named `rounded_coords`, and return this variable.
