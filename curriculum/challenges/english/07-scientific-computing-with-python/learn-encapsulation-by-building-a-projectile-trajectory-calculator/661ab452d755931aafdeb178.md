...
This formula is the formula to calculate the /( y )/ position for any /(x)/ given the starting angle (/(\theta)/), speed (/(v_0/)) and height ( /(y_0/) )
...
angle: {round(math.degrees(self._angle))°}
