...
Define the method `calculate_all_coordinates`, and call it for the `ball` instance and assign the output to a new `coordinates` variable.
...
Call the new method and assign it to `coordinates`.
