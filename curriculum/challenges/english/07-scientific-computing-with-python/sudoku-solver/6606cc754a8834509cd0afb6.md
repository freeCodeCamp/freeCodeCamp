...
Inside the `Board` class, create a method named `valid_in_square` and give it four parameters: `self`, `row`, `col`, and `num`. Where `row`, `col`, and `num` represent the row index, the column index, and the number to be checked, respectively.
...
Your `valid_in_square` method should have four parameters: `self`, `row`, `col`, and `num`.
