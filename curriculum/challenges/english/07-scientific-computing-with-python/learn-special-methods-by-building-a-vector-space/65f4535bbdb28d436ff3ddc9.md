...
As you can see from the output, `__dict__` contains the values of your instance attributes. Instead of explicitly adding `self.x` and `self.y`, you are going to iterate over the values stored in `__dict__` to calculate the value of the norm.
