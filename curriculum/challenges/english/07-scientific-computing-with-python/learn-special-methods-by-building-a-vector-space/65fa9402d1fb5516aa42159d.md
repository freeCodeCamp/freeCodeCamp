...
Feel free to modify `v3` so that it sums an `R2Vector` instance with an object of different type, such as an integer or a string. You will be able to see the custom error message printed to the console.
