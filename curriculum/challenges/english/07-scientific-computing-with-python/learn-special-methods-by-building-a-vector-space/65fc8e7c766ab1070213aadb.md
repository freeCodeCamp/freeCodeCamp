...
After the `elif` statement, raise a `TypeError` and use the following f-string to provide custom message: `f"Multiplication is not defined between '{self.__class__.__name__}' and '{other.__class__.__name__}'"`.
