...
The `__getattribute__()` method is called under the hood when trying to access an instance attribute. You can call it directly in special cases, such as when you want to dynamically access some attributes starting from a string input.
