...
So far, in this project you have not seen any usage of list comprehensions whatsoever.  To see how List Comprenhensions can make your code more concise and readable, you will now begin the transition from a `for` loop to a list comprehension.
