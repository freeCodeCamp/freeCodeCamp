...
({
    test: () => {
        ...
        assert(runPython(`
            Node(${function_body}).find_variable("converted_character").is_equivalent('converted_character = "f_{char.lower()}"') | Node(${function_body}).find_variable("converted_character").is_equivalent('converted_character = "_" + char.lower()')
        `));
    }
})
```
