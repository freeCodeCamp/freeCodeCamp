...
Iterate through the `results` attribute of your equation and concatenate each element in `results` to `output_string`. Keep aligning the text to the center and make each result string end with a new line character.
