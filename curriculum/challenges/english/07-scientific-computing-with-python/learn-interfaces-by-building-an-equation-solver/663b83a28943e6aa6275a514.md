...
Still within the `Equation` class, define a `__str__` method to give a proper string representation to the equation objects you are going to create. The final goal is to represent a polynomial equation of any degree.
