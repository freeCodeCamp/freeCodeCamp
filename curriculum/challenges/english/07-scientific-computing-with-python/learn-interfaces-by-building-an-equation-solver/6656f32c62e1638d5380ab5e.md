...
Next, iterate over the `details` attribute of your equation and concatenate each element in the list to `output_string`. Make sure to add a new line after each element. Do not use any format option for now.
