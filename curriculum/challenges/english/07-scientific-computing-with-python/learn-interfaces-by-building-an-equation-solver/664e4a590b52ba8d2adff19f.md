...
Within the `QuadraticEquation` class, define an `__init__` method. Use a `super()` call to to inherit the method define inside the interface and define a new atttribute named `delta`, which stores the value of the discriminant of the equation.
