...
Create a string containing the string representation of your equation centered in a width of 24 characters. Make the string begin and end with two new line characters, and add your new string to the current value of `output_string`.
