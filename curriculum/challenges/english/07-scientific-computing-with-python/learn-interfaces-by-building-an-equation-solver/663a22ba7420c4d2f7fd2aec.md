...
Use the value stored in the `coefficients` attribute to compute the result. Remember that the `coefficients` attribute stores data as degree-coefficient pairs.
