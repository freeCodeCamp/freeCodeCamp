...
f-strings also enable you to set a specific precision to your numerical data by using the `.nf` the format specifier, where `n` is the number of decimal digits to display.
