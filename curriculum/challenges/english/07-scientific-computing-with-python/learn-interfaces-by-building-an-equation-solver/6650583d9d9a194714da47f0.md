...
When the discriminant is non-negative, the roots of the equation can be found with the formula:
...
You `solve` method should return the a list containing the correct solutions.
