...
For that reason, the `target` arguments corresponds to your second rod, while the `auxiliary` arguments is the third rod. Keep in mind that those will keep swapping as the recursion proceeds.
