...
Again, note how the method is defined with three parameters, but it is called only with two arguments, since `self` is automatically passed in as the object the method is called on.
