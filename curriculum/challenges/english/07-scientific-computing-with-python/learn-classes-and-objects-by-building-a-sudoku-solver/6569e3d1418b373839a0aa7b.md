...
Your method should be named `solver`. Do not forget to add the `pass` keyword in the method body.
...
You should add the parameter `self` to the method. Do not forget to add the `pass` keyword in the method body.
