...
In order to be an instance method, a method requires a special parameter, named `self` by convention. This is a reference to the instance of the class and must be always the first parameter.
