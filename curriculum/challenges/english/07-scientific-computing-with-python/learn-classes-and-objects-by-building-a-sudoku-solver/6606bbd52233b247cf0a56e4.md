...
Now, turn the `1` you modified before back into a `0` to restore the original board. Then, delete your `print` call.

# --hints--

You should turn the first item of the first list back into a zero.
