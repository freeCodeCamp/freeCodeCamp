...
({
    test: () => {
        ...
        console.log(typeof(__helpers.python.astHelpers));

       // let greaterThanNode = __helpers.python.astHelpers(verify_card_number).find_if("number>=10");
        //const { function_body } = verify_card_number;

        // OLD CODe; nothing to see here 
        //assert.match(function_body, /if\s+number\s+>=\s+10:/);
    }
})
```
