...
In this project, you will implement the Luhn Algorithm. This algorithm is a
formula to validate a variety of identification numbers.
...
Start by declaring a function called `main`, this will be the entry point of the
program. The Python interpreter actually creates this function automatically but
we will explicitly declare it for this project. Use the `pass` keyword to avoid
an error
