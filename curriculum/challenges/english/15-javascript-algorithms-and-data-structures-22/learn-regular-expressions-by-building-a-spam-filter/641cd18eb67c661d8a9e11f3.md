...
To get this project started, use `.getElementById()` to get the `#message-input`, `#result`, and `#check-message-btn` elements, and assign them to `messageInput`, `result`, and `checkMessageButton` respectively.
