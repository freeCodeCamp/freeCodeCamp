...
The `.match()` method returns an array of match results, which your application doesn't need. Instead, you can use the `.test()` method of a regular expression to test if a string matches the pattern.
