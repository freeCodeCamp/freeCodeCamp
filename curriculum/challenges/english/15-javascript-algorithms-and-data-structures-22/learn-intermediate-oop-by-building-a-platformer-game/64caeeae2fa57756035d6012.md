...
```js
const xPositionMinCheck = /player\.position\.x\s*>=\s*platform\.position\.x\s*-\s*player\.width\s*\/\s*2/;
const xPositionMaxCheck = /player\.position\.x\s*<=\s*platform\.position\.x\s*\+\s*platform\.width\s*-\s*(?:player\.width\s*\/\s*3|\(\s*player\.width\s*\/\s*3\s*\)|player\.width\s*\*\s*1\s*\/\s*3|\(\s*player\.width\s*\*\s*1\s*\/\s*3\s*\)|1\s*\/\s*3\s*\*\s*player\.width|\(\s*1\s*\/\s*3\s*\*\s*player\.width\s*\))/;

const regexPattern = new RegExp(
  `const\\s+platformDetectionRules\\s*=\\s*\\[\\s*${xPositionMinCheck.source}\\s*,\\s*${xPositionMaxCheck.source}\\s*,?\\s*\\]\\s*;?`
);
