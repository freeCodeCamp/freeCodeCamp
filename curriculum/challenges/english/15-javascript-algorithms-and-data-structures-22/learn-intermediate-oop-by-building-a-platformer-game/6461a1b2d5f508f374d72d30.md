...
Don't forget to include the `.` inside the `document.querySelector` method because you are targeting classes. 

# --hints--

You should use the `document.querySelector()` method to get the `.start-screen` element.
