...
In this project, you are going to learn intermediate Object Oriented Programming principles by building a platformer game. All of the HTML and CSS has been provided for you. 
...
You should use the `document.getElementById()` method to get the `#start-btn` element.
