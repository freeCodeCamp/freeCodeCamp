...
The `innerHeight` property is a number that represents the interior height for the browser window. 
...
You should assign the `innerHeight` property to `canvas.innerHeight`.
