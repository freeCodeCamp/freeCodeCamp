...
The last step is to call the `showCheckpointScreen` function and pass in the message "You reached a checkpoint!".

Congratulations on completing the platformer game! 
