...
Now you will need to starting building out the function that will show the player cards based on the selections made by the user in the "Filter Teammates" dropdown menu. 
...
You should create an arrow function called `setPlayerCards`.


```js
assert(typeof setPlayerCards === 'function');
```
