...
assert.match(code, /const\s*{\s*((sport|team|year|players)\s*\,\s*(sport|team|year|players)\s*\,\s*(sport|team|year|players)\s*\,\s*(sport|team|year|players))\s*}\s*=\s*myFavoriteFootballTeam\s*/)
