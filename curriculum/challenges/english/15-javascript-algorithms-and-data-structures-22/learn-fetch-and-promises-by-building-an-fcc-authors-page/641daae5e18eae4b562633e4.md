...
Inside the `.catch()`, remove the console log, set the `innerHTML` of the author container to a `p` element with the `class` `error-msg` and text `There was an error loading the authors`.
