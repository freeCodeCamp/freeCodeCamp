...
In this project, you will learn about asynchronous JavaScript and how to use the `Fetch API`. You will also learn how to display data from a remote source on a web page.
