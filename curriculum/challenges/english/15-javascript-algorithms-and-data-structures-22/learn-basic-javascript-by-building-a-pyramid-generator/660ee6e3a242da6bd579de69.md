...
There are specific rules on naming your variables. Variable names can be made up of numbers, letters, dollar signs, and underscores. They may not contain spaces. They may not start with a number.

Declare a `character` variable in your code. Note that statements in JavaScript should be ended with a `;`.
