...
When you assign a value at the same time as declaring a variable, it is called <dfn>initialization</dfn>.

Initialize your `character` variable by assigning the value `"Hello"` in the declaration.
