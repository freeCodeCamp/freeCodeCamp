...
Now, it's time to add the functionality to the button. Using the arrow syntax, add a click event listener to the `resetButton` variable. Leave the callback function empty for now.
