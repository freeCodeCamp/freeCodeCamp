...
*Note*: You should not use optional chaining for this step because `currentSong` and `songCurrentTime` because you are explicitly setting these properties to be `null` and `0` respectively.
