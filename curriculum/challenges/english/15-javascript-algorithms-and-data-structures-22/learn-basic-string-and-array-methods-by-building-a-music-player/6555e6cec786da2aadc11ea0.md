...
```js
assert.match(code, /const\s+shuffle\s*=\s*\(\)\s*=>\s*\{\s*userData\.songs\s*=\s*userData\?\.songs\.sort\(\(\)\s*=>\s*Math\.random\(\)\s*-\s*0\.5\);?\s*userData\.currentSong\s*=\s*null;\s*userData\.songCurrentTime\s*=\s*0;?\s*.*\s*.*\s*.*\s*.*\s*\};?/)
```

You should call the `renderSongs` function with `userData?.songs`.

```js
assert.match(code, /const\s+shuffle\s*=\s*\(\)\s*=>\s*\{\s*userData\.songs\s*=\s*userData\?\.songs\.sort\(\(\)\s*=>\s*Math\.random\(\)\s*-\s*0\.5\);?\s*userData\.currentSong\s*=\s*null;\s*userData\.songCurrentTime\s*=\s*0;?\s*renderSongs\(userData\?\.songs\);?\s*.*\s*.*\s*.*\s*\};?/)
```

You should call the `pauseSong` function.

```js
assert.match(code, /const\s+shuffle\s*=\s*\(\)\s*=>\s*\{\s*userData\.songs\s*=\s*userData\?\.songs\.sort\(\(\)\s*=>\s*Math\.random\(\)\s*-\s*0\.5\);?\s*userData\.currentSong\s*=\s*null;\s*userData\.songCurrentTime\s*=\s*0;?\s*renderSongs\(userData\?\.songs\);?\s*pauseSong\(\);?\s*.*\s*.*\s*\};?/)
```

You should call the `setPlayerDisplay` function.

```js
assert.match(code, /const\s+shuffle\s*=\s*\(\)\s*=>\s*\{\s*userData\.songs\s*=\s*userData\?\.songs\.sort\(\(\)\s*=>\s*Math\.random\(\)\s*-\s*0\.5\);?\s*userData\.currentSong\s*=\s*null;\s*userData\.songCurrentTime\s*=\s*0;?\s*renderSongs\(userData\?\.songs\);?\s*pauseSong\(\);?\s*setPlayerDisplay\(\);?\s*.*\s*\};?/)
```

You should call the `setPlayButtonAccessibleText` function.

```js
assert.match(code, /const\s+shuffle\s*=\s*\(\)\s*=>\s*\{\s*userData\.songs\s*=\s*userData\?\.songs\.sort\(\(\)\s*=>\s*Math\.random\(\)\s*-\s*0\.5\);?\s*userData\.currentSong\s*=\s*null;\s*userData\.songCurrentTime\s*=\s*0;?\s*renderSongs\(userData\?\.songs\);?\s*pauseSong\(\);?\s*setPlayerDisplay\(\);?\s*setPlayButtonAccessibleText\(\);?\s*\};?/)
```
