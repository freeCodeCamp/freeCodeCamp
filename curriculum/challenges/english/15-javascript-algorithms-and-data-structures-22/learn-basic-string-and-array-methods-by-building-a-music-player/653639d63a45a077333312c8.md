...
Despite the use of the logical *OR* operator, order in this statement is important, as `userData?.currentSong.id` depends on the existence of `userData?.currentSong`.  Don't forget to include optional chaining.
