...
You need to work on playing the next song and the previous one. For this, you will need a `playNextSong` and `playPreviousSong` function.

Use an arrow syntax to create an empty `playNextSong` function.
