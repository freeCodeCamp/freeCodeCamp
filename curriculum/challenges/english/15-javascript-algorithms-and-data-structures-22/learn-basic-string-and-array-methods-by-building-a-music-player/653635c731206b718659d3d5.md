...
Inside the `playSong` funstion, set the `audio.src` property equal to `song.src`. This tells the audio element where to find the audio data for the selected song. 
