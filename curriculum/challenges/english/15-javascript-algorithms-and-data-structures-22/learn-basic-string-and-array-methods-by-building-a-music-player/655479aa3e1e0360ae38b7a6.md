...
Next, you will need to retrive the next song in the playlist. For that, you will need to get the index of the current song and then add `1` to it. 

Create a constant `nextSong` constant and assign it `userData?.songs[currentSongIndex + 1]`.
