...
Define a `pauseSong` function using the `const` keyword and the arrow function sysntax. The function should take no parameters. 

The function is responsible for pausing the current playing song.
