...
*Note*: You should not use optional chaining when you assign the result of  `userData?.songs.filter` to `userData.songs` because the songs array will not be `undefined` or `null` at that point.
