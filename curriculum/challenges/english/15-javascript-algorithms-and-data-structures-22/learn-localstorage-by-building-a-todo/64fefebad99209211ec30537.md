...
If you check the `Application` tab of your browser console, you'd see that what you have there is a series of `[object Object]`. That's because everything you save in `localStorage` has to be a string.

To fix the issue, wrap the data you're saving in the `JSON.stringify()` method, then check local storage again to see what happens.
