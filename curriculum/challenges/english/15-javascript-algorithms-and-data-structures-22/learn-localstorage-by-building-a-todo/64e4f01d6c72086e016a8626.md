...
After getting the user inputs, you need to hide the form modal again then add those content to the page.

First, hide the form modal by setting the display property of the `form` variable to `none`.
