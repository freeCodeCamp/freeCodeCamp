...
Now you should display the user inputs on the page. You set a `taskData` array for this in step 8.

Loop through the `taskData` array with a `forEach()` and set an empty explicit return.
