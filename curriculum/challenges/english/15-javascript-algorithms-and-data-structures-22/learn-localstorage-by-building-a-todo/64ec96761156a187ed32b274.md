...
If you add the inputs and open up the form modal again, you will still see the values in the input fields. Also if you click the `Discard` button and check the inputs again, the values are still there.

You need to clear those input fields. To do that you need to set the value of the input fields to an empty string.

Start by using arrow syntax to create a `resetForm` function, then set it to an empty explicit return.
