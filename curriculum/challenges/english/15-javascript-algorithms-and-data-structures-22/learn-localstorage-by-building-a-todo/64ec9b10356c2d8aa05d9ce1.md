...
After adding the task to the page, you need to close the form modal so you can see it. To do that, use `classList` on the `taskForm` element to toggle the class `hidden`.
