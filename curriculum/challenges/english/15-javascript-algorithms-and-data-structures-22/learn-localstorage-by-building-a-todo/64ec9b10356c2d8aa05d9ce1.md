...
After adding the task to the page, you need to close the form modal so you can see the task. To do that, use `classList` to toggle the class `hidden`on `taskForm` element.
