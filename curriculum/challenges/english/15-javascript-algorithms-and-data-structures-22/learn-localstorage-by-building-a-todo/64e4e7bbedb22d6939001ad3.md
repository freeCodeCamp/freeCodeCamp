...
Add a `click` event listener to the `closeTaskFormBtn` variable, then use the `showModal()` method on your `confirmCloseDialog` variable. This would show the next modal showing the `Discard` and `Cancel` buttons.
