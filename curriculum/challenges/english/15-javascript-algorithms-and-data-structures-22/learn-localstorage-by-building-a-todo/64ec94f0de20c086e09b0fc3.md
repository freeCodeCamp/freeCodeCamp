...
Create a `p` element and use template interpolation to set the text to the `title` you destructured. Right before the text of the `p` element, create a `strong` element with the text `Title:`.
