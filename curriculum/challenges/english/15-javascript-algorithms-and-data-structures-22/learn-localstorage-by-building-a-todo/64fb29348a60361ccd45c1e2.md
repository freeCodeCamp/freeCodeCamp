...
Now that the task list app has a full CRUD functionality implemented, it's time to implement localstorage functionality. Remember that's the main reason you're here.
