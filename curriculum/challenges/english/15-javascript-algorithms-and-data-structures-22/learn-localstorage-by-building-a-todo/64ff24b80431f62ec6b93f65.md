...
Now you should save the task items to local storage when the user add, update, or remove a task.

First, remove the `myTaskArr` array and every other code with which you've learned local storage because you don't need them anymore.
