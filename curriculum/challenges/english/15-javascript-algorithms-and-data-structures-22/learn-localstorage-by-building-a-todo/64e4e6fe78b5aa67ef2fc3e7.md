...
Continuing the pattern, access the`discard-btn`, `tasks-container`, and `title-input` elements. Save them in the variables `discardBtn`, `tasksContainer`, and `titleInput` respectively.
