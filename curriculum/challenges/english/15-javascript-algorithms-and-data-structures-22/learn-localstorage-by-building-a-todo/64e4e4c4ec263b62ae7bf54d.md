...
Begin by accessing the `modal`, `confirm-modal`, and `confirm-btn` elements with the `getElementById() method`. Save them in the variables `form`, `confirmModal`, and `confirmBtn`.
