...
Now, inside the template literals you need to create an HTML `img` image tag.

# --hints--

You should write a self-closing HTML image tag inside the template literal, please don't put any attributes for now.
