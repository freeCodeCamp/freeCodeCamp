...
Create a constant named `currentTime` inside the `timeAgo` function and assign `new Date()` to it.

# --hints--

Your code should create a constant named `currentTime` inside the `timeAgo` function and then assign `new Date()` to it.
