...
In this step, you will add a `if` statement with the `user` condition to check if the user is the same as the `user` variable.

# --hints--

You should create an `if` statement that with the condition `user`
