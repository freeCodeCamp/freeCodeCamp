...
In this step, you will add an `if` statement with `user` as a condition to check if user was assigned to the `user` variable.

# --hints--

You should create an `if` statement with the condition `user`
