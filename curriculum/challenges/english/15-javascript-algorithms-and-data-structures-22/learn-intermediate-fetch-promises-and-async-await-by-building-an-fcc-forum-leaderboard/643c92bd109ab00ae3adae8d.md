...
Add a callback function to the `.forEach()` method. The callback function should take `item` as an argument.

# --hints--

You should add a callback function to the `.forEach()` method that takes `item` as an argument.
