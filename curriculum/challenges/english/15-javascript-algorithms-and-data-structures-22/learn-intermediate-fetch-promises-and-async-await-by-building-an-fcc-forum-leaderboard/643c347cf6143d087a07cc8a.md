...
Now you will trigger the `fetchData` function by calling it like this `fetchData()`. This function will fetch the data from the API and display it on the console. Check the `console` to see the results after you've completed this step.
