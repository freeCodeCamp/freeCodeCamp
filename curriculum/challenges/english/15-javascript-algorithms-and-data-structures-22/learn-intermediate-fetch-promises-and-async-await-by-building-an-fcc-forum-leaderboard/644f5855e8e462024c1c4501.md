...
After your `${selectedCategory.className}`, add a forward slash `/` followed by another embedded expression for the `id`. 
...
You should add an embedded expression for the `id` after the forward slash `/`.
