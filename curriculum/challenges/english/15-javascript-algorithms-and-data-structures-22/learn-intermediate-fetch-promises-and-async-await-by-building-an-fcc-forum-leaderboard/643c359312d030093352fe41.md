...
You have created a function that fetches the latest forum topics. Now, you need to create a function that helps to display the data in the DOM. For that create a function named `showLatestPosts` and pass the `data` as an argument to it.
...
You should pass the `data` as an argument to the `showLatestPosts` function.
