...
Within the `viewCount` function, create an `if` statement that checks whether `views` is greater than or equal to 1000.  If it is, return the template literal `${thousands}k`. 

# --hints--

You should create an `if` statement that checks whether `views` is greater than or equal to 1000.
