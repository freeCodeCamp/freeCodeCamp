...
Using the dot notation, you will set the `className` property of the `selectedCategory` object to the `className` property of the `categorieList` object, Like this:
...
You should assign the `className` property of the `categorieList` object to the `className` property of the `selectedCategory` object.
