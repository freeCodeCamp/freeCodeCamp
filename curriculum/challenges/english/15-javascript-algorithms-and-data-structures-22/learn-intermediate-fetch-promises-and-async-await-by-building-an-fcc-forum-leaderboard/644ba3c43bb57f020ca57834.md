...
Using the dot notation, you will set the `className` property of the `selectedCategory` object to the `className` property of the `allCategories` object, Like this:
