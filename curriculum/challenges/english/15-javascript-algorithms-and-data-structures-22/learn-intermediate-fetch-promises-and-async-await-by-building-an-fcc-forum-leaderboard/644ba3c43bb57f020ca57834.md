...
Using the dot notation, you will set the `className` property of the `selectedCategory` object to the `className` property of the `categoryList` object, Like this:
...
You should use the dot notation to target the `className` property of the `selectedCategory` object.

```js
assert(code.match(/selectedCategory\.className/g));
```

You should assign the `className` property of the `categoryList` object to the `className` property of the `selectedCategory` object.

```js
assert(code.match(/selectedCategory\.className\s*=\s*className/g));
```
