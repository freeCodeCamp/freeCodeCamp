...
Add a `console.log` statement to check the value of `data`. Also, add a `console.log` to check when the catch block is executed.
...
You should use `console.log` to log the `err` variable inside the `catch` block.
