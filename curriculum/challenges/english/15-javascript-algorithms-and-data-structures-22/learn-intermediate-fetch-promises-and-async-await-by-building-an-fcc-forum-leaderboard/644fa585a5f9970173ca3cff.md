...
Create a constant named `linkClass`, and assign 2 things in a template literal, first the word `category` and then the property `selectedCategory.className`. Both of them are class names that are used to apply styles to the anchor tag.
