...
The `topic_list` object contains 4 more properties, but you only need the `topics` array. In this step, you will destructure the `topics` array from the `topic_list` object.
