...
Use object destructuring to assign the following properties of the `item` to separate variables:
...
```js
assert.match(code, /const\s*\{\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*,\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*,\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*,\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*,\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*,\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*,\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*,\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*,\s*(id|title|views|posts_count|slug|posters|excerpt|category_id|bumped_at)\s*\}\s*=\s*item\s*/);
