...
You will create a constant named `hoursAgo` that will store the number of hours that have passed since the last post. You can do this by dividing `minutesAgo` by `60`, and then rounding down to the nearest whole number. Do it like this :
