...
Create a constant named `linkText` and assign it the value of `selectedCategory.category`. This will display the name of the category in the anchor tag.

# --hints--

You should create a constant named `linkText` and assign it the value of `selectedCategory.category`.
