...
Now, time to implement the function you created to convert the views. On the fourth `td` element, add the `countingViews` function and then passing the `views` property as an argument.
