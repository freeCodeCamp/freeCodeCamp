...
Inside the function named `fetchData`, add a `try...catch` statement. The `try` block should have an empty body. The `catch` block should have an error parameter named `err`.

# --hints--

You should add a `try...catch` statement.
