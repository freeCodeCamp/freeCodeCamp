...
At the end of the map, you will add a `.join("")` method to the array. This will join all the elements of the array into a string.

# --hints--

You should use the `.join("")` method at the end of the `map` to join the elements of the array into a string.
