...
In the function named `forumCategories` pass an argument named `id`, this argument will be used to get the category name and the corresponding class name from the object named `categorieList` 
