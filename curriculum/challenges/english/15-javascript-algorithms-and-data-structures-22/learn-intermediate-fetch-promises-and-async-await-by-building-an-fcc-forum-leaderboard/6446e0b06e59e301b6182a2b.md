...
Pass the `id` argument to the `forumCategory` function. This argument will be used to get the category name and the corresponding class name from the object `allCategories`  
