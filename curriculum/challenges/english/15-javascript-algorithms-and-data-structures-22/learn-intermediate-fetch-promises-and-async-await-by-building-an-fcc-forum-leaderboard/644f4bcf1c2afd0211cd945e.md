...
Inside the template literal, add another embedded expression for the `selectedCategory.className`.

# --hints--

You should have an embedded expression for the `selectedCategory.className` after the `FORUM_CATEGORY_URL`.
