...
Before implementing the function, create a `div` with a class name `avatar-container`

# --hints--

You should create a `div` HTML element
...
You should set the class name of the div to `avatar-container`
