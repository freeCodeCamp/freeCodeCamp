...
Create a constant named `daysAgo` that will store the number of days that have passed since the last post. You can do this by dividing `hoursAgo` by `24`, and then rounding down to the nearest whole number. Here is an example:
