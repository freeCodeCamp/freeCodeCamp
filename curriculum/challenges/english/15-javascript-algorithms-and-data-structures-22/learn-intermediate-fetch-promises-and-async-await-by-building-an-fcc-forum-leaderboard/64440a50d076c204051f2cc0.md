...
You need a function to convert view counts to a more readable format. For example, if the view count is 1000, it should be converted to 1k. If the view count is 100,000 then it will be 100k. For that, create a function named `viewCount`

# --hints--

You need to create a es6 arrow function named `viewCount`
