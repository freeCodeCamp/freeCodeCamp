...
You will create an `if` statement to check if the argument named `id` is available to the `allCategories` object. To do this task, you will need to use the `hasOwnProperty()` method.

# --hints--

You should use the `hasOwnProperty()` method to check if the `id` argument is available to the `allCategories` object.
