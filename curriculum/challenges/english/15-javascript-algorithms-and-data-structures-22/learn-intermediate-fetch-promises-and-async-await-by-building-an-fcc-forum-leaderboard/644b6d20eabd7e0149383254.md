...
Create a empty object variable named `selectedCategory` in the function named `forumCategories`, this variable will be used to select the category name and class name for each category.
