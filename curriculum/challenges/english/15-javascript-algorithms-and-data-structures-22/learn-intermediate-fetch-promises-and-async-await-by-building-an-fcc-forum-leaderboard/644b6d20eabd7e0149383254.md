...
Create an empty object variable named `selectedCategory` in the function named `forumCategory`, this will be used to store the category name and class name for each category.

# --hints--

You should use a `let` variable to store the empty object named `selectedCategory` in the function named `forumCategory`
