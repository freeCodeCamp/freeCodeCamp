...
Create a new `let` variable named `selectedCategory` and assign it an empty object. This will be used to store the category name and class name for each category.
