...
Now, you will use the function named `forumCategory` with the argument called `category_id` inside the function named `showLatestPosts`, after the post title. This will help to show the category of the post.

# --hints--

You should call the function `forumCategory` with the argument `category_id` using a dollar sign and curly braces `${}`.
