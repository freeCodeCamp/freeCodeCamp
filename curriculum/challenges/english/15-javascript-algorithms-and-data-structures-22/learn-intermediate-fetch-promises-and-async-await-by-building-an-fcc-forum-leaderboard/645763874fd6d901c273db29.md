...
Now, you will implement the function named `forumCategories` with the argument called `category_id` inside the function named `showLatestPosts`, after the post title. This will help to show the category of the post.
