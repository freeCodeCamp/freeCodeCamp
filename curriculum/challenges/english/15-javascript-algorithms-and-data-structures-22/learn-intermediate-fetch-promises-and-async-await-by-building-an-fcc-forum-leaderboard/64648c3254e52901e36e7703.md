...
You will trigger the function named `avatars` and pass 2 arguments `posters` and `users`

# --hints--

You should call the function named `avatars` wrapped in curly braces with a dollar sign in front of it
...
You should call 2 arguments named `posters` and `users` in the function named `avatars`
