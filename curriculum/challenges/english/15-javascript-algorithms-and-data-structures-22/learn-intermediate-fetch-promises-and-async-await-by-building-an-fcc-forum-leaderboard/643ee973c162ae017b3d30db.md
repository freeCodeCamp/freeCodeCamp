...
To show some data at the Activity column, you need to use the `bumped_at` property of each topic. This property is a timestamp which is in the ISO 8601 format with timezone information. You need to process this data before displaying it on the project. For that, create a function named `showTime`.
