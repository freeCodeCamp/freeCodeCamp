...
You will create a constant named `MS_PER_MINUTE` that will store the number of milliseconds in a minute. There are `1000 * 60` milliseconds in a minute. Do it like this :
