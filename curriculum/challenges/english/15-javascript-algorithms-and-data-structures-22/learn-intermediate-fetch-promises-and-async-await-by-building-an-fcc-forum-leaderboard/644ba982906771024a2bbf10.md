...
Similarly to the previous step, using the dot notation, you will set the `category` property of the `selectedCategory` object to the `category` property of the `allCategories` object, Like this:
