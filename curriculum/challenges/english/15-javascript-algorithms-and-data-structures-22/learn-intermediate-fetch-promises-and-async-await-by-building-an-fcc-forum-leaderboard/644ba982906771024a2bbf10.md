...
Similarly to the previous step, using the dot notation, you will set the `category` property of the `selectedCategory` object to the `category` property of the `categorieList` object, Like this:
...
You should assign the `category` property of the `categorieList` object to the `category` property of the `selectedCategory` object.
