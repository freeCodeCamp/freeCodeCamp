...
assert.lengthOf(
  String(showAnimation).match(
    /document\.getElementById\s*\(\s*obj\.inputVal\s*\)|document\.getElementById\s*\(\s*obj\[\s*('|"|`)\s*inputVal\s*\1\s*\]\s*\)/g
  ),
  2
);
```
...
assert.match(
  ...
  /document\.getElementById\s*\(\s*obj\.inputVal\s*\)\s*\.\s*remove\s*\(\s*\)|document\.getElementById\s*\(\s*obj\[\s*('|"|`)\s*inputVal\s*\1\s*\]\s*\)\s*\.\s*remove\s*\(\s*\)/g
);
```
