...
Now your `showAnimation()` function is set up. But if you look closely at your `checkUserInput()` function, you'll notice that it's calling `parseInt()` to convert `numberInput.value` into a number several times.
