...
Note that, since the string itself contains single quotation marks, you'll need to escape them with a backslash, or use double quotation marks for your string value.
