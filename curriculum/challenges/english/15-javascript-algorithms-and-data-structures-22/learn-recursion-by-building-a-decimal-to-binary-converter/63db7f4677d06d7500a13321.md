...
Feel free to explore the provided HTML and CSS.

When you're ready to get started, use the `.getElementById()` method on the `document` object to get the input element with the id `number`, and store it in a variable called `numberInput`.
