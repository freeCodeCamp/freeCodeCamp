...
You should use the `.getElementById()` method, set the `textContent` property of the targeted element equal to the `msg` property of the current object.

```js
const oldAnimationData = animationData;
animationData = animationData.map((obj) => Object.assign({}, obj, {
  addElDelay: 0,
  showMsgDelay: 0
}));
try {
  ...
  animationData = oldAnimationData;
}
```
