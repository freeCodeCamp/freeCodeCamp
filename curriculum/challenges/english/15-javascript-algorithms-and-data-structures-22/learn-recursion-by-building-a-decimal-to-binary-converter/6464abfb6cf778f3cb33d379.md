...
Add another `setTimeout()` function. Pass in an empty callback function as the first parameter, and pass in the `showElDelay` property of the current object as the second parameter.
