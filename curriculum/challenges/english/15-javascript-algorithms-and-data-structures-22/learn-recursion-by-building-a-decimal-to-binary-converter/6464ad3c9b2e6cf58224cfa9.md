...
You have set the `id` attribute value for your paragraph elements to the `obj.inputVal` property. Now, you can target those the paragraph elements with those `id`s.

Use the `getElementById()` function to select the element with that attribute value using the `obj.inputVal` property.
