...
Use the `setTimeout` function to add a one second delay before the text `Code` to the console. Then see what happens after you enter `5` into the number input and click the `Convert` button.
