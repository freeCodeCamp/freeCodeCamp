...
Within the callback function, add a `setTimeout()` function. Pass in an empty callback function as the first parameter, and `obj.addElDelay` as the second parameter.
