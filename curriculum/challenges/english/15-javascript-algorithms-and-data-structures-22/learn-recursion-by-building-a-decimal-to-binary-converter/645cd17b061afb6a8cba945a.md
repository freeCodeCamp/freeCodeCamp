...
Next, add the following text to your mock call stack: `- b(): "is " + c()`. Remember that the call stack is a LIFO data structure, so the last function is added to the top of the stack.
