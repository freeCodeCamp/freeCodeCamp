...
After alerting the user if the number input is empty or the value is not a number greater than or equal to 0, you can use the `return` keyword to break out of this function early. This will prevent future code in this function from running.
