...
Your final calculation is the <dfn>standard deviation</dfn>, which is the square root of the variance. Begin by declaring a `getStandardDeviation` function, with the `array` parameter. In the function body, declare a `variance` variable and assign it the variance of the `array`.
...
YOur `getStandardDeviation` function should have a `array` parameter.
