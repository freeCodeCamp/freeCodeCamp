...
The `.reduce()` method takes a second parameter that is used as the initial value of the accumulator. To be safe, set your initial value to `0`. Here is an example of setting the initial value to an empty string:
