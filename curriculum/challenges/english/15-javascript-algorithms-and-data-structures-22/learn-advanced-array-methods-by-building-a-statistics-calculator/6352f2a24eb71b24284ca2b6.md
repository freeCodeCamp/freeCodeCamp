...
The <dfn>variance</dfn> of a series represents how much the data deviate from the mean, and can be used to determine how spread out the data are. The variance is calculated in a few steps.
