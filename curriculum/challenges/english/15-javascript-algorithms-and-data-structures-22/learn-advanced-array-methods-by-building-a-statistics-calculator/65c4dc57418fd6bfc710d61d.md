...
Inside your `getMode` function, chain a `forEach` to the returned `array` parameter. Your `.forEach()` method should have an empty callback function which takes an `el` parameter.
