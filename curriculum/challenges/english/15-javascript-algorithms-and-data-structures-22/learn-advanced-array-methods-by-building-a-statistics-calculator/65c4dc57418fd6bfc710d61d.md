...
Inside your `getMode` function, add a `forEach` on your `array` parameter. Your `.forEach()` method should have an empty callback function which takes an `el` parameter.
