...
To find the median for an even list of numbers, you need to find the two middle numbers and calculate the mean of those numbers. 
...
You should assign the result of finding the median of the `testArr2` to the `evenListMedian` variable. 
