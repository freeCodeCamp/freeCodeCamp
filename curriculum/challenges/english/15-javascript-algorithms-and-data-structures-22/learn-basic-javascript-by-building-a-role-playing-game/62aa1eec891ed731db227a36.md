...
If you play the game in its current state you might notice a bug. If your `xp` is high enough, the `getMonsterAttackValue` function will retrun a negative number, which will actually add to your total health when fighting a monster!
