...
Now that you are updating the `gold` and `health` variables, you need to display those new values on the game screen. If you recall, we retrieved the `healthText` and `goldText` elements in a prior step.
