...
Now that you are updating the `gold` and `health` variables, you need to display those new values on the game screen. Thankfully, you retrieved the `healthText` and `goldText` elements in a prior step.
