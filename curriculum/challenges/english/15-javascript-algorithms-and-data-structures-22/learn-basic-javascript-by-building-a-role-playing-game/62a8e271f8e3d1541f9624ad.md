...
You should set the `innerText` property of `monsterHealthText` to be the `health` value of the current monster. Remember that you can get the current monster with `monsters[fighting]`, or that you can access this value using the `monsterHealth` variable that you previously assigned.
