...
Update the `gold` amount to `250`. *NOTE*: The HTML has already been updated to reflect this change.
...
You should see the updated inventory message as well as the gold amount decrease by `30`.

You should also see an error message in the console which will be fixed in the next step.
