...
Add a <code>console.log("Hello World");</code> line between your <code>script</code> tags. Then click the "Console" button to open the console. You should see the text <code>Hello World</code>.
