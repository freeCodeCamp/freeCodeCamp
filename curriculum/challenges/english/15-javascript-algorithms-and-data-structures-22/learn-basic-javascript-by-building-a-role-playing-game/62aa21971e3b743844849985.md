...
The logical or operator will use the first value if it is truthy – that is, it is anything apart from `Nan`, `null`, `0`, `-0`, `0n`, `""`, and `false`. Otherwise it will use the second value.
