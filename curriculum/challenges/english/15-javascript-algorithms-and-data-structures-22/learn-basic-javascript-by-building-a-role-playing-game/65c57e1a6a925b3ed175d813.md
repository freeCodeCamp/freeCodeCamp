...
The monsters array represents the different types of monsters you will encounter in the game. Each monster has a `name`, `level`, and `health` property. In order to access the current monster's stats, you will need to create a variable that represents the index of the current monster in the `monsters` array.
