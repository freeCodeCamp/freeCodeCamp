...
The `monsters` array represents the different types of monsters you will encounter in the game. In order to access the current monster, you will need to create a variable that represents the index of the current monster in the `monsters` array.
