...
Now when you test your `buyWeapon` function, you should see that the previous error message has disappeared. 

However, if the player has purchased all of the weapons in the inventory, the player should not be able to purchase any more and a message should be displayed.
