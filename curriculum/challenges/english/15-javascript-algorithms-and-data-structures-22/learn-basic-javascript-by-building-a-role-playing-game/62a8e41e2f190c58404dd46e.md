...
# --description--
On a new line, append the string `" You attack it with your <CURRENT_WEAPON_NAME>."` to the current value of `text`, and replace `<CURRENT_WEAPON_NAME>` with the player's current weapon. Additionally, remember that this new string starts with a space to display it properly.
