...
*NOTE*: JavaScript will receive the input as a string, so you will need to convert the string to a number before performing any calculations. You will learn how to convert string values into a number in a future step. 
