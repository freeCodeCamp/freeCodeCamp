...
Because you will be writing algorithms that won't have necessarily have a return value, set a fallback value for `array` to be an empty array. Here is an example of a function that has a fallback value:
