...
To fix this, you can pass a callback function to the `.sort()` method. The callback function have two parameters - for yours, use `a` and `b`. Leave the function empty for now.
