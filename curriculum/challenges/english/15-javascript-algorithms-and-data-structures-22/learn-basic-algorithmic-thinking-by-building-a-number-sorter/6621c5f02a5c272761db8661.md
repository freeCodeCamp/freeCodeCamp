...
Before going further, make sure to observe the data type of the printed result in the console. 
...
Print or log the results using `console.log()`.

```js
assert.match(code, /console\.log\(.*\);/);
```

Make a test call for `inputValues`.
