...
You should mount your event listener now, so that you can test your code as you write it. Add an event listener to your `sortButton` element. It should listen for the `click` event, and take `sortInputArray` as the callback.
