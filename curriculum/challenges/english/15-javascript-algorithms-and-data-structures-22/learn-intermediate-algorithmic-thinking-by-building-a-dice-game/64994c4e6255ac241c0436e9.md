...
The very first thing you will be doing is to set the initial values for the game. First, declare variables named `rolls`, `score` and `totalScore` and set all of their values to `0`. Then, declare a variable named `round` and set its value to `1`.
