...
When you roll the dice and make a selection, you are not able to keep the score you selected and move onto the next round. Create an `updateScore` function to add this functionality. Your function will need a parameter for the score option the user selected and **achieved**.

The function will need to add the value the user selected to the total score ## TODO: STOPPED HERE
