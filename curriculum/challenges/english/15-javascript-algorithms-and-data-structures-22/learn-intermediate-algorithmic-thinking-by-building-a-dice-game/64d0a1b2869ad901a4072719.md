...
Finally, if none of the cases match, then call the function named `updateRadioOption` with arguments of `5` and `0`

# --hints--

You should call the function named `updateRadioOption` with arguments `5` and `0`.
