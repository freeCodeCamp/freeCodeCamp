...
You should use the `.getElementById()` method to target the element with the id of `roll-dice-btn` and store it in a `rollDiceBtn` variable declared with `const`.
