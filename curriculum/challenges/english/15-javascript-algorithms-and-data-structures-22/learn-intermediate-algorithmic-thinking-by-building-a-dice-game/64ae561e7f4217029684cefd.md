...
Inside the event listener for the `rollDiceBtn` button, call the `findRollResult` function passing `displayArray` as the argument . This will display the results of the roll on the screen every time the user clicks the roll dice button.
