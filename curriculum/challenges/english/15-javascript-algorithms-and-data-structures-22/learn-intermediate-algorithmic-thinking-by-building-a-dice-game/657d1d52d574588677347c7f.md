...
Create a `resetRadioOption` function. Your function should iterate through the `scoreInputs` to disable them and remove the `checked` attribute. Your function should also remove the text from each of the `scoreSpans`. Finally, call this function before you roll the dice.
