...
<!-- might need some help here to write description/ test cases ? -->
Inside the loop, write this code `counts[num] = counts[num] ? counts[num] + 1 : 1` which will help to count how many times a number appears in the array.

# --hints--

You should use the `counts` object to keep track of how many times a number appears in the array.
