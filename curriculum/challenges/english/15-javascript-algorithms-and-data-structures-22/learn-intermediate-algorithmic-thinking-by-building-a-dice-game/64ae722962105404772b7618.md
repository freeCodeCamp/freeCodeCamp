...
declare 2 unassigned variables named `selectedValue` and `achieved`. These will be used to store the selected value and the achieved value respectively.

# --hints--

You should declare 2 unassigned variables named `selectedValue` and `achieved`.
