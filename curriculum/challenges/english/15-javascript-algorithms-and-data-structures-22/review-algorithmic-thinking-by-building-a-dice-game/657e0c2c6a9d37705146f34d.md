...
If the user rolls three of one number, and two of another number, this is called a full house. You will need to declare a `detectFullHouse` function to check for this, the `detectFullHouse` function expects an array as required parameter.
