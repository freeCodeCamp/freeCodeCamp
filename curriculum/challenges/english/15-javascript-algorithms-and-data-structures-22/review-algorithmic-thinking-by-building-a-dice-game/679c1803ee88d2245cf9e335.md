...
When a full house is not rolled, your `detectFullHouse` function should not enable the final radio button, or set the final `span` text.
...
When no straight is rolled, your `checkForStraights` function should not enable the final radio button, or set the final `span` text.
