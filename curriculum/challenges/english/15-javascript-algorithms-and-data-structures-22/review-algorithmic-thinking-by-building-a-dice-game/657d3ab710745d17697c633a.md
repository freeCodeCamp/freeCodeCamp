...
The function will need to add the value the user selected to the running score, update the total score text on the page, and add a new list item to the score history with the format `${achieved} : ${selectedValue}`.
