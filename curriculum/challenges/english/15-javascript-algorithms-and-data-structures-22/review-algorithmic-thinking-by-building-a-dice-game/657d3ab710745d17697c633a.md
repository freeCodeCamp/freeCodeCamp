...
The function will need to add the value the user selected to the running score, update the running score text on the page, and add a new list item to the score history with the format `${achieved} : ${selectedValue}`.
...
Your `updateScore` function should add the value of the first parameter to the running score.
