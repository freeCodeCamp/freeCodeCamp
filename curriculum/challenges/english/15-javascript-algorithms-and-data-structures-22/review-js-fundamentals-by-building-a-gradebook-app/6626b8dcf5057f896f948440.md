...
Complete the `studentMsg` function with `totalScores` and `studentScore` for parameters. The function should return string representing a message to the student.
