...
To display the time since the last post, call the `timeAgo` function and pass in the `bumped_at` variable for the argument. Place this function call inside the last `td` element of the `tr` element.
