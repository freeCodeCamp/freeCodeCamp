...
Verify the code includes a properly configured href attribute (${forumTopicUrl}${slug}/${id}) and a target attribute (_blank) within the opening <a> tag.

```js
assert.match(
  code,
  /<a\s+(?:(?:class=['"]post-title['"]\s+target=['"]_blank['"]|target=['"]_blank['"]\s+class=['"]post-title['"])|(?:class=['"]post-title['"]\s+href=['"]\S+['"]|href=['"]\S+['"]\s+class=['"]post-title['"])|(?:target=['"]_blank['"]\s+href=['"]\S+['"]|href=['"]\S+['"]\s+target=['"]_blank['"]))(?:.|\n)*?<\/a>/
);
```
