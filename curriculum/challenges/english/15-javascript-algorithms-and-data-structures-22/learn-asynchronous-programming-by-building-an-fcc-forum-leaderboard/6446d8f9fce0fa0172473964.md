...
Below each of the topics, you will need to display a `category`. In the next few steps, you will create a function to retrieve the category name from the `allCategories` object. 

The `allCategories` object has been created for you and contains objects with the `category` name and the corresponding `className` used to style & color the `category`.
...
You should pass a argument named `id` in the function named `forumCategory`
