...
- If the amount of minutes that have passed is less than 60, return the minutes.
- If the amount of hours that have passed is less than 24, return the hours.
- If the amount of days that have passed is less than 30, return the days.
...
You should return the string `"30m ago"` when the `time` parameter is 30 minutes ago.
...
You should return the string `"1 hour ago"` when the `time` parameter is 1 hour ago.
...
You should return the string `"1 day ago"` when the `time` parameter is 1 day ago.
