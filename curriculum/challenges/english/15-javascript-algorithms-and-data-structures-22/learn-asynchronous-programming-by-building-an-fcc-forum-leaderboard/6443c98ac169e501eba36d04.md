...
- If the amount of days that have passed is less than `30`, return the string `xd ago`. `x` will represent the days. 
...
You should return the string `"30m ago"` when the amount of minutes that have passed is `30`.
...
You should return the string `"1d ago"` when the amount of days that have passed is `1`.
