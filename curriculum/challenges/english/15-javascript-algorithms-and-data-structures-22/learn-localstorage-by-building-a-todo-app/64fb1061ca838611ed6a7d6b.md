...
Use square bracket notation to get the task to be edited from the `taskData` array using the `dataArrIndex`. Assign it to the `currentTask` object to keep track of it.
