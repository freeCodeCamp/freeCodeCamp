...
After adding the task to the page, you should hide the form to view the task. To do this, utilize `classList` to toggle the `hidden` class on the `taskForm` element.
