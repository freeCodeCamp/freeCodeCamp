...
Now that you have the `myTaskArr` array saved in `localStorage` in the right way, you can retrieve it with `getItem()` by passing in the key you saved the item with.
