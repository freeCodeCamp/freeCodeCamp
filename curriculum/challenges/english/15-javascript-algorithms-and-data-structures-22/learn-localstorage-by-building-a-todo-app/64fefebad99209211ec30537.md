...
If you check the `Application` tab of your browser console, you'll see a series of `[object Object]`. That's because everything you save in `localStorage` has to be a string.
