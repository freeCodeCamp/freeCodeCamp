...
```js
const player = { name: "Name", isCaptain: true, position: 'goalkeeper' };

playerCards.innerHTML = "";
setPlayerCards([player]);

assert.equal(playerCards.querySelector("p").innerText, `Position: ${player.position}`);
```
...
assert.equal(playerCards.querySelector(".player-card p").innerText, `Position: ${player.position}`);
```
