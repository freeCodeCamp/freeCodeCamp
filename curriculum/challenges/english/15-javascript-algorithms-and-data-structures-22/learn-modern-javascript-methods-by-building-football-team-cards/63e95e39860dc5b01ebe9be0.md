...
assert.equal(playerCards.querySelector(".player-card:nth-child(1) h2").innerText, "<h2>(Captain) First</h2>");
assert.equal(playerCards.querySelector(".player-card:nth-child(2) h2").innerText, "<h2>Second</h2>");
```
