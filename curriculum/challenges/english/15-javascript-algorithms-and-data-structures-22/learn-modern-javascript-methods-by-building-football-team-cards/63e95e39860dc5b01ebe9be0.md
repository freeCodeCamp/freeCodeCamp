...
const before = playerCards.innerHTML;
setPlayerCards(players);
const after = playerCards.innerHTML.replace(before, "");

assert.ok(after.includes("<h2>(Captain) First</h2>"));
assert.ok(after.includes("<h2>Second</h2>"));
```
