...
assert.match(code, /const\s*{\s*coachName\s*}\s*=\s*myFavoriteFootballTeam\.headCoach\s*|const\s*{\s*headCoach\s*:\s*{\s*coachName\s*}\s*}\s*=\s*myFavoriteFootballTeam(?!.headCoach)\s*/)
