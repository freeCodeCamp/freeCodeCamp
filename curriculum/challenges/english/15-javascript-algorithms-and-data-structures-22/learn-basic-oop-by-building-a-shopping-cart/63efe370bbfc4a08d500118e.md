...
To fix this, you can use the `||` operator to set the value to `0` if it doesn’t exist. Wrap `totalCountPerProduct[dessert.id]` on the right-hand side of the assignment in parentheses and add `|| 0` to the end of the expression.

# --hints--

You should wrap `totalCountPerProduct[dessert.id]` on the right-hand side of the assignment in parentheses and add `|| 0` to the end of the expression before adding `1`.
