...
# --description--
A <dfn>function</dfn>, a function is a reusable block of code designed to perform a specific task. Functions are defined using the `function` keyword followed by a name. Here’s the syntax:
