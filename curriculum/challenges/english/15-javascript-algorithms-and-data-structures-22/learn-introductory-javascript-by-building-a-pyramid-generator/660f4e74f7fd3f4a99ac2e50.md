...
Directly below the declaration of `numbers`, declare a `shifted` variable, and assign it the result of calling `.shift()` on your `numbers` array. Then, on the next line, print the variable.
