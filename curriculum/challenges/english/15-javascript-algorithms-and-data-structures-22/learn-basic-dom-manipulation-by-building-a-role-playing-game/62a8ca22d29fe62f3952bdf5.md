...
In the previous project, you learned how to work with the `increment` (`++`) operator which is a shorthand way to increase a number by `1`.
...
You should not use the addition assignment operator to increase `currentWeapon` by `1`.
