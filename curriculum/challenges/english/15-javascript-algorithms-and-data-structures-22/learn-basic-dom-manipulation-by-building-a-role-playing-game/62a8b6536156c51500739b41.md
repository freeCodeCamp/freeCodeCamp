...
Pass in only the first element of the `locations` array. Remember that arrays are zero-based and the first element is at index `0`.

Here is the basic syntax as a reminder:
