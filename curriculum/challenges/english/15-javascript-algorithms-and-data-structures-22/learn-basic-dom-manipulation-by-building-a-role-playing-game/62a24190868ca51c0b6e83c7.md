...
Even though all of the CSS has been provided for you, there is still one last change to make.

When the game first loads, the stats for the monster should be hidden. Later on in the project, you will learn how to show and hide the `#monsterStats` element using JavaScript.
