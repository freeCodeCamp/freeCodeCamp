...
Inside the `goTown` function, call the `update` function and pass your `locations` array as an argument.

Here is a reminder on how to call a function with an argument:
...
You should call the `update` function with `locations` as an argument.
