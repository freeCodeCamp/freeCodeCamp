...
If the monster dies in a fight, then the player will receive experience points and gold. 

In the previous project, you learned how to work with `if...else` statements. You can make an `else` statement conditional by using `else if`. Here's an example:
