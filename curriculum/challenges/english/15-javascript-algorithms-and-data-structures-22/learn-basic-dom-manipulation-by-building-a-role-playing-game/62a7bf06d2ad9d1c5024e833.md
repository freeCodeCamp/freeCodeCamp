...
When you click on the `"Go to store"` button followed by the `"Buy weapon (30 gold)"` button, you will notice that the message of `"Going to cave."` is logged to the console. The correct behavior should be to buy a weapon instead of going to the cave.
