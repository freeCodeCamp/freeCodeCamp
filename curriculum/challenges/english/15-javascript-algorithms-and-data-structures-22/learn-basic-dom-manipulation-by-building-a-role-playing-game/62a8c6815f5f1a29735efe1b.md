...
In the game, the player will be able to buy weapons from the store and add it to their inventory. You will need to create a data structure that represents all of the available weapons in the game.
