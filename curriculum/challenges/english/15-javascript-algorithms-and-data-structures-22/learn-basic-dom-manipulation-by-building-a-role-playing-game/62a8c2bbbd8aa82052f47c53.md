...
In order for the player to be able to enter into the cave, you will need to add a third object to the `locations` array. It will have the same properties as the other two objects.
