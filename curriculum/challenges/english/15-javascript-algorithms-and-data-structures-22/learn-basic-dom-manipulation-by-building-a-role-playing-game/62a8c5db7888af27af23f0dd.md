...
Now when a player tries to buy health, it will only work if they have enough money. If they do not, nothing will happen. 

Add an `else` statement where you can put code to run if a player does not have enough money.

You learned about `else` statements in the previous project. Here is the basic syntax:
