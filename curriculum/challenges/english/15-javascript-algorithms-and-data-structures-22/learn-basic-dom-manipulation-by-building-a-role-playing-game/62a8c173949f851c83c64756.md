...
To test your `update` function, click on the `"Go to store"` button. You should see the text and buttons change to the store's location.

Then click on the `"Go to town square"` button to see the text and buttons change back to the town square's location.
