...
When you click on the `"Go to store"` button, the display text still shows the `"Welcome to Dragon Repeller."` message. This is because the `text` element is not being updated when you click on the `"Go to store"` button.
