...
When you click on the `"Go to store"` button, the text for the buttons should show options for buying health and weapons. To accomplish this, you can use the <dfn>innerText</dfn> property.

The `innerText` property controls the text that appears in an HTML element. This property can be used to change the text of an element.

Here is the basic syntax:

```js
element.innerText = "New text goes here";
```
