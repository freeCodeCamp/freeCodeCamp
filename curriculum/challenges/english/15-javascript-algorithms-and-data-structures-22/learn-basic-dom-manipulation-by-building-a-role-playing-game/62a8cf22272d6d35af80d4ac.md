...
When a player buys a new weapon, that weapon should be added to the `inventory` array that you created earlier on in the project. 

In the previous project, you learned how to work with the `push()` method to add a new item to an array. 
