...
When the player is in the store, they should be able to buy health, buy a weapon, or go back to the town square. 

Create three new functions called `buyHealth`, `buyWeapon`, and `goTown`.

Your `buyHealth` and `buyWeapon` functions should be empty. Your `goTown` function should have the following code:
