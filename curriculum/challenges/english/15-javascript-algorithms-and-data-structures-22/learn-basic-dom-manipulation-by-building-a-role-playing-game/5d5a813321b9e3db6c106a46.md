...
JavaScript is a powerful language which allows you to build websites that are interactive. Part of this interactivity comes from the ability to manipulate the Document Object Model (DOM) of your web page. The DOM is a representation of the HTML elements on your web page and is a powerful tool for creating dynamic web pages.

In this project, you will use JavaScript to create a simple role-playing game (RPG) where you can fight a dragon. You will learn how to manipulate the DOM to create a game that is fun and interactive.
