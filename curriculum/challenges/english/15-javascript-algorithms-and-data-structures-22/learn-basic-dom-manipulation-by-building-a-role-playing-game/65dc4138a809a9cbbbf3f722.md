...
When the user clicks on the `"Fight dragon"` button, the `fightDragon` function should be called.

Set the `onclick` property of the `button3` element to the `fightDragon` function reference.

Test out your code by clicking on the `"Fight dragon"` button. You should see the message `"Fighting dragon"` in the console.
