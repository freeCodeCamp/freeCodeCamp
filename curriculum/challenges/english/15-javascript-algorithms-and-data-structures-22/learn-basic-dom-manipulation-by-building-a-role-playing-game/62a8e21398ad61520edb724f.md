...
When the player is fighting a monster, the monster's health should be displayed on the screen. Earlier on in the project, you created a variable called `monsterHealth`. Currently this variable has a value of `undefined` because it has not been assigned a value yet.
...
You should assign the value of `monsters[fighting].health` to the `monsterHealth` variable.
