...
If the player does not have enough gold to buy a weapon, then a message should be displayed to let them know.
...
To test out your changes, click on the `"Go to store"` button, followed by the `"Buy weapon"` button twice. When the amount of gold is less than `30`, you should see the `text` change to `"You do not have enough gold to buy a weapon."`.
