...
When you click on the `"Go to store"` button, you should be taken to the store. When you want to leave the store, you should be able to click on the `"Go to town square"` button to return to the town square. To do this, you need to update the `goTown` function to change the buttons and text.
...
Test out your changes by clicking on the `"Go to store"` button, and then clicking on the `"Go to town square"` button to return to the town square.
