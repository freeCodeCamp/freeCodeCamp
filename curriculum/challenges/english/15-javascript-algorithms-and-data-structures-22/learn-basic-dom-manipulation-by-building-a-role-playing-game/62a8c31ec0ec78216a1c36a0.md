...
Also, do not forget to remove your `console.log` call!

To test out your changes, click on the `"Go to cave"` button in your game. You should see the buttons and text change to the new values for the `"cave"` location.
...
You should call `update` with `locations[2]` in your `goCave` function.
