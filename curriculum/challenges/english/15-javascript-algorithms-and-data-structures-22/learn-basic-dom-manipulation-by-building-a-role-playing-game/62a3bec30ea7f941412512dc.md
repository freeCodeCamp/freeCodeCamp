...
In the game, you will need to display the player's stats and the monster's stats. You will also need to display the text that will be updated as the game progresses.
