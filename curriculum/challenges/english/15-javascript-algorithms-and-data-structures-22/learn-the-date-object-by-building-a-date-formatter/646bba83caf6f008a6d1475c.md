...
The `getHours()` method returns a number between 0 and 23 which represents the hour for the provided date. 

Create a constant named `hours` and assign it `date.getHours()`.
