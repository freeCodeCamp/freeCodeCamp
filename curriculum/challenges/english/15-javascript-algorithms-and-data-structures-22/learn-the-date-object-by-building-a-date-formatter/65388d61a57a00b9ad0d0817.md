...
When a user makes a selection from the dropdown menu, the function should get the user's value and display the date in their chosen date format. To accomplish this task, you can use the `switch` statement.
