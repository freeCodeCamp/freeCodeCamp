...
You should chain the `reverse` method to your `"freeCodeCamp rules".split("")` method.

```js
assert.deepEqual(exampleSentence, ["s", "e", "l", "u", "r", " ", "p", "m", "a", "C", "e", "d", "o", "C", "e", "e", "r", "f"]);
```
...
--fcc-editable-region--
const exampleSentence = "freeCodeCamp rules".split("");
