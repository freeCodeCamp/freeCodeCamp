...
The `getFullYear()` method will return a number which represents the year for the provided date. 

Create a `const` variable named `year` and assign it `date.getFullYear()`.
