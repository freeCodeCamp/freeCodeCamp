...
In JavaScript, there are a number of built-in <dfn>constructors</dfn> that create objects. A constructor is like a regular function, but starts with a capital letter, and is used with the `new` operator.
