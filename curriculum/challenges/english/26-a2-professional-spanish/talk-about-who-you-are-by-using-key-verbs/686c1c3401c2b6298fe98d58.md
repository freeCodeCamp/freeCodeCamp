...
`Me llamo` is a common phrase used to introduce oneself. It translates to "My name is". 

It's derived from the verb `llamarse`, which means "to be called". For example:
