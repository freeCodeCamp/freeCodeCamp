...
To answer correctly, listen for verbs in the past tense that describe actions. These often end in `-é` for the first person (yo) form. In the audio, words like `escuché` and `bailé` signal what Mateo did before work.
