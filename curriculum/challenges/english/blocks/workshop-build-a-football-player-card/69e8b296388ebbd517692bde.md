...
Add a `value` attribute of `player.dri` to the DRI input. Then add an `onChange` attribute set to an arrow function that takes `e` as its parameter and calls `setPlayer` with a spread of `player` and `dri` set to `Number(e.target.value)`.
            ...
            <div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input id="position" className="input" type="text" value={player.position} onChange={(e) => setPlayer({ ...player, position: e.target.value })} />
                </div>
                <div className="form-group">
