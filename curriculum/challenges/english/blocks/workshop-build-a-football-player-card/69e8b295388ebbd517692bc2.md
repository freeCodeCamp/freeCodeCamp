...
The card wrapper class name is currently hardcoded as `card-wrapper tier-gold`. Replace it with a dynamic value using a template literal and calling `getPlayerTier` with `player.overallRating`. This will reference the tier from the CSS.
