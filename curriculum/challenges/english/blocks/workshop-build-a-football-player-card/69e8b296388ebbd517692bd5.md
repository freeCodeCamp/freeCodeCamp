...
After the DRI `form-group`, add two more `div` elements each with the class name `form-group` inside `stats-grid`, one for DEF and the other for PHY.
...
Your should add another set of two `div` elements each with the class name `form-group` inside the `div` of class name `stats-grid`.
...
Your fifth `div` element of class name `form-group` should have a `label` with an `htmlFor` attribute of `def`, a class name of `label`, and a text `DEF`.
...
Your fifth `div` element of class name `form-group` should have an `input` with a class name of `input`, an`id` of `def` and a `type` of `number`.
...
Your sixth `div` element of class name `form-group` should have a `label` with an `htmlFor` attribute of `phy`, a class name of `label`, and a text `PHY`.
...
Your fourth `div` element of class name `form-group` should have an `input` with a class name of `input`, an`id` of `phy` and a `type` of `number`.
