...
To start, you'll create an abstract base class for all bugs. Abstract classes cannot be instantiated directly and are meant to be extended by other classes.
