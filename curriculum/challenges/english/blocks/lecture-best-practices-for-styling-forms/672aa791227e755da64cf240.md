...
To have the error message dynamically update, you would need to use JavaScript for that which you will learn about in future lessons. 
...
As you give your element your personal flair you want to be sure that state is still noticeable and that it does not look similar to the focus indicator. With all this in mind you can now create captivating user forms.
