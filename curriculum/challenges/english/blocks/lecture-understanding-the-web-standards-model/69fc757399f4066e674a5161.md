...
1. ## Finalization
    Once all independent implementations pass the tests, the feature is finalized. For W3C, it is a recommendation, for TC39, it is stage 4, and it is a stable entry in the WHATWG living standard. The flags come down and the feature ships to users. At this point, it becomes part of the baseline web platform, something every developer can rely on indefinitely.
