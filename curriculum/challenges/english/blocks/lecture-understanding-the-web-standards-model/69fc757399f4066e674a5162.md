...
1. ## Accessibility
    The web was designed to be usable by everyone, regardless of ability. Accessibility isn't an add-on to web standards, it is baked into the design of HTML, CSS, and browser behavior, and the W3C's WCAG guidelines set the formal bar for what accessible means in practice. A feature that creates barriers for people using screen readers, keyboard navigation, or assistive technology is considered deficient by design, not just by ethics.
