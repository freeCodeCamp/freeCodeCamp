...
These instructions are called web standards. And the groups responsible for setting them are called standards bodies. Take a look at them as the legislators of the internet.
...
**European Computers Manufacturing Association**, ECMA, is a general-purpose standards body, originally founded for computing hardware, that today formally publishes and owns the official standard that JavaScript is based on. It handles the institutional and legal scaffolding, like versioning, publication, and formal recognition. The actual technical work is delegated entirely to one of its committees, **TC39**.
