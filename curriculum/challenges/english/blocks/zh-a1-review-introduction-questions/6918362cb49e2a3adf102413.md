...
- `请问，你是设计师吗？(qǐng wèn nǐ shì shè jì shī ma)` – Excuse me, are you a designer?
...
Speaker B: `是的，我是设计师。(shì de, wǒ shì shè jì shī)` – Yes, I am a designer. / `我不是设计师。(wǒ bù shì shè jì shī)` – I'm not a designer.
...
- `我是中国人。你呢？(wǒ shì zhōng guó rén nǐ ne)` – I am Chinese. And you?

- `我是数据分析师。你呢？(wǒ shì shù jù fēn xī shī nǐ ne)` – I'm a data analyst. How about you?
