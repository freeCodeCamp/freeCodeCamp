...
## Using Methods of the Crypto Module
...
Other crypto methods for data transformation are `sign()` and `verify()`. 
...
## Generating Random Values and Creating Secrets
...
## Other Important Crypto Module Methods
