...
The `node:buffer` module is built into Node.js, so you don't need to install it separately.

Although the `Buffer` class is available globally, Node.js recommends explicitly importing it:
