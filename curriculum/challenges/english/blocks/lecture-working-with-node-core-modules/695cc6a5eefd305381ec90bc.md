...
This is a valid callback-based way to write data to a file.
...
This is a valid promise-based way to write data to a file.
...
This is a valid synchronous way to write data to a file.
...
The `fs` module does not provide a `writeFileAsync()` method.
