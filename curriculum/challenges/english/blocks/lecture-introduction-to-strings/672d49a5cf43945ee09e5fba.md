...
Here is an example of trying to change the first character of a string, which throws an error:
...
To change the value, you assign a whole new string to the `developer` variable:
