...
When the inbox is not empty, you'll try to access the email at the given index and display it. Python's `try` statement is perfect for this - it lets you try something that might fail and handle the error gracefully.
