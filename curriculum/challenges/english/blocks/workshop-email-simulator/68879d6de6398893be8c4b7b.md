...
Now add the email body to complete the main content. In the `display_full_email` method, add another print statement in the format `Body: [body]` to show the email's content.
