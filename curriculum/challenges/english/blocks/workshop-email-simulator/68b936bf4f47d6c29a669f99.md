...
Modify the `send_email` method to add the email to the receiver's inbox by calling the `receive_email` method of the `Inbox` class. Remember that the `receiver` object will be an instance of the class `User`.
