...
<!-- [x] delte email was never defined -->
...
class Email:
    ...
    def __str__(self):
        ...
        return f"[{status}] Email from {self.sender.name}: {self.subject} | Time: {self.timestamp.strftime('%Y-%m-%d %H:%M')}"
