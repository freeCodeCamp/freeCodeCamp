...
# --description--
Every frame, snap the marker to the player's position so the minimap dot tracks them.

In `MainScene.update`, after the room detect block:
