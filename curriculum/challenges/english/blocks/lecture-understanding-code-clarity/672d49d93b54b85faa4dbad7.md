...
```js
const variableOne = 5;  // Declare a variable and assign a value
const variableTwo = 10; // Declare another variable and assign a value
```
...
```js
const a = 1;   // Statement ends here
const b = 2;   // Another statement starts here
```
