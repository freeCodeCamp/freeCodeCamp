...
The new card data should be wrapped into a new variable called `newCard`. As the data is the same shape as the interface, 
should explicitly set the type of `newCard` to `FlashCard`. 
