...
The very last component is the `FlashCardController`. Create a class using the `class` keyword called `FlashCardController`.

# --hints--

A class called `FlashCardController` should exist.

```js
assert.isFunction(FlashCardController);
```
