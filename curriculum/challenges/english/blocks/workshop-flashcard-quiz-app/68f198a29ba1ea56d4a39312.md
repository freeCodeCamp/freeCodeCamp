...
Inside of the `FlashCardController` class, define a `constructor` method. This method will be called
whenever a new `FlashCardController` class is initiated and assign proper values to the class's variables. 

# --hints--

The `FlashCardController` should have a `constructor`. 
...
There should be a `constructor` method defined inside of the `FlashCardController`. 
