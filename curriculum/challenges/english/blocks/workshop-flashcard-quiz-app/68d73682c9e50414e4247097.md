...
Create a variable called `currentCardIndex` and set it to `-1`. Then assign the `onclick` method of the `btn` variable to a
function that sets `currentCardIndex` to the `index` variable. 
