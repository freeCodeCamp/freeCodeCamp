...
- **Declaring Variables**: To declare a variable, you start with the variable name followed by the assignment operator (`=`) and followed by the value. This can be a number, string, boolean, etc. Here are some examples:
