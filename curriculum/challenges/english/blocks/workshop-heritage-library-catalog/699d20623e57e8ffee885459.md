...
You should have a function named `parseCatalog` with a `rawCards` parameter.
...
You should declare a variable named `catalog`, initialize it as an empty array, and then return it.
