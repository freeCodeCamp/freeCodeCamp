...
Congratulations! Your Heritage Library Catalog is complete.

You have built functions to parse raw catalog card strings into objects, search entries by author, group books by decade, render formatted output, validate data quality, and export to JSON and CSV.

For the final step, log the text `"Heritage Library Catalog complete!"` to the console.

# --hints--

You should log `"Heritage Library Catalog complete!"` to the console.
...
console.log("Heritage Library Catalog complete!");
```
