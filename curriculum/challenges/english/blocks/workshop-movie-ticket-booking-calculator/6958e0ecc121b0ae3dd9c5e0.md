...
You also want to display the updated value of `discount`. Below the `if...else` statement, use the `print()` function to display a message that shows `Discount:` followed by the value of `discount`. Then, check the output in the terminal.
