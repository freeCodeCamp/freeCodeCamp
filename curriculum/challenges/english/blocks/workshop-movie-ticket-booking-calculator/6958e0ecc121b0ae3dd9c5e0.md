...
You should print `Discount:` followed by the value of `discount` below your `if...else` statement.
...
print_calls = ["print('Discount:', discount)", "print(f'Discount: {discount}')", "print('Discount: ' + str(discount))", "print('Discount:', str(discount))"]
