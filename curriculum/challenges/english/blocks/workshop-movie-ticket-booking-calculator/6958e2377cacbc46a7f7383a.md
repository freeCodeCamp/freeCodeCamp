...
You should print `Extra charges:` followed by the value of `extra_charges` below your `if...else` statement.
...
print_calls = ["print('Extra charges:', extra_charges)", "print(f'Extra charges: {extra_charges}')", "print('Extra charges: ' + str(extra_charges))", "print('Extra charges:', str(extra_charges))"]
assert any(_Node(_code).is_ordered(if_stmt, pc) for pc in print_calls)
`)) })
```
