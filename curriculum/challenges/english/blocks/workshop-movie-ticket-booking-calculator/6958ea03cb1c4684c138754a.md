...
_first = _var.is_equivalent("final_price = base_price + extra_charges + service_charges - discount") 
_second = _var.is_equivalent("final_price = base_price + service_charges + extra_charges - discount") 
...
```js
({ test: () => (runPython(`
_first = """final_price = base_price + extra_charges + service_charges - discount"""
_second = """final_price = base_price + service_charges + extra_charges - discount"""
print_call = "print('Final price of ticket:', final_price)"
assert _Node(_code).is_ordered(_first, print_call) or _Node(_code).is_ordered(_second, print_call)
`)) })
```
