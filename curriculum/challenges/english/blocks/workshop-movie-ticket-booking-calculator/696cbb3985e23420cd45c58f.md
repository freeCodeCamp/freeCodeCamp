...
You should assign the integer value `3` to the `service_charges` variable inside your `elif` body.
...
You should print `Service charges:` followed by the value of `service_charges` below your `if...elif...else` statement.
...
print_calls = ["print('Service charges:', service_charges)", "print(f'Service charges: {service_charges}')", "print('Service charges: ' + str(service_charges))", "print('Service charges:', str(service_charges))"]
