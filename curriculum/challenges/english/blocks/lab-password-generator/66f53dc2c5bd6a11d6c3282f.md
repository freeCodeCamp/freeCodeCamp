...
```js
const password1 = new Set(generatePassword(12)).size;
const password2 = new Set(generatePassword(12)).size;
const password3 = new Set(generatePassword(12)).size;
assert.isAbove(password1 + password2 + password3, 3);
```
