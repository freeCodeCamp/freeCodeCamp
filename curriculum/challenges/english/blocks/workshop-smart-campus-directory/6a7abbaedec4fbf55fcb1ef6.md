...
To search through `programs`, you first need them as an array. 

Declare a variable called `programValues` and set it to `Object.values(normalizedData.programsById)`.
