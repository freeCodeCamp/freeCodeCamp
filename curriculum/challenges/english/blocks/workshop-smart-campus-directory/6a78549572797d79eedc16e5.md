...
Since the property names match the variable names, you can use object property shorthand: write `{ departmentsById }` instead of `{ departmentsById: departmentsById }`.
