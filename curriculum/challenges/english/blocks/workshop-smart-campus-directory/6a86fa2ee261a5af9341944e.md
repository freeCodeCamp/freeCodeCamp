...
ID-based lookup tables, and using them to power `getInstructorByEmail`, `listRoomsByBuilding`, and `renderDirectorySummary`.

This same pattern — flattening nested data into lookup tables keyed by `ID` — is used constantly in real-world applications, 
