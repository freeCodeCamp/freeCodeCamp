...
assert.match(
  __helpers.removeJSComments(code),
  /const\s+departments\s*=\s*Object\s*\.\s*keys\s*\(\s*normalizedData\.departmentsById\s*\)\s*\.\s*length/
);
```
...
assert.match(
  __helpers.removeJSComments(code),
  /const\s+programs\s*=\s*Object\s*\.\s*keys\s*\(\s*normalizedData\.programsById\s*\)\s*\.\s*length/
);
```
...
assert.match(
  __helpers.removeJSComments(code),
  /const\s+instructors\s*=\s*Object\s*\.\s*keys\s*\(\s*normalizedData\.instructorsById\s*\)\s*\.\s*length/
);
```
