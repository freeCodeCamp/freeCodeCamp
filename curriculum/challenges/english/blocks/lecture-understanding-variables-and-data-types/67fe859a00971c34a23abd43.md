...
The dynamic-typing nature of Python makes coding faster and more flexible, but it can lead to unexpected bugs because type errors are detected only when a program runs, not when the program compiles.
...
print('Set:', my_set_var) # Output order may vary
```
...
print('List:', my_list_var ) # [22, 'Hello world', 3.14, True]
```
