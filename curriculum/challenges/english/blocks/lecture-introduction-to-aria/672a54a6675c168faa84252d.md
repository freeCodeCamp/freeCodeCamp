...
Here is an example of an input with no visible label, using aria-label:
...
Here is an example illustrating this warning:

:::interactive_editor

text
<input aria-label="Username" aria-labelledby="login-label">
<label id="login-label">Login ID</label>
:::
