...
Finally, change the last value in `flex` from `100px` to `150px` in the `box` class of our `styles.css` file.

The last value represents `flex-basis`. This property sets the starting size of a flex item before it grows or shrinks.

# --hints--

Your `box` class should have a property `flex` with a value of `0 0 150px`.
