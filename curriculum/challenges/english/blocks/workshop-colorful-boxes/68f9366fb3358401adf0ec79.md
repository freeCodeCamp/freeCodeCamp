...
Now you will set the width and height of the `flex-container` class. To do this, add a `width` property with a value `70%` and `height` property with a value `600px`.
