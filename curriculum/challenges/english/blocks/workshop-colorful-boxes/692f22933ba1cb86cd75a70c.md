...
Now it's time to create the color name for the boxes. To do this, add a `p` element below the `h2` element with these color names in order: `Red`, `Orange`, `Yellow`, `Green`, `Blue`, and `Indigo`. One color for each box.
