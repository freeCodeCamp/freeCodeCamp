...
Now change the first number (flex-grow) in `flex` from `1` to `0` in the `box` class of our `styles.css` file.
...
The `box` class should have a property `flex` with a value of `0 1 100px`.
