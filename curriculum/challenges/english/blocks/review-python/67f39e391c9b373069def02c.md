...
- **Definition**: Strings in Python are immutable, which means you cannot change them after they have been created. You can use either single or double quotes. It is recommended to choose a rule and stick with it:
...
Python has additional scope rules that are not covered here.

- **Local Scope**: A variable created inside a function can only be used within that function. Function parameters are local variables too.
...
- **Global Scope**: A variable created outside a function can be used both inside and outside functions.
