...
- **`replace()`**: This string method returns a new string with all occurrences of the old string replaced by a new one.
...
- **`split()`**: This string method is used to split a string into a list using a specified separator. A separator is a string specifying where the split should happen.
...
- **`join()`**: This string method is used to join elements of an iterable into a string with a separator. An iterable is a collection of elements that can be looped over like a list, string or a tuple. 
