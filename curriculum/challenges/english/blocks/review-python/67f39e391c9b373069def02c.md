...
- **`super()` Function**: A function that lets you call a method from a parent class, when class has different implementation of the method, or it extends the method, without duplicating the code.
