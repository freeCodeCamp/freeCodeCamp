...
# --description--
Since you’re calling `initializeEventListeners()` inside the constructor, you need to define that method as well, Create the initializeEventListeners method inside the class and make it private.
