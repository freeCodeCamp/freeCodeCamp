...
You should declare function named `getRandomItem`.

```js

```

Your getRandomItem function should have parameter of `items`.
...
The index variable assigned with math.random and math.floor should use `items.length` to make sure it's with in the bound.
