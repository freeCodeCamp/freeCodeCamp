...
you should have passed singleCardBtn to the hideElements

```js

```

you should have passed multipleCardsBtn to the hideElements

```js

```

you should have passed multipleCard to the hideElements

```js

```

you should have passed text to the hideElements

```js

```

you should have passed headerTitle to the hideElements
