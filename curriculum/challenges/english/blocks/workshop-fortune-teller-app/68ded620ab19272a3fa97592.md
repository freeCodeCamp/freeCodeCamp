...
`drawingType, isReversed, shortName, img`, and for drawingType, shortName and img should have type of string and isReversed one with boolean type 
and the function return type should be string 
