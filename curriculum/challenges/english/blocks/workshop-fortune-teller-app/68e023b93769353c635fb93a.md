...
```js
const html = renderCard("past", false, "ar", "test.jpg");
const doc = new DOMParser().parseFromString(html, 'text/html');
assert.exists(doc.querySelector('div'));
```
...
assert.exists(h2);
assert.equal(h2.textContent.trim(), 'past');
```
...
const html = renderCard("past", false, "ar", "test.jpg");
const doc = new DOMParser().parseFromString(html, 'text/html');
assert.exists(doc.querySelector('figure'));
```
...
const html = renderCard("past", false, "ar", "test.jpg");
const doc = new DOMParser().parseFromString(html, 'text/html');
assert.include(doc.querySelector('figure').className, 'card_container');
const reversedHtml = renderCard("past", true, "ar", "test.jpg");
const reversedDoc = new DOMParser().parseFromString(reversedHtml, 'text/html');
assert.include(reversedDoc.querySelector('figure').className, 'reversed-card');
```
...
const html = renderCard("past", false, "ar", "test.jpg");
const doc = new DOMParser().parseFromString(html, 'text/html');
assert.equal(doc.querySelector('figure').getAttribute('data-id'), 'ar');
```
