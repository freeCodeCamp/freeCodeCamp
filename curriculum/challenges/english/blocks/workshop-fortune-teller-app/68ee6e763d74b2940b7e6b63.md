...
# --description--
 ...
 the fortune-teller-app support rendering multiple card so you have to have methond that can help to render multiple card so declare method called `multipleCardSelected`, inside it call the `hideElements` and pass the following property 
