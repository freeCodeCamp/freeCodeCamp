...
assert.exists(doc.querySelector('figure div'));
```
...
const html = renderCard("past", false, "ar", "test.jpg");
const doc = new DOMParser().parseFromString(html, 'text/html');
assert.exists(doc.querySelector('figure div.img-loader'));
```
...
const html = renderCard("past", false, "ar", "test.jpg");
const doc = new DOMParser().parseFromString(html, 'text/html');
assert.exists(doc.querySelector('figure img'));
```
...
const html = renderCard("past", false, "ar", "test.jpg");
const doc = new DOMParser().parseFromString(html, 'text/html');
const imgEl = doc.querySelector('figure img');
assert.include(imgEl.getAttribute('src'), CDN_URL);
assert.include(imgEl.getAttribute('src'), 'test.jpg');
const htmlNoImg = renderCard("past", false, "ar", "");
const docNoImg = new DOMParser().parseFromString(htmlNoImg, 'text/html');
assert.equal(docNoImg.querySelector('figure img').getAttribute('src'), LOCAL_DEFAULT_IMG);
```
