...
Now add the remaining properties to the elements object.
Make sure each property uses the `HTMLElement` type.
...
You should have declared method named `elements` with `private` sign, inside the class.

```js

```

Inside elements method `singleCardBtn` property assign to `HTMLElement`.

```js

```

Inside elements method `multipleCardsBtn` property assign to `HTMLElement`.

```js

```

Inside elements method `singleCard` property assign to `HTMLElement`.

```js

```

Inside elements method `multipleCard` property assign to `HTMLElement`.

```js

```

Inside elements method `title` property assign to `HTMLElement`.

```js

```

Inside elements method `newReadingBtn` property assign to `HTMLElement`.

```js

```

Inside elements method `fortuneContainer` property assign to `HTMLElement`.

```js

```

Inside elements method `fortuneDescription` property assign to `HTMLElement`

```js

```

Inside elements method `headerTitle` property assign to `HTMLElement`.

```js

```

Inside elements method `subTitle` property assign to `HTMLElement`.

```js

```

Inside elements method `cardTitle` property assign to `HTMLElement`.

```js

```

Inside elements method `description` property assign to HTMLElement.

```js

```

Inside elements method `text` property assign to `HTMLElement`.
