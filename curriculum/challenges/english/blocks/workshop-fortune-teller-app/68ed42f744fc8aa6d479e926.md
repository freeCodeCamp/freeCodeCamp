...
Now add the remaining properties to the elements object. Make sure each property uses the `HTMLElement` type.
`multipleCard`, `title`, `newReadingBtn`, `fortuneContainer`, `fortuneDescription`, `headerTitle`, `subTitle`,
`cardTitle`, `description`, `text`


# --hints--


Inside elements method you should have `multipleCard` property assigned to `HTMLElement`.

```js
assert.match(code, /multipleCard\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `title` property assigned to `HTMLElement`.

```js
assert.match(code, /title\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `newReadingBtn` property assigned to `HTMLElement`.

```js
assert.match(code, /newReadingBtn\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `fortuneContainer` property assigned to `HTMLElement`.

```js
assert.match(code, /fortuneContainer\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `fortuneDescription` property assigned to `HTMLElement`

```js
assert.match(code, /fortuneDescription\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `headerTitle` property assigned to `HTMLElement`.

```js
assert.match(code, /headerTitle\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `subTitle` property assigned to `HTMLElement`.

```js
assert.match(code, /subTitle\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `cardTitle` property assigned to `HTMLElement`.

```js
assert.match(code, /cardTitle\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `description` property assigned to HTMLElement.

```js
assert.match(code, /description\s*:\s*HTMLElement\s*;/);
```

Inside elements method you should have `text` property assigned to `HTMLElement`.

```js
assert.match(code, /text\s*:\s*HTMLElement\s*;/);
```
