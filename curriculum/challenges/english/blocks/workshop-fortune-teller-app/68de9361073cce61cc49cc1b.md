...
well now in a previouse lecture, you learned how that an interface is TypeScript's ability to automatically determine and assign types to variables, function returns, and expressions based on their usage and context
...
You should have declared a function named getElement.
