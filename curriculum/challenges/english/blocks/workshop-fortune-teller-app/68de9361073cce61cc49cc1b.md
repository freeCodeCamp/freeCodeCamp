...
Items<string | number>(["apple", 12,"orange"])// here we are passing union type
```
...
For this lesson, declare a function called GetElement to help select elements from the DOM. Use Generics so it can work with any element type
# --hints--
