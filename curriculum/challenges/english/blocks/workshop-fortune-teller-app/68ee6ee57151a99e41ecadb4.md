...
you should have passed fortuneContainer as first argument to showElements function

```js

```

you should have passed text as first argument to showElements function
