...
after you fetch you should have variable to parse it to json and give it type of `Deck` 
then after that inside the `cards` add the fetched data to it, inside the catch block log the error 
