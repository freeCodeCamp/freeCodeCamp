...
you should have access the multipleCardsBtn by using getElement method by passing #btn-multiple-cards.
...
you should have access the multipleCard by using getElement method by passing multiple_card.
...
you should have access the title by using getElement method by passing title.
...
you should have access the newReadingBtn by using getElement method by passing btn_reveal.
...
you should have access the fortuneContainer by using getElement method by passing fortune_container.
...
you should have access the fortuneDescription by using getElement method by passing fortune_description.
...
you should have access the headerTitle by using getElement method by passing header_title.
...
you should have access the subTitle by using getElement method by passing sub_title.

```js 
``` 


you should have access the cardTitle by using getElement method by passing desc_title.
...
you should have access the description by using getElement method by passing description.
...
you should have access the text by using getElement method by passing text.
