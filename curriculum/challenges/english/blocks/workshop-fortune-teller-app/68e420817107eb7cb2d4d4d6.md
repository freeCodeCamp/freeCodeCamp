...
assert.match(__helpers.removeJSComments(code), onErrorRegex)
```
...
assert.match(__helpers.removeJSComments(code), ifInOnErrorRegex)
```
...
assert.match(__helpers.removeJSComments(code), datasetCheckRegex)
```
...
assert.match(__helpers.removeJSComments(code), setFailedRegex)
```
...
assert.match(__helpers.removeJSComments(code), setSrcRegex)
```
...
assert.match(__helpers.removeJSComments(code), elseRemoveHiddenRegex)
```
...
assert.match(__helpers.removeJSComments(code), prevSiblingNoneInsideElse);
```
