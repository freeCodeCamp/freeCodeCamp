...
inside the multipleCardsBtn callback event you should have called multipleCardSelected.
...
inside the newReadingBtn callback event you should have called newReading.
