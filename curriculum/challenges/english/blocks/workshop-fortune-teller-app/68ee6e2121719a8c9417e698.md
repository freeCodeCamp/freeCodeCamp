...
Right after you clear `multipleCard`, inside the `singleCardSelected` method, call the `showElements` function and pass `singleCard` as the first argument and `fortuneContainer` as the second argument.
