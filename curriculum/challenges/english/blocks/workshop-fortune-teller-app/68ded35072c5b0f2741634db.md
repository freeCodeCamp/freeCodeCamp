...
You probably guessed it: you need another function that shows elements in the DOM.
Create a function similar to the previous one, but this time use `classList.remove("hidden")`.
Name this function `showElements`.
