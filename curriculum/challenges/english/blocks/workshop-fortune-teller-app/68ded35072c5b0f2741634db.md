...
You need another function that shows elements in the DOM. Similar to the last function, create a function named `showElements`. This time use `classList.remove("hidden")`.
