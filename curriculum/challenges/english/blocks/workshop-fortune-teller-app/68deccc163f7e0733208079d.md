...
Now you have a function that can select elements from the DOM. Next, create a function to hide elements from the DOM. Declare a `hideElements` function that takes `...elements` as a parameter with the type `HTMLElement[]`.
