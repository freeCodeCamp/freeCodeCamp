...
now we have function that can help us to selecet element from the DOM, so for now we are going to create function that help to hide element from the DOM, 
