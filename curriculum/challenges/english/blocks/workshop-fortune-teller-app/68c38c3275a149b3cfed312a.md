...
In this Workshop, you are going to build a fortune-telling-app step by step.

Begin by declaring an interface named Card. Inside it, add the following properties    `name` and `name_short` with type string and for `value` you should have type union of `string | number`
