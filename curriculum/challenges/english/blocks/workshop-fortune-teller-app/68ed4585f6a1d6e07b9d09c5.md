...
Inside the fetchCardsData method, use the fetch function with the following URL `${CDN_URL}/card_data.json`,
Make sure to wrap the fetch logic in a try...catch block to handle any potential errors.
