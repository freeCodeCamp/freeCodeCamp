...
```js
assert.match(code, /class\s+\w+\s*{[\s\S]*?private\s+elements\s*:\s*{[\s\S]*?}/);
```

Inside the `elements` property, the `singleCardBtn` property should be assigned the type `HTMLElement`.

```js
assert.match(code, /class\s+\w+\s*{[\s\S]*?private\s+elements\s*:\s*{[\s\S]*?singleCardBtn\s*:\s*HTMLElement\s*;[\s\S]*?}/
);
```
...
```js
assert.match(code, /class\s+\w+\s*{[\s\S]*?private\s+elements\s*:\s*{[\s\S]*?multipleCardsBtn\s*:\s*HTMLElement\s*;[\s\S]*?}/);
```

Inside the `elements` property, the `singleCard` property should be assigned the type `HTMLElement`.

```js
assert.match(code, /class\s+\w+\s*{[\s\S]*?private\s+elements\s*:\s*{[\s\S]*?singleCard\s*:\s*HTMLElement\s*;[\s\S]*?}/);
```
