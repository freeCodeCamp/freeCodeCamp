...
Inside the class, add a private `elements` property as an object. Inside it, add the properties `singleCardBtn`, `singleCard`, and `multipleCardsBtn`, each typed as `HTMLElement`.
