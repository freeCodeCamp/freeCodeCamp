...
Inside the `elements` property, `singleCardBtn` should be typed as `HTMLElement`.

```js
assert.match(__helpers.removeJSComments(code), /singleCardBtn\s*:\s*HTMLElement\s*;/);
```

Inside the `elements` property, `multipleCardsBtn` should be typed as `HTMLElement`.

```js
assert.match(__helpers.removeJSComments(code), /multipleCardsBtn\s*:\s*HTMLElement\s*;/);
```

Inside the `elements` property, `singleCard` should be typed as `HTMLElement`.

```js
assert.match(__helpers.removeJSComments(code), /singleCard\s*:\s*HTMLElement\s*;/);
```
