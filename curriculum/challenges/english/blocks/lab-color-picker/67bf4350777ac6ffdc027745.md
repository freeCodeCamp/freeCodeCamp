...
Your `#color-input`'s initial value should be managed by your `useState` hook.
...
Your `#color-picker-container` should change its background color to reflect the new value when your `#color-input` value is changed.
