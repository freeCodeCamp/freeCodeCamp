...
If you want to leave the interactive shell you can type `exit()` or press <kbd>Ctrl</kbd> + <kbd>D</kbd> for (Mac/Linux) or <kbd>Ctrl</kbd> + <kbd>Z</kbd> + <kbd>Enter</kbd> for (Windows).
