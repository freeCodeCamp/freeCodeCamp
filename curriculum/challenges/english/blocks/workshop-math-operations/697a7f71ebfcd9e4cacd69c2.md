...
Finally, use `print()` to display the string `"Each person pays:"` followed by your `each_pays` variable.
...
You should use `print()` to display the string `"Each person pays:"` followed by your `each_pays` variable.
