...
**Note:** The stack should be implemented as an object with a `collection` property (an array), since the tests expect this structure instead of a plain array.

**Objective:** Fulfill the user stories below...
