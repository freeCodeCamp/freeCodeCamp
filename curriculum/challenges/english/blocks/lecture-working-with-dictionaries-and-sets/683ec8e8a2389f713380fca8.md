...
## Applying Changes to Every Value in a Key-Value Pair
...
## Using `enumerate()` to Track a Counter
...
## Using `enumerate()` with Values and Items
...
## Customizing the Starting Count
