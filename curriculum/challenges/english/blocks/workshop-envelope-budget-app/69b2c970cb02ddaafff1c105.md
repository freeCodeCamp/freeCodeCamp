...
You'll need to know which category the expense goes in. Thankfully, you added a dropdown for the user to select a category.
...
Assign the `value` property of `entryDropdown` to a variable called `category`.
