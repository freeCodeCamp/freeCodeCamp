...
Following this same pattern, declare variables for the `number` inputs in the `#utilities` and `#entertainment` elements. Assign them the appropriate `getTotalFromInputs` calls.
