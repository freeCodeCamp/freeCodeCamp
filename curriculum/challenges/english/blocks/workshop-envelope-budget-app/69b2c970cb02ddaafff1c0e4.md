...
You need one more of these `fieldset` code blocks for `entertainment`.
...
Your fourth `fieldset` element should have an `id` set to `entertainment`.
...
Your fourth `legend` element should have the text `Entertainment`.
