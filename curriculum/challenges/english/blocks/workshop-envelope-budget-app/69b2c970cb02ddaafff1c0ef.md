...
When the user inputs their income or expense amounts, the input fields will only accept numerical values. However, if a number is entered with a `+` or `-` sign, you'll need to remove those characters.
