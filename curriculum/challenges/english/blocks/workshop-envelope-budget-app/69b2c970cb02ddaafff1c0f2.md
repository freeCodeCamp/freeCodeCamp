...
Shorthand character classes are preceded with a backslash (`\`). The character class `\s` will match any whitespace character. Add this to the end of your regex pattern.
