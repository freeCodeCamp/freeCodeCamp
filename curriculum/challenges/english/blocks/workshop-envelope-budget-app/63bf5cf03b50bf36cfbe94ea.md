...
Your next step is to allow users to add entries to the envelope budgeter. Declare an empty function `addEntry`. This function should not take any parameters.
