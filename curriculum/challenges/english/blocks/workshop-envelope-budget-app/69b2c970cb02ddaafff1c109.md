...
Each entry will have a text input for the entry's name, and a number input for the budget. To get a count of the number of entries, you can query by text inputs.
