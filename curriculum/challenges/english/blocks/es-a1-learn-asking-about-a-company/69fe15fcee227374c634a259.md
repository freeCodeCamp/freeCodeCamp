...
Elena mentions a number in the 70s when she answers Sebastián's question.
...
Therefore, the word in the blank should be `setenta y tres`, which means "seventy three" (73).
