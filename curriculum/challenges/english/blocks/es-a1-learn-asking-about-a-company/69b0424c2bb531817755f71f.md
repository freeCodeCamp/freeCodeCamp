...
When Elena answers, she speaks in **first person** because she is talking about herself, not about the company.
...
That question would begin with `¿Cuántos...?` ("How many?"), not `¿Dónde...?`.
...
That question would begin with `¿Cómo se llama...?` ("What's the name of...?").
...
Therefore, Sebastián is asking Elena where she works.

Then, Elena replies `trabajo en una empresa de tecnología`, which means "I work at a technology company".
