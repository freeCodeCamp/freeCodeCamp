...
In this task, you will learn how to recognize third person singular structures.

When the subject is a singular noun like a company, you should use the **third person singular** verb form. For example:
...
The article `la` to match the feminine gender of the noun `empresa`.
