...
Since Python determines data types while your program is **running**, type-related mistakes are only discovered at that moment. When a program runs, Python executes your code line by line. If it reaches a line where a type mistake happens, it will stop and show an error.
...
- **Python catches type errors during execution**, when the program is actually running and using your code.
