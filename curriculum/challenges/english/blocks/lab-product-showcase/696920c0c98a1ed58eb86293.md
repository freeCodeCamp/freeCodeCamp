...
assert.exists(explorer.getInterfaces().Item);
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Item.hasTypeProp("id", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Item.hasTypeProp("price", "number"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.exists(explorer.getInterfaces().Book);
```
...
```js
// const explorer = await __helpers.Explorer(code);
// assert.isTrue(explorer.getInterfaces().Book.doesExtend("Item"));
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Book.hasTypeProp("type", "'book'"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Book.hasTypeProp("title", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Book.hasTypeProp("author", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.exists(explorer.getInterfaces().Electronics);
```
...
```js
// const explorer = await __helpers.Explorer(code);
// assert.isTrue(explorer.getInterfaces().Electronics.doesExtend("Item"));
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Electronics.hasTypeProp("type", "'electronics'"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Electronics.hasTypeProp("item", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Electronics.hasTypeProp("model", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Electronics.hasTypeProp("warranty", "number", true));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.exists(explorer.getInterfaces().Clothing);
```
...
```js
// const explorer = await __helpers.Explorer(code);
// assert.isTrue(explorer.getInterfaces().Clothing.doesExtend("Item"));
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Clothing.hasTypeProp("type", "'clothing'"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Clothing.hasTypeProp("item", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.getInterfaces().Clothing.hasTypeProp("brand", "string"));
```
