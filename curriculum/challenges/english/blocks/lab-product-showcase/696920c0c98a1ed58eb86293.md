...
assert.isTrue(explorer.hasInterface("Item"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Item").hasTypeProp("id", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Item").hasTypeProp("price", "number"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.hasInterface("Book"));
```
...
```js
// const explorer = await __helpers.Explorer(code);
// assert.isTrue(explorer.findInterface("Book").doesExtend("Item"));
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Book").hasTypeProp("type", "'book'"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Book").hasTypeProp("title", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Book").hasTypeProp("author", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.hasInterface("Electronics"));
```
...
```js
// const explorer = await __helpers.Explorer(code);
// assert.isTrue(explorer.findInterface("Electronics").doesExtend("Item"));
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Electronics").hasTypeProp("type", "'electronics'"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Electronics").hasTypeProp("item", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Electronics").hasTypeProp("model", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Electronics").hasTypeProp("warranty", "number", true));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.hasInterface("Clothing"));
```
...
```js
// const explorer = await __helpers.Explorer(code);
// assert.isTrue(explorer.findInterface("Clothing").doesExtend("Item"));
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Clothing").hasTypeProp("type", "'clothing'"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Clothing").hasTypeProp("item", "string"));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.isTrue(explorer.findInterface("Clothing").hasTypeProp("brand", "string"));
```
