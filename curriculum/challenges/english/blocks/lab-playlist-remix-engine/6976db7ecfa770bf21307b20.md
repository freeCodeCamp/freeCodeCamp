...
2. Your `flattenPlaylist` function should convert multiple playlists into a single list of tracks annotated with source metadata indicating where each track originated.
