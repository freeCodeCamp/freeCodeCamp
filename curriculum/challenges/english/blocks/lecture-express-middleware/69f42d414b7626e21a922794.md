...
In a coming lesson on error handling, you will see that Express error-handling middleware has four parameters: `err`, `req`, `res`, and `next`. This middleware is invoked when an error is passed to the `next()` function.
