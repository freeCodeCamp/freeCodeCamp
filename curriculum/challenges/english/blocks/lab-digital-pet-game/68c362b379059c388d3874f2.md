...
const isRemoved = !form;
const isDisplayNone = form && window.getComputedStyle(form).display === 'none';
const isHiddenAttr = form && form.hasAttribute('hidden');

assert.isTrue(isRemoved || isDisplayNone || isHiddenAttr);
```
