...
//  otherwise, null.
function deepMatchText(elem, regex) {
  let nodes = [elem];
...
function findFirstStatFor(targetStat) {
  const statRegEx = {
    'hunger': /.*hunger.*/i,
    'energy': /.*energy.*/i,
...
async function waitFor(fn, { timeout = 100, interval = 50} = {}) {
