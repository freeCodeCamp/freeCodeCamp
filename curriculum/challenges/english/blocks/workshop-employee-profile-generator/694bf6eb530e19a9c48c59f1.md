...
Remember that strings are immutable, so this operation does not change the original string. Instead it creates a new string and reassigns it to the variable.
