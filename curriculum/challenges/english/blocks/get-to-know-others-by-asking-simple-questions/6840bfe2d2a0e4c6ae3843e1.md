...
`Poco` means "a little" and helps describe a small amount of something. For example:

`Tengo un poco de hambre.` – I'm a little hungry.

`Cansada` is the feminine form of `cansado`, meaning "tired". It matches the speaker's gender. For example:
