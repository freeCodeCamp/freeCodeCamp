...
Chromebooks include a built-in screen reader called ChromeVox. You can access it by pressing `Ctrl + Alt + z`, or by going to _Settings > Accessibility > Text-to-Speech and toggle Enable ChromeVox (spoken feedback)_
