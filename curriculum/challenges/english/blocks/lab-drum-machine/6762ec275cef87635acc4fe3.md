...
Each `.drum-pad` should be a `button` element for accessibility.
    ...
    <div class="inner-container" id="drum-machine">
      ...
      <div class="controls-container">
        ...
        <div class="volume-slider">
          ...
          <input type="range" id="volume-control" min="0" max="1" step="0.01" value="0.3" aria-label="Volume control" />
        </div>
