    ...
    <div class="inner-container" id="drum-machine">
      ...
      <div class="controls-container">
        <div class="control power-control">
          ...
          <label class="select">
            <input type="checkbox" id="power-toggle" checked aria-label="Power toggle" />
        ...
        <div class="control bank-control">
          ...
          <label class="select">
            <input type="checkbox" id="bank-toggle" checked aria-label="Bank toggle" />
            <span class="slider"></span>
          </label>
        </div>
      </div>
...
.select input:checked + .slider::before {
  transform: translateX(30px);
}

.select input:focus + .slider {
  outline: 2px solid #ffaa33;
  outline-offset: 2px;
}
...
document.getElementById('bank-toggle').addEventListener('change', selectBank);
document
