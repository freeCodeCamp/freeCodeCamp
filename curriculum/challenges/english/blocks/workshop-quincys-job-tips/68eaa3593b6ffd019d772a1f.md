...
assert(
  html ==='—Quincy Larson, How to Learn to Code and Get a Developer Job [Full Book]' ||
  html === '&mdash;Quincy Larson, How to Learn to Code and Get a Developer Job [Full Book]' 
);
```
