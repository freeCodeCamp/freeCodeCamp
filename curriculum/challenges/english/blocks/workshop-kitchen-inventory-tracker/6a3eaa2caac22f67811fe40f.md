...
It's time for the moment of truth! You have successfully updated your global `available_eggs` variable with the new value returned by your `make_fried_egg` function.
