...
Your `make_fried_egg` function has successfully used an egg and checked if the cooking was successful. The last thing it needs to do is `return` the updated egg count so the rest of the program knows about it.
