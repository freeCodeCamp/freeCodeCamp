...
# --description--
Time for obstacles. The cactus PNG is a 24 × 32 pixel art sprite. Load it next to the hero spritesheet:
...
```js
assert.match(code, /this\.load\.image\(\s*["\']cactus["\']\s*,\s*["\']\/curriculum-assets\/phaser\/spritesheets\/cactus\.png["\']\s*\)/);
```
