...
- **`\w`**: This is used to match any word character (`a-zA-Z0-9_`) in a string. A word character is defined as any letter, from a to z, or a number from 0 to 9, or the underscore character.
