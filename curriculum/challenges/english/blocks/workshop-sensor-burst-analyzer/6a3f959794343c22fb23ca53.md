...
You are almost there! Before you move on to your fourth tool, remove the `console.log("Bursts with faulty reading:", burstsWithFault);` statement from your code.
