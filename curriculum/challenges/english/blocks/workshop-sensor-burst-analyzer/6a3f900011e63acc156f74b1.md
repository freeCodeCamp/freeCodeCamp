...
Inside `findReading`, create a copy of `burst` as `sample` using the spread operator.

# --hints--

You should create `const sample = [...burst]` inside `findReading`
