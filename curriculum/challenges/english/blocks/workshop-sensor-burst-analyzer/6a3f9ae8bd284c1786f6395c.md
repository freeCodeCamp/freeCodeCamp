...
Log `cleanedBursts` to the console to see the repaired bursts with `99` replaced by `75`.

# --hints--

You should log `cleanedBursts` to the console.
