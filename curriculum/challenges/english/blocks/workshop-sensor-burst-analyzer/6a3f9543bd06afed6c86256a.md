...
Log `burstsWithFault` to the console to confirm you have found the two bursts containing the faulty spike of `99`.

# --hints--

You should log `burstsWithFault` to the console.
