...
Now, you should work on the function that will handle choosing a shape, including showing the input fields for the selected shape and hiding those of others.

Create a `chooseShape` function with a `shapeType` parameter of type `string`.  
