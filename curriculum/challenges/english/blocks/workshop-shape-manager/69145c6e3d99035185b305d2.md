...
Add a `"rectangle"` case that returns a template literal string showing the area of a rectangle when selected. Use the formula `shape.width * shape.height`, and format it as `Area of Rectangle: ${area}`.
