...
Add a case for `"triangle"`. It should return a template literal string showing the correct area. Use the formula `0.5 * shape.base * shape.height`, and format it as `Area of Triangle: ${area}`.
