...
Now, create an `updateResult` function. Inside it, create a `shape` variable set to `shapeTypeSelect.value` and use `let` to create a `result` variable of type `string` set to an empty string.
