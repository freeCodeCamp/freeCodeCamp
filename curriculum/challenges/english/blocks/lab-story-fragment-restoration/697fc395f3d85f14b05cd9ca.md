...
`sortFragments([{ id: 30, text: "c" }, { id: 10, text: "a" }, { id: 10, text: "dup" }, { id: 20, text: "b" }])` should return `[{ id: 10, text: "a" }, { id: 10, text: "dup" }, { id: 20, text: "b" }, { id: 30, text: "c" }]`.
...
`assembleStory([{ id: 1, text: "Hello" }, { id: 2, text: "World" }])` should return the string `"Hello\nWorld"`.
