...
- **animation-timing-function**: This defines how the animation progresses over time (such asease,linear,ease-in-out).
...
- **animation-direction**: This determines whether the animation should play in thenormaldirection, inreverse, oralternatebetween the two.
