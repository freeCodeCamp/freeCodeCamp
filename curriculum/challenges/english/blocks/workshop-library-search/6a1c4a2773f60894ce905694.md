...
***Note:** If you have your browser's Developer Tools open when you click the search button, your browser will actually pause on this line!
...
```js
assert.match(__helpers.removeWhiteSpace(__helpers.removeJSComments(code)), /console\.error\(err\);debugger[;}]/);
```
