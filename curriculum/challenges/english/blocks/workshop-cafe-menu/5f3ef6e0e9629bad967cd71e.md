...
You can add a <dfn>fallback</dfn> font name for the `font-family` property by adding another font name separated by a comma. Fallbacks are used when the first font is not available.
