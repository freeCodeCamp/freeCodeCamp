...
- **Product manager:** `That's a reasonable suggestion. It will make the app easier to use.` - This person thinks improving the user interface is a good idea for usability.
