...
Select the element with the class `container`. Set its `background-color` to `#ffffff1a`. (The hex code `#ffffff1a` represents white with a low opacity. You'll learn more about hex codes later!)
