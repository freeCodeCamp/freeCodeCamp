...
Select the element with the class `description` and set its `font-size` to `1.2rem`. Select the element with the class `description` and set its `font-size` to `1.2rem`.
