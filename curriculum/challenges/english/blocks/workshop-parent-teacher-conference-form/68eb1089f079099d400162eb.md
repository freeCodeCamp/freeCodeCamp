...
Let's make the title and paragraph centered by defining the `center` class.

Select the element with the class `center` and set its `text-align` property to `center`.

# --hints--

You should target the element with the class `center`.
