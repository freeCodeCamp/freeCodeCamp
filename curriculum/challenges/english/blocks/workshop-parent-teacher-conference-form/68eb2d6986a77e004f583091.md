...
Now, let's start customizing the radio buttons. By default, radio buttons have a native browser appearance. We want to remove this so we can create a custom look.
