...
Now it is time to define what happens when the radio button is checked.

Select `.contact-method-radio-btn:checked::before`, because you are styling the inner circle only when the radio button is selected. 
...
Because you added a `transition` earlier, this change will animate smoothly — the circle will grow and fade in, giving a polished, interactive feel.

This technique lets you fully customize how radio buttons behave and look, instead of relying on the browser’s default styling.
