...
Before shutting down, you can update your health check to return a `503` status code. That way, the load balancer sees the unhealthy response and stops routing new traffic to your app during the shutdown window, as demonstrated in the code below.
...
Why would you send a `503` response from your health check during shutdown?
