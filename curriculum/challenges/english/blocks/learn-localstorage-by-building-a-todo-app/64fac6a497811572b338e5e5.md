...
After clicking the discard button, `confirmCloseDialog` should be closed.
...
After clicking the discard button, `taskForm` should be hidden.

```js
taskForm.classList.remove("hidden");
titleInput.value = "test"; dateInput.value = "2024-01-01"; descriptionInput.value = "desc";
confirmCloseDialog.showModal();
discardBtn.click();
...
After clicking the discard button, the input fields should be cleared.
