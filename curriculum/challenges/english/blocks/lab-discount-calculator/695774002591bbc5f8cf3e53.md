...
Discount calculator should work with floating numbers. `apply_discount(74.87, 5.67)` should return `70.624871`.

```js
({
  test: () => runPython(
`
result = apply_discount(74.87, 5.67)
assert round(result, 6) == 70.624871
`
  )
})
