...
For example, if the price of an item is `50` and a discount of `20` percent is applied, the discount amount is `10` (which is 20% of 50), and the final price is `40`.
