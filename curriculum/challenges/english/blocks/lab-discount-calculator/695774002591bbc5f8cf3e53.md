...
title: Apply Discount to a Price
challengeType: 27
dashedName: apply-discount-to-a-price
---
...
When `apply_discount` is called with a `price` lower than or equal to `0`, it should return `The price should greater than 0`.
