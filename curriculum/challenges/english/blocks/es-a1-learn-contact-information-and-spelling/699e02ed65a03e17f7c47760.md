...
As you saw, `repetir` means to say something again. When you add the pronoun `lo`, you are referring to something already mentioned. The pronoun replaces the specific thing (a word, a number, an email address, etc.). So:
