...
After a request like `¿Puedes repetirlo?` you can confirm in a short and natural way. Common ways to say yes include:
...
`¿Puedes repetirlo?` is a polite request formed with `poder` + infinitive.
