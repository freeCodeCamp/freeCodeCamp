...
After calling `reset()`, `titleInput.value` should be an empty string.
...
After calling `reset()`, `dateInput.value` should be an empty string.
...
After calling `reset()`, `descriptionInput.value` should be an empty string.
...
After calling `reset()`, `taskForm` should be hidden.
