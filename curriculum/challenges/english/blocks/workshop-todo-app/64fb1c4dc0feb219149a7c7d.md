...
const regex = new RegExp(
  String.raw`const\s+formInputValuesUpdated\s*=` +
  String.raw`(?=[\s\S]*\(?\s*(?:` + __helpers.permutateRegex(['currentTask\\.title', 'titleInput\\.value'], { elementsSeparator: String.raw`\s*!==?\s*` }).source + String.raw`)\s*\)?)`
)
...
const regex = new RegExp(
  String.raw`const\s+formInputValuesUpdated\s*=` +
  String.raw`(?=[\s\S]*\(?\s*(?:` + __helpers.permutateRegex(['currentTask\\.title', 'titleInput\\.value'], { elementsSeparator: String.raw`\s*!==?\s*` }).source + String.raw`)\s*\)?)` +
  String.raw`(?=[\s\S]*\(?\s*(?:` + __helpers.permutateRegex(['currentTask\\.date', 'dateInput\\.value'], { elementsSeparator: String.raw`\s*!==?\s*` }).source + String.raw`)\s*\)?)`
)
...
const regex = new RegExp(
  ...
  String.raw`(?=[\s\S]*\(?\s*(?:` + __helpers.permutateRegex(['currentTask\\.title', 'titleInput\\.value'], { elementsSeparator: String.raw`\s*!==?\s*` }).source + String.raw`)\s*\)?)` +
  String.raw`(?=[\s\S]*\(?\s*(?:` + __helpers.permutateRegex(['currentTask\\.date', 'dateInput\\.value'], { elementsSeparator: String.raw`\s*!==?\s*` }).source + String.raw`)\s*\)?)` +
  String.raw`(?=[\s\S]*\(?\s*(?:` + __helpers.permutateRegex(['currentTask\\.description', 'descriptionInput\\.value'], { elementsSeparator: String.raw`\s*!==?\s*` }).source + String.raw`)\s*\)?)` +
  String.raw`(?=[\s\S]*\|\|)`
)
