...
```js
currentTask = { title: 'test title', date: '2024-01-01', description: 'test description' };
...
When editing a task and an input value differs from the current task, clicking the close button should open the confirmation dialog.

```js
currentTask = { title: 'original title', date: '2024-01-01', description: 'original description' };
