...
const { getTaskArr } = explorer.variables;
assert.exists(getTaskArr);
assert.isTrue(getTaskArr.toString().startsWith('const'));
assert.isTrue(getTaskArr.value.matches('localStorage.getItem("data")'));
```
