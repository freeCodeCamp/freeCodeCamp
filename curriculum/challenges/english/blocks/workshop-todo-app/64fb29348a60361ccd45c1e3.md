...
Now let's see what's stored in `localStorage`. Open your browser's developer tools and navigate to the local storage section:
...
You should see the data you just stored with the key `data`. Take a moment to examine it and notice what the values look like.

When you're ready to continue, click the "Check Your Code" button to proceed to the next step.
