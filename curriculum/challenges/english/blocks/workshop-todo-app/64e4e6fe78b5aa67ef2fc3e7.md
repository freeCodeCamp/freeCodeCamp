...
```js
assert.strictEqual(discardBtn, document.getElementById('discard-btn'));
```
...
```js
assert.strictEqual(tasksContainer, document.getElementById('tasks-container'));
```
...
```js
assert.strictEqual(titleInput, document.getElementById('title-input'));
```
