...
```js
assert.strictEqual(closeTaskFormBtn, document.getElementById('close-task-form-btn'));
```
...
```js
assert.strictEqual(addOrUpdateTaskBtn, document.getElementById('add-or-update-task-btn'));
```
...
```js
assert.strictEqual(cancelBtn, document.getElementById('cancel-btn'));
```
