...
```js
assert.strictEqual(taskForm, document.getElementById('task-form'));
```
...
```js
assert.strictEqual(confirmCloseDialog, document.getElementById('confirm-close-dialog'));
```
...
```js
assert.strictEqual(openTaskFormBtn, document.getElementById('open-task-form-btn'));
```
