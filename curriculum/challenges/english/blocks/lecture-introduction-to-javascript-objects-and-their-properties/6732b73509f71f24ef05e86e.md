...
Nested object destructuring allows you to **extract values from objects within objects in a single statement**.  
This is useful when you want to directly access deeply nested properties without multiple lines of code.
