...
- **The `charCodeAt()` Method**: This method is called on a string and returns the UTF-16 code unit of the character at a specified index.
...
- **The `length` Method** : Thsi method returns the number of characters in a string.
