...
The `MediaCatalogue` class needs a method to add media items to the catalogue. Create an `add` method that accepts an item and appends it to the `items` list.
