...
A docstring is a string placed as the first statement in a class or function, and it's used to provide documentation for that class or function. Docstrings are tipically enclosed by triple double quotes:
