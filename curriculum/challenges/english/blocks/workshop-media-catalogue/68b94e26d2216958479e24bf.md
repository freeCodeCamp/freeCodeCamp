...
You should raise a `TypeError` with the message `Only Movie or TVSeries instances can be added` when `mediat_item` is not an instance of `Movie` or its subclasses.
