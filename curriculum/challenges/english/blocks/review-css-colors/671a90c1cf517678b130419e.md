...
<p>This text is red using rgb().</p>
```
...
<div>This div has a semi-transparent blue background.</div>
```
...
<p>This text is green using hsl().</p>
```
...
<h1>This heading is reddish-orange</h1>
