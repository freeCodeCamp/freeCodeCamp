...
title: Changer une variable pour une zone spécifique
challengeType: 0
...
Lorsque vous créez vos variables dans `:root`, elles définissent la valeur de cette variable pour toute la page.

Vous pouvez ensuite écraser ces variables en les redéfinissant dans un sélecteur spécifique.
 # --instructions--
