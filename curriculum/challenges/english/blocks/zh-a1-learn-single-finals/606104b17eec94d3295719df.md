...
- a single vowel, like `a` in `ma`,

- a combination of vowels, like `ou` in `mou`, or

- vowels with `n` or `ng`, like `an` in `shan` and `ong` in `gong`.
...
Pinyin is pretty magical, right? As you move through this curriculum, it will guide you whenever you meet new characters and words. Step by step, you'll unlock more of the Chinese language.
