...
This option is wrong. It first says auto-completion is automatic by saying `It is`, but then says you have to enable it manually. If it must be enabled manually, it is not automatic.
