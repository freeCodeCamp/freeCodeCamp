...
Ángela asks a question using the structure `¿Cuál es tu + noun?`, which introduces the second person singular in Spanish.

Instead of asking just one information Angela includes a second request by adding the connector `y` ("and") to add a second piece of information. Notice these elements:
...
- `y` – conjunction used to connect two nouns.
