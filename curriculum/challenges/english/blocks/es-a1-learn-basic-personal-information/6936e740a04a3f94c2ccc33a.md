...
In this task, you will hear Esteban respond at the end of a conversation. Listen carefully to the farewell he uses. It’s a common and polite way to close an interaction in Spanish.
...
What does it mean when Esteban says, `Gracias, Ángela. Hasta luego`?

## --answers--

He is saying thank you and goodbye for now.
...
- `Gracias` means "thank you" — he is expressing appreciation.

- `Hasta luego` means "see you later" or "until later" — a common and friendly farewell in Spanish.  
