...
And with that, your Fruit Search app is complete! Try it out by typing in the name of a fruit like `apple` or `pear` to see the results appear.

# --hints--

You should return an arrow function that calls `clearTimeout(timeoutId)`.
