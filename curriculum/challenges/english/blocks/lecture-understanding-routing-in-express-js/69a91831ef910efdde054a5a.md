...
Similarly, if the user visits [`http://localhost:3000/menu/food`](http://localhost:3000/menu/food), the server responds with the follwing: `You are viewing the food menu!`
