...
![Diagram showing the four nested areas of the CSS box model: content area at the center, surrounded by padding, then border, then margin](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-is-the-css-box-model-1.png)
...
![Diagram showing the padding area highlighted between the content area and the border in the CSS box model](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-is-the-css-box-model-2.png)
...
The border is the outer edge or outline of an element in the CSS box model. It's the visual boundary of the element. You can customize the border style, width, color and other properties using the `border` property. 

![Diagram showing the border highlighted as the visible outline around the padding and content area in the CSS box model](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-is-the-css-box-model-3.png)

Here's an example where we set the border to a width of five pixels, the style to solid and a color of blue: 
...
![Diagram showing the margin as the outermost space around the border in the CSS box model](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-is-the-css-box-model-4.png)
...
![Diagram showing all four components of the CSS box model together: content area, padding, border, and margin, nested inside one another](https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-is-the-css-box-model-4.png)
