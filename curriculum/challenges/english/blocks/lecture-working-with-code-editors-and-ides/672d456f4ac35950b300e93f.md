...
Use `Ctrl + Shift + F` (Windows/Linux), or `Cmd + Shift + F` (macOS), to search the text contents of all the files in your workspace. Then `Ctrl + Shift + H` (Windows/Linux), or `Cmd + Shift + H` (macOS), if you want to run a find-and-replace.
