...
const previousDeclaration = previous?.toString();
assert.isTrue(previousDeclaration?.startsWith('let'));
...
const currentDeclaration = current?.toString();
assert.isTrue(currentDeclaration?.startsWith('let'));
