...
The `__init__` function should raise a `ValueError` with the message `name, planet type, and star must be strings` if the first argument passed in is not a string type.
...
try:
  ...
  assert e == "name, planet type, and star must be strings"
else:
...
The `__init__` function should raise a `ValueError` with the message `name, planet type, and star must be strings` if the second argument passed in is not a string type.
...
The `__init__` function should raise a `ValueError` with the message `name, planet type, and star must be strings` if the third argument passed in is not a string type.
...
The `__init__` function should raise a `ValueError` with the message `name, planet_type, and star must be non-empty strings` if the first argument passed in is an empty string.
...
try:
  ...
  assert e == "name, planet_type, and star must be non-empty strings"
else:
  assert False, "Expected to raise error..."
`
    )
...
The `__init__` function should raise a `ValueError` with the message `name, planet_type, and star must be non-empty strings` if the second argument passed in is an empty string.
...
The `__init__` function should raise a `ValueError` with the message `name, planet_type, and star must be non-empty strings` if the third argument passed in is an empty string.
...
You should assign the values passed in to the instance attributes `name`, `planet_type`, and `star` in the `__init__` method.
