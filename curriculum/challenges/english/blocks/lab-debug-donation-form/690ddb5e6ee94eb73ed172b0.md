...
You should still have an `input` element with a `name` attribute of `name`.

```js
assert.exists(document.querySelector("input[name='name']"));
```

You should still have an `input` element with a `name` attribute of `email`.

```js
assert.exists(document.querySelector("input[name='email']"));
```

You should still have an `input` element with a `name` attribute of `amount`.

```js
assert.exists(document.querySelector("input[name='amount']"));
```

You should still have an `input` element with a `name` attribute of `newsletter`.

```js
assert.exists(document.querySelector("input[name='newsletter']"));
```

You should still have an `input` element with a `type` attribute of `submit`.

```js
assert.exists(document.querySelector("input[type='submit']"));
```
