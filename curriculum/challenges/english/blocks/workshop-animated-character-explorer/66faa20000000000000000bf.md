...
Frames `4..7` are the up-facing walk cycle. Below the `walk-down` animation, register `walk-up` with `start: 4, end: 7`, `frameRate: 8`, `repeat: -1`.
