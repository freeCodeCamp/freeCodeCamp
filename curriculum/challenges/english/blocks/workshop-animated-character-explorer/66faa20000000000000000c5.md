...
- when `this.cursors.up.isDown` is true, call `setVelocityY(-120)` and `anims.play("walk-up", true)`. (No flip — the up-facing frames are already drawn.)
