...
Spawn the slime patrol on the floor of the room. Below the `slime-idle` animation, assign `this.physics.add.sprite(240, 320, "slime")` to `this.slime`.
