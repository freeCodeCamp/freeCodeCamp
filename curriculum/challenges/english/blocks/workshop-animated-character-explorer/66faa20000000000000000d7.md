...
Get ready for the win condition. Below the slime overlap, set `this.cleared = false` — a flag the rest of the game will read to know when the level is over.
