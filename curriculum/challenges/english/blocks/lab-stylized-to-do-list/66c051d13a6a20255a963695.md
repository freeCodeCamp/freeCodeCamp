...
4. Your unvisited anchor elements shouldn't have any default text decoration.
...
The links on the page should have no text decoration by default.
...
assert.isTrue(
  new __helpers.CSSHelp(document).getStyle('a.sub-item-link')
    ...
    new __helpers.CSSHelp(document).getStyle('.sub-item-link')
      ?.textDecoration === 'none' ||
    new __helpers.CSSHelp(document).getStyle('a.sub-item-link:link')
      ?.textDecoration === 'none' ||
    new __helpers.CSSHelp(document).getStyle('a:link')?.textDecoration === 'none' ||
    new __helpers.CSSHelp(document).getStyle('.sub-item-link:link')
        ?.textDecoration === 'none'
);
```
