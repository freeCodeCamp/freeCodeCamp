...
const rawData = [
  ...
  "B21|Bananas|10|2027-01-01|general"
];
...
try{
  const expectedString = '{"fridge":[{"type":"restock","item":{"sku":"A10","name":"Tomatoes","qty":5,"expires":"2027-01-01","zone":"fridge"}}],"general":[{"type":"donate","item":{"sku":"B21","name":"Bananas","qty":10,"expires":"2027-01-01","zone":"general"}}]}';

  assert.deepEqual(spy.returns[0], expectedString , "Consider de use of JSON.stringify() to log the resulting objects in a proper format.");
