...
Mission control requires a method to swap two crew members' positions inside a roster. Create an empty function named `swapCrewMembers` function that accepts three parameters:
