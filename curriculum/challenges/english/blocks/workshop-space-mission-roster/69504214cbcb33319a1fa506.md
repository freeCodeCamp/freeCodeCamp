...
Use `chunkCrew()` to create chunks of `size` 3 from your `EVAReadySquad` array and store them in a new array named `EVAReadyChunks`.

# --hints--

You should store `chunkCrew(EVAReadySquad, 3)` in a new array named `EVAChunks`.
