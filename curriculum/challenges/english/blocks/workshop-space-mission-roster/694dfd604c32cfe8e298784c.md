...
Mission control has requested you to swap two astronauts' positions, specifically `squad` members at indices `2` and `5`. Use your `swapCrewMembers` function to swap them and store the result in a new array named `updatedSquad`.
