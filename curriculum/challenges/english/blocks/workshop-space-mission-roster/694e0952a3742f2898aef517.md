...
Mission control requires a method for copying EVA-eligible astronauts from a crew. First, create an empty function named `getEVAReadyCrew` that accepts a `crew` parameter.
