...
Mission control requires a method for copying EVA-Eligible astronauts from a crew. First, create an empty `getEVAReadyCrew` function that accepts a `crew` argument. Note: this function should be empty for this step.
