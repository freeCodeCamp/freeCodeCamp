...
To create a file on Windows using the Explorer, you can click on the "New" option at the top. This will show you a list of the different types of files that you can create. 
...
The process of creating folders is exactly the same. Click the "New" button at the top and then select the "Folder" option or right-click on an empty spot and go to "New." Then, select the "Folder" option. You'll see a new empty folder in your current location.
...
Once you are inside the app, you should see an option to save your file in the App menu. This menu is located at the top left, next to the Apple menu icon.
