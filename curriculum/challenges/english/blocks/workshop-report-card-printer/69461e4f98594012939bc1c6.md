...
Python is sensitive to indentation (spaces at the start of a line). In this workshop, you will not use indentation yet. Always begin typing your code at the very start of each line to avoid `IndentationError`.
