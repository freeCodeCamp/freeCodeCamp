...
Use the `type()` function with `name` as its argument and print the output like the example. Check the output in the console that shows `name` is of the type `str` (string).
