...
You will be <a href="https://codespaces.new/freeCodeCamp/boilerplate-rock-paper-scissors/" target="_blank" rel="noopener noreferrer nofollow">working on this project with our starter code</a>.
...
- `player1`: The first player function
- `player2`: The second player function
- `num_games`: The number of games to play in the match
- `verbose`: An optional argument to see a log of each game (default: `False`). Set it to `True` to see these messages.
