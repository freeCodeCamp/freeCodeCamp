...
Before we get started, two important words that you should know about are `número` ("number") and its plural form, `números` ("numbers").

You'll start by learning the numbers from 0 to 9.

Listen to their pronunciations and try to repeat them until you familiarize yourself with their sounds. We'll also cover them individually in the next tasks.
