...
Let's look at what integers and floats are, how to perform arithmetic calculations with them, and at several built-in functions Python provides for working with both.

Integers are whole numbers without decimal points, including positive numbers, negative numbers, and zero:
...
Floats represent numbers in floating-point form, including zero, like `3.14`, `-0.5`, or `0.0`.
...
Here are some other built-in functions Python provides for working with integers and floats.
...
Integers cannot be used in division operations.
...
Think about the function that always gives a non-negative result.
