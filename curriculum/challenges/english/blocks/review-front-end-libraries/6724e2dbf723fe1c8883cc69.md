...
- An export makes a component available to other files, and an import allows another file to use that component.
- In React, components can be exported using default exports or named exports.

### Default exports

- A default export is useful when a file exports one main component.
