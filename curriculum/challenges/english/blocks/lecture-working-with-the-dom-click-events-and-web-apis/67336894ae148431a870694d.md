...
In the DOM, an HTML document is represented as a tree of nodes. Many of these nodes represent HTML elements, while others can represent text, comments, or the document itself:
