...
Create a variable called `subject` and assign it the string value of `"JavaScript"`.

Then create a variable called `topic` and assign it the string value of `"strings"`.
