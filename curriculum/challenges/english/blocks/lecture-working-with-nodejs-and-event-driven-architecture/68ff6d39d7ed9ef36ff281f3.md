...
On macOS, you can install Xcode command line tools by running this command on your terminal:
...
However, for Windows itself there are a few alternatives. One of them is `nvm-windows`, a Node.js version management utility for Windows. This is a completely separate project than the official NVM project. But the purpose of these tools is the same — to help you work with multiple versions of Node.js on the same device.
