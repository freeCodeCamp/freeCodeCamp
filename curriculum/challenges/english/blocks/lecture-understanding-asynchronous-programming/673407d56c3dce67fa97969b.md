...
When we call this function, you'll see `First Printed Message!` appears first, even though it comes after the function call. This is because the function is asynchronous - it doesn't block the rest of the code from running.
