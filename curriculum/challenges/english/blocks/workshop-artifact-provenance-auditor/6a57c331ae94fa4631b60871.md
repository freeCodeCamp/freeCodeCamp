...
Declare a `currentLocation` variable and assign it the last element of the artifact's `locations` array. Use the array's `length` property to access the last index.
