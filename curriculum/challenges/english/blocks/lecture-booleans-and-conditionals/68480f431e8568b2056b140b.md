...
The preceding code will print the number 19 because the first operand `age` is truthy.
...
It is common to use the `not` operator in conditionals to check whether a value is falsy, like this:
