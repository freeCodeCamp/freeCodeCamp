...
Accessing a missing nested property without optional chaining causes a `TypeError`.
...
Optional chaining returns `undefined` instead of throwing an error when a nested property is missing.
