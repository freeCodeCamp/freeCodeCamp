...
When talking about performance, the term itself can feel a bit subjective, right? What is good performance? What is bad performance?
...
A website's performance can be classified into two different categories: perceived performance and real performance.
...
These techniques will be covered in more detail in the next few lessons.
