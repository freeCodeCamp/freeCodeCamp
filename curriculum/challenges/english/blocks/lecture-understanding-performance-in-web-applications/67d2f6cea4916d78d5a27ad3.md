...
First of all, let's open DevTools by pressing <kbd>F12</kbd> or Right-click and click on "Inspect".
...
First, we would open Chrome DevTools. We would do so, once again, by opening Google Chrome, navigating to a webpage that we want to analyze, and pressing <kbd>F12</kbd> or right-clicking the page and clicking "Inspect". Now, let's head to the "Performance" tab - and there is everything that you need.
...
By pressing <kbd>F12</kbd> or Right-clicking and selecting "Inspect".
