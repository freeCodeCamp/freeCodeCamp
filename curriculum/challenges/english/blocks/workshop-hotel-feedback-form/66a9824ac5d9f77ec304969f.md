...
The `textarea` element is a multi-line text input control. It can be used to create a comment box, a message input, or other text input that requires multiple lines.
