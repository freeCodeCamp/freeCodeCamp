...
**Important:** Before starting this project, you need to know how to run freeCodeCamp backend challenges locally.

Follow this official freeCodeCamp guide to set up Node.js, npm, and run the backend projects on your machine:
...
It stores information about your project. It consists of a single JSON object where information is stored in key-value pairs. There are only two required fields; `name` and `version`, but it's good practice to provide additional information.
