...
**Important:** Before starting, make sure you have Node.js installed locally. You can follow the setup instructions in the [freeCodeCamp guide](https://www.freecodecamp.org/news/how-to-install-node-js-and-npm-on-windows-mac-and-linux/).
...
```js
// 'code' is provided by the testing environment
