...
- **James:** `Should we order pizza for lunch?` – This person suggests the menu for lunch.

- **Phoebe:** `Yes, let's do that.` – This means the speaker agrees and wants to follow through with the suggestion.
