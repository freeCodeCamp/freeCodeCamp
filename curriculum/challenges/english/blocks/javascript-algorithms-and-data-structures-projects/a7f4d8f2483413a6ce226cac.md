...
Write a function that takes a positive integer and converts it into its corresponding **Roman numeral**.

All Roman numeral outputs should be returned in **uppercase**.
