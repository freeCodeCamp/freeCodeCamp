...
One of the simplest and most widely known <dfn>ciphers</dfn> is a <dfn>Caesar cipher</dfn>, also known as a <dfn>shift cipher</dfn>. In a shift cipher, each letter is replaced by another letter a fixed number of positions ahead in the alphabet.
