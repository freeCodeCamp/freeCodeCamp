...
`find_left_handed_seats([["O", "R", "O", "L"], ["O", "R", "R", "R"]])` should return `2`.

```js
({test: () => { runPython(`
from unittest import TestCase
TestCase().assertEqual(find_left_handed_seats([["O", "R", "O", "L"], ["O", "R", "R", "R"]]), 2)`)
}})
```

`find_left_handed_seats([["O", "O", "O", "O"], ["O", "O", "O", "O"]])` should return `8`.

```js
({test: () => { runPython(`
from unittest import TestCase
TestCase().assertEqual(find_left_handed_seats([["O", "O", "O", "O"], ["O", "O", "O", "O"]]), 8)`)
}})
```

`find_left_handed_seats([["O", "R", "O", "R"], ["L", "R", "R", "O"]])` should return `0`.

```js
({test: () => { runPython(`
from unittest import TestCase
TestCase().assertEqual(find_left_handed_seats([["O", "R", "O", "R"], ["L", "R", "R", "O"]]), 0)`)
}})
```

`find_left_handed_seats([["L", "O", "R", "R"], ["L", "O", "R", "R"]])` should return `1`.

```js
({test: () => { runPython(`
from unittest import TestCase
TestCase().assertEqual(find_left_handed_seats([["L", "O", "R", "R"], ["L", "O", "R", "R"]]), 1)`)
}})
```

`find_left_handed_seats([["O", "R", "O", "O"], ["O", "O", "L", "O"]])` should return `5`.

```js
({test: () => { runPython(`
from unittest import TestCase
TestCase().assertEqual(find_left_handed_seats([["O", "R", "O", "O"], ["O", "O", "L", "O"]]), 5)`)
}})
```
