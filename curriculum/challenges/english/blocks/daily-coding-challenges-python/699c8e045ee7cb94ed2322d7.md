...
Given an integer (`n`), where is between 1 and 1000 (inclusive), return the `n`th decimal of π.

- Make sure to return a number not a string.

π with it's first five decimals is 3.14159. So given `5` for example, return `9`, the fifth decimal.
