...
title: "Challenge 285: Meeting Start Time"
challengeType: 29
...
- Each person's availability is an array of `[start, end]` integer pairs in 24-hour time. Start times range from 0-23, and end times range from 1-24.
