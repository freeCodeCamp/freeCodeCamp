...
- `tank_size` is the total capacity of the tank in gallons.
- `fuel_level` is the current amount of fuel in the tank in gallons.
- `price_per_gallon` is the cost of one gallon of fuel.
