...
But other programming languages, like C#, do support them. However, the term "static array" means something different in C, so this is actually an example of a fixed-size array in C# that can store three integers:
