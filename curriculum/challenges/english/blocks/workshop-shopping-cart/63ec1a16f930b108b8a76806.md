...
const { totalNumberOfItems } = explorer.variables;
assert.isTrue(totalNumberOfItems?.toString().startsWith('const'));
```
...
```js
const explorer = await __helpers.Explorer(code);
const { cartSubTotal } = explorer.variables;
assert.isTrue(cartSubTotal?.toString().startsWith('const'));
```
...
```js
const explorer = await __helpers.Explorer(code);
const { cartTaxes } = explorer.variables;
assert.isTrue(cartTaxes?.toString().startsWith('const'));
```
...
```js
const explorer = await __helpers.Explorer(code);
const { cartTotal } = explorer.variables;
assert.isTrue(cartTotal?.toString().startsWith('const'));
```
