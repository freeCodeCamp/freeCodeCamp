...
12. When a user clicks the `#theme-switcher-button` and selects a theme different to the current theme, the background and font color will match the selection on the `body` element.
...
When a user clicks the `#theme-switcher-button` and selects a theme the background and font color will match the selection.
