...
To complete your simulation, call `simulateFestival()` with `nightgates` and `"Night"`.
...
assert(
  endsCorrectly,
  "At the end of your script, you must call `simulateFestival()` with `nightGates` and Night."
);
```
