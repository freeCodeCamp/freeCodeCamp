...
Which of the following is a built-in Express middleware function?
...
What is true about the order in which both built-in and third-party middleware are added with `app.use()`?

#### --distractors--

The order does not matter because Express resolves dependencies automatically.

---

Third-party middleware always runs before built-in middleware regardless of order.

---

Built-in middleware always runs before third-party middleware regardless of order.

#### --answer--

They are executed in the order they are called with `app.use()`.
