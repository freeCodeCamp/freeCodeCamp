...
Your `h1` element should have the text `Pricing Plans`.
...
Your `pricing-container` element should have the property `display` and the value `flex`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.pricing-container')?.display, 'flex');
```

Your `pricing-container` element should have the property `flex-wrap` and the value `wrap`.
...
Your `div` element should have the class `pricing-card` and the class `basic-plan`.
...
Your `div` element should have the class `pricing-card` and the class `premium-plan`.
...
Your `div` element should have the class `pricing-card` and the class `pro-plan`.
...
Your page should have a `pricing-card` selector.

```js
assert.exists(document.querySelector('.pricing-card'));
```

Your `.pricing-card` selector should have the property `display` and the value `flex`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.pricing-card')?.display, 'flex');
```

Your `.pricing-card` selector should have the property `flex-direction` and the value `column`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.pricing-card')?.flexDirection, 'column');
```

Your `.pricing-card` selector should have the property `justify-content` and the value `space-between`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.pricing-card')?.justifyContent, 'space-between');
```

Your `.pricing-card` selector should have the property `flex` and the value `0 0 200px`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.pricing-card')?.flex, '0 0 200px');
```

Your `.pricing-card` selector should have the property `border` and the value `2px solid black`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.pricing-card')?.border, '2px solid black');
```

Your `basic-plan` element should have the property `order` and the value `0`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.basic-plan')?.order, '0');
```

Your `basic-plan` element should have a `h2` element and the text `Basic`.
...
Your `basic-plan` element should have a `p` element and the text `$9/month`.
...
Your `pro-plan` element should have a `h2 element` and the text `pro`.
...
Your `pro-plan` element should have a `p` element and the text `$19/month`.
...
Your `pro-plan` element should be the second element in the layout and have the property `order` and the value `1`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.pro-plan')?.order, '1');
```

Your `pro-plan` element should be the second element in the layout and have the property `flex-grow` and the value `2`.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.pro-plan')?.flexGrow, '2');
```

Your `premium-plan` element should have a `h2` element and the text `Premium`.
...
Your `premium-plan` element should have a `p` element and the text `$29/month`.
