...
2. Your page should have a `div` element with the class `pricing-container` below the `h1` element.
    - The `.pricing-container` selector should have a `display` property with the value of `flex` and
    a `flex-wrap` property with the value of `wrap`.
...
```js
assert.exists(document.querySelector('.pricing-container'));
```

Your `pricing-container` selector should have the property `display` with a value of `flex`.

```js
assert.strictEqual(getComputedStyle(document.querySelector('.pricing-container'))?.display, 'flex');
```

Your `.pricing-container` selector should have the property `flex-wrap` with a value of `wrap`.

```js
assert.strictEqual(getComputedStyle(document.querySelector('.pricing-container'))?.flexWrap, 'wrap');
```
...
```js
assert.strictEqual(getComputedStyle(document.querySelector('.pricing-card'))?.display, 'flex');
```

Your `.pricing-card` selector should have the property `flex-direction` with a value of `column`.

```js
assert.strictEqual(getComputedStyle(document.querySelector('.pricing-card'))?.flexDirection, 'column');
```

Your `.pricing-card` selector should have the property `justify-content` with a value of `space-between`.

```js
assert.strictEqual(getComputedStyle(document.querySelector('.pricing-card'))?.justifyContent, 'space-between');
```

Your `.pricing-card` selector should have the property `flex` with a value of `0 0 200px`.

```js
assert.strictEqual(getComputedStyle(document.querySelector('.pricing-card'))?.flex, '0 0 200px');
```
...
```js
assert.strictEqual(getComputedStyle(document.querySelector('.basic-plan'))?.order, '0');
```

Your `.basic-plan` element should have a `h2` element with the text `Basic`.
...
Your `.pro-plan` element should have a `h2` element with the text `Pro`.
...
```js
assert.strictEqual(getComputedStyle(document.querySelector('.pro-plan'))?.order, '1');
```

Your `.pro-plan` element should have the property `flex-grow` with a value of `2`.

```js
assert.strictEqual(getComputedStyle(document.querySelector('.pro-plan'))?.flexGrow, '2');
```

Your `.premium-plan` element should have a `h2` element with the text `Premium`.
...
```js
assert.strictEqual(getComputedStyle(document.querySelector('.premium-plan'))?.order, '2');
```
