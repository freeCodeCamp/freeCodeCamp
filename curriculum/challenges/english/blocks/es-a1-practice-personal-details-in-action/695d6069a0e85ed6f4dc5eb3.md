...
The question `¿Cuál es tu profesión?` asks about someone's job or occupation. So you need to have a look on the `proféssion` field which says Luna is a `científica de datos`. So, to answer the question Luna would need to use the structure:
