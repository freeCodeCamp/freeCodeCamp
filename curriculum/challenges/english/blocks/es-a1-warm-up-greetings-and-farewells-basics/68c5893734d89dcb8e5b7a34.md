...
This means "See you soon", and is similar to "Hasta luego" but not the correct word here.
...
`Adiós` is a common way to say goodbye in Spanish.  
It translates to "Goodbye".
