...
In this task, Sebastián is talking about a company. Since "company" is a singular noun, he uses the third person singular form of the verb.
...
When describing a company or singular noun, use `es` because the subject is third person singular. For example:
...
`Soy` is first person singular (`yo`). The subject in this task is not "I".
...
The `es` form of the verb `ser` ("to be") is used in this case because the sentence is describing a company. For example:
