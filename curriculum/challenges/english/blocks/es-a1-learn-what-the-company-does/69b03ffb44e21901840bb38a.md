...
In this task, we are practicing a conjugation of the verb `ayudar` ("to help").

When conjugated in third person singular (`él / ella / la empresa`), this verb becomes **`ayuda`**.
