...
When the subject of a sentence is a singular noun (like `la empresa`, `el proyecto`, `la oficina`), the verb should be in third person singular.

These are some common third person singular verb endings:
