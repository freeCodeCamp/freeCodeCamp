...
If the input manifest object is valid, your `processManifest` function should also log its weight in kilograms in this format: `Total weight: ${weight} kg`. You should use your `normalizeUnits` function for this conversion before logging.
