...
As of end-2026, the browser support for the CSS `@property` rule has significantly improved and is considered widely available across all major modern browser engines. It achieved this status primarily through its inclusion in the "Baseline 2024 Newly Available" features. Full support was initially established by Chrome, Edge, and Opera (late 2022/early 2023), followed by Safari (mid-2023). Firefox solidified this cross-browser stability in early 2024 by eliminating its feature flag.
