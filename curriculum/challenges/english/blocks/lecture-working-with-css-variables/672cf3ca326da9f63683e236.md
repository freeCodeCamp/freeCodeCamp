...
The browser support for the CSS @property rule has significantly improved and is considered widely available across all major modern browser engines (like Chrome, Edge, Opera, Firefox, and Safari). It achieved robust, cross-platform stability—supported by all browsers since early 2024—primarily through its inclusion in the "Baseline 2024 Newly Available" features, making it a reliable tool for production use today.
