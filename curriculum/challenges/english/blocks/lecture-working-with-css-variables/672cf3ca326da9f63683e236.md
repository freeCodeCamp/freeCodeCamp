...
The browser support for the CSS @property rule has significantly improved and is considered widely available across all major modern browser engines ( like Chrome, Edge, Opera, Firefox, etc) as of late 2025. It achieved this robust, cross-platform stability primarily through its inclusion in the "Baseline 2024 Newly Available" features, making it a reliable tool for production use today.
