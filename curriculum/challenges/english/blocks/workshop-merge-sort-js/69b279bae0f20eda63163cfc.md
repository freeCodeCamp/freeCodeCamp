...
You should increment the current value of `sortedIndex` by one within the `while` loop. Note that the increment should be done after assigning the left part element to the sorted array.
