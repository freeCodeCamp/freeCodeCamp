...
Lets start with write the correct typings for a state of the `ResumeBuilder` main component. This  component will host all the app logic and a child components.

Also the state should recieve the object with empty fields.
