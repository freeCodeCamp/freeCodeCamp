...
Add some of tsx markup of the data fields in component body:
Add input for `FullName` field
Input should have `value` attribute set to `data.fullName`
And also should have `onChange` attribute should set to empty function
