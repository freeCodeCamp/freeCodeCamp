...
6. You  should have a class called `MotorcycleGalleryApp`. 
   ...
   3. That class should have a public function called `renderMotorcycles` that renders the equivalent motorcycle card components of the `allMotorcycles` property inside the element with id of `motorcycle-grid`. 
