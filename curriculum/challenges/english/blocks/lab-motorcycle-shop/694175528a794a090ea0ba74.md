...
5. You should create a function named `renderMotorcycleCard` that takes a single `Motorcycle` object as a parameter and returns the HTML of the motorcycle card element as formatted HTML string. 
