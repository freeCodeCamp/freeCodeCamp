...
6. You  should have a class called `MotorcycleGalleryApp`. 
   ...
   2. The class should have a `public` function named `loadData`. It should be defined as `async`, and should call to `fetchMotorcycles` and store the returned data into `allMotorcycles` class member.
