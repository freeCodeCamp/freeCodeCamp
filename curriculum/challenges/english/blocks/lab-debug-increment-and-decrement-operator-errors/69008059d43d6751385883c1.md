...
assert.equal(explorer.variables.updatedCounter.value.toString(), "++counter");
...
assert.equal(explorer.variables.finalScore.value.toString(), "score++");
...
assert.equal(explorer.variables.updatedCoins.value.toString(), "--coins");
...
assert.equal(explorer.variables.newHealth.value.toString(), "health--");
