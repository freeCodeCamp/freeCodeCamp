...
_Node(_code).has_call("print('Dots in email: ' + str(dot_count))") or
_Node(_code).has_call("print('Dots in email:', dot_count)")
)
`)) })
```
...
_Node(_code).has_call("print('Dashes in code: ' + str(dash_count))") or
_Node(_code).has_call("print('Dashes in code:', dash_count)")
)
`)) })
```
