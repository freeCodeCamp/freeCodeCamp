...
1. Press <kbd>F5</kbd> or go to Run > Start Debugging
...
- **Continue (<kbd>F5</kbd>)**: Resume execution until the next breakpoint

- **Step Over (<kbd>F10</kbd>)**: Execute the current line and move to the next

- **Step Into (<kbd>F11</kbd>)**: Enter into function calls

- **Step Out (<kbd>Shift</kbd> + <kbd>F11</kbd>)**: Exit the current function
