...
Focus on the company details mentioned in the profile.
...
This is different from what Sebastián mentions.
...
This domain is not mentioned in the audio.
...
The `.` ("period") is known as `punto` in Spanish.
