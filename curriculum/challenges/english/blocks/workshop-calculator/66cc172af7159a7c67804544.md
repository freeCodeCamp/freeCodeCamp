...
const expectedStatement = "console.log(calculateProduct(13,5))";
const alternateExpectedStatement = "console.log(calculateProduct(5,13))";
assert.isTrue(
  strippedCode.includes(expectedStatement) ||
    strippedCode.includes(alternateExpectedStatement),
  `Expected ${expectedStatement} or ${alternateExpectedStatement} to be present.`
);
```
