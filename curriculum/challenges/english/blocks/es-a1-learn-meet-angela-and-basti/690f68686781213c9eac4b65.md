...
`¿Cuántos años tienes?` is the most common way to ask someone's age in Spanish. It is equivalent to "How old are you?"

Spanish expresses age using possession. That is why this phrase has a conjugation of the verb `tener` ("to have").

The formal version of this question is `¿Cuántos años tiene usted?`.
