...
<!-- (AUDIO) Ángela: Soy salvadoreña. ¿Y vos? -->
...
Previously, Ángela said `Soy de El Salvador`.

The nationality for someone from El Salvador is `salvadoreño` (masculine form) or `salvadoreña` (feminine form).
