...
If you've done this correctly, the `try` block will contain two lines of code in it and the `catch` block will contain just one line of code. Also, the `SyntaxError` will be resolved and the app should function normally.
