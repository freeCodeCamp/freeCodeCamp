...
Finally, what if there's an error and the author data fail to load? An error should be shown in the UI. That's exactly what the `.catch()` method is for – handling errors.
