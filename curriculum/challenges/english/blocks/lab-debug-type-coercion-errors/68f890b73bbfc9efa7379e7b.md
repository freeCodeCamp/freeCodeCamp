...
```js
const explorer = await __helpers.Explorer(code);
const expression = explorer.variables.thirdResult?.value?.toString() || '';
...
```js
const explorer = await __helpers.Explorer(code);
const expression = explorer.variables.fourthResult?.value?.toString() || '';
assert.notMatch(expression, /\btrue\b|\bfalse\b/);
```
...
```js
const explorer = await __helpers.Explorer(code);
const expression = explorer.variables.fifthResult?.value?.toString() || '';
...
```js
const explorer = await __helpers.Explorer(code);
const expression = explorer.variables.sixthResult?.value?.toString() || '';
