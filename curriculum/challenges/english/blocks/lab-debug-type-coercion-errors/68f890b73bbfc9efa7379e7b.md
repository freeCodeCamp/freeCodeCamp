...
assert.notInclude(fifthResult?.value?.toString(), "true")
assert.notInclude(fifthResult?.value?.toString(), "false")
```
...
assert.notInclude(sixthResult?.value?.toString(), "true")
assert.notInclude(sixthResult?.value?.toString(), "false")
```
