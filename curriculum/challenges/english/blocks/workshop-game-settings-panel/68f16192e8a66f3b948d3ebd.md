...
To finish setting up the visual effect of your checkbox, you will want to set the `font-weight` property with a value of `bold`. This will increase the visibility of the checkmark.
