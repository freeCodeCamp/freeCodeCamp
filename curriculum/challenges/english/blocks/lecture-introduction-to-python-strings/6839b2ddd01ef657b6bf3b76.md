...
A method is a function that belongs to a specific object or class. You will learn more about classes, objects, functions and methods later on. For now, know that methods have to be called on the object they belong to by writing the object followed but a dot and the method call. Python provides a number of built-in methods that you can use to manipulate strings. They include, but are not limited to, the following:
