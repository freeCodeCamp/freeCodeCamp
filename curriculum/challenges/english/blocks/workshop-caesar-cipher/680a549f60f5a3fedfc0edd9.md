...
You should set `shifted_alphabet` equal to `alphabet[shift:]` concatenated with the missing first portion of `alphabet`. Use `shift` to specify where to stop the slicing.
