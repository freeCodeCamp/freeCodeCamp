...
Remove the `print(encrypted_text)` call from your function. Then, delete the declaration of the `encrypted_text` variable from your function and return directly `text.translate(translation_table)` from your function.
