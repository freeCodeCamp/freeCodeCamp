...
In this workshop, you will create a program that implements a Caesar cipher, an encryption method that shifts letters in the alphabet to encode messages.
Start by creating a variable called `shift` and assign the value `5` to your new variable.

# --hints--

You should declare a variable called `shift`. Be sure to place the variable name at the beginning of the line.
