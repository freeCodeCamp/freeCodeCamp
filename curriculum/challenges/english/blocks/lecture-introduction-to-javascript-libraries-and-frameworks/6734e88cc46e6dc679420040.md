...
If you need to stop the local server, press <kbd>Ctrl</kbd> + <kbd>C</kbd> in the command line.

To actually see the code for this starter template, you can open the `src` folder inside your project, where you should see the `App.jsx` file.
