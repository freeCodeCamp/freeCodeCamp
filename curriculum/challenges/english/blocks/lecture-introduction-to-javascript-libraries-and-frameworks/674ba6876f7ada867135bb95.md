...
Remember that a JavaScript module is limited to only one default export.
...
When a component is exported using a named export which syntax is required to import it into another file?
...
Consider which specific type of brackets JavaScript uses to destructure.
