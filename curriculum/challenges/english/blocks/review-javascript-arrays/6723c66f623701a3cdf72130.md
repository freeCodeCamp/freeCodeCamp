...
- **`slice()` Method**: This method returns a shallow copy of a portion of the array, starting from a specified index or the entire array. If there are any sub-arrays inside the main array, a shallow copy will copy the reference to the sub-array instead of duplicating it.
