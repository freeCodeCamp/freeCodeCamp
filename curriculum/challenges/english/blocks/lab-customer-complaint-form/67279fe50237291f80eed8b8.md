...
**Note:** Check the lengths of the description fields in JavaScript using their `value.length` property. The tests set field values programmatically, so the browser does not enforce the HTML `minlength` constraint for those values. You can still use the Constraint Validation API for other checks, such as `required`, `pattern`, and numeric constraints.

# --before-all--

```js
globalThis.__setComplaintFormChecked = (field, checked) => {
...
```js
delete globalThis.__setComplaintFormChecked;
```
...
```js
__setComplaintFormChecked(document.getElementById("damaged-product"), true);
...
```js
__setComplaintFormChecked(document.getElementById("damaged-product"), false);
__setComplaintFormChecked(document.getElementById("nonconforming-product"), false);
__setComplaintFormChecked(document.getElementById("delayed-dispatch"), false);
__setComplaintFormChecked(document.getElementById("other-complaint"), false);
...
__setComplaintFormChecked(damagedProduct, true);
...
__setComplaintFormChecked(nonConfProduct, false);
const fieldset = document.getElementById("complaints-group");
...
```js
__setComplaintFormChecked(document.getElementById("other-complaint"), true);
...
```js
__setComplaintFormChecked(document.getElementById("refund"), true);
...
```js
__setComplaintFormChecked(document.getElementById("refund"), false);
__setComplaintFormChecked(document.getElementById("exchange"), false);
__setComplaintFormChecked(document.getElementById("other-solution"), false);
...
__setComplaintFormChecked(refundRadioBtn, true);
...
__setComplaintFormChecked(exchangeRadioBtn, false);
const fieldset = document.getElementById("solutions-group");
assert.equal(fieldset.style.borderColor, "red");
```
...
```js
__setComplaintFormChecked(document.getElementById("other-solution"), true);
...
quantity.value = "5";
__setComplaintFormChecked(damaged, true);
__setComplaintFormChecked(refund, true);
...
quantity.value = 5;
__setComplaintFormChecked(damaged, false);
__setComplaintFormChecked(nonConforming, false);
__setComplaintFormChecked(delayed, false);
__setComplaintFormChecked(otherC, false);
assert.isFalse(isValid(validateForm()));

// invalid complaint-description
__setComplaintFormChecked(otherC, true);
...
__setComplaintFormChecked(refund, false);
__setComplaintFormChecked(exchange, false);
__setComplaintFormChecked(otherS, false);
assert.isFalse(isValid(validateForm()));

// invalid solutions-description
__setComplaintFormChecked(otherS, true);
