...
Next, at the end of the `remove` method, decrement `self.length` by 1. 

You've successfully built a linked list data structure! In the next step, you'll test removing an element from your linked list.
