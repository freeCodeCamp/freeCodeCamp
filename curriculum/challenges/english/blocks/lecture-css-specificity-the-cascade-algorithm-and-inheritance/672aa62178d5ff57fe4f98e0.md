...
In this example, the first paragraph will be red because an ID selector has a higher specificity than classes and type selectors. The second paragraph with a class selector of `.example-para` will have a color of green. The third paragraph with both an ID selector of `#para` and a class selector of `.example-para` will have a color of red. The remaining paragraph element will have a color of blue.
...
<p id="para" class="example-para">Another paragraph</p>
<p>Yet another paragraph</p>
```
