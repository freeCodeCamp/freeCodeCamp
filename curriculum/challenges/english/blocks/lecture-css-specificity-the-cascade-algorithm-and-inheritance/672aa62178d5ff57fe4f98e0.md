...
- In this example, the first paragraph will be red because an ID selector has a higher specificity than classes and type selectors. 
- The second paragraph with a class selector of `.example-para` will have a color of green.
- The third paragraph with both an ID selector of `#para-3` and a class selector of `.example-para` will have a color of purple.
