...
What is the time complexity of appending an element to the end of a dynamic array when no resizing is needed?
...
What are edge cases in algorithm design?

#### --distractors--

Inputs that always cause runtime errors during program execution.

---

Inputs generated randomly to measure an algorithm's performance.

---

Invalid inputs that should never be considered during testing.

#### --answer--

Specific, valid inputs at the boundaries of what an algorithm should handle.

### --question--

#### --text--

What is the head node in a singly linked list?

#### --distractors--

The node located in the middle of the list.

---

The node with the largest value in the list.

---

The most recently added node in the list.

#### --answer--

The first node in the list, usually the only directly accessible node.
