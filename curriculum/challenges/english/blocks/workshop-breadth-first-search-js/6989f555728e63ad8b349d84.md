...
Inside the `else` block, you'll handle adding opening parentheses. Add an `if` statement to check if `opensUsed` is lesser than `pairs`. This ensures you don't use more opening parentheses than allowed.
