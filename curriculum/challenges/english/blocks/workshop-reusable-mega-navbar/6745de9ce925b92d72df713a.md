...
assert.equal(subMenuItems[0]?.querySelector('a')?.getAttribute('href'), '#');
assert.equal(subMenuItems[1]?.querySelector('a')?.getAttribute('href'), '#');
assert.equal(subMenuItems[2]?.querySelector('a')?.getAttribute('href'), '#');
```
