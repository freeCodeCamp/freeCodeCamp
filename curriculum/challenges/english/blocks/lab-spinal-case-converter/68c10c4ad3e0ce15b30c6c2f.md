---
id: 68c10c4ad3e0ce15b30c6c2f
title: Build a Spinal Case Converter
challengeType: 26
dashedName: build-a-spinal-case-converter
---
...
3. The `spinalCase` function should return the string in spinal case format.
4. `spinalCase("JavaScript is awesome")` should return the string `javascript-is-awesome`.
