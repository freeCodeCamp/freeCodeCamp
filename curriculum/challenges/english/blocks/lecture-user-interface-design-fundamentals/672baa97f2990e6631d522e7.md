...
- In Chrome/Edge, press **Ctrl + Shift + C**.  
  Hover over text to see the **Contrast Ratio**.

<div style="padding: 2rem; border: 1px solid #ccc; margin: 2rem 0; "> 
  <!-- 21:1 contrast -->
  <p style="color: #000000; background: #ffffff; padding: 0.5rem;">
    Black text on a white background 
  </p>

  <!-- 1.48:1 contrast -->
  <p style="color: #FF74FF; background: #78DDFF; padding: 0.5rem;">
    Purple text on a blue background 
  </p>

  <!-- 1.49:1 contrast -->
  <p style="color: #FF8888; background: #78DDFF; padding: 0.5rem;">
    Red text on a blue background
  </p>

  <!-- 3.54:1 contrast -->
  <p style="color: #D50000; background: #78DDFF; padding: 0.5rem;">
    Saturated red text on a blue background 
  </p>

  <!-- 10.34:1 contrast -->
  <p style="color: #4A0505; background: #78DDFF; padding: 0.5rem;">
    Dark red text on a blue background 
  </p>
</div>
