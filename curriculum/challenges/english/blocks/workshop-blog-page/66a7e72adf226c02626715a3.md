...
Your second paragraph should have the text of `His playful nature and boundless energy keep me on my toes. I love him so much.` Double check your spelling.

```js
const pElement = document.querySelector('#about p:last-of-type');
const text = "His playful nature and boundless energy keep me on my toes. I love him so much."
assert.strictEqual(pElement?.innerText.trim(), text);
```
