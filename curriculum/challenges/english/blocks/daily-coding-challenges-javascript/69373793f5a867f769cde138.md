...
`ticTacToe([["X", "O", "X"], ["O", "O", "X"], ["O", "X", "X"]])` should return `"X wins"`.

```js
assert.equal(ticTacToe([["X", "O", "X"], ["O", "O", "X"], ["O", "X", "X"]]), "X wins");
```

`ticTacToe([["X", "O", "X"], ["X", "X", "O"], ["O", "X", "O"]])` should return `"Draw"`.

```js
assert.equal(ticTacToe([["X", "O", "X"], ["X", "X", "O"], ["O", "X", "O"]]), "Draw");
```

`ticTacToe([["X", "X", "O"], ["X", "O", "X"], ["O", "O", "X"]])` should return `"O wins"`.

```js
assert.equal(ticTacToe([["X", "X", "O"], ["X", "O", "X"], ["O", "O", "X"]]), "O wins");
```

`ticTacToe([["X", "O", "O"], ["X", "X", "O"], ["O", "X", "X"]])` should return `"X wins"`.

```js
assert.equal(ticTacToe([["X", "O", "O"], ["X", "X", "O"], ["O", "X", "X"]]), "X wins");
```
