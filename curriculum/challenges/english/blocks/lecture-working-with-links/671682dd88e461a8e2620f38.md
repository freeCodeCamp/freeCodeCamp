...
So imagine you are on the `contact.html` page. Because the `about.html` page is in the same folder, you can use the filename directly. This is an example of using a relative file path.
