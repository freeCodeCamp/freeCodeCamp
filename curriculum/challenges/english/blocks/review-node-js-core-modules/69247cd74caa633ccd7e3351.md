...
title: NodeJS Core Modules Review
challengeType: 31
...
- **`createHmac()` Method**: Creates hash with secret key for authentication and data integrity.
...
- **`cpus()` Method**: Returns array of CPU core information.
