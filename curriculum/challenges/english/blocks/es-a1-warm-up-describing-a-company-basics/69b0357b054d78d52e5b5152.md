...
This word refers to the visual and functional creation of a product. Remember to use the letter `ñ`.
...
This word means "user". This is the person interacting with the product.

# --explanation--

`Diseño` means "design" and `usuario` means "user".
