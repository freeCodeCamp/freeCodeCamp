...
- **Maria:** `Will do. I think it will only take a couple of hours.` - This person responds with `Will do`, meaning they'll do it, and then adds `I think...` to give their estimate of how long it might take.
