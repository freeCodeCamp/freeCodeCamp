...
Other common attributes are the `src` and `alt`, or alternative, attributes, which are used to specify the source of an image and provide alternative descriptive text for the image, respectively. 
