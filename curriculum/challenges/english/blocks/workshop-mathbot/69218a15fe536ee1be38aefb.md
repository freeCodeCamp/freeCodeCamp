...
You have already created `min` and `max` variables, so no need to create new variables. 

In the next step, you will generate a random integer between these two values.
