...
const { animationContainer } = variables;
const { value } = animationContainer || {};
assert.exists(animationContainer);
assert.isTrue(value?.matches('document.getElementById("animation-container")'));
```
...
const { animationContainer } = variables;
assert.exists(animationContainer);
assert.isTrue(animationContainer?.matches('const animationContainer = document.getElementById("animation-container")') || animationContainer?.matches("const animationContainer = document.getElementById('animation-container')"));
```
