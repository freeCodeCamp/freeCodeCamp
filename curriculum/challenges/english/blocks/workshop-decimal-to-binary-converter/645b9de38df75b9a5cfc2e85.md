...
assert.isTrue(binary?.matches("let binary = ''"));
```
...
const { decimalToBinary } = explorer.allFunctions;
const { binary } = decimalToBinary?.variables ?? {};
assert.isTrue(binary?.value?.matches("''"));
```
...
const validExpressions = [
  "function decimalToBinary(input) { let binary = '' }",
  "const decimalToBinary = (input) => { let binary = '' }",
  "let decimalToBinary = (input) => { let binary = '' }",
  "const decimalToBinary = input => { let binary = '' }",
  "let decimalToBinary = input => { let binary = '' }",
  "const decimalToBinary = function(input) { let binary = '' }",
  "let decimalToBinary = function(input) { let binary = '' }"
];

const explorer = await __helpers.Explorer(code);
const { decimalToBinary } = explorer.allFunctions;
assert.isTrue(validExpressions.some(expr => decimalToBinary?.matches(expr)));
```
