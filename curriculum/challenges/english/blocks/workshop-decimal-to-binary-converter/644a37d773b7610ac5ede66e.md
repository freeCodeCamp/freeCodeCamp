...
const { decimalToBinary } = explorer.allFunctions;
const { inputs } = decimalToBinary?.variables ?? {};
assert.isTrue(inputs?.value?.matches('[]'));
```
...
const explorer = await __helpers.Explorer(code);
const { decimalToBinary } = explorer.allFunctions;
const { quotients } = decimalToBinary?.variables ?? {};
assert.exists(quotients);
```
...
const { decimalToBinary } = explorer.allFunctions;
const { quotients } = decimalToBinary?.variables ?? {};
assert.isTrue(quotients?.value?.matches('[]'));
```
...
const explorer = await __helpers.Explorer(code);
const { decimalToBinary } = explorer.allFunctions;
const { remainders } = decimalToBinary?.variables ?? {};
assert.exists(remainders);
```
...
const { decimalToBinary } = explorer.allFunctions;
const { remainders } = decimalToBinary?.variables ?? {};
assert.isTrue(remainders?.value?.matches('[]'));
```
