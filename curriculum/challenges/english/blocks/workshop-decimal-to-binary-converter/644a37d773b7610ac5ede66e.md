...
const { inputs } = decimalToBinary?.variables ?? {};
...
```js
const explorer = await __helpers.Explorer(code);
const inputsVal = explorer.allFunctions.decimalToBinary?.variables?.inputs?.value;
assert.isTrue(inputsVal?.matches('[]'));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.exists(explorer.allFunctions.decimalToBinary?.variables?.quotients);
```
...
```js
const explorer = await __helpers.Explorer(code);
const quotientsVal = explorer.allFunctions.decimalToBinary?.variables?.quotients?.value;
assert.isTrue(quotientsVal?.matches('[]'));
```
...
```js
const explorer = await __helpers.Explorer(code);
assert.exists(explorer.allFunctions.decimalToBinary?.variables?.remainders);
```
...
```js
const explorer = await __helpers.Explorer(code);
const remaindersVal = explorer.allFunctions.decimalToBinary?.variables?.remainders?.value;
assert.isTrue(remaindersVal?.matches('[]'));
```
