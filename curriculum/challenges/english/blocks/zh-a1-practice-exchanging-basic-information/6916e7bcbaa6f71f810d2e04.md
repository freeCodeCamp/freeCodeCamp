...
Wang Hua starts with a greeting `你好 (nǐ hǎo)` and says `我是王华 (wǒ shì wáng huá)`, which is a basic self-introduction. Then she asks for Liu Ming's name with `请问你叫什么名字 (qǐng wèn nǐ jiào shén me míng zì)？`.
