...
Julieta shared what she does for a living in Spanish.
...
The word `soy` comes from the verb `ser`, which means **to be.**. For example:

`Soy` - I am 

Used to describe **professions, nationalities, and personal identity**. For example:

- `Soy ingeniero.` – I am an engineer. (masculine)

- `Soy científica.` – I am a scientist. (feminine)
