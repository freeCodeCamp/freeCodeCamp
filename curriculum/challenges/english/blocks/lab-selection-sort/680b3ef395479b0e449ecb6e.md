...
1. Your `selection_sort` function should modify input list in-place, and return it once it's sorted.
1. Your `selection_sor` function should follow selection sort algorithm, swapping the smallest element from unsorted portion of list, with the first unsorted element.
...
Your `selection_sort` should modify input list in-place. You should not use any method adding, or removing items from the list.
...
Your `selection_sort` should follow selection sort algorithm, swapping the minimum value in unsorted part of list with first unsorted element.
