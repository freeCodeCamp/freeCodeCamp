...
You should declare a variable named `low` set to `0` in your `binarySearch` function.
...
You should declare a variable named `high` set to `searchList.length - 1` in your `binarySearch` function.
