...
```js
const funcStr = binarySearch.toString();
const formattedStr = funcStr.startsWith("function") ? funcStr : "function binarySearch " + funcStr;
const binSearchParams = __helpers.getFunctionParams(formattedStr);
