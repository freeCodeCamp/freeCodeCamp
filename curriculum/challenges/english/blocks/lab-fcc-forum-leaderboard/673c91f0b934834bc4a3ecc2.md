...
globalThis._testPosters = [
  { user_id: 6 },
  { user_id: 285941 },
  { user_id: 170865 }
];

globalThis._testData = {
  users: globalThis._testUsers,
  topic_list: {
    topics: [
      {
        bumped_at: '2024-04-15T16:01:26.403Z',
...
window.fetch = () =>
  Promise.resolve({ json: () => Promise.resolve(globalThis._testData) });
```
...
```js
const posters = _testPosters;
const users = [..._testUsers, { id: 20 }];
