...
1. Each img element in the string returned by the avatars function should have a src built from the avatar_template property of the matched user object, after replacing {size} with 30. If avatar_template starts with /, prepend avatarUrl directly to it.
