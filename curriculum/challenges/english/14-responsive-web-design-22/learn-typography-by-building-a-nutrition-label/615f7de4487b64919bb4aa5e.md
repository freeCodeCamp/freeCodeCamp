...
Your `Cholesterol` text should be nested in a `span`.
...
Your `0%` text should be nested in a `span`.
...
Your `Cholesterol` `span` and your `0mg` text should be nested together in a `span`.
