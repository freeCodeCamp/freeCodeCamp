...
Flexbox has a main and cross axis. The main axis is defined by `flex-direction`, which has four possible values:

- `row` (default): content direction, depending on writing mode.
- `row-reverse`: opposite to the content direction.
