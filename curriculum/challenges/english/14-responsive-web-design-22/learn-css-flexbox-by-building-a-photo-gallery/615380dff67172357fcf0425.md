...
When this property is set to `border-box`, the total width and height of an element will be calculated by including the padding and border of the element within the declared width and height.
