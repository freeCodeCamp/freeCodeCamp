...
Below your `header`, create a new `div` element and assign a class of `gallery` to it. The class of `gallery` is an identifer that will be referenced to style the image gallery and make it responsive.
