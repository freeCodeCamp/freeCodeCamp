...
To complete this challenge, add `alt` text to the images.

The alternative text should describe the image content. Screen readers announce alternative text in place of images. If the image can't be loaded, or is blocked, the alternative text is presented in place of the image.

Add an `alt` attribute to all nine images and give them text describing each. Use at least `5` letters for each `alt` text value.

**Note:** If you are unable to view the images, you may use any `alt` text you like.
