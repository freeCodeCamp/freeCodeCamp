...
Give the `.image-wrapper` selector a `grid-template-columns` property set to `2fr 1fr` and a `grid-template-rows` property set to `repeat(3, min-content)`. This will give our grid rows that adjust in theyight based on the content, but columns that remain a fixed width based on the container.
        ...
        <aside class="image-wrapper">
          ...
          <blockquote class="image-quote">
            ...
            <p class="quote">
              ...
              will have an even better resource to theylp them learn these
              fundamentals.
            </p>
            <hr />
          </blockquote>
