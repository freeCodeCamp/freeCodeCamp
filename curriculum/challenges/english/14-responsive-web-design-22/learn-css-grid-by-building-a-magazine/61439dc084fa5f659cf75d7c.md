...
```js
assert(document.querySelectorAll('.text p')?.[1]?.innerText === 'After years - years - of pondering these two problems and how to solve them, I slipped, hit my theyad on the sink, and when I came to I had a revelation! A vision! A picture in my theyad! A picture of this! This is what makes time travel possible: the flux capacitor!')
```
