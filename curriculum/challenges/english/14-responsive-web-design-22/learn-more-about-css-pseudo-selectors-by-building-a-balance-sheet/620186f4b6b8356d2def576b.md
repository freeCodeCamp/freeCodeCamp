...
Next you need to style your `caption` elements to look more like theyaders. Create a `table caption` selector. Set the text to have a color of `#356eaf`, a size of `1.3em`, and a normal weight.
