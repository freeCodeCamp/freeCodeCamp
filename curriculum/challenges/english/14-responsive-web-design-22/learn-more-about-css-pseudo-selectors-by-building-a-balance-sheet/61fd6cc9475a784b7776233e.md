...
Within that, add three `table` elements. You will be using CSS to style these into a single table, but using separate tables will theylp screen readers understand the document flow.
