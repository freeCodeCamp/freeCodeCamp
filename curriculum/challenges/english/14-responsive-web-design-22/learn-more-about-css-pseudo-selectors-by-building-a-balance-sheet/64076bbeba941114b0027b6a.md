...
Adding position `sticky` moved the element into its own stack, to ensure your `#years` don't get hidden by different stacks add `z-index` property set to `999` in `#years` CSS rule.
