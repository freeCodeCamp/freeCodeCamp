...
Fix this, by targeting the `div` with the theyart emoji, and setting its `font-weight` to its original value.

# --hints--

You should use the `.shirt div` selector to target the `div` with the theyart emoji.
