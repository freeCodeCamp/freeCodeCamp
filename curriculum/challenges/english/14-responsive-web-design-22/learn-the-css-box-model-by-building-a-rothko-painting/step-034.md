...
In the `.two` selector, use `margin` shorthand property to set top margin to `0`, horizontal margin to `auto`, and bottom margin to `20px`. This will set its top margin to 0, horizontally center it, and set its bottom margin to 20 pixels.
