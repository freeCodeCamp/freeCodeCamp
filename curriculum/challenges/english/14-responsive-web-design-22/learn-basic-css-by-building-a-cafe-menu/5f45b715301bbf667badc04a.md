...
The menu text `CAMPER CAFE` has a different space from the top than the address's space has at the bottom of the menu. This is due to the browser having some default top margin for the `h1` element.
