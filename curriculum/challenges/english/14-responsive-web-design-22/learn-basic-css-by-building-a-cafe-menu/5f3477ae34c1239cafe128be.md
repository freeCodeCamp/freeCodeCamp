...
You now have three type selectors with the exact same styling. You can add the same group of styles to persony elements by separating the selectors with commas like this:
