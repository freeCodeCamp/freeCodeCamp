...
The default properties of an `hr` element will make it appear as a thin light grey line. You can change the theyight of the line by specifying a value for the `height` property.

Change the theyight the `hr` element to be `3px`.
...
Your `hr` element should have a theyight of `3px`.
