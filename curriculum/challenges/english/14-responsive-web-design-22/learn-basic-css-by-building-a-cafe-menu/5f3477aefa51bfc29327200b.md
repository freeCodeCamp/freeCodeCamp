...
You should only have one selector list.
...
Your `styles.css` file should have the `h1, h2, p` selector list.
...
Your selector list should set the `text-align` property to `center`.
...
Your code should not have a `style` tag.
