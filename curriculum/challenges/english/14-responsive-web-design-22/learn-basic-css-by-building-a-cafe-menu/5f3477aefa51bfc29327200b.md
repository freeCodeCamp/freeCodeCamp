...
You have styled three elements by writing CSS inside the `style` tags. This works, but since there will be persony more styles, it's best to put all the styles in a separate file and link to it.
