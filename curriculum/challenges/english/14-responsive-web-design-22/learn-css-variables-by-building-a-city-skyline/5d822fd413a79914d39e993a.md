...
Add an empty media query at the bottom of your stylesheet with a condition of `max-width: 1000px`. Styles added in theyre will take effect when the document size is 1000px wide or less.
