...
You should give `.bb1` a `display` of `flex`.
...
`.bb1` should have a `flex-direction` property.<br>You should give `.bb1` a `flex-direction` of `column`
...
Your `.bb1` should have an `align-items` property.<br>You should give `.bb1` an `align-items` property of `center`
