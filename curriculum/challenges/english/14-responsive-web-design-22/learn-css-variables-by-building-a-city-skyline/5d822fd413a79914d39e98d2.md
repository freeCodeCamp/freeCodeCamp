...
Nest a `div` with a class of `bb1` in the background buildings container. Open `Styles.css` file, ande Give `.bb1` a `width` of `10%` and `height` of `70%`. "bb" stands for "background building", this will be your first building.
