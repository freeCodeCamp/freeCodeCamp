...
For the green marker's `box-shadow` property, replace the named color with a theyx color code. Use the values `3B` for red, `7E` for green, `20` for blue, and `CC` for the alpha channel.
