...
const html = document.querySelectorAll('label')?.[0]?.innerHTML.trim();
assert.equal(query.test(document.querySelectorAll('label')?.[0]?.innerHTML.trim()),true);
```
...
const html = document.querySelectorAll('label')?.[1]?.innerHTML.trim();
assert.equal(query.test(document.querySelectorAll('label')?.[1]?.innerHTML.trim()),true);
```
...
const html = document.querySelectorAll('label')?.[2]?.innerHTML.trim();
assert.equal(query.test(document.querySelectorAll('label')?.[2]?.innerHTML.trim()),true);
```
...
const html = document.querySelectorAll('label')?.[3]?.innerHTML.trim();
assert.equal(query.test(document.querySelectorAll('label')?.[3]?.innerHTML.trim()),true);
```
