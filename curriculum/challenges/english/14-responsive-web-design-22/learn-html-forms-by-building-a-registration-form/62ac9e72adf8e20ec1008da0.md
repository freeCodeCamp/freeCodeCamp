...
The last border looks a little out of place. You can select the last
element of a specific type using the `last-of-type` CSS pseudo-class, like this: 
...
You can use the `:last-of-type` pseudo-class to select all but the last element.
