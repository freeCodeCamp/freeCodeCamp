...
Change the `margin property to include `1em` on the top and bottom. Be sure to leave the right and left margins at `auto` and then set the width as described above.
