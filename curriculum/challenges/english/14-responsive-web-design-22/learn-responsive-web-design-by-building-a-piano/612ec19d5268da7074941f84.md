...
# --description--
In order to query 2 media condition, the `and` keyword is used. This one of many [logical operators](https://www.freecodecamp.org/news/media-query-css-example-max-and-min-screen-width-for-mobile-responsive-design/) that are used to construct media queries.
