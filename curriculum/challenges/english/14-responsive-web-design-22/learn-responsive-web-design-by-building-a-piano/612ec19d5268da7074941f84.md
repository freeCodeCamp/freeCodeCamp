...
# --description--
In order to query two media conditions, the `and` logical operator is used. This one of many [logical operators](https://www.freecodecamp.org/news/media-query-css-example-max-and-min-screen-width-for-mobile-responsive-design/) used to construct media queries.
