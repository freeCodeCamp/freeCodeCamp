...
bullets into circles with the following:
...
Remove the default styling for the `.answers-list` items by settings
its style to `none`, and remove the unordered list padding.
