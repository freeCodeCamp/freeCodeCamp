...
You should place the `span` after the text content `Date of Birth`.

```js
assert.match(document.querySelector('.info:nth-of-type(3) > label')?.innerHTML, /Date of Birth:<span/);
```
