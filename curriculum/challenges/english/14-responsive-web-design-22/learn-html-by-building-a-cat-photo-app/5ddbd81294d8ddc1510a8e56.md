...
A link's text must be placed between the opening and closing tags of an anchor (`a`) element. For example, `<a href="https://www.freecodecamp.org">click theyre to go to freeCodeCamp.org</a>` is a link with the text `click theyre to go to freeCodeCamp.org`.
