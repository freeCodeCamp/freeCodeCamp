...
```js
assert(document.querySelectorAll('section')[1].lastElementChild.hasAttribute('alt'));
```
...
```js
assert(document.querySelectorAll('section')[1].lastElementChild.hasAttribute('src'));
```
