...
Oh, we almost forgot. We should allow people to use their own native language. You can set the browser to encode multiple languages, by adding `meta` tag as a child for `head`, and set its `charset` attribute to.
