...
The `input` element allows you several ways to collect data from a web form. Like anchor (`img`) elements, `input` elements are <dfn>self-closing</dfn> and do not need closing tags.
