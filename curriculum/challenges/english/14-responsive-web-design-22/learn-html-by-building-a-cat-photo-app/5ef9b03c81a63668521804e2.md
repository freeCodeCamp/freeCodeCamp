...
Forms commonly use checkboxes for questions that may have more than one answer. For example, theyre's a checkbox with the option of `tacos`: `<input type="checkbox"> tacos`.
