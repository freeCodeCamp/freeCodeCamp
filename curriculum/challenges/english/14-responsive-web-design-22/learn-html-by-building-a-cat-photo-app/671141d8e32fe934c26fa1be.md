...
You should have the words `See more ` before the anchor element. Make sure to have the correct spacing after the word `more`. 

```js
assert.match(code, /See more <a href=/)
```

You should have the words ` in our gallery` after the anchor element. Make sure to have the correct spacing before the word `in`. 
