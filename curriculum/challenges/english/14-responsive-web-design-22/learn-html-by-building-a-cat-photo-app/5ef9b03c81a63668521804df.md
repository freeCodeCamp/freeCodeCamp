...
```js
assert(document.querySelector('input').hasAttribute('id'));
```
...
```js
assert(document.querySelector('input').hasAttribute('type'));
```
...
```js
assert(document.querySelector('input').id.match(/^indoor$/));
```
