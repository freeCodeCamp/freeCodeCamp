...
const paragraphElem = document.querySelectorAll("fieldset");
assert.equal(
  labelElem.textContent.replace(/\s/g, "").match(/Loving/i) &&
    paragraphElem[1].textContent.replace(/\s/g, "").toLowerCase(),
  "what'syourcat'spersonality?loving"
);
