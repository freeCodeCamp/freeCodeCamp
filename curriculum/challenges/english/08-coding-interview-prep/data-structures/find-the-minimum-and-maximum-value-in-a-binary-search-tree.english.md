...
tests:
  ...
  - text: The <code>findMin</code> method returns the minimum value in the binary search tree.
    testString: assert((function() { var test = false; if (typeof BinarySearchTree !== 'undefined') { test = new BinarySearchTree() } else { return false; }; if (typeof test.findMin !== 'function') { return false; }; addNodes(test, [4,1,7,87,34,45,73,8]); return test.findMin() == 1; })());
  - text: The <code>findMax</code> method returns the maximum value in the binary search tree.
    testString: assert((function() { var test = false; if (typeof BinarySearchTree !== 'undefined') { test = new BinarySearchTree() } else { return false; }; if (typeof test.findMax !== 'function') { return false; }; addNodes(test, [4,1,7,87,34,45,73,8]); return test.findMax() == 87; })());
...
class BinarySearchTree {
  ...
  // Add findMin method here

  // Add findMax method here
