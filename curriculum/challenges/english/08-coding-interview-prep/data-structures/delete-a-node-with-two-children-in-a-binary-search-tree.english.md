...
tests:
  ...
  - text: The <code>remove</code> method should removes nodes with two children while maintaining the binary search tree structure.
  ...
  - text: The root should be able to removable on a tree of three nodes.
