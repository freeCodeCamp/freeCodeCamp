...
tests:
  - text: Your <code>Set</code> class should have a <code>subset</code> method.
    testString: 'assert((function(){var test = new Set(); return (typeof test.subset === "function")})(), "Your <code>Set</code> class should have a <code>subset</code> method.");'
  - text: The first <code>Set()</code> should be contained in the second <code>Set</code>
    testString: 'assert((function(){var setA = new Set(); var setB = new Set(); setA.add("a"); setB.add("b"); setB.add("c"); setB.add("a"); setB.add("d"); var subsetSetAB = setA.subset(setB);return (subsetSetAB === true)})(), "The first Set() should be contained in the second Set");'
