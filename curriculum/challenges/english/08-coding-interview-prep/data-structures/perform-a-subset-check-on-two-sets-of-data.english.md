...
tests:
  ...
  - text: The first `Set` is a `subset` of the second `Set`.
  ...
  - text: The first `Set` is not a `subset` of the second `Set`
  ...
  - text: The `subset` function should return true for empty `Set`s
