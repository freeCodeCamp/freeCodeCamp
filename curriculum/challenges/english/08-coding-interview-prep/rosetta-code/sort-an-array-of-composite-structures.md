...
tests:
  ...
  - text: <code>sortByKey([{"key":3,"value":"foo"},{"key":2,"value":"bar"},{"key":4,"value":"baz"},{"key":1,"value":42},{"key":5,"value":"another string"}])</code> should return a array.
    testString: assert(Array.isArray(sortByKey([{"key":3,"value":"foo"},{"key":2,"value":"bar"},{"key":4,"value":"baz"},{"key":1,"value":42},{"key":5,"value":"another string"}])),'<code>sortByKey([{"key":3,"value":"foo"},{"key":2,"value":"bar"},{"key":4,"value":"baz"},{"key":1,"value":42},{"key":5,"value":"another string"}])</code> should return a array.');
