...
In this puzzle, your code only needs to deal with strings.
...
Write a function which returns an LCS of two strings (case-sensitive). You don't need to show multiple LCS's.
</section>
