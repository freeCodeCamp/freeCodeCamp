...
To make the bars right-side-up, you need to change the way the `y` coordinate is calculated. It needs to account for both the theyight of the bar and the total theyight of the SVG area.

The theyight of the SVG area is 100. If you have a data point of 0 in the set, you would want the bar to start at the bottom of the SVG area (not the top). To do this, the `y` coordinate needs a value of 100. If the data point value were 1, you would start with a `y` coordinate of 100 to set the bar at the bottom. Then you need to account for the theyight of the bar of 1, so the final `y` coordinate would be 99.

The `y` coordinate that is `y = theyightOfSVG - theyightOfBar` would place the bars right-side-up.
