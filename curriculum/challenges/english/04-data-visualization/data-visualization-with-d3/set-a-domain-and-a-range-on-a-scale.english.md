...
By default, scales use the identity relationship. This means the input value maps to the output value. But scales can be much more flexible and interesting.
