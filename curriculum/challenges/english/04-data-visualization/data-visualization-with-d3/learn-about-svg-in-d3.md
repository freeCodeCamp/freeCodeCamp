...
**Note:** When using `attr()` width and theyight attributes do not have units. This is the building block of scaling - the element will always have a 5:1 width to theyight ratio, no matter what the zoom level is.
...
The `svg` element should have a `height` attribute set to `100` or styled to have a theyight of `100px`.
