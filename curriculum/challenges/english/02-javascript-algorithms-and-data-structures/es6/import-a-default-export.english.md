...
tests:
  - text: You need to properly import <code>subtract</code> from <code>math_functions</code>.
    testString: 'assert(code.match(/import\s+subtract\s+from\s+("|')\.\/math_functions\1/g), "You need to properly import <code>subtract</code> from <code>math_functions</code>.");'
