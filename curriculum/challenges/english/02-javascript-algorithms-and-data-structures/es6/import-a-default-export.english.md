...
tests:
  - text: You need to properly import <code>subtract</code> from <code>"math_functions"</code>.
    testString: 'getUserInput => assert(getUserInput("index").match(/import\s+subtract\s+from\s+("|')\.\/math_functions\s*\1/g), "You need to properly import <code>subtract</code> from <code>"math_functions"</code>.");'
