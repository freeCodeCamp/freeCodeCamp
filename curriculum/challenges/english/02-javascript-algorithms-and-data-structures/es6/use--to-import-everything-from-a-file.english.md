...
The code in this file requires the contents of another file, <code>"capitalize_strings"</code>. <code>"capitalize_strings"</code> is in the same directory as the current file. Add the appropriate <code>import *</code> statement to the top of the file, using the object provided.
</section>
