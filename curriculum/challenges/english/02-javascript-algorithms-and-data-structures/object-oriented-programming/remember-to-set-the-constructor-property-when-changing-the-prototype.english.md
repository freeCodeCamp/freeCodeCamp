...
There is one crucial side effect of manually setting the prototype to a new object. It erases the <code>.constructor</code> property! This property can be used to check which function created the instance object, but since the property has been overwritten, it now gives false results:
