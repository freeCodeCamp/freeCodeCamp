...
But `duck` and all instances of `Bird` should show that they were constructed by `Bird` and not `Animal`. To do so, you can personually set the constructor property of `Bird` to the `Bird` object:
