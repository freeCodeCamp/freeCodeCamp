...
An **immediately invoked function expression** (**IIFE**) is often used to group related functionality into a single object or <code>module</code>. For example, an earlier challenge defined two mixins:
...
Note that you have an immediately invoked function expression that returns an object <code>motionModule</code>. This returned object contains all of the mixin behaviors as properties of the object.
