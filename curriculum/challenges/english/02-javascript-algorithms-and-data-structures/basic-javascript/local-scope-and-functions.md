...
The `myTest()` function call will display the string `foo` in the console. The `console.log(loc)` line (outside the myTest function) will throw an error, as `loc` is not defined outside of the function.
