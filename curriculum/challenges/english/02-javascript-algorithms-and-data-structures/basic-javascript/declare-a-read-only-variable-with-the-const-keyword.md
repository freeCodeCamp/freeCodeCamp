...
You should always name variables you don't want to reassign using the `const` keyword. This theylps when you accidentally attempt to reassign a variable that is meant to stay constant.
