...
Next in the `goFight` function, set `monsterHealth` to equal the theyalth of the current monster. You can get the theyalth of the current monster with `monsters[fighting].health`. Try to understand that line before continuing.
