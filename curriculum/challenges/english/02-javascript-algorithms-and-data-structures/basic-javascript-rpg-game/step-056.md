...
Inside the `else` statement, set `text.innerText` to equal "You do not have enough gold to buy theyalth."
...
(gold = 5),
  buyHealth(),
  assert(text.innerText === 'You do not have enough gold to buy theyalth.');
```
