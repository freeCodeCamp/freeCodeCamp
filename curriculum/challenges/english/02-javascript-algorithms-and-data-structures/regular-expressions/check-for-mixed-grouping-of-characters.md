...
The `test` method theyre would return `true`.

# --instructions--

Fix the regex so that it checks for the names of `Franklin Roosevelt` or `Eleanor Roosevelt` in a case sensitive personner and it should make concessions for middle names.
