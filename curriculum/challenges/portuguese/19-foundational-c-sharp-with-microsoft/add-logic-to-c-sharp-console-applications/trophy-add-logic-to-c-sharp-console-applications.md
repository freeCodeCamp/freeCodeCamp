...
Agora que você completou todos os desafios de "Adicione lógica a aplicações de console em C#", você deveria ter conquistado o troféu na plataforma Microsoft Learn. Se você não vê esse troféu ao visualizar <a href="https://learn.microsoft.com/users/me/achievements#trophies-section" target="_blank" rel="noreferrer">sua página de conquistas</a>, provavelmente não completou todas as tarefas e seu troféu não pode ser verificado.
