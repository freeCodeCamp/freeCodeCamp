...
Uma dica mostra mais informações sobre um item em uma página quando o usuário passa o mouse por cima do item. Existem várias personeiras de adicionar uma dica a uma visualização. Este desafio usa o elemento SVG `title`.
