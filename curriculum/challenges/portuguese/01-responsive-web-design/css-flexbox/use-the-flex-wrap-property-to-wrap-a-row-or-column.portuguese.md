...
## Description
<section id="description"> Flexbox CSS tem um recurso para dividir itens flexíveis em várias linhas (ou colunas). Por padrão, um contêiner flexível acomodará todos os itens flexíveis juntos. Por exemplo, uma *row* (linha) estará toda em uma linha.
...
## Instructions
<section id="instructions"> O layout atual tem muitas caixas para uma só linha. Adicione a propriedade CSS <code>flex-wrap</code> ao elemento <code>#box-container</code> e atribua a ela um valor de *wrap*. </section>
