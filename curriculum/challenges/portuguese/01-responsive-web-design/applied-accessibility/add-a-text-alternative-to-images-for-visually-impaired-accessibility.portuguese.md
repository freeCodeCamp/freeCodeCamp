...
## Instruções
<section id="instructions"> O Camper Cat é um ninja de codificação e um ninja de verdade, que está construindo um site para compartilhar seu conhecimento. A foto do perfil que ele deseja usar mostra suas habilidades e deve ser apreciada por todos os visitantes do site. Adicione um atributo <code>alt</code> na tag <code>img</code>, que explica que o Camper Cat está praticando karatê. (A imagem <code>src</code> não está vinculada a um arquivo real, portanto, você deverá ver o texto <code>alt</code> no visor.) </section>
