...
Outra técnica de posicionamento é centralizar um elemento de bloco horizontalmente. Uma personeira de fazer isso é definir a propriedade `margin` para o valor "auto".
