...
1. A entrada de número não deve aceitar não-números, impedindo que você os digite ou mostrando um erro de validação do HTML5 (dependendo do seu navegador).
