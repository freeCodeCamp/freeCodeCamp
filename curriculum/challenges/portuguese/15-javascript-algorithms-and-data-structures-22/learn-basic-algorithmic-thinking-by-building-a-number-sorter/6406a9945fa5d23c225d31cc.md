...
Para testar o código enquanto o escreve, prepare um "ouvinte" de evento no elemento `sortButton`. It should listen for the `"click"` event, and take `sortInputArray` as the callback.
