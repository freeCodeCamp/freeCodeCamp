...
Para preaprar a lógica do projeto, use `const` e a sintaxe das arrow functions para declarar uma função `sortInputArray`. It should take a single `event` parameter.
