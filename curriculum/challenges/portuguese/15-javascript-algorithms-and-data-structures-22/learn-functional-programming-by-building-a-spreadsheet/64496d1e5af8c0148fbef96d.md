...
Agora, declare uma variável `length` e atribua a ela o comprimento do array ordenado, bem como uma variável `middle` que tenha o valor do comprimento dividido por `2`, menos `1`.

# --hints--

Você deve declarar uma variável `length` após a variável `sorted`.
...
Você deve usar `const` para declarar a variável `length`.
...
Você deve atribuir o comprimento do array `sorted` à variável `length`.
...
Você deve declarar uma variável `middle` após a variável `length`.
...
Você deve usar `const` para declarar a variável `middle`.
...
Você deve atribuir a `middle` o valor da divisão da variável `length` por `2`.
...
Você deve subtrair `1` do cálculo de `length / 2`.
