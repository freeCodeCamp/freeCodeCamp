...
Declara uma função `toNumberList`, que recebe um parâmetro `args` e retorna o resultado da divisão dos `args` por vírgulas e mapeia o array resultante para `parseFloat`.
