...
Por fim, torne a `rangeRegex` global e sem distinção entre maiúsculas e minúsculas.

# --hints--

`rangeRegex` não deve diferenciar maiúsculas de minúsculas.
...
`rangeRegex` deve ser global e não diferenciar maiúsculas de minúsculas.
