...
Declare uma variável `str2` e atribua a ela o resultado da chamada de `infixEval()`, com `noHigh` e `infix` como argumentos.
...
Você deve atribuir a `str2` o resultado da chamada de `infixEval()`.
...
Você deve passar `noHigh` como o primeiro argumento para `infixEval()`.
...
Você deve passar `infix` como o segundo argumento para `infixEval()`.
