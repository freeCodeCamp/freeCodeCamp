...
Add an `else` statement to the first `if` statement inside you `attack()` function. Na instrução `else`, use o operador `+=` para adicionar o texto `You miss.` até o final do `text.innerText`.
