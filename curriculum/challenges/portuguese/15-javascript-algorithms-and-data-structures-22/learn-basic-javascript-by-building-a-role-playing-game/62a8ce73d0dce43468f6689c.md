...
Você pode inserir variáveis em uma string com o <dfn>operador de concatenação</dfn> `+`. Update the `"You now have a new weapon."` string to say `"You now have a "` and the name of the new weapon. Lembre-se de terminar a frase com um ponto.
