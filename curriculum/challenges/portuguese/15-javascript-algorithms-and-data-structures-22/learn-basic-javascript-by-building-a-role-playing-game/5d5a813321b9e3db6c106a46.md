...
*Observação*: para todos os projetos desse currículo, você precisa ter um conhecimento básico de HTML e CSS. Se você é iniciante em HTML e CSS, confira a [Certificação de Design Responsivo para a Web](https://www.freecodecamp.org/learn/2022/responsive-web-design/) primeiro.
