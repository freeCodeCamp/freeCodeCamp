...
Em seguida, atribua aos elementos `.stat` um `padding-right` de `10px`.

# --hints--

Você deve ter um seletor `.stat`.
...
O seletor `.stat` deve ter um `padding-right` com o valor de `10px`.
