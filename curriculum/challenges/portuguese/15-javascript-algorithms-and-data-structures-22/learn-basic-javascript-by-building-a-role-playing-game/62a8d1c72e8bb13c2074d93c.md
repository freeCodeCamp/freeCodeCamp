...
A variável `currentWeapon` é o índice do array `weapons`, mas a indexação do array começa em zero. O índice do último elemento em um array é um a menos do que o tamanho do array.
