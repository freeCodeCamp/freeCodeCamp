...
The `currentWeaponIndex` variable is the index of the `weapons` array, but array indexing starts at zero. O índice do último elemento em um array é um a menos do que o tamanho do array.
