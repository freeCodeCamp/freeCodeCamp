...
Agora, precisamos de um estilo rápido. Comece dando ao `body` um `background-color` definido como `darkblue`.
...
O seletor `body` deve ter a propriedade `background-color` definida como `darkblue`.
