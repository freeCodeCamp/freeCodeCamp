...
You should assign the `#player-song-title` element to the variable `playingSong`. Não se esqueça de usar `const` para declarar a variável.
...
You should assign the `#player-song-artist` element to the variable `songArtist`. Não se esqueça de usar `const` para declarar a variável.
