...
You should assign the `#playlist-songs` element to the variable `playlistSongs`. Não se esqueça de usar `const` para declarar a variável.
...
You should assign the `#play` element to the variable `playButton`. Não se esqueça de usar `const` para declarar a variável.
...
You should assign the `#pause` element to the variable `pauseButton`. Não se esqueça de usar `const` para declarar a variável.
