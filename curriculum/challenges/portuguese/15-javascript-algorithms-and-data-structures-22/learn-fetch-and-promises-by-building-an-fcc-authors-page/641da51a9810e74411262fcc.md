...
O método `.catch()` deve usar `console.error()` para registrar `err` no console com o texto &#96`There was an error: ${err}`&#96;. Não se esqueça de usar as crases no início e no fim da string.
