...
O segundo objeto no array `products` deve ter uma propriedade `name` definida como `French Macaron`.
...
O segundo objeto no array `products` deve ter uma propriedade `category` definida como `Macaron`.
...
O sétimo objeto no array `products` deve ter uma propriedade `name` definida como `Chocolate Macarons (4 Pack)`.
...
O sétimo objeto no array `products` deve ter uma propriedade `category` definida como `Macaron`.
...
O décimo primeiro objeto no array `products` deve ter uma propriedade `name` definida como `Vanilla Macarons (5 Pack)`.
...
O décimo primeiro objeto no array `products` deve ter uma propriedade `category` definida como `Macaron`.
