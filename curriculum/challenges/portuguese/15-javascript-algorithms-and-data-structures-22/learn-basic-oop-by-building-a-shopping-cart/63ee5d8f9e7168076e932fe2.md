...
Após o elemento `h2`, crie dois elementos `p`. Dê ao primeiro a `class` `dessert-price` e o texto da variável `price` com um sinal de dólar na frente. Dê ao segundo a `class` `product-category` e o texto `Category:` seguido pelo valor da variável `category`.
...
O primeiro elemento `p` deve ter o texto da variável `price` com um sinal de dólar na frente.
...
O segundo elemento `p` deve ter o texto `Category:` seguido pelo valor da variável `category`.
