...
Assign the value of calling your new `.calculateTaxes()` method, passing `subTotal` as the argument, to the `tax` variable. Lembre-se de usar a palavra-chave `this`.
