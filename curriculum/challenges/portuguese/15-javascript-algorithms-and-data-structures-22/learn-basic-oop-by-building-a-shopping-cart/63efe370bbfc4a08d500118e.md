...
Para consertar isso, você pode usar o operador `||` para definir o valor como `0`, se ele não existir. Wrap your right-hand `totalCountPerProduct[dessert.id]` in parentheses, and add `|| 0` to the end of the expression.
