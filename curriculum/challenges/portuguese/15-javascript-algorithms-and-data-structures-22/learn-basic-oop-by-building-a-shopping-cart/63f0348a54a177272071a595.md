...
Agora, atribua ao `textContent` da variável `showHideCartSpan` o resultado de uma expressão ternária que verifica se `isCartShowing` é verdadeiro. If it is, set the `textContent` to `"Hide"`, otherwise set it to `"Show"`.
