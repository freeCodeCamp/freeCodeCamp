...
O segundo objeto no array `products` deve ter uma propriedade `name` definida como `French Macaroon`.
...
O segundo objeto no array `products` deve ter uma propriedade `category` definida como `Macaroon`.
...
O sétimo objeto no array `products` deve ter uma propriedade `name` definida como `Chocolate Macaroons (4 Pack)`.
...
O sétimo objeto no array `products` deve ter uma propriedade `category` definida como `Macaroon`.
...
O décimo primeiro objeto no array `products` deve ter uma propriedade `name` definida como `Vanilla Macaroons (5 Pack)`.
...
O décimo primeiro objeto no array `products` deve ter uma propriedade `category` definida como `Macaroon`.
