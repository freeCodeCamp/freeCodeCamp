...
Add your new `HTMLString` to the `targetInputContainer` by using the `innerHTML` property. Lembre-se de usar o operador `+=` para adicionar ao HTML existente em vez de substituí-lo.
