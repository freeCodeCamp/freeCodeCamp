...
Números triângulares, quadrados, pentagonais, hexagonais, heptagonais e octogonais são números figurativos (poligonais) e são gerados pelas seguintes fórmulas:
...
| Octogonal      | $P_8(n) = n(3n−2)$            | 1, 8, 21, 40, 65, ... |
