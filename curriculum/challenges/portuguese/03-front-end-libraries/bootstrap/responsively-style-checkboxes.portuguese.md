...
```yml
tests:
  - text: Aninhe todas as suas caixas de seleção dentro de uma <code>div</code> com a <code>row</code> da turma.
  ...
  - text: Aninhe cada uma das suas caixas de seleção dentro de sua própria <code>div</code> com a classe <code>col-xs-4</code> .
