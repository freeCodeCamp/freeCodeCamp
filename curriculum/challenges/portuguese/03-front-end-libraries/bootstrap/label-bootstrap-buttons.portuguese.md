...
```yml
tests:
  - text: 'Dê ao seu elemento de <code>button</code> com o id <code>target1</code> o texto <code>#target1</code> .'
  ...
  - text: 'Dê ao seu elemento de <code>button</code> com o id <code>target2</code> o texto <code>#target2</code> .'
  ...
  - text: 'Dê ao seu elemento de <code>button</code> com o id <code>target3</code> o texto <code>#target3</code> .'
  ...
  - text: 'Dê ao seu elemento de <code>button</code> com o ID <code>target4</code> o texto <code>#target4</code> .'
  ...
  - text: 'Dê ao seu elemento de <code>button</code> com o ID <code>target5</code> o texto <code>#target5</code> .'
  ...
  - text: 'Dê seu elemento de <code>button</code> com o id <code>target6</code> o texto <code>#target6</code> .'
