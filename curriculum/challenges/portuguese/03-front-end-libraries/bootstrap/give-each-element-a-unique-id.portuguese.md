...
```yml
tests:
  - text: Um elemento de <code>button</code> deve ter o id <code>target1</code> .
  ...
  - text: Um elemento de <code>button</code> deve ter o id <code>target2</code> .
  ...
  - text: Um elemento de <code>button</code> deve ter o id <code>target3</code> .
  ...
  - text: Um elemento de <code>button</code> deve ter o id <code>target4</code> .
  ...
  - text: Um elemento de <code>button</code> deve ter o ID <code>target5</code> .
  ...
  - text: Um elemento de <code>button</code> deve ter o ID <code>target6</code> .
