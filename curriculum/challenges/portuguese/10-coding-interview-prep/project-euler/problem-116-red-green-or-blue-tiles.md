...
Se forem escolhidos os blocos vermelhos, haverá exatamente sete personeiras de fazer isso.
...
Se escolhermos os blocos verdes, há três personeiras de fazer isso.
...
E se os blocos azuis forem escolhidos, há duas personeiras de fazer isso.
...
Assumindo que as cores não podem ser misturadas, há 7 + 3 + 2 = 12 personeiras de substituir os blocos pretos em sequência, medindo cinco unidades de comprimento. De quantas personeiras diferentes os blocos pretos em uma fileira medindo cinquenta unidades de comprimento podem ser substituídos, se as cores não podem ser misturadas e pelo menos um bloco colorido deve ser usado?
