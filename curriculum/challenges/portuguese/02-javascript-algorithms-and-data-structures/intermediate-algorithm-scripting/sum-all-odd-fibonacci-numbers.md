...
The first two numbers in the Fibonacci sequence are 0 and 1. Todo número adicional na sequência é a soma dos dois números anteriores. The first seven numbers of the Fibonacci sequence are 0, 1, 1, 2, 3, 5 and 8.
