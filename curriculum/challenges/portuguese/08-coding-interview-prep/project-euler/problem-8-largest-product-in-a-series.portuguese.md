...
```yml
tests:
  - text: <code>largestProductinaSeries(4)</code> deve retornar 5832.
    testString: 'assert.strictEqual(largestProductinaSeries(4), 5832, "<code>largestProductinaSeries(4)</code> should return 5832.");'
  - text: <code>largestProductinaSeries(13)</code> deve retornar 23514624000.
