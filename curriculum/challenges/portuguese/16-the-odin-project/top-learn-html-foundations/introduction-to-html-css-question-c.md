...
title: Questão C de Introdução ao HTML e ao CSS
challengeType: 15
...
Entre o HTML e o CSS, qual deles você deve usar para alterar a cor de fundo e a fonte de um botão?

## --answers--

Você deve usar o CSS para alterar a cor de fundo e a fonte de um botão.

---

Você deve usar o JavaScript para alterar a cor de fundo e a fonte de um botão.

---

Você deve usar o HTML para alterar a cor de fundo e fonte de um botão.
