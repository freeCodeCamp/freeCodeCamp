...
Vale a pena observar que você nomeou o seu arquivo HTML como index. Você sempre deve dar ao arquivo HTML que conterá a página inicial do seu site o nome de `index.html`. Isto acontece porque os servidores da web procurarão, por padrão, por uma página `index.html` quando os usuários acessam os sites - não ter uma página com esse nome causará grandes problemas.
