...
In English, the verb `to be` is used to talk about identities, characteristics, and more. The contraction `I'm` is a combination of `I` and `am`. Aqui, o Tom a usa para se apresentar.
