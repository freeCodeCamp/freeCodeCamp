...
Em seguida, na regra `.one`, use a função `rgb` para definir o `background-color` para preto. E na regra `.two`, use a função `rgb` para definir o `background-color` para vermelho.
