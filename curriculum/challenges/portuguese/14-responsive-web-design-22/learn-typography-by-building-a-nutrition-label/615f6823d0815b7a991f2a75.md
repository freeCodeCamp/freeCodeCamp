...
A estilização `float` está fazendo com que o novo elemento `p` fique fora da borda do rótulo. Use o elemento `.divider` existente como um exemplo para adicionar um novo divisor após o elemento `p`.

# --hints--

Você deve criar um `div` dentro do elemento `.daily-value.sm-text`.
