...
O primeiro elemento `span` `Cholesterol` deve ter o atributo `class` definido como `bold`.
...
O primeiro elemento `span` deve encapsular o texto `Cholesterol 0mg`.
...
O segundo elemento `span` deve ter o atributo `class` definido como `bold`.
