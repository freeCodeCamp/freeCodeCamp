...
Crie um seletor `.calories-info h2` e remova todas as margens.

# --hints--

Crie um seletor `.calories-info h2`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.calories-info h2'));
```

O seletor `.calories-info h2` deve ter uma `margin` definida como `0`.
