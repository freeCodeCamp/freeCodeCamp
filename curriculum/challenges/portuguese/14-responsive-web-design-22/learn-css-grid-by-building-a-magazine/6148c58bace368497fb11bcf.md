...
Muito parecido com o Flexbox, com o CSS Grid você pode alinhar o conteúdo de itens de grade com `align-items` e `justify-items`. `align-items` alinhará os elementos filhos ao longo do eixo da coluna e `justify-items` alinhará os elementos filhos ao longo do eixo da linha.
