...
Agora, vamos estilizar a segunda `section`. Observe que ela tem os valores de `text` e `text-with-images` para o atributo `class`, o que significa que já está herdando os estilos da regra `.text`.
