...
Use outro ícone de FontAwesome para `.guitar`. Dentro dos elementos `#guitar-left` e `#guitar-right`, adicione um elemento `i` e dê a ele uma `class` de `fas fa-bars`.
...
Os dois novos elementos `i` devem ter `class` definida como `fas fa-bars`.
