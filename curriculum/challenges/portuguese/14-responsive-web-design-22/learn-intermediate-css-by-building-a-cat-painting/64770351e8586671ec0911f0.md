...
**Observação**: para ver como `sticky` funciona, você tem de colocar alguns textos antes e depois do elemento `div` de `.cat-head`. Se você rolar para cima depois disso, verá que `.cat-head` fica preso na parte superior e permanece lá.
