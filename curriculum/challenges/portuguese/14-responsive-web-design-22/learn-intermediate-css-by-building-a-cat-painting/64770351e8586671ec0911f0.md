...
**Observação**: para ver como `sticky` funciona, você tem de colocar alguns textos antes e depois do elemento `div` de `.cat-head`. If you scroll down after that, you'll see that the `.cat-head` gets stuck to the top and remains there.
