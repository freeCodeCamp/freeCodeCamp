...
Por último, mas não menos importante, torne o `input` para os termos e condições `inline`. Depois, altere a cor do texto de elemento do link, `terms and conditions`, para `#dfdfe2`.
...
Você deve usar o seletor de elemento `a`.
