...
Adicione o texto `I accept the terms and conditions` ao rótulo recém-adicionado. Depois, faça um link no texto `terms and conditions` apontando para a seguinte localização:
