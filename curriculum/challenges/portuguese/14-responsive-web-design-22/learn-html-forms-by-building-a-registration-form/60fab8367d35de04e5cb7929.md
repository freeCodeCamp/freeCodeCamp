...
Add the text `I accept the terms and conditions` immediately after the `input` element in the newly added `label`. Então link o texto `terms and conditions` para o destino a seguir:
