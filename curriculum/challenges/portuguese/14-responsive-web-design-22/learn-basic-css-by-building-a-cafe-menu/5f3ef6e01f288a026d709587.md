...
Primeiro, adicione um elemento `hr` entre o elemento `p` com a classe `established` e o primeiro elemento `section`. Observe que os elementos `hr` fecham em si mesmos.
