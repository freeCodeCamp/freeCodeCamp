...
Agora você tem três tipos de seletores exatamente com o mesmo estilo. Você pode adicionar o mesmo grupo de estilos a muitos elementos, separando os seletores com vírgulas. Veja o exemplo:
...
Use um seletor de tipo único para centralizar os elementos `h1`, `h2` e `p` ao mesmo tempo.
