...
Definir o `scroll-behaviour` para `smooth` é o preferido da maioria dos usuários. No entanto, alguns usuários acham isso muito lento e preferem que a rolagem aconteça instantaneamente.
