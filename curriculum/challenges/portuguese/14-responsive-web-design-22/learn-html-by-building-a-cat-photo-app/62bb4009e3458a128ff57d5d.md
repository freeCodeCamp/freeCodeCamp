...
Tell the browser to parse the markdown into multiple languages by creating a `meta` element as a child of the `head` element. Defina o atributo `charset` como `UTF-8`.
