...
Mais uma coisa. Você deve permitir que as pessoas usem seu idioma nativo. Diga ao navegador para codificar vários idiomas adicionando uma tag `meta` como filha do elemento `head`. Defina o atributo `charset` como `UTF-8`.
