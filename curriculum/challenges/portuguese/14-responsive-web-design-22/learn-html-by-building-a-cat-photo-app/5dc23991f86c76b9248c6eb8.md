...
Os elementos do HTML costumam estar aninhados dentro de outros elementos do HTML. No passo anterior, você aninhou o elemento `h2`, o comentário e o elemento `p` dentro do elemento `main`. Um elemento aninhado é "filho" de seu elemento "pai".

Para tornar o HTML mais fácil de ler, faça a indentação do elemento `h2`, do comentário e do elemento `p` exatamente dois espaços para frente para indicar que eles são filhos do elemento `main`.
