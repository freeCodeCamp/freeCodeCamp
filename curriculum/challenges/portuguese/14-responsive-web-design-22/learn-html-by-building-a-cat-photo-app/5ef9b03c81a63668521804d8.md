...
O elemento `input` permite a você várias maneiras de coletar dados a partir de um formulário da web. Like `img` elements, `input` elements are a <dfn>void element</dfn> and do not need closing tags.
