...
Adicione um atributo `src` ao elemento `img` existente, definindo-o com o seguinte URL: `https://cdn.freecodecamp.org/curriculum/cat-photo-app/relaxing-cat.jpg`.
