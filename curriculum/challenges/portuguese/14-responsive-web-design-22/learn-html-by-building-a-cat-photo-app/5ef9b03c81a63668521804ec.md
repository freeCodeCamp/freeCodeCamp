...
Observe que todo o conteúdo da página está aninhado em um elemento `html`. The `html` element is the root element of an HTML page and wraps all content on the page.
