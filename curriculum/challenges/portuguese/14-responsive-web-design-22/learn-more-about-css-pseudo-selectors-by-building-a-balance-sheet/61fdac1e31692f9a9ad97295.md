...
A propriedade `clip-path` determina a forma que a propriedade `clip` receberá. Set the `clip-path` property to the value of `inset(50%)`, forming the clip-path into a rectangle within the element.
