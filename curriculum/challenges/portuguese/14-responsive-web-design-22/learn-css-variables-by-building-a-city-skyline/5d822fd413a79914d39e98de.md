...
Crie uma variável abaixo da outra chamada `--building-color2` e dê a ela um valor de `#66cc99`. Em seguida, defina-a como a `background-color` de `.bb2`.
...
Você deve dar a `--building-color2` um valor de `#66cc99`.
