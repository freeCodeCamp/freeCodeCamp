...
As transições gradientes muitas vezes mudam gradualmente de uma cor para outra. When a more abrupt change is required, the transition can be made with a hard stop like this:
