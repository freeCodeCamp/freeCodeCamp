...
Agora você tem algo que começa a se parecer com um edifício. Você está pronto para criar sua primeira variável. Declarações de variáveis começam com dois traços (`-`) e recebem um nome e um valor como este: `--variable-name: value;`. Na classe `.bb1`, crie uma variável chamada `--building-color1` e dê a ela um valor de `#999`.
