...
Aquele também usou o valor substituto? Eu vejo o problema agora! As variáveis que você declarou em `.bb1` não são reproduzidas nos elementos irmãos `.bb2` e `.bb3`. É assim que o CSS funciona. Por causa disso, as variáveis são frequentemente declaradas no seletor `:root`. Esse é o seletor de nível mais alto no CSS; colocar as variáveis lá as tornará utilizáveis em todos os lugares. Adicione o seletor `:root` ao topo da folha de estilos e mova todas as váriaveis declaráveis para lá.
