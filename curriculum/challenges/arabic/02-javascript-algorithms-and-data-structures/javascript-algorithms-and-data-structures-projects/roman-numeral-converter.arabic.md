...
```yml
tests:
  - text: <code>convertToRoman(2)</code> يجب أن ترجع &quot;II&quot;.
  ...
  - text: <code>convertToRoman(400)</code> يجب أن ترجع &quot;CD&quot;
  ...
  - text: <code>convertToRoman(501)</code> يجب أن ترجع &quot;DI&quot;
