...
بالإضافة إلى إعداد وتحديث `state`، يمكنك أيضًا تحديد طرق لفئة المكونات الخاصة بك. عادة ما تحتاج طريقة الفئة (class method) إلى استخدام الكلمة المفتاحية `this` حتى تتمكن من الوصول إلى الخصائص في الفئة (مثل `state` و `props`) داخل نطاق الطريقة. هناك بعض الطرق للسماح لطرقية الفئة الخاص بك بالوصول إلى `this`.
