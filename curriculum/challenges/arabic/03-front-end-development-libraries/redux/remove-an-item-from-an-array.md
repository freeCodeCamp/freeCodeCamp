...
تم تعديل reducer ولإجراء (action) لإزالة عنصر من قائمة استنادًا على ترتيب العنصر. إنهاء كتابة reducer حتى يتم إعادة حالة قائمة (state array) جديدة مع هذا العنصر في الترتيب المحدد.

# --hints--

يجب أن يكون متجر Redux موجوداً ويبدأ مع حالة مساوية `[0,1,2,3,4,5]`
...
إرسال منشئ إجراء `removeItem` لإزالة العناصر من الحالة ويجب ألا يغير الحالة.
