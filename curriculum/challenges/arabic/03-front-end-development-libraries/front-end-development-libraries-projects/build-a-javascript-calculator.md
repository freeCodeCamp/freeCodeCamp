...
**قصة المستخدم #7:** في أي وقت، الضغط على زر `clear` يؤدي إلى مسح قيم الإدخال والإخراج، ويعيد الآلة الحاسبة إلى حالتها المبدئية؛ 0 يجب أن يظهر في العنصر بمعرف `display`.
