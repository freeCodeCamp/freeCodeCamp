...
ماذا لو لم يكن لدى اللاعب ما يكفي من الذهب (gold) لشراء الصحة (health)؟ You should use an `if` statement to check if the player has enough gold to buy health.
