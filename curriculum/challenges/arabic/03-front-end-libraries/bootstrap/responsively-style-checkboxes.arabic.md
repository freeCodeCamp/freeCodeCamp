...
challengeType: 0
videoUrl: ''
localeTitle: Checkbox Style Responsively
---

## Description
<section id="description"> يمكنك استخدام صفوف <code>col-xs-*</code> في Bootstrap على عناصر <code>form</code> أيضًا! بهذه الطريقة ، سيتم توزيع مربعات الاختيار الخاصة بنا بشكل متساوٍ عبر الصفحة ، بغض النظر عن مدى اتساع دقة الشاشة. وضع علامة على جميع ثلاثة من مربعات الاختيار في عنصر <code>&lt;div class=&quot;row&quot;&gt;</code> . ثم تداخل كل منها في عنصر <code>&lt;div class=&quot;col-xs-4&quot;&gt;</code> . </section>
...
```yml
tests:
  - text: استبدل جميع مربعات الاختيار داخل <code>div</code> واحد <code>row</code> .
  ...
  - text: عش كل من مربعات الاختيار داخل <code>div</code> الخاص بها باستخدام فئة <code>col-xs-4</code> .
