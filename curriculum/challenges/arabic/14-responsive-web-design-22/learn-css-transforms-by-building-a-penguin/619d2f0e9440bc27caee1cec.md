...
حقيقة ممتعة: معظم الزعانف الأسماك، إن لم يكن كلها، ليست مستطيلة طبيعيا.

اعطي `.arm` عناصر أعلى اليسار (top-left)، وأعلي اليمين (top-right)، والزوايا أسفل اليمين (bottom-right) قطر `30%`، و الزاوية أسفل اليسار (bottom-left) قطر `120%`.
