...
ستنشئ الإعدادات الافتراضية لـ CSS Grid صفوف (rows) إضافية حسب الحاجة، على عكس Flexbox. قم باعطاء منتقي `.social-icons` الخاصية `grid-template-columns` بقيمة `repeat(5, 1fr)` لترتيب الأيقونات في صف واحد.
