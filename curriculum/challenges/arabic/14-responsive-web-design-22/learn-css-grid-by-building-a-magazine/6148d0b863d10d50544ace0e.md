...
أما النص الآخر فقد نُقل من مكانه. حركه إلى موضعه عن طريق إعطاء منتقي `.first-paragraph::first-letter` خاصية `float` بقيمة `left` و الخاصية `margin-right`بقيمة `1rem`.
