...
إذا كنت ترغب في إضافة المزيد من أيقونات مواقع التواصل الاجتماعي، ولكن مع ابقائها على نفس الصف، ستحتاج إلى تحديث `grid-template-columns` لإنشاء أعمدة إضافية. كبديل، يمكنك استخدام خاصية `grid-auto-flow`.
