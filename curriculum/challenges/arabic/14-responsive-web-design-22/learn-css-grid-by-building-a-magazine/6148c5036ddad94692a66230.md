...
الآن خوارزمية التثبيت التلقائي ستفعل عند إضافة عنصر أيقونة جديد. ومع ذلك ، فإن الخوارزمية تُفترض أن عرض العمود الجديد هو `auto`، وهو ما لن يتطابق مع الأعمدة الحالية.

يمكنك تجاوز هذا مع خاصية `grid-auto-columns`. اعطي منتقي `.social-icons` الخاصية `grid-auto-columns` بقيمة `1fr`.

# --hints--

يجب أن يكون لمنتقي `.social-icons` الخاص بك الخاصية `grid-auto-columns` بقيمة `1fr`.
