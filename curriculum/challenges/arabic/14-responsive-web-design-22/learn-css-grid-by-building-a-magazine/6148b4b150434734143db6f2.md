...
تذكر أن خاصية `grid-column` تحدد الأعمدة التي يبدأ و ينتهي العنصر عندها. قد تكون هناك أوقات لا تكون فيها متأكد من عدد الأعمدة التي ستحصل عليها الـ grid الخاصه بك، لكنك تريد أن يتوقف العنصر عند العمود الأخير. للقيام بذلك، يمكنك استخدام `-1` في العمود النهائي.
