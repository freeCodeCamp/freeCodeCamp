...
قم إنشاء منتقي `.hero-title` وإعطائه خاصية `text-align` تم تعيينها إلى `center` و الخاصية `color` التي تم تعيينها إلى `orangered` و خاصية `font-size` تم تعيينها إلى `8rem`.
