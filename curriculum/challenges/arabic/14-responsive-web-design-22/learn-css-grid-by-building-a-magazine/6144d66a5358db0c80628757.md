...
قم بإنشاء منتقي `html` وإعطائه الخاصية `font-size` بقيمة `62.5%`. سيؤدي هذا إلى تعيين حجم الخط (font size) الافتراضي لصفحة الويب الخاصة بك إلى 10 بكسل (الافتراضي للمتصفح هو 16 بكسل).
