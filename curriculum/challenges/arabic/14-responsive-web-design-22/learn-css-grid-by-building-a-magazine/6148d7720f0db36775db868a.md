...
سوف تحتاج إلى أن يكون لديك عمود للنص وعمود للصور. اعطي منتقي `.text-with-images` الخاصية `grid-template-columns` بقيمة `1fr 2fr`. قم أيضًا بتعيين خاصية `column-gap` إلى `3rem` لتوفير المزيد من المسافات بين الأعمدة.
