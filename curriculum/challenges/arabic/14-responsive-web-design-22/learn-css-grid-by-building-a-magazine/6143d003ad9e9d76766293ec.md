...
ضمن عنصر `.image-quote`، قم بدمج عنصر `hr` و عنصر `p` وعنصر `hr` ثانِ. اعطي عنصر `p` الـ `class` بقيمة `quote` والنص `The millions of people who are learning to code through freeCodeCamp will have an even better resource to help them learn these fundamentals.`.
