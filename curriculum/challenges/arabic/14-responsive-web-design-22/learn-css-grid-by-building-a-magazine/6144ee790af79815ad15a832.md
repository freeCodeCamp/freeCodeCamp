...
أنت الآن على استعداد للبدء في بناء الـ grid layout. توفر CSS Grid مخططاً ذا بعدين يستند إلى الشبكة (grid)، مما يسمح لك بتركيز العناصر أفقياً ورأسياً مع الاحتفاظ بالتحكم للقيام بأشياء مثل العناصر المتداخلة (overlap elements).
