...
نطحات السحاب تجتمع معا حلياً. قم بملء خاصية `background-color` للمباني الأمامية. استخدم متغير `--building-color1` الخاص بك لملء `.fb3` و`.fb4`, و`--building-color2` إلى `.fb5`، و `--building-color3` إلى `.fb2` و `.fb6`، و `--building-color4` إلى `.fb1`.
