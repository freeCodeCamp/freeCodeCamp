...
في فئة `sky` للاستعلام الوسائل (media query)، تغيير قيم الألوان `#ffcf33` إلى `#ccc`، و`#ffff66` إلى `#445`، و`#bbeeff` إلى `#223`. ثم يمكنك تغيير حجم النافذة لرؤية تغير ألوان الخلفية.
