...
للمبنى التالي، أدخل أربع عناصر `div` داخل <`.fb3` مع فئات `fb3a`، و `fb3b`، و`fb3a` مرة أخرى، و `fb3b` مرة أخرى، بهذا الترتيب. هذا المبنى سيتكون من أربع أقسام، أما القسمين الأوائل فسيكونون تقريبا نفس القسمين السفليين.
