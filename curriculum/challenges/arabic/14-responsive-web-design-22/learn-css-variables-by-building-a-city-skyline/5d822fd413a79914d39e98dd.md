...
المباراة الفاصلة بين المباني. ممرهم معا عن طريق إضافة عنصرين `div` فارغين إلى الجزء العلوي `.background-buildings`، اثنتان أخريان في أسفلها، وواحدة أخرى في ما بين `.bb3` و `.bb4`. وستضاف هذه العناصر إلى المسافات المتكافئة (evenly-space) بين عناصر الحاوية، مما سيجعل المباني أكثر قربا من المركز.
