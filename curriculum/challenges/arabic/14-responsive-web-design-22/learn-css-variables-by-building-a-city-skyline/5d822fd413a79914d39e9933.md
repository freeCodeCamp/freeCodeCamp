...
أضف `repeating-linear-gradient` أسفل الذي أضفته للتو. أعطاه أتجاه `90deg`، واستخدم لون بنائك من `0%` إلى `12%` ولون النافذة `12%` إلى `44%`. هذا سيصنع مجموعة من النوافذ المستطيلة.
