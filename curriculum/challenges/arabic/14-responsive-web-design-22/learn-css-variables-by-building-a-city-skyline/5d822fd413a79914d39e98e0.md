...
إنشاء مٌتغير جديد أسفل المتغيرات الأخرى باسم `--building-color3` وإعطائه قيمة `#cc6699`. ثم استخدمه في `background-color` من فئة `.bb3` وإعطائه قيمة احتياطية من `pink`.
