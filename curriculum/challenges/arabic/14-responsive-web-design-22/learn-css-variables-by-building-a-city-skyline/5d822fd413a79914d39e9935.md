...
إضافة متدرج متكرر آخر إلى هذا المبنى؛ جعله الشيء نفسه الذي أضفته للتو، باستثناء عدم إضافة اتجاه `90deg` واستخدام لون النافذة (window color) بدلاً من لون `transparent`.
