...
أخيرا، في منتقي `:root` للاستعلام الوسائل (media query)، إعادة تعريف المتغيرات `--window-color` الأربعة لاستخدامها `#777`. عندما تنتهي، غيّر حجم النافذة وشاهدها تذهب من النهار إلى الليل.

المتغيرات تستخدم في الأساس مع الألوان، وهذه هي الطريقة التي استخدمتها هنا. ولكن يمكن إعطاؤها أي قيمة واستخدامها في أي خصائص. يبدو مشروعك رائعاً!

# --hints--

يجب عليك إضافة `--window-color1` بقيمة `#777`.
...
يجب عليك إضافة `--window-color2` بقيمة `#777`.
...
يجب عليك إضافة `--window-color3` بقيمة `#777`.
...
يجب عليك إضافة `--window-color4` بقيمة `#777`.
