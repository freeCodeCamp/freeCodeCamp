...
إنشاء مُتغير جديد أسفل المُتغير الآخر يسمى `--building-color2` وإعطائه قيمة `#66cc99`. ثم عيّنها كخاصية `background-color` لعنصر `.bb2`.
...
يجب عليك إعطاء `--building-color2` قيمة `#66cc99`.
