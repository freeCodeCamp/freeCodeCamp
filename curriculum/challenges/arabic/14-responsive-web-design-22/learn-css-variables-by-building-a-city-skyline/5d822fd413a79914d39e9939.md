...
في الجزء العلوي من قائمة لون معامل تدرج السماء، حيث يمكنك وضع اتجاه لمعامل التدرج؛ أضف `circle closest-corner at 15% 15%,`. سيؤدي هذا إلى نقل بداية معامل التدرج إلى `15%` من الأعلى واليسار. سوف يجعله ينتهي عند `closest-corner` وسوف يحافظ على شكل `circle`. هذه بعض الكلمات الرئيسية التي تم بناؤها في التدرج لوصف كيفية سلوكه.

# --hints--

يجب عليك إعطاء `.sky` وظيفية `radial-gradient` اتجاه `circle closest-corner at 15% 15%`.
