...
على الرغم من أنه غير مطلوب لعناصر `label` التي بداخلها `input`، لا يزال من أفضل الممارسات ربط `label` ربطاً صريحاً بعنصر `input` الخاص به.

قم بربط عناصر `label` مع عناصر `input` الخاصه بها.

# --hints--

يجب عليك إعطاء أول `label` سمة `for` التي تطابق الـ `id` لعنصر الـ `input` الخاص به.
...
يجب عليك إعطاء ثاني `label` سمة `for` التي تطابق الـ `id` لعنصر الـ `input` الخاص به.
...
يجب عليك إعطاء ثالث `label` سمة `for` التي تطابق الـ `id` لعنصر الـ `input` الخاص به.
...
يجب عليك إعطاء رابع `label` سمة `for` التي تطابق الـ `id` لعنصر الـ `input` الخاص به.
