...
التعليق يسمح لك بترك الرسائل دون التأثير على العرض في المتصفح. كما يسمح لك بجعل الكود غير نشط. يبدأ التعليق في HTML بـ `<!--`، يحتوي على أي عدد من الأسطر ، وينتهي بـ `-->`.
