...
يجب أن تحتوي جميع عناصر `img` على سمة `alt`. يتم استخدام نص السمة `alt` لقراء الشاشة (screen readers) لتسهيل الوصول (accessibility) ويتم عرضه إذا فشل تحميل الصورة.
