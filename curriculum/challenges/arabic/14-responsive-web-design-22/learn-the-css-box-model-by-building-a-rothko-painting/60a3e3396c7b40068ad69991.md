...
قم بإضافة `box-shadow` إلى `.three` مع القيم `0 0 5px 5px #b20403`.

# --hints--

يجب عليك تعيين خاصية `box-shadow` إلى `0 0 5px 5px #b20403`.
...
يجب أن يكون لعنصر `.three` الخاص بك `box-shadow` بقيمة `0 0 5px 5px #b20403`.
