...
لجعل حركة cabin يبدو أشبه بحركة تأرجح طبيعية، يمكنك استخدام وظيفة التوقيت `ease-in-out`. هذا الإعداد سيجعل الرسوم المتحركة تبدأ وتنتهي بوتيرة أبطأ، لكن تتحرك بسرعة أكبر في منتصف الدورة.
