...
## Description
<section id="description"> تعد <dfn>متغيرات CSS</dfn> طريقة فعالة لتغيير العديد من خصائص أنماط CSS مرة واحدة عن طريق تغيير قيمة واحدة فقط. اتبع الإرشادات أدناه لمعرفة كيف يمكن لتغيير ثلاث قيم فقط تغيير تصميم العديد من العناصر. </section>
...
```yml
tests:
  - text: يجب أن تعلن فئة <code>penguin</code> عن متغير <code>--penguin-skin</code> وتعيينه إلى <code>gray</code> .
  ...
  - text: يجب أن تعلن الطبقة <code>penguin</code> المتغير <code>--penguin-belly</code> وتعيينه إلى <code>white</code> .
