...
يظهر أداة لتلميح (tooltip) المزيد من معلومات العنصر في صفحة عندما ينتقل المستخدم فوق (hovers) هذا العنصر. هناك عدة طرق لإضافة تلميح لعرض البيانات. هذا التحدي يستخدم عنصر `title` في SVG.
