...
You want to map those points along the `x` axis on the SVG area, between 10 units and 500 units. This is the output information, also known as the <dfn>range</dfn>.
