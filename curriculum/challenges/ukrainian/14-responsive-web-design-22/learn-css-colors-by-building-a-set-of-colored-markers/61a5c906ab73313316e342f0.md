...
Якщо не надано аргумент `gradientDirection` для функції `linear-gradient`, то вона розташовує кольори зверху вниз або вздовж лінії під кутом 180 градусів за замовчуванням.
