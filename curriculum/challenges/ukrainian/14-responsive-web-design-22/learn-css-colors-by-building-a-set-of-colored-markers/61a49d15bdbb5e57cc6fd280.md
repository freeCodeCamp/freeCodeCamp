...
Кольорові зупинки дозволяють точно налаштувати розташування кольорів уздовж лінії градієнта. Це одиниці довжини, як-от `px` (пікселі) або відсотки, які слідують за кольором в функції `linear-gradient`.
