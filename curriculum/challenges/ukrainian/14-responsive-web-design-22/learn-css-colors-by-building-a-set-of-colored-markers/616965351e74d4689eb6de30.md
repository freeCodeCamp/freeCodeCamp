...
Ви можете мати декілька самозакривних елементів `meta` на вебсторінці. Each `meta` element adds information about the page that cannot be expressed by other HTML elements.
