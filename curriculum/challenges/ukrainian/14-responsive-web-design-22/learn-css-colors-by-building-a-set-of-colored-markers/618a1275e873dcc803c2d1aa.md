...
Далі використайте функцію `rgb` в правилі `.one`, щоб встановити `background-color` на чорний. Та використайте функцію `rgb` в правилі `.two`, щоб встановити `background-color` на червоний.
