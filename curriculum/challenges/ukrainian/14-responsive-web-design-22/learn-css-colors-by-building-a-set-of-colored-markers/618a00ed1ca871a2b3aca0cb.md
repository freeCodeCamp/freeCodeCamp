...
Спочатку налаштуйте значення в функції `rgb` в правилах `.one`, `.two` та `.three` таким чином, що `background-color` кожного елемента встановлено на чисто чорний. Пам’ятайте, що функція `rgb` використовує адитивну колірну модель, де кольори починаються з чорного та змінюються зі збільшенням значень червоного, зеленого та синього.
