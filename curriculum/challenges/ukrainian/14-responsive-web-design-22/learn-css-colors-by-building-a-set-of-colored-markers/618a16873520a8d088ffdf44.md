...
А в правилі `h1` видаліть властивість `background-color` та її значення, щоб повернутися до білого кольору за замовчуванням.

# --hints--

Ваше CSS-правило `h1` не повинне мати властивості `background-color`.
