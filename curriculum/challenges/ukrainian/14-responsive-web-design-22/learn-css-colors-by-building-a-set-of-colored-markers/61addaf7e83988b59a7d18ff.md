...
Скорочена властивість `border-left` дозволяє одночасно встановити ширину, стиль та колір лівого краю.
...
В правилі CSS `.sleeve` замініть `border-left-width`, `border-left-style` та `border-left-color` на скорочену властивість `border-left`. Значення ширини, стилю та кольору лівого краю повинні бути однаковими.
