...
Зверніть увагу, що червоний та блакитний кольори дуже яскраві поруч один з одним. Цей контраст може відвертати увагу, якщо його надмірно використовувати на вебсайті, та може ускладнити читання тексту, якщо він розміщений на фоні з доповняльних кольорів.
...
Спочатку використайте функцію `rgb` в правилі `h1`, щоб встановити колір фону на блакитний.
