...
Щоб створити шартрез, оновіть функцію `rgb` в правилі `.one`, щоб червоний мав значення `127` та встановіть для зеленого максимальне значення.

Для лазурного, оновіть функцію `rgb` в правилі `.two`, щоб зелений мав значення `127`, а синій – максимальне.

А для рожевого оновіть функцію `rgb` в правилі `.three`, щоб синій мав значення `127`, а червоний – максимальне.
