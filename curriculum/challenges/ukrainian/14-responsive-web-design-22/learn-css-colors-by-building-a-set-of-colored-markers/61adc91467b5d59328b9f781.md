...
Всі елементи HTML мають кордони, хоча за замовчуванням для них зазвичай встановлено `none`. З допомогою CSS ви можете керувати всіма аспектами кордону елемента та встановлювати кордон з всіх сторін або лише з однієї сторони за раз. Щоб бачити край, вам потрібно встановити його ширину та стиль.
