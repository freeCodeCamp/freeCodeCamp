...
Ці точки занадто квадратні. Надайте класу `black-dot` властивість `border-radius` зі значенням `50%`, щоб виправити це.

# --hints--

Ваш селектор `.black-dot` повинен мати властивість `border-radius` зі значенням `50%`.
