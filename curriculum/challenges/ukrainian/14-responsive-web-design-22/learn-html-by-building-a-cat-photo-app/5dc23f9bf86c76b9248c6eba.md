...
Ви можете додати зображення до свого сайту з допомогою елемента `img`. Елементи `img` мають початковий теґ без кінцевого теґа. A tag for an element without a closing tag is known as a <dfn>void element</dfn>.
