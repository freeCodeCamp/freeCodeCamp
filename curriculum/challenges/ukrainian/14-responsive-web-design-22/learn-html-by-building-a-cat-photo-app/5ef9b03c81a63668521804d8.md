...
Елемент `input` дозволяє збирати дані з вебформи кількома способами. Like `img` elements, `input` elements are a <dfn>void element</dfn> and do not need closing tags.
