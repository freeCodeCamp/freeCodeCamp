...
Зазвичай форми використовують прапорці для запитань, які можуть мати більше за одну відповідь. The `input` element with a `type` attribute set to `checkbox` creates a checkbox.
