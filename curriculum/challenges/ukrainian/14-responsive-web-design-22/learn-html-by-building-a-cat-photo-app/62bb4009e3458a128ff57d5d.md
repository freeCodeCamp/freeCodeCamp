...
Ви можете налаштувати поведінку браузера, додавши самозакривні елементи `meta` у `head`. Ось приклад:
...
Ви повинні створити самозакривний елемент `meta` в межах елемента `head`.
...
Ваш елемент `meta` повинен бути самозакривним теґом, вам не потрібно додавати `</meta>`.
