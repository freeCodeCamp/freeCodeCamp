...
Вставте іншу радіокнопку з опцією `Outdoor` в новий елемент `label`. Нову радіокнопку потрібно розмістити після першої. Також встановіть для атрибута `id` значення:
