...
Ваш елемент `legend` має бути першим елементом прямо під початковим теґом елемента `fieldset` та перед початковим теґом `label` першої радіокнопки. Він в неправильному положенні.
