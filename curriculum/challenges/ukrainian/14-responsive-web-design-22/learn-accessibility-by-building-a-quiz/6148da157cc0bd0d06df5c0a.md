...
Щоб вирівняти блоки `input` один з одним, встановіть властивість `display` на `inline-block` для всіх елементів `input` та `label` в межах елементів `.info`.

Також вирівняйте текст за правим краєм.
