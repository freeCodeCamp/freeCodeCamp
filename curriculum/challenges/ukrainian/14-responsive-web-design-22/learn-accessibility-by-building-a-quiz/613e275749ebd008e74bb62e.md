...
У цьому прикладі елементи `img` матимуть мінімальну ширину `250px`. І зі збільшенням вікна перегляду, зображення буде відповідно збільшуватися, щоб бути 25 відсотками ширини вікна перегляду.
