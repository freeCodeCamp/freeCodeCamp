...
Make the `header` take up the full width of its parent container, set its `height` to `50px`, and set the `background-color` to `#1b1b32`. Потім встановіть `display` так, щоб він використовував _Flexbox_.
