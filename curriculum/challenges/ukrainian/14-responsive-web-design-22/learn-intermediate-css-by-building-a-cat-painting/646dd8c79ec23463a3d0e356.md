...
Час попрацювати над правим внутрішнім вухом. Надайте елементу `.cat-right-inner-ear` лівий та правий кордон зі значенням `20px solid transparent` за допомогою селектора класу. Також надайте йому нижній кордон зі значенням `40px solid #3b3b4f`.
