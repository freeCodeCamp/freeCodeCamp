...
Перемістіть праву зіницю, використавши властивість `position` зі значенням `absolute`, `top` зі значенням `8px` та `left` зі значенням `18px`. Also, give it a border radius of `60%` and rotate it at `-5deg`.
