...
**Примітка:** щоб дізнатись, як працює `sticky`, потрібно розмістити певний текст до та після елемента `div` `.cat-head`. Якщо після цього прогорнути, ви побачите, що `.cat-head` прикріплений зверху та залишається там.
