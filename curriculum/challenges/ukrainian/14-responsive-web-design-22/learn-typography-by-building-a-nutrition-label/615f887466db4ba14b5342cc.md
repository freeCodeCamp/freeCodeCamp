...
Після останнього роздільника створіть інший елемент `p` з текстом `Protein 3g`. Використайте необхідні класи, щоб видалити нижній край, та `span`, щоб зробити `Protein` жирним шрифтом.
