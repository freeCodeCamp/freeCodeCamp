...
Під елементом `.dbl-indent` додайте новий елемент `p` з текстом `Includes 10g Added Sugars 20%`. Ваш новий елемент `p` також повинен мати подвійний відступ та не мати нижнього краю. Використайте `span`, щоб зробити `20%` жирним та вирівняним за правим краєм.
