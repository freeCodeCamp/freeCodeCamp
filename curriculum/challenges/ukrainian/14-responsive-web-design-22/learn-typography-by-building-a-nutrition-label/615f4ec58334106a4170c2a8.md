...
Створіть новий елемент `div` під своїм елементом `header` та надайте йому атрибут `class` зі значенням `divider lg`.
...
Ваш новий елемент `div` повинен мати атрибут `class` зі значенням `divider lg`.
