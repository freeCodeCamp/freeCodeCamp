...
Під останнім елементом `p` створіть ще один елемент `p` з текстом `Sodium 160mg 7%`. Оберніть текст `Sodium` в елемент `span` з атрибутом `class`, встановленим на `bold`. Оберніть текст `7%` в інший елемент `span` з `class`, встановленим на `bold right`.
...
Ваш новий елемент `p` повинен мати два елементи `span`.
...
Ваш перший елемент `span` повинен обгортати текст `Sodium`.
...
Ваш другий елемент `span` повинен обгортати текст `7%`.
