...
Завдяки останнім змінам ваша етикетка готова!

# --hints--

Ваш селектор `.note` повинен мати властивість `padding` зі значенням `0 8px`.
...
Ваш селектор `.note` повинен мати властивість `text-indent` зі значенням `-8px`.
