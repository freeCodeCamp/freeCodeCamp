...
Замість того, щоб постійно перевіряти, чи ви не перезаписали ваші попередні властивості, ви можете використати ключове слово `!important`, щоб переконатися, що ці властивості завжди застосовуються, незалежно від порядку чи специфіки.
...
Ваш селектор `span[class~="sr-only"]` повинен мати властивість `-webkit-clip-path` зі значенням `inset(50%) !important`.
