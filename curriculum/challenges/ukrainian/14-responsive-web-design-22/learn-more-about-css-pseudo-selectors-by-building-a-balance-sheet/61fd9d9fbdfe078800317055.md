...
Час стилізувати вашу таблицю. Почніть зі скидання блокової моделі. Створіть селектор `html` та надайте йому властивість `box-sizing` зі значенням `border-box`.
