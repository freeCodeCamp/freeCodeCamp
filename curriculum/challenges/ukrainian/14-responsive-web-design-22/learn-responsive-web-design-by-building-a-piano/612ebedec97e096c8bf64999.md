...
В запиті `@media` додайте селектор `.keys` та встановіть `width` на `318px`.

# --hints--


Ваше правило `@media` повинне мати селектор `.keys`.
...
Ваш новий селектор `.keys` повинен мати `width` зі значенням `318px`.
