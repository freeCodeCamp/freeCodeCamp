...
Поверніть `.three` проти годинникової стрілки на 0,2 градуса.

На цьому етапі ваша картина Ротко завершена.

# --hints--

Ви повинні встановити властивість `transform` на `rotate(-0.2deg)`.
...
Ваш елемент `.three` повинен мати `transform` зі значенням `rotate(-0.2deg)`.
