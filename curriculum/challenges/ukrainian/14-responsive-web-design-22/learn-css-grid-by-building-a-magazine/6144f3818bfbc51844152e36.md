...
Використовуйте функцію `minmax`, щоб ваші стовпчики були адаптивними на будь-якому пристрої. Функція `minmax` приймає два аргументи: перший – мінімальне значення, а другий – максимальне. Цими значеннями можуть бути довжина, відсоток, `fr` або навіть ключове слово, як-от `max-content`.
