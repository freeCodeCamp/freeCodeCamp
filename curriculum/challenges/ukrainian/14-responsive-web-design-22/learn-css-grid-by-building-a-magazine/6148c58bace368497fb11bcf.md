...
Подібно до Flexbox, з допомогою CSS Grid ви можете вирівнювати вміст елементів сітки завдяки `align-items` та `justify-items`. `align-items` вирівняє дочірні елементи вздовж осі стовпчика, а `justify-items` вирівняє дочірні елементи вздовж осі рядка.
