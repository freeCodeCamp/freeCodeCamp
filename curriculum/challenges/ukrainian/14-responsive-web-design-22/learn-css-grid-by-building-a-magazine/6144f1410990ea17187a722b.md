...
Тепер ви можете стилізувати макет своєї сітки. CSS Grid схожий на Flexbox тим, що має спеціальні властивості як для батьківського, так і для дочірнього елементів.
