...
Пам’ятайте, що властивість `grid-column` визначає, в яких стовпчиках починається та закінчується елемент. Бувають випадки, коли ви невпевнені, скільки стовпчиків матиме ваша сітка, але потрібно, щоб елемент закінчувався в останньому стовпчику. Для цього ви можете використати `-1` до останнього стовпчика.
