...
Тепер настав час стилізувати другий `section`. Зауважте, що він має значення `text` та `text-with-images` для атрибута `class`, що означає, що він вже успадковує стилі з вашого правила `.text`.
