...
Тепер ви готові почати складати сітку. CSS Grid пропонує двовимірний макет на основі сітки, що дозволяє розташовувати елементи за центром горизонтально та вертикально, зберігаючи при цьому контроль, щоб виконувати такі дії, як накладання елементів.
