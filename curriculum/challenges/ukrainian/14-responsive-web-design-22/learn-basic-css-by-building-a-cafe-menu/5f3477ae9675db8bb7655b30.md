...
В попередніх кроках ви використовували <dfn>селектор типу</dfn> для стилізації елемента `h1`. Зцентруйте елементи `h2` та `p` з новим селектором типу для кожного.
