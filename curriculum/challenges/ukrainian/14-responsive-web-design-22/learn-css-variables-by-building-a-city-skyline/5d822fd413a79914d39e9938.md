...
Класу `sky` надайте `radial-gradient`. Використайте `#ffcf33` від `0%` до `20%`, `#ffff66` на `21%` та `#bbeeff` на `100%`. Це додасть круговий градієнт до фону, який буде вашим сонцем.
