...
В класі `sky` медіазапиту змініть два значення кольору `#ffcf33` на `#ccc`, `#ffff66` на `#445` та `#bbeeff` на `#223`. Потім ви можете змінити розмір вікна, щоб побачити як змінюється фон.
