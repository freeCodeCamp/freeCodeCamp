...
Додайте ті самі властивості `display`, `align-items` і `justify-content` та значення до `.foreground-buildings`, які ви використали для `.background-buildings`. Знову ж таки, це використовуватиме Flexbox для рівномірного розміщення будівель через низ контейнера.
