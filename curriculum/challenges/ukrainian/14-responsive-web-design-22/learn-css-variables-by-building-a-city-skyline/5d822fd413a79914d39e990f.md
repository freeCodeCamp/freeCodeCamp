...
Вікна розташовані одне на одному в лівій частині секції, позаду фіолетової будівлі. Add a new class below `.building-wrap` called `window-wrap`. Make `.window-wrap` a flexbox container, and use the `align-items` and `justify-content` properties to center its child elements vertically and evenly space them in their parent, respectively.
