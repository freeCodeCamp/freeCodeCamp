...
Створіть нову змінну під своєю змінною `--building-color1`. Створіть нову змінну `--building-color2` та надайте їй значення `#66cc99`. Потім встановіть її як `background-color` для `.bb2`.
