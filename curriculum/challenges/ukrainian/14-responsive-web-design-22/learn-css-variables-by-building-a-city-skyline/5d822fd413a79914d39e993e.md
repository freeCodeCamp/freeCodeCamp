...
Зрештою, в селекторі `:root` медіазапиту переозначте всі чотири змінні `--window-color` на `#777`. Коли ви закінчите, змініть розмір вікна та спостерігайте, як воно змінюється з дня на ніч.
