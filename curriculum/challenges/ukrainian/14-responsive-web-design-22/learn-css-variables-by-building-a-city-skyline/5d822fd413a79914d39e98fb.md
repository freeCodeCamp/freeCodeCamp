...
Градієнтні переходи часто поступово змінюються з одного кольору на інший. When a more abrupt change is required, the transition can be made with a hard stop like this:
