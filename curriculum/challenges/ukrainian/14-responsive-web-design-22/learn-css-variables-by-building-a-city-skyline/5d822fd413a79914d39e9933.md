...
Додайте ще один `repeating-linear-gradient` під тим, який ви щойно додали. Надайте йому напрямок `90deg`, використайте колір будівлі від `0%` до `12%` та колір вікна від `12%` до `44%`. Це створить декілька прямокутних вікон.
