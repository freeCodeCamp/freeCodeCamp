...
Націльте елемент `.back-mountain` та встановіть його `width` та `height` на `300px`. Потім встановіть `background` на лінійний градієнт, починаючи з `rgb(203, 241, 228)` та закінчуючи на `rgb(47, 170, 255)`.
