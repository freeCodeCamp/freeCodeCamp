...
Видаліть поле зі свого елемента `body`, встановіть `font-family` на `sans-serif` та надайте `background-color` зі значенням `#f5f6f7`.
...
Ваш селектор `body` повинен мати властивість `margin` зі значенням `0`.
...
Ваш селектор `body` повинен мати властивість `background-color` зі значенням `#f5f6f7`.
