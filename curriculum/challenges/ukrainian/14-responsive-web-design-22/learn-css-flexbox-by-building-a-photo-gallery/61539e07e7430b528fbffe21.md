...
Надайте селектору `.gallery` властивість `padding` зі значенням `20px 10px`, щоб створити простір навколо контейнера.

Потім надайте йому `max-width` зі значенням `1400px` та додайте `margin` зі значенням `0 auto`, щоб зцентрувати його.

# --hints--

Ваш селектор `.gallery` повинен мати властивість `padding` зі значенням `20px 10px`.
...
Ваш селектор `.gallery` повинен мати властивість `max-width` зі значенням `1400px`.
