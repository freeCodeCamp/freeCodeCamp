...
Вирівняйте свій текст `.header` по центру, надайте padding зі значенням `32px` для всіх сторін та встановіть фон на `#E0DDDD`.
...
Ваш селектор `.header` повинен мати властивість `background-color` зі значенням `#E0DDDD`.
