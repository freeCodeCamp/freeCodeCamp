...
Атрибут зображення `alt` повинен описувати вміст зображення. Читачі екрана повідомляють альтернативний текст замість зображень. Якщо зображення не завантажено, замість нього з'являється цей текст.
