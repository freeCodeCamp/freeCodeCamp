...
Властивість `animation-iteration-count` встановлює, скільки разів повинна повторюватися ваша анімація. Її значенням може бути число або `infinite`, щоб безперервно повторювати анімацію. Ваше оглядове колесо не повинне зупинятися, тому встановіть селектору `.wheel` властивість `animation-iteration-count` зі значенням `infinite`.
