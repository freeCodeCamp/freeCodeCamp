...
title: Робота з текстом. Запитання D
challengeType: 15
...
Елемент `em` робить текст курсивним. Він також робить акцент на тексті, що може вплинути на читачів екрана. To define an emphasized element you wrap text content in an `<em>` tag.
