...
Видаліть наявні виклики `print`. Потім, як ви робили раніше для `v1`, надрукуйте `v2` та значення, яке повертає `v2.norm()`.

# --hints--

Код не повинен містити `print(v1)` та `print(v1.norm())`.
