...
Надалі ви працюватимете над методом, який намагатиметься розв’язати судоку на місці, тобто буде змінювати наявну сітку, а не створювати нову.

Створіть метод `solver` в межах класу `Board`, який приймає один аргумент (`self`, що представляє екземпляр класу).

# --hints--

Метод повинен мати назву `solver`.
