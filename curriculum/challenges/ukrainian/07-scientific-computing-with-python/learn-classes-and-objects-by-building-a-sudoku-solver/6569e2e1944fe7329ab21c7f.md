...
Перевірте, чи можна вставити число в певний ряд, викликавши `self.valid_in_row(row, num)`. Призначте результат до `valid_in_row`.

# --hints--

`is_valid` має містити `valid_in_row = self.valid_in_row(row, num)`.
