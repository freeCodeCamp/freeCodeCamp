...
Якщо припущення дійсне, то метод оновлює сітку, призначаючи `guess` до клітинки, вказаної в `next_empty`.

Розпакуйте кортеж `next_empty` на `row, col`.

# --hints--

Внутрішня інструкція `if` повинна містити `row, col = next_empty`.
