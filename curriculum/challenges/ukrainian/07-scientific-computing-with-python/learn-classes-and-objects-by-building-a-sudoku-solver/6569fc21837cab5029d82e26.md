...
Поза визначенням класу створіть функцію для друку та розв’язку сітки судоку.

Назвіть її `solve_sudoku`. Вона має приймати параметр `board`, який є 2D-списком.
...
Ви повинні мати функцію під назвою `solve_sudoku`.
