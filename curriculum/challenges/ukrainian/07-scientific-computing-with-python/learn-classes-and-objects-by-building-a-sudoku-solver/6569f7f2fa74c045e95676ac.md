...
Отримайте доступ до клітинки у вказаному ряді й стовпці сітки та призначте до неї значення `guess`.

# --hints--

Внутрішній блок `if` повинен містити `self.board[row][col] = guess`.
