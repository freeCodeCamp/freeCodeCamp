...
Якщо числа немає, його можна вставити у квадрат, не порушуючи правил судоку.

У цьому випадку поверніть `True` і зверніть увагу на відступи.

# --hints--

Поза зовнішнім циклом `for` має бути `return True`.
