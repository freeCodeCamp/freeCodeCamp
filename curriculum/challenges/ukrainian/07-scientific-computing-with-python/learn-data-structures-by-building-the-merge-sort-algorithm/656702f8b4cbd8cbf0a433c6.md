...
Your `while` loop should have these conditions: `left_array_index < len(left_part) and right_array_index < len(right_part)`. Не забудьте використати ключове слово `pass` у тілі циклу.
