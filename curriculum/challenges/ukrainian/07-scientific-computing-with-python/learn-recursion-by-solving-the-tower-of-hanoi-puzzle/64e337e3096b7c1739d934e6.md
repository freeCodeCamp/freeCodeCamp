...
Додайте коментар `move n - 1 disks from source to auxiliary, so they are out of the way` перед рекурсивним викликом.

# --hints--

Додайте коментар з наданим текстом перед рекурсивним викликом.
