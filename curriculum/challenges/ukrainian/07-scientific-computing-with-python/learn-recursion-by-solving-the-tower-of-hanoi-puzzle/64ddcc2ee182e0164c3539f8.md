...
Після того, як ви надрукували хід, потрібно видалити останній елемент з першого стрижня та додати його до цільового стрижня. Для цього використайте методи `.pop()` та `.append()`.

# --hints--

Видаліть останній елемент з `rods[source]`.
