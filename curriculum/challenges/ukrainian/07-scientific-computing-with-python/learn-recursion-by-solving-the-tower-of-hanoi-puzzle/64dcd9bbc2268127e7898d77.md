...
Зрештою, якщо при діленні числа ходу на 3 немає остачі, то дозволено перемістити диски між `'B'` та `'C'`.

Для цього додайте інструкцію `elif`. Потім надрукуйте відповідний рядок, якщо умова виконана.

# --hints--

Ви повинні мати інструкцію `elif`, яка виконується, якщо `remainder == 0`.
