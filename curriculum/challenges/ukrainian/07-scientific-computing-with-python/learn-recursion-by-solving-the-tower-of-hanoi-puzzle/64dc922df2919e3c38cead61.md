...
У верхній частині коду оголосіть змінну під назвою `NUMBER_OF_DISKS`, щоб зберегти кількість дисків і призначте до неї значення `3`. Потім замініть перший аргумент, переданий до функції `range()`, на нову змінну.
