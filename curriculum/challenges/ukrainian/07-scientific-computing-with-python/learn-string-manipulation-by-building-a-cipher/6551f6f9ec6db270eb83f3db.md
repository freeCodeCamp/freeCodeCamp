...
You should pass `type(text)` to the `print()` function by including it between the parentheses. Зверніть увагу на те, щоб розмістити виклик функції на початку рядка.
