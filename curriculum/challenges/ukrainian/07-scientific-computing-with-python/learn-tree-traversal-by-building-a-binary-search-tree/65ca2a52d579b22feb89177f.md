...
Надрукуйте ціле дерево як останній крок.

Викличте `print()`, передавши рядок `'Inorder traversal after deleting 40:'` як перший аргумент та `inorder_traversal()` як другий аргумент.
