...
У попередньому проєкті ви використовували `fetch()` з методом `.then()`, щоб виконати логіку після виконання промісу. Now you will use the `await` keyword to handle the asynchronous nature of the `fetch()` method.
