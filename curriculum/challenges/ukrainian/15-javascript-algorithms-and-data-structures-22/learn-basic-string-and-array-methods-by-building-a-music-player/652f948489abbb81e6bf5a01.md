...
You should assign the `#playlist-songs` element to the variable `playlistSongs`. Не забувайте використовувати `const` для оголошення змінної.
...
You should assign the `#play` element to the variable `playButton`. Не забувайте використовувати `const` для оголошення змінної.
...
You should assign the `#pause` element to the variable `pauseButton`. Не забувайте використовувати `const` для оголошення змінної.
