...
You should assign the `#player-song-title` element to the variable `playingSong`. Не забувайте використовувати `const` для оголошення змінної.
...
You should assign the `#player-song-artist` element to the variable `songArtist`. Не забувайте використовувати `const` для оголошення змінної.
