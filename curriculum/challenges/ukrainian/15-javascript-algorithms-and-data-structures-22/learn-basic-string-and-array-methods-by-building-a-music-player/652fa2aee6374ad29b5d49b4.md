...
You should assign the `#previous` element to the variable `previousButton`. Не забувайте використовувати `const` для оголошення змінної.
...
You should assign the `#shuffle` element to the variable `shuffleButton`. Не забувайте використовувати `const` для оголошення змінної.
