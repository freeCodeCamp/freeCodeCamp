...
The `currentWeaponIndex` variable is the index of the `weapons` array, but array indexing starts at zero. Індекс останнього елемента в масиві на один менший, ніж довжина масиву.
