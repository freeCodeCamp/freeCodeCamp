...
Всередині функції `update` змініть значення присвоєння `button1.innerText` на `location["button text"]`. That way, you use bracket notation to get the `"button text"` property of the `location` object passed into the function.
