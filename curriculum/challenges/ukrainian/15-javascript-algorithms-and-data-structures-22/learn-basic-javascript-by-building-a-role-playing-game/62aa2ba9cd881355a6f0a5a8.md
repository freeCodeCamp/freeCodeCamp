...
Looking at your `"kill monster"` object, `"button functions"` currently has three `goTown` variables. Змініть третю на `easterEgg`: таким чином гравець отримає доступ до прихованої властивості гри. Do not change the `"button text"`.
