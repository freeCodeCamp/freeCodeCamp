...
У своїй функції `defeatMonster` встановіть `gold` на `gold` плюс рівень монстра, помножений на `6.7`. Remember you can get the monster's level by using `monsters[fighting].level`.
