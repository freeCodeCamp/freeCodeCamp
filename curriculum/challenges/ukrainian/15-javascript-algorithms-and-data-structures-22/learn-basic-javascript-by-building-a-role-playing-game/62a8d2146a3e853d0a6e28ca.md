...
Додайте інструкцію `else` до своєї зовнішньої інструкції `if`. Inside this new `else` statement, set `text.innerText` to `You already have the most powerful weapon!`.
