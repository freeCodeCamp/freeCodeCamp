...
Ви можете отримати доступ до властивостей в JavaScript різними способами. Першим є <dfn>точкова нотація</dfn>. Отримання доступу до властивості кнопки `onclick` виглядатиме так:
