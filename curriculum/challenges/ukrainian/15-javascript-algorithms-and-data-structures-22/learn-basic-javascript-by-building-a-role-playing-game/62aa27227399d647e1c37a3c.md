...
Встановіть `text.innerText` на `You picked [guess]. Here are the random numbers:` після циклу `while`. Замініть `guess` на здогадку гравця.

# --hints--

Ви повинні встановити `text.innerText` на рядок `You picked`. Пам'ятайте, що інтервал має значення.
