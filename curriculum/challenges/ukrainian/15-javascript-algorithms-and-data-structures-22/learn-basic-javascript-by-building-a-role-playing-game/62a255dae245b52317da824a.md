...
Додайте рядок `console.log("Hello World");` між тегами `script`, потім натисніть кнопку «Консоль», щоб відкрити нашу консоль, та ви повинні побачити текст `Hello World` у своїй консолі.
