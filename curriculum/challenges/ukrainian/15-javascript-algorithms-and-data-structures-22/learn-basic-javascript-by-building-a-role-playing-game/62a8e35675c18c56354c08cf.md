...
Тепер ви можете побудувати функцію `attack`. First, update the `text` message to say `"The <monster name> attacks."`, replacing `<monster name>` with the name of the monster. Не забудьте, що ви можете використати оператор конкатенації для цього.
