...
Перше значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `name` зі значенням `slime`.

```js
assert.equal(monsters[0].name, "slime");
```

Перше значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `level` зі значенням `2`.

```js
assert.equal(monsters[0].level, 2);
```

Перше значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `health` зі значенням `15`.

```js
assert.equal(monsters[0].health, 15);
```

Друге значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `name` зі значенням `fanged beast`.

```js
assert.equal(monsters[1].name, "fanged beast");
```

Друге значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `level` зі значенням `8`.

```js
assert.equal(monsters[1].level, 8);
```

Друге значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `health` зі значенням `60`.

```js
assert.equal(monsters[1].health, 60);
```

Третє значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `name` зі значенням `dragon`.

```js
assert.equal(monsters[2].name, "dragon");
```

Третє значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `level` зі значенням `20`.

```js
assert.equal(monsters[2].level, 20);
```

Третє значення у вашому масиві `monsters` повинне мати об'єкт із властивістю `health` зі значенням `300`.
