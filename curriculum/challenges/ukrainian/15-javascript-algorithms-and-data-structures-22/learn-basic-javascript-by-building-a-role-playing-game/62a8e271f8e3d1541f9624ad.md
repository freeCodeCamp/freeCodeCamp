...
Now, set the `innerText` property of `monsterName` to be the `name` property of the current monster. Зробіть те саме для `monsterHealthText` та властивості `health`.
