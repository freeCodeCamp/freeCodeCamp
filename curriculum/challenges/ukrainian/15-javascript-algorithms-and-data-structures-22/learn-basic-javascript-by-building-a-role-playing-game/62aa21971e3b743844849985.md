...
В кінці своєї інструкції `return` використайте <dfn>логічний оператор or</dfn> `||`, щоб перевірити, чи `health` менше за `20`.

Логічний оператор or використовуватиме перше значення, якщо воно істинне (будь-що, окрім `NaN`, `null`, `0`, `-0`, `0n`, `""` чи `false`). В іншому випадку він буде використовувати друге значення.
