...
JavaScript взаємодіє із HTML завдяки <dfn>об'єктній моделі документа</dfn>, або DOM. DOM – це дерево об'єктів, які представляють HTML. You can access the HTML using the `document` object, which represents your entire HTML document.
