...
Наступним кроком є переконатися, що ви не можете змінити цей об’єкт, додаючи або видаляючи будь-які властивості. We are going to use a method called `Object.freeze(obj)` which will freeze this object and prevent any changes being made to it.
