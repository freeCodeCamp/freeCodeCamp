...
Ваш другий об’єкт у масиві `products` повинен мати властивість `name` зі значенням `French Macaroon`.
...
Ваш другий об’єкт у масиві `products` повинен мати властивість `category` зі значенням `Macaroon`.
...
Ваш сьомий об’єкт у масиві `products` повинен мати властивість `name` зі значенням `Chocolate Macaroons (4 Pack)`.
...
Ваш десятий об’єкт у масиві `products` повинен мати властивість `category` зі значенням `Macaroon`.
...
Ваш одинадцятий об’єкт у масиві `products` повинен мати властивість `name` зі значенням `Vanilla Macaroons (5 Pack)`.
...
Ваш одинадцятий об’єкт у масиві `products` повинен мати властивість `category` зі значенням `Macaroon`.
