...
Ваш другий об’єкт у масиві `products` повинен мати властивість `name` зі значенням `French Macaron`.
...
Ваш другий об’єкт у масиві `products` повинен мати властивість `category` зі значенням `Macaron`.
...
Ваш сьомий об’єкт у масиві `products` повинен мати властивість `name` зі значенням `Chocolate Macarons (4 Pack)`.
...
Ваш десятий об’єкт у масиві `products` повинен мати властивість `category` зі значенням `Macaron`.
...
Ваш одинадцятий об’єкт у масиві `products` повинен мати властивість `name` зі значенням `Vanilla Macarons (5 Pack)`.
...
Ваш одинадцятий об’єкт у масиві `products` повинен мати властивість `category` зі значенням `Macaron`.
