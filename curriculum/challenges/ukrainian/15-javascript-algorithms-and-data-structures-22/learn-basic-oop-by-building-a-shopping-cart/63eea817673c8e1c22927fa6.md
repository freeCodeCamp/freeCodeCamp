...
Використайте `const` та деструктуризацію, щоб добути змінні `name` та `price` з `product`.

# --hints--

Ви повинні використати деструктуризацію, щоб взяти змінні `name` та `price`.
...
Ви повинні використати деструктуризацію, щоб взяти змінні `name` та `price` з `product`.
