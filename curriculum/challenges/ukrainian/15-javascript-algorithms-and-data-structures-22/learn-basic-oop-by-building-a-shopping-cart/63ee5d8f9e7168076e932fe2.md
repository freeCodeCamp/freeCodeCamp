...
Після свого елемента `h2` створіть два елементи `p`. Дайте першому `class` типу `dessert-price` та текст змінної `price` зі знаком долара перед ним. Дайте другому `class` типу `product-category`, та текст `Category:`, за яким слідує значення змінної `category`.
...
Ваш перший елемент `p` повинен мати текст змінної `price` зі знаком долара перед ним.
...
Ваш другий елемент `p` повинен мати текст `Category:`, за яким слідує значення змінної `category`.
