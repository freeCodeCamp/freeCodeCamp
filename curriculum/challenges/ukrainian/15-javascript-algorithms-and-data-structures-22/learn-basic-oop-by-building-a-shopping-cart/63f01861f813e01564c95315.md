...
Всередині вашого `div` додайте два елементи `p`. Встановіть текст другого елемента `p` як значення змінної `price`.

# --hints--

Необхідно додати два елементи `p` всередині свого елемента `div`.
...
Ваш другий елемент `p` повинен мати текст змінної `price`.
