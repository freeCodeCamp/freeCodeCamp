...
Наприкінці після своїх елементів `p` створіть елемент `button`. Надайте йому `id` встановленим на значення змінної `id`, `class` типу `btn add-to-cart-btn` та використайте `Add to cart` для тексту.
...
Ваш елемент `button` повинен мати текст `Add to cart`.
