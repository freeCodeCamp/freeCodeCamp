...
Наприкінці, оновіть властивість `display` об’єкта `style` змінної `cartContainer` до іншого потрійного, який перевіряє, чи `isCartShowing` істинна. If it is, set the `display` property to `"block"`, otherwise set it to `"none"`.
