...
Тепер присвойте `textContent` змінної `showHideCartSpan` результат потрійного виразу, який перевіряє, чи значення `isCartShowing` є істинним. If it is, set the `textContent` to `"Hide"`, otherwise set it to `"Show"`.
