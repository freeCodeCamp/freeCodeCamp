...
Щоб виправити це, ви можете використати оператор `||`, щоб встановити значення на `0`, якщо воно не існує. Wrap your right-hand `totalCountPerProduct[dessert.id]` in parentheses, and add `|| 0` to the end of the expression.
