...
Declare a `rangeExpanded` variable and assign it the result of calling the `.replace()` method of your `x` parameter. Передайте змінну `rangeRegex` як аргумент.
...
Ви повинні використати `const`, щоб оголосити змінну `rangeExpanded`.
