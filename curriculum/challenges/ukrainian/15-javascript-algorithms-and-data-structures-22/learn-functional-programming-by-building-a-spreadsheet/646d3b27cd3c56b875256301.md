...
Declare a `cellExpanded` variable and assign it the value of calling `.replace()` on your `rangeExpanded` variable. Pass it your `cellRegex` and an empty callback function. Функція зворотного виклику має приймати параметр `match`.

# --hints--

Ви повинні оголосити змінну `cellExpanded`.
...
Ви повинні використати `const`, щоб оголосити змінну `cellExpanded`.
...
Ви повинні передати `cellRegex` як перший аргумент до виклику `.replace()`.
