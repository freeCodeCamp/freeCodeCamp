...
Ви повинні передати `arg1` як перший аргумент до виклику `infixToFunction[operator]`.
...
Ви повинні передати `arg2` як другий аргумент до виклику `infixToFunction[operator]`.
