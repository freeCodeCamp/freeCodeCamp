...
Ви повинні використати `let`, щоб оголосити змінну під назвою `startingIndex`.
...
Ви повинні використати `let`, щоб оголосити змінну під назвою `endingIndex`.
...
Ви повинні використати `let`, щоб оголосити змінну під назвою `authorDataArr`.
