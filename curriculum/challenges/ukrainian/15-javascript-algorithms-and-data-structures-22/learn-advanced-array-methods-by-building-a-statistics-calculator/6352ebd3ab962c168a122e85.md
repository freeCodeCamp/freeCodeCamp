...
Ваша функція `getMode` повинна мати змінну `highest`.
...
Функція `getMode` повинна використовувати метод `Object.keys()`, щоб отримати ключі об’єкта `counts` та присвоїти їх до змінної `highest`.
