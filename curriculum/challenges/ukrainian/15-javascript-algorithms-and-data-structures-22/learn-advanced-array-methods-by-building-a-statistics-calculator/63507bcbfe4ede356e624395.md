...
Use the `/,\s*/g` regex to split the `value` string by commas. You can tweak it based on the number of spaces separating your values. Збережіть масив у змінній `array`.
