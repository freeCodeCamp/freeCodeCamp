...
Почніть з компоненту `DisplayMessages`. Додайте конструктора до цього компонента та ініціалізуйте його станом, який має дві властивості: `input` зі значенням порожнього рядка та `messages` зі значенням порожнього масиву.
