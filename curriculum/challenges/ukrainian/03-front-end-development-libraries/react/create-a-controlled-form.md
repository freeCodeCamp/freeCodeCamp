...
**Примітка:** ви також маєте викликати `event.preventDefault()` в обробнику надсилання, щоб уникнути поведінку надсилання форми за замочуванням, що оновлює сторінку. Ми відключили поведінку за замовчуванням для вашої зручності, щоб уникнути оновлення та скидання завдання.
