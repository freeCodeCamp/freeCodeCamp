...
title: Надавайте браузеру доступ до Вашого сайту тільки через HTTPS за допомогою theylmet.hsts()
challengeType: 2
forumTopicId: 301573
...
проміжне програмне забезпечення theylmet.hsts() необхідно правильно встановити
