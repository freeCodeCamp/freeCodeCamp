...
Напишіть функцію, щоб відсортувати масив цілих чисел (будь-якого зручного розміру) у порядку зростання за допомогою сортування млинцями. Функція має повернути відсортований масив.
...
Можна перевернути лише один кінець списку. Це має бути нижня межа, але допустима й верхня межа, якщо її легше запрограмувати або вона краще працює, але це **повинен** бути один і той самий кінець для повного розв’язку. (Перевернутий кінець не можна змінити довільно.)
