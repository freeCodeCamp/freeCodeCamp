...
Знайдіть розв’язки до головоломки *«Сума 100»*.

Додайте (вставте) математичні оператори **+** або **─** (плюс або мінус) перед будь-якою цифрою в десятковому числовому рядку **123456789**, щоб отриманий математичний вираз дорівнював певній сумі (в цьому випадку **100**).
...
Напишіть функцію, яка приймає число як параметр. Ця функція має повернути масив, який містить всі розв’язки для даного числа. Розв’язками мають бути рядки у вигляді виразів. Наприклад, "1+23-456+78-9". Відсортуйте масив, перш ніж повернути його.
