...
Напишіть функцію, щоб відсортувати масив (або список) рядків за зменшенням довжини і за зростанням лексикографічного порядку, якщо рядки однакової довжини.
