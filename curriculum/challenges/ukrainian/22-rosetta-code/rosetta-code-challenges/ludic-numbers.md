...
Грайливі числа пов’язані з простими числами, оскільки вони генеруються за допомогою алгоритму, дуже схожого на решето Ератосфена, яке використовують для генерації простих чисел.

Першим грайливим числом є 1.

Щоб згенерувати наступні грайливі числа, створіть масив зі зростаючих цілих чисел, починаючи з 2.
...
<ul>
  <li>Візьміть перший член отриманого масиву як наступне грайливе число <span style='color:blue;font-weight:bold'>2</span>.</li>
  <li>Видаліть кожен <strong>2<sup>-ий</sup></strong> елемент з масиву (включно з першим).</li>
...
<ul>
  <li>(Виконання декількох циклів...)</li>
  <li>Візьміть перший член отриманого масиву як наступне грайливе число <span style='color:blue;font-weight:bold'>3</span>.</li>
  <li>Видаліть кожен <strong>3<sup>-ій</sup></strong> елемент з масиву (включно з першим).</li>
...
<ul>
  <li>Візьміть перший член отриманого масиву як наступне грайливе число <span style='color:blue;font-weight:bold'>5</span>.</li>
  <li>Видаліть кожен <strong>5<sup>-ий</sup></strong> елемент з масиву (включно з першим).</li>
...
<ul>
  <li>Візьміть перший член отриманого масиву як наступне грайливе число <span style='color:blue;font-weight:bold'>7</span>.</li>
  <li>Видаліть кожен <strong>7<sup>-ий</sup></strong> елемент з масиву (включно з першим).</li>
...
<ul>
  <li><big><b> ... </b></big></li>
  <li>Візьміть перший член поточного масиву як наступне грайливе число <span style='color:blue;font-weight:bold'>L</span>.</li>
  <li>Видаліть кожен <strong>L<sup>-ий</sup></strong> елемент з масиву (включно з першим).</li>
  <li><big><b> ... </b></big></li>
</ul>

# --instructions--

Напишіть функцію, яка повертає всі грайливі числа, які є меншими або дорівнюють даному числу.
