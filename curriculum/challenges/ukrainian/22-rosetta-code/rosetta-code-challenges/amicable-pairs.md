...
Сума дільників для першого значення, **1184**, це **1210**, а сума дільників для другого значення, **1210**, це **1184**.

# --instructions--

Порахуйте та покажіть тут дружні числа менші 20 000 (тут їх вісім).
