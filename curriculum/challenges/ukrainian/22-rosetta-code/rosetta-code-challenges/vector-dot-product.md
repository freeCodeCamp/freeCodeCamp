...
Напишіть функцію, яка приймає два вектори (представлені як одновимірні масиви) як ввід та обчислює їхній скалярний добуток. Функція має повернути `null`, якщо ввід недійсний (наприклад, надано вектори різної довжини або передано інші дані, а не вектори).
