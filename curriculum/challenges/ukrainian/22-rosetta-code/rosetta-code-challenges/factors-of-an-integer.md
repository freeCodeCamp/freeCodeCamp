...
Напишіть функцію, яка повертає множники натурального числа у вигляді масиву.

Якщо задане число поділити на ці множники, то отримаємо результат у вигляді натурального числа.
