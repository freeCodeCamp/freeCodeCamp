...
JavaScript розпізнає сім примітивних (незмінних) типів даних: `Boolean`, `Null`, `Undefined`, `Number`, `String`, `Symbol` (новий з ES6) та `BigInt` (новий з ES2020), та один тип для змінних елементів: `Object`. Візьміть до уваги, що у JavaScript масиви технічно є типом об'єкту.
