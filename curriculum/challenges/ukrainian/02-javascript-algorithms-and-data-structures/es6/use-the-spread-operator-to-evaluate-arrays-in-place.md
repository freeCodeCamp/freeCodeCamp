...
`...arr` повертає запакований масив. Іншими словами, це *розширює* масив. Однак оператор розширення працює лише на місці, наприклад, в аргументі функції чи літералі масиву. Наступний код не буде працювати:
