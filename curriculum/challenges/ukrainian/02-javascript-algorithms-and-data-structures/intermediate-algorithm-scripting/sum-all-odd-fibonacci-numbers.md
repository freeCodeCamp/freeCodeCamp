...
The first two numbers in the Fibonacci sequence are 0 and 1. Кожне додаткове число у послідовності є сумою двох попередніх чисел. The first seven numbers of the Fibonacci sequence are 0, 1, 1, 2, 3, 5 and 8.
