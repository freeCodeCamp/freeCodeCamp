...
1. Перейдіть до <a href="https://learn.microsoft.com/training/modules/challenge-project-create-mini-game/" target="_blank">https://learn.microsoft.com/training/modules/challenge-project-create-mini-game/</a> та виконайте всі завдання модуля «Проєкт завдання: створіть міні гру». Це обов’язково, щоб отримати трофей «Створення методів в консольних застосунках C#».
