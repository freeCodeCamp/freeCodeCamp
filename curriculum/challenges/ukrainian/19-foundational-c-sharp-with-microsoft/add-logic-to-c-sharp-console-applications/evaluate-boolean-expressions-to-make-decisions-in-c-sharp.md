...
1. Перейдіть до <a href="https://learn.microsoft.com/training/modules/csharp-evaluate-boolean-expressions/" target="_blank">https://learn.microsoft.com/training/modules/csharp-evaluate-boolean-expressions/</a> та виконайте всі завдання модуля «Оцініть булеві вирази, щоб прийняти рішення в C#». Це обов’язково, щоб отримати трофей «Додавання логіки до консольних застосунків C#».
