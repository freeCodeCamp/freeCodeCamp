...
П'ятикутні числа обчислюються за формулою P<sub>n</sub>=`n`(3`n`−1)/2. Перші десять п'ятикутних чисел:

1, 5, 12, 22, 35, 51, 70, 92, 117, 145, ...

Бачимо, що P<sub>4</sub> + P<sub>7</sub> = 22 + 70 = 92 = P<sub>8</sub>. Проте їх різниця, 70 − 22 = 48, не є п'ятикутним числом.

Знайдіть пару п'ятикутних чисел, P<sub>j</sub> і P<sub>k</sub>, для яких їхня сума та різниця є п’ятикутними числами, а значення D = |P<sub>k</sub> − P<sub>j</sub> зводиться до мінімуму; яке значення D?
...
`pentagonNumbers()` має повернути число 5482660.
