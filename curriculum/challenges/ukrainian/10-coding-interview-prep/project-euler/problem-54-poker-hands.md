...
title: 'Завдання 54: Покерні комбінації'
challengeType: 1
forumTopicId: 302165
...
У картковій грі покер комбінація складається з п'яти карт і оцінюється від найменшої до найстаршої в такому порядку:

<ul>
  <li>Старша карта: Найстарша за значенням карта.</li>
  <li>Одна пара: Дві карти одного значення.</li>
  <li>Дві пари: Дві різні пари.</li>
  <li>Трійка: Три карти одного значення.</li>
  <li>Стріт: Всі карти мають послідовні значення.</li>
  <li>Флеш: Всі карти однієї масті.</li>
  <li>Фул-хаус: Три карти одного значення та дві іншого.</li>
  <li>Каре: Чотири карти одного значення.</li>
  <li>Стріт-флеш: Всі карти однієї масті, що йдуть у порядку зростання.</li>
  <li>Роял-флеш: Десятка, валет, дама, король і туз однієї масті.</li>
</ul>

Значення карт оцінюється у порядку: 2, 3, 4, 5, 6, 7, 8, 9, 10, валет, дама, король, туз.

Якщо у двох гравців комбінації одного порядку, то виграє той, у кого карти старшого значення: наприклад, дві вісімки виграють дві п'ятірки (див. приклад 1 нижче). Якщо ж значення карт у гравців однакові, наприклад, у обох гравців пара дам, то порівнюють найстарші карти у кожній комбінації (див. приклад 4 нижче); якщо ж і ці карти однакові, порівнюють наступні дві і т. д.

Розглянемо наступні п'ять комбінацій, які роздали двом гравцям:

| Комбінація                | Гравець 1                                                                | Гравець 2                                                             | Переможець |
| ------------------------- | ------------------------------------------------------------------------ | --------------------------------------------------------------------- | ---------- |
| <strong>1</strong> | 5H 5C 6S 7S КД <br> Пара п'ятірок                                  | 2C 3S 8S 8D TD <br> Пара вісімок                                | Гравець 2  |
| <strong>2</strong> | 5D 8C 9S JS AC <br> Найстарша карта - туз                          | 2C 5C 7D 8S QH <br> Найстарша карта - дама                      | Гравець 1  |
| <strong>3</strong> | 2D 9C AS AH AC <br> Три тузи                                       | 3D 6D 7D TD QD <br> Флеш з бубнами                              | Гравець 2  |
| <strong>4</strong> | 4D 6S 9H QH QC <br> Пара дам <br> Найстарша карта - дев'ятка | 3D 6D 7H QD QS <br> Пара дам <br> Найстарша карта - сімка | Гравець 1  |
| <strong>5</strong> | 2H 2D 4C 4D 4S <br> Фул-хаус <br> з трьома четвірками        | 3C 3D 3S 9S 9D <br> Фул-хаус <br> з трьома трійками       | Гравець 1  |

Глобальний масив (`handsArr`) переданий до функції, складається з тисячі випадкових карт, які розподілені між гравцями. У кожному рядку файлу є десять карт (розділених одним пробілом): перші п'ять - це карти 1-го гравця, а ті п'ять, що залишилися - карти 2-го гравця. Можете вважати, що всі комбінації правильні (немає недопустимих символів або повторів карт), роздача карт гравцям проводиться не у визначеному порядку, і що при кожній роздачі є безумовний переможець.

Скільки комбінацій виграє 1-й гравець?
...
`pokerHands(testArr)` має повернути число 2.

```js
assert.strictEqual(pokerHands(testArr), 2);
```

`pokerHands(handsArr)` має повернути число 376.
