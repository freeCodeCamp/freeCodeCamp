...
Чотири суміжні цифри у 1000-цифровому числі, які мають найбільший добуток, це 9 × 9 × 8 × 9 = 5832.
...
Знайдіть `n` суміжних цифр у 1000-цифровому числі, які мають найбільший добуток. Яке значення має цей добуток?
...
`largestProductinaSeries(4)` має повернути число 5832.

```js
assert.strictEqual(largestProductinaSeries(4), 5832);
```

`largestProductinaSeries(13)` має повернути число 23514624000.
