...
Скажімо, що `n`-цифрове число є панцифровим, якщо воно використовує всі цифри від 1 до `n` лише один раз. Наприклад, 2143 є 4-значним панцифровим числом, яке також є простим.

Яким є найбільше `n`-значне панцифрове просте число, що існує?
...
`pandigitalPrime(4)` має повернути число 4231.

```js
assert(pandigitalPrime(4) == 4231);
```

`pandigitalPrime(7)` має повернути число 7652413.
