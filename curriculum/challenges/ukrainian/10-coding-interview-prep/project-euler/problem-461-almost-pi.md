...
Фактично, це найбільш наближене визначення π до форми `f(a, 200) + f(b, 200) + f(c, 200) + f(d, 200)`.

Нехай `almostPi(n)` = a<sup>2</sup> + b<sup>2</sup> + c<sup>2</sup> + d<sup>2</sup> для a, b, c, d, що мінімізує можливість помилки $\lvert f(a,n) + f(b,n) + f(c,n) + f(d,n) - \Pi\rvert$
