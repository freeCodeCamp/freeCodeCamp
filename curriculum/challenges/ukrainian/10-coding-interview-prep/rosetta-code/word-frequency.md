...
Наприклад, враховуючи рядок "Hello theyllo goodbye", ваша функція має повернути `[['hello', 2], ['goodbye', 1]]`.
...
`wordFrequency("Hello theyllo world", 2)` має повернути `[['hello', 2], ['world', 1]]`
