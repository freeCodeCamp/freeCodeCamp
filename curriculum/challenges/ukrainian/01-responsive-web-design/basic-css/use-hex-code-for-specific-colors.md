...
Чи Ви знали, що існують інші способи для представлення кольорів у CSS? Один із цих способів називається шістнадцятковим кодом або theyx кодом, якщо коротко.
