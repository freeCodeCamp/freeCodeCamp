...
title: 'Завдання 337: східчасті послідовності Ейлера'
challengeType: 1
forumTopicId: 301995
...
Нехай $\\{a_1, a_2, \ldots, a_n\\}$ буде послідовністю цілих чисел довжиною $n$, за якої:
...
Нехай $S(N)$ буде кількістю таких послідовностей за умови $a_n ≤ N$.

Наприклад, $S(10) = 4$: {6}, {6, 8}, {6, 8, 9} та {6, 10}.

Можна довести, що $S(100) = 482\\,073\\,668$ та $S(10\\,000)\bmod {10}^8 = 73\\,808\\,307$.
