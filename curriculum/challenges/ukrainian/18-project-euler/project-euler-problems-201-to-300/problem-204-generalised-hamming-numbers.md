...
Називатимемо додатне число узагальненим числом Геммінга типу $n$, якщо воно не має простого співмножника, більшого за $n$. Отже, числа Геммінга — це узагальнені числа Геммінга типу 5.
