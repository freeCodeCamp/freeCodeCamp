...
Нехай $S = \\{2, 3, 5, \ldots, 4999\\}$ буде множиною простих чисел менших за 5000.

Знайдіть кількість підмножин $S$, сума елементів яких є простим числом.

Введіть останні 16 цифр як відповідь.
