...
Послідовність трикутних чисел утворюється додаванням натуральних чисел. Отже, сьомим трикутним числом буде 1 + 2 + 3 + 4 + 5 + 6 + 7 = 28. Першими десятьма складовими послідовності будуть:
