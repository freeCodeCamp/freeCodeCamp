...
Легко довести, що КОЖНЕ початкове число рано чи пізно замкне ланцюг. Наприклад,

$$\begin{align} &69 → 363600 → 1454 → 169 → 363601\\ (→ 1454)\\\\
&78 → 45360 → 871 → 45361\\ (→ 871)\\\\ &540 → 145\\ (→ 145)\\\\
\end{align}$$

Починаючи з 69, ми отримаємо ланцюг з 5 неповторюваних членів, але найдовший ланцюг з початковим числом менше одного мільйона містить шістдесят неповторюваних членів.

Скільки ланцюгів з початковим числом менше `n` містять шістдесят неповторюваних членів?
