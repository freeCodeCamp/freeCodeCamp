...
Замінивши першу цифру двозначного числа \*3, виявляється, що шість із дев’яти можливих значень (13, 23, 43, 53, 73 та 83) є простими числами.

При заміні третьої і четвертої цифри числа 56\*\*3 однаковими цифрами, виходить, що це п’ятизначне число — перший приклад, який містить сім простих чисел з десяти: 56003, 56113, 56333, 56443, 56663, 56773 та 56993. Число 56003, будучи першим членом цієї послідовності, є найменшим простим числом з цією властивістю.

Знайдіть найменше просте число, яке при заміні частини числа (не обов’язково сусідніх цифр) тією самою цифрою буде частиною послідовності з `n` простих чисел.
