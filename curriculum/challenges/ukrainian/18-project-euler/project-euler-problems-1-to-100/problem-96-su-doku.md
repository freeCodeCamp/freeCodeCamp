...
Судоку (з японської * розміщення чисел*) — це назва популярної головоломки. Її походження невідоме, проте варто згадати Леонарда Ейлера, який створив схожий, але набагато складніший пазл під назвою «Латинський квадрат». Мета судоку — заповнити пусті клітинки (або нулі) на полі 9×9 таким чином, щоб кожен ряд, стовпець і квадрат 3×3 містив усі цифри від 1 до 9. Нижче наведено приклад початкового поля судоку і поля з уже вирішеною головоломкою.
