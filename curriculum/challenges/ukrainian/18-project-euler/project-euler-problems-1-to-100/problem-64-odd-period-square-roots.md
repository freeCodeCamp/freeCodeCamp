...
Усі квадратні корені є періодичними, якщо їх записати у вигляді неперервних дробів наступним чином:

$\\displaystyle \\quad \\quad \\sqrt{N}=a_0+\\frac 1 {a_1+\\frac 1 {a_2+ \\frac 1 {a3+ \\dots}}}$

Наприклад, розгляньмо $\\sqrt{23}$:
...
Чотири неперервні дроби за умови $N \\le 13$ мають непарний період.

Скільки неперервних дробів за умови $N \\le n$ мають непарний період?
