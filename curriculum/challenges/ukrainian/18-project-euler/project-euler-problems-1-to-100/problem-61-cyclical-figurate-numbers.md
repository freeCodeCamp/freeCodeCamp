...
Трикутні, квадратні, п’ятикутні, шестикутні, семикутні і восьмикутні числа є фігурними (багатокутними) числами, які визначаються за такими формулами:
...
Впорядкована множина з трьох чотиризначних чисел (8128, 2882, 8281) має три цікаві властивості.

1. Множина є циклічною, оскільки дві останні цифри кожного числа є першими двома цифрами наступного числа (включно з останнім та першим числом).
...
3. Це єдина множина чотиризначних чисел з цією властивістю.

Знайдіть суму всіх чисел у впорядкованих множинах з `n` циклічних чотиризначних чисел, в яких кожен з типів багатокутника від $P_3$ до $P_{n + 2}$ представлений іншим числом цієї множини.
