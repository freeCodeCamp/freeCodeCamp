...
Let $N(a,b,c)$ be the number of configurations of type $(a,b,c)$. Наприклад, $N(1,0,3) = 24$, $N(0,2,4) = 92928$ та $N(2,2,3) = 20736$.

Знайдіть останні вісім цифр числа $N(25,75,1984)$.
