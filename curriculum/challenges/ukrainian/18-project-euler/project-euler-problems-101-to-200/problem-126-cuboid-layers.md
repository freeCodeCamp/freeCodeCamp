...
Мінімальна кількість кубів, необхідних для того, щоб охопити кожну видиму грань прямокутного паралелепіпеда розміром 3 x 2 x 1, становить двадцять два.
...
Однак перший шар на паралелепіпеді розміром 5 x 1 x 1 також вимагає двадцяти двох кубів, а перший шар на паралелепіпедах розмірами 5 x 3 x 1, 7 x 2 x 1 та 11 x 1 x 1 вимагає сорок шість кубів.

Визначимо $C(n)$ як число паралелепіпедів, які містять $n$ кубів в одному зі своїх шарів. Отже, $C(22) = 2$, $C(46) = 4$, $C(78) = 5$ і $C(118) = 8$.
