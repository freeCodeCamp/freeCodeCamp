...
Можна довести, що многочлен $n^4 + 4n^3 + 2n^2 + 5n$ кратний 6 за кожного цілого $n$. Також можна довести, що 6 є найбільшим цілим числом, яке задовільняє цю властивість.

Визначимо $M(a, b, c)$ як максимальне значення $m$, за якого $n^4 + an^3 + bn^2 + cn$ є кратним $m$ для всіх цілих $n$. Наприклад, $M(4, 2, 5) = 6$.
