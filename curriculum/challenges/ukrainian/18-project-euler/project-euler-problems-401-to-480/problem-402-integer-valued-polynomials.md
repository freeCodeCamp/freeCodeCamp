...
Define $M(a, b, c)$ as the maximum $m$ such that $n^4 + an^3 + bn^2 + cn$ is a multiple of $m$ for all integers $n$. Наприклад, $M(4, 2, 5) = 6$.
...
Знайдіть останні дев’ять цифр $\sum S(F_k)$ за умови $2 ≤ k ≤ 1\\,234\\,567\\,890\\,123$.
