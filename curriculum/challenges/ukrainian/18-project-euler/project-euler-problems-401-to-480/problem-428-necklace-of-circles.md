...
Триплет ($a$, $b$, $c$) називають *триплетом намиста*, якщо можна розмістити $k ≥ 3$ окремих кіл $C_1, C_2, \ldots, C_k$, за яких:
...
Наприклад, (5, 5, 5) та (4, 3, 21) є триплетами намиста, а (2, 2, 5) — ні.
