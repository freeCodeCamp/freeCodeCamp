...
With the *Present Perfect* tense, you use the form `become` after `have` or `has`, meaning it is a change that still influences you. Наприклад, `I've become interested in video games at age 20`.
