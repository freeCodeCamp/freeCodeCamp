...
In the Present Perfect Tense, `for` and `since` are used to discuss time duration and starting points. `For` вказує, скільки часу відбувається дія. `Since` вказує, коли дія розпочалась.
