...
In the Present Perfect Tense, y`for` and `since` are used to discuss time duration and starting points. `For` tells how long something has been happening. `Since` tells when something started.
