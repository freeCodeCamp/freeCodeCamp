...
You say you `recommend` that someone does something when you tell this person that what you suggest is a good, maybe the best choice for them. Наприклад, `I recommend that you read this book. It's the best on the topic.` When you have actions following the verb `recommend`, use them in the `-ing` form. Наприклад, `I recommend reading this book if you want to understand this topic better`.
