...
`After that` is often used to indicate what comes next in a series of actions or events. Наприклад:
...
A phrase indicating the next step in a sequence. Напишіть це слово з великої літери.
