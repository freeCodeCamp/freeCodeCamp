...
**Примітка:** ви повинні повернути оновлений документ. Для цього потрібно передати опції документа `{ new: true }` до `findOneAndUpdate()` як третій аргумент. За замовчуванням ці методи повертають незмінений об’єкт.
