...
D3 має два методи: `axisLeft()` та `axisBottom()`, щоб відтворити вісь y та вісь x відповідно. Ось приклад для створення осі Х на основі `xScale` у попередніх завданнях:
...
Елемент осі y `g` повинен мати атрибут `transform`, який переміщує вісь на `(60, 0)`.
