...
## Anchor Elements
To create a link in HTML, you use the anchor element. Ein Anchor-Element wird definiert, indem man den Text oder ein anderes HTML-Element, welches ein Link sein soll, mit einem `<a>`-Tag umgibt. Add the following to the `body` of the `index.html` page you created and open it in the browser:
