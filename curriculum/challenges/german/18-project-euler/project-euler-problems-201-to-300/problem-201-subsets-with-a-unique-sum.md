...
Einige dieser Summen kommen mehrmals vor, andere sind einmalig. Für eine Menge $A$ sei $U(A,k)$ die Menge der eindeutigen Beträge von $k$-Element-Teilmengen von $A$, in unserem Beispiel finden wir $U(B,3) = \\{10,12,14,18,21,25,27,29\\}$ und $sum(U(B,3)) = 156$.
