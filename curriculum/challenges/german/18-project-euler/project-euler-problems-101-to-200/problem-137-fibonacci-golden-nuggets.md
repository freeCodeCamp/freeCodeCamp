...
title: 'Problem 137: Fibonacci Goldnuggets'
challengeType: 1
forumTopicId: 301765
...
Für dieses Problem sind wir an Werten von $x$ interessiert, für die $A_{F}(x)$ eine positive Integer ist.
...
Wir nennen $A_F(x)$ einen Goldnugget, wenn $x$ rational ist, weil sie immer seltener werden; zum Beispiel ist der 10. Goldnugget 74049690.

Finde den 15. Goldnugget.
