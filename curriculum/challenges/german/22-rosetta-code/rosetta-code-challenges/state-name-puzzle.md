...
title: Staatliches Namensrätsel
challengeType: 1
forumTopicId: 302323
...
Die Funktion sollte ein Array zurückgeben. Jedes Element sollte ein Objekt in dieser Form sein: `{"from":[],"to":[]}`. Die `from`-Anordnung sollte die ursprünglichen Namen enthalten und die `to`-Anordnung sollte die resultierenden Namen enthalten.
