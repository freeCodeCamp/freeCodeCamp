...
Dein neues `input`-Element sollte nur ein `type`-Attribut haben. Remove any extras.
...
The text `Indoor` should be located directly to the right of your `radio` button. Du hast entweder den Text weggelassen oder einen Tippfehler gemacht.
