...
In Formularen werden häufig Kontrollkästchen für Fragen verwendet, die mehr als eine Antwort haben können. Hier ist zum Beispiel ein Kontrollkästchen mit der Option `tacos`: `<input type="checkbox"> tacos`.
