...
Ein (`figcaption`)-Element für die Beschriftung der Abbildung wird verwendet, um eine Beschriftung hinzuzufügen, die das Bild im `figure`-Element beschreibt. Zum Beispiel fügt `<figcaption>A cute cat</figcaption>` die Beschriftung `A cute cat` hinzu.
