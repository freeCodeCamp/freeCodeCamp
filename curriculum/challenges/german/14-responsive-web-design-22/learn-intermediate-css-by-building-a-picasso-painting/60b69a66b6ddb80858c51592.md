...
Verwende einen Klassenselektor, um mit der `black-dot`-Klasse eine Regel für die Elemente zu erstellen. Set the `width` to `10px`, the `height` to `10px`, and the `background-color` to `rgb(45, 31, 19)`.
