...
Dein `#black-character`-Selektor sollte eine `position`-Eigenschaft von `absolute` haben.
...
Dein `#black-character`-Selektor sollte eine `left`-Eigenschaft von `59%` haben.
