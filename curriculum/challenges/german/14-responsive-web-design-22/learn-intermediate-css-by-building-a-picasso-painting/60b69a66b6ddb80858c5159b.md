...
Zeit einige FontAwesome Symbole zu verwenden.
...
Diese spezielle Klasse bestimmt, wie FontAwesome festlegt, welches Symbol geladen werden soll. `fas` indicates the category of icons (FontAwesome Solid, here), while `fa-music` selects the specific icon.
