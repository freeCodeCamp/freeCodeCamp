...
Verwende einen id-Selektor, um eine Regel für die ID `guitar-neck` zu erstellen. Setze die `width` auf `200px`, die `height` auf `30px` und den `background-color` auf `#D2691E`.

# --hints--

Du solltest einen `#guitar-neck`-Selektor erstellen.
