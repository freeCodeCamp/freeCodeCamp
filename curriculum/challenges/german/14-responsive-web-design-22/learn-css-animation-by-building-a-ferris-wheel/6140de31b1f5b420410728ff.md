...
Gib der `@keyframes wheel`-Regel einen `100%`-Selektor. Darin setzt du `transform` auf `rotate(360deg)`. Damit wird deine Animation nun eine komplette Rotation durchführen.
