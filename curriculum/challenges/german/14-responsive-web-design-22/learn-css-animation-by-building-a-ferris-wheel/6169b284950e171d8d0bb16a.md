...
Erstelle schließlich einen neuen `75%`-Selektor zwischen deinen `50%`- und `100%`-Selektoren. Gib diesem neuen Selektor eine `background-color` Eigenschaft von `yellow`.
