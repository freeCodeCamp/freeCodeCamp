...
Ensure your years do not get hidden by setting a `z-index` of `999`. Gib ihm dann eine `margin` von `0 -2px`, und ein `padding` von `0.5rem calc(1.25rem + 2px) 0.5rem 0`.
...
Dein `#years`-Selektor sollte eine `padding`-Eigenschaft auf `0.5rem calc(1.25rem + 2px) 0.5rem 0` gesetzt haben.
