...
Füge anschließend drei `td`-Elemente mit dem folgendem Text hinzu (in dieser Reihenfolge): `$500`, `$650`, `$728`. Give the third `td` element a `class` attribute set to `current`.
