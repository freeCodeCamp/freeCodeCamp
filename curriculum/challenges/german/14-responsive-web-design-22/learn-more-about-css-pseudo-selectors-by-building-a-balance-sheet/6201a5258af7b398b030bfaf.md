...
Deine Dollarbeträge sind derzeit falsch eingestellt. Erstelle einen Selektor, um die `td`-Elemente innerhalb deines `tr.data`-Elements auszuwählen. Vertically align the text to the top, horizontally align the text to the right, and set the padding to `0.3rem 0.25rem 0`.
