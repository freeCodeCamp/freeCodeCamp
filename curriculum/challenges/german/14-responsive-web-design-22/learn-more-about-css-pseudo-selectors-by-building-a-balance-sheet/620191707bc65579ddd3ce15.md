...
Using the same selector syntax, target the `th` elements within your table rows where the `class` is `total`. Richte den Text links aus und gib ihm einen Padding-Wert von `0.5rem 0 0.25rem 0.5rem`.
