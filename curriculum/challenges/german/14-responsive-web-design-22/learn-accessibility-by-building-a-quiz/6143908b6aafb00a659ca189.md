...
Keeping in mind best-practices for form inputs, give each `input` an appropriate `type` and `name` attribute. Gib anschließend dem ersten `input` ein `placeholder`-Attribut.
