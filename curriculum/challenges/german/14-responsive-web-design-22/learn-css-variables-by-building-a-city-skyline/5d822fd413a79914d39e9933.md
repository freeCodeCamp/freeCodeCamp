...
Füge ein weiteres `repeating-linear-gradient` unterhalb des gerade hinzugefügten hinzu. Weise ihm eine `90deg`-Richtung zu, verwende deine Baufarbe von `0%` bis `12%` und Fensterfarbe von `12%` bis `44%`. Dies wird eine Reihe von Rechteckfenstern erzeugen.
