...
Gib der `sky`-Klasse einen `radial-gradient`. Verwende `#ffcf33` von `0%` bis `20%`, `#ffff66` auf `21%` und `#bbeeff` auf `100%`. Dies wird einen kreisförmigen Farbverlauf zum Hintergrund hinzufügen, der deine Sonne sein wird.
