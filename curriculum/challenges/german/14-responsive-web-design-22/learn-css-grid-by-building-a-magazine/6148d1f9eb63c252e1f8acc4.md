...
Um dem `hr`-Element eine Farbe zuzuweisen, musst du die `border`-Eigenschaft anpassen. Gib dem `hr`-Selektor eine `border`-Eigenschaft mit dem Wert `1px solid rgba(120, 120, 120, 0.6)`.
