...
Dein Bild benötigt derzeit viel Speicherplatz. Füge, um besser zu sehen, woran du arbeitest, ein `width`-Attribut mit einem Wert von `400` zu dem `img`-Element hinzu.
