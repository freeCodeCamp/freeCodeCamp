...
Um Abstand zwischen den Zeilen im Gitterlayout hinzuzufügen, kannst du die `row-gap`-Eigenschaft verwenden. Gib dem `main`-Selektor eine `row-gap`-Eigenschaft von `3rem`.
