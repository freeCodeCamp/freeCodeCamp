...
Willkommen beim Registrierungsformular-Projekt! Start by adding the `!DOCTYPE html` declaration at the top of the document so the browser knows what type of document it's reading.
