...
Wähle das `.shirt`-Element aus und setze seine `font-size` auf `25px`, die `font-family` auf `Helvetica` mit einem Fallback von `sans-serif` und das `font-weight` auf `bold`.
