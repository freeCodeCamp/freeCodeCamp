...
Position the `.chin` element such that it is `25%` from the top, and `5%` from the left of its parent. Gib dann den oberen Ecken einen Radius von `70%` und den unteren Ecken einen Radius von `100%`.
