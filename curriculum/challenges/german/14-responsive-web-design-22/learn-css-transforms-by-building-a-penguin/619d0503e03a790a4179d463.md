...
Positioniere das `.chin`-Element so, dass es `25%` von oben und `5%` links von seinem übergeordneten Element liegt. Gib dann den oberen Ecken einen Radius von `70%` und den unteren Ecken einen Radius von `100%`.
