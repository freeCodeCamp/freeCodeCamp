...
Füge unter deinem `.chin`-Element zwei `div`-Elemente mit einer `class` von `eye` hinzu. Gib dem ersten `.eye`-Element eine `class` von `left` und dem zweiten `.eye`-Element eine `class` von `right`.
