...
Wähle das `.beak`-Element mit einer `class` von `top` aus, weise ihm eine `width` von `20%` zu und positioniere es `60%` von oben und `40%` links von seinem Elternelement.
