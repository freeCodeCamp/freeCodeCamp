...
Drehe innerhalb des zweiten Wegpunktes auf `130deg` und behalte die Skalierung des linken Arms.

# --hints--

Du solltest den `20%`igen Wegpunkt einen `transform` von `rotate(130deg) scaleX(-1)` geben.
