...
Positioniere das `.shirt`-Element `165px` von oben und `127.5px` links von seinem übergeordneten Element. Then, increase its stacking order such that it appears above the `.penguin-body` element.
