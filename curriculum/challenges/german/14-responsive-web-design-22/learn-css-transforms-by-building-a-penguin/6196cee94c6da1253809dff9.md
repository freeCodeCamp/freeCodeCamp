...
Target the `.back-mountain` element, and set its `width` and `height` to `300px`. Setze dann die `background` auf einen linearen Farbverlauf, der mit `rgb(203, 241, 228)` beginnt und mit `rgb(47, 170, 255)` endet.
