...
The `align-items` property positions the flex content along the cross axis. Wenn deine `flex-direction` auf `row` gesetzt ist, wäre deine Querachse in diesem Fall vertikal.
