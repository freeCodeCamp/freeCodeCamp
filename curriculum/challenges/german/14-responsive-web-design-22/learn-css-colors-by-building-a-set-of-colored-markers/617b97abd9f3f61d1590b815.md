...
In the additive RGB color model, <dfn>primary colors</dfn> are colors that, when combined, create pure white. Doch damit dies geschieht, muss jede Farbe ihre höchste Intensität haben.
