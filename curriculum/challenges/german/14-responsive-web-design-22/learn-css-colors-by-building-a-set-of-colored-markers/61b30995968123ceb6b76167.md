...
If a `blurRadius` value isn't included, it defaults to `0` and produces sharp edges. Je höher der Wert von `blurRadius`, desto größer ist der Verwischungseffekt.
