...
If you inspect your `.label` element with your browser's developer tools, you may notice that it's actually 288 pixels wide instead of 270. Dies liegt daran, dass der Browser standardmäßig den Rand und das Padding enthält, wenn die Größe eines Elements festgelegt wird.
