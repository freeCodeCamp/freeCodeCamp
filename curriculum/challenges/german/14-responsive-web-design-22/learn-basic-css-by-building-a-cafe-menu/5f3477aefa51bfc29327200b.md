...
Du gestaltest drei Elemente, indem du CSS in die `style` -Tags schreibst. This works, but since there will be many more styles, it's best to put all the styles in a separate file and link to it.
