...
Deklariere eine `currValue`-Variable und weise ihr den Wert an der Stelle `i` zu. Deklariere dann eine `j`-Variable und weise ihr `i - 1` zu. Deine `j`-Variable sollte neu zuweisbar sein.
...
Du solltest `currValue` den Wert an der Stelle `i` zuweisen.
