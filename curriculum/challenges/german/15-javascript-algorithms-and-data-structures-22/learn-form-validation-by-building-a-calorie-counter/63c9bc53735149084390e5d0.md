...
Browsers have a built in `alert()` function, which you can use to display a pop-up message to the user. Die anzuzeigende Meldung wird als Argument an die `alert()`-Funktion übergeben.
