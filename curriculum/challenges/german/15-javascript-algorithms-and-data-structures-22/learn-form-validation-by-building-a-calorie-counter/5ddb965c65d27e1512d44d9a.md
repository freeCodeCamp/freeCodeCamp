...
Du hast Boilerplate-CSS und HTML zur Verfügung gestellt bekommen. Du musst jedoch dein Kalorienzähler-Formular erstellen.
...
Dein `form`-Element sollte ein `id`-Attribut auf `calorie-counter` gesetzt haben.
