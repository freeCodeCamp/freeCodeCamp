...
It is time to start writing the script that makes your form work. Beginne damit, das `form`-Element (mit Hilfe der `id`) abzurufen und es in einer Variablen namens `calorieCounter` zu speichern.
