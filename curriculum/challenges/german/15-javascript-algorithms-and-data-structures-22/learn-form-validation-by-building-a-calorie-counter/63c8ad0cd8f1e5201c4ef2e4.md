...
Der `list`-Parameter wird das Ergebnis eines Query-Selektors sein, der eine `NodeList` zurückgeben wird. Eine `NodeList` ähnelt einem Array, der die Elemente enthält, die dem Query-Selektor entsprechen.
