...
Inside the loop, set the `innerHTML` property of the element at the current index to an empty string. Dies wird den gesamten Inhalt des Eingabebehälters löschen.
