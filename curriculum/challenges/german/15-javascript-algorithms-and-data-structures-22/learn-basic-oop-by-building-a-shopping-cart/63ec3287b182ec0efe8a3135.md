...
Dein zweites Objekt im `products`-Array sollte eine `name`-Eigenschaft haben, die auf `French Macaron` gesetzt ist.
...
Dein zweites Objekt im `products`-Array sollte eine `category`-Eigenschaft haben, die auf `Macaron` gesetzt ist.
...
Dein siebtes Objekt im `products`-Array sollte eine `name`-Eigenschaft haben, die auf `Chocolate Macarons (4 Pack)` gesetzt ist.
...
Dein siebtes Objekt im `products`-Array sollte eine `category`-Eigenschaft haben, die auf `Macaron` gesetzt ist.
...
Dein elftes Objekt im`products`-Array sollte eine `name`-Eigenschaft haben, die auf `Vanilla Macarons (5 Pack)` gesetzt ist.
...
Dein elftes Objekt im `products`-Array sollte eine `category`-Eigenschaft haben, die auf `Macaron` gesetzt ist.
