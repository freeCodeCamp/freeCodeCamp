...
Weise nun dem `textContent` der `showHideCartSpan`-Variablen das Ergebnis eines Ternary-Ausdrucks zu, der überprüft, ob `isCartShowing` wahr ist. If it is, set the `textContent` to `"Hide"`, otherwise set it to `"Show"`.
