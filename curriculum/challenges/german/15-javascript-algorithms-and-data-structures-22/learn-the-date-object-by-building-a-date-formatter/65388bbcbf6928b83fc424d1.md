...
In JavaScript wird das `change`-Ereignis verwendet, um zu erkennen, wenn sich der Wert eines HTML-Elements geändert hat:
...
Du solltest eine leere Arrow-Funktion als zweites Argument zu der `addEventListener`-Methode hinzufügen.
