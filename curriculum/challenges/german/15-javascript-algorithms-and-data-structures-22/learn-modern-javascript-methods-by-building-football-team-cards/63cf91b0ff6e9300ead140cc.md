...
Füge unterhalb der `sport`-Eigenschaft eine neue Eigenschaft mit einem Schlüssel namens `year` und dem Nummerwert `1986` hinzu.
...
Deine `year`-Eigenschaft sollte auf `1986` eingerichtet sein.
