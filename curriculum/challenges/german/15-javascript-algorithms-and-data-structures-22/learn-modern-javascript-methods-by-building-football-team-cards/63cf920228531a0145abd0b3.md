...
Füge unterhalb der `year`-Eigenschaft eine neue Eigenschaft mit einem Schlüssel namens `isWorldCupWinner` und einem booleschen Wert, der auf `true` gesetzt ist, hinzu.
...
Deine `isWorldCupWinner`-Eigenschaft sollte ein Boolean sein.
