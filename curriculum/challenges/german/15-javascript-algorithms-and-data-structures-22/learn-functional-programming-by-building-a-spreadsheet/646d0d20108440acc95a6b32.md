...
In deiner `elemValue`-Funktion hast du explizit eine Funktion mit dem Namen `inner` deklariert und diese zurückgegeben. Da du jedoch die Arrow-Syntax verwendest, kannst du eine Funktion implizit zurückgeben. Zum Beispiel:
