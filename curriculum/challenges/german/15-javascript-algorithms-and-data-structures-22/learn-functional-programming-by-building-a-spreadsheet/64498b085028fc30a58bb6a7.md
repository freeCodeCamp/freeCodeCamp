...
Deklariere eine `elemValue`-Funktion, die einen `num`-Parameter verwendet. Die Funktion sollte leer sein.

# --hints--

Du solltest eine `elemValue`-Variable nach deiner `rangeFromString()`-Funktion deklarieren.
