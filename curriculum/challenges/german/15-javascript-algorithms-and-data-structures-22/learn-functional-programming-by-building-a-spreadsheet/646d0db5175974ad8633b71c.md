...
Deine inneren Funktionen können auch eine Funktion zurückgeben. Aktualisiere deine `addCharacters`-Funktion mit der gleichen Arrow-Syntax so, dass sie eine dritte Funktion zurückgibt, die einen `num`-Parameter verwendet.

# --hints--

Deine innere Arrow-Funktion sollte eine weitere Arrow-Funktion mit einem `num`-Parameter zurückgeben.
...
Deine innerste Arrow-Funktion sollte leer sein.
