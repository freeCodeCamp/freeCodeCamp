...
Die Callback-Funktion hat dann einen Parameter für jede Capture-Gruppe im regulären Ausdruck. In deinem Fall hat `rangeRegex` vier Capture-Gruppen: den ersten Buchstaben, die ersten Zahlen, den zweiten Buchstaben und die zweiten Zahlen.
