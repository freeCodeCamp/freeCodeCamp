...
Have your callback function implicitly return the `operator` property of your `infixToFunction` object. Denke daran, dass `operator` eine Variable ist, die den Eigenschaftsnamen und nicht den eigentlichen Eigenschaftsnamen enthält.
