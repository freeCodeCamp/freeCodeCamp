...
You can quickly get all cells from your page by getting the `#container` element by it's `id` and accessing the `children` property of the result. Übergib dies an deinen `evalFormula()`-Aufruf als zweiten Parameter.
