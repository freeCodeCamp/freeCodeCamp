...
Das zweite Argument der `.replace()`-Methode muss nicht unbedingt ein String sein. You can instead pass a callback function to run more complex logic on the matched string.
