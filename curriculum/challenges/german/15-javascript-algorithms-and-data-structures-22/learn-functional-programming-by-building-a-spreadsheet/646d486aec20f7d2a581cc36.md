...
Unfortunately, that `children` property is returning a collection of elements, which is array-like but not an array. Umschließe dein zweites Argument mit `Array.from()`, um es in ein Array zu umwandeln.
