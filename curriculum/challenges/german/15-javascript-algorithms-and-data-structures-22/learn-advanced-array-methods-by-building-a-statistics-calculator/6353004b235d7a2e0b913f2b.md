...
Zur Berechnung eines Wurzelexponenten, wie $\sqrt[n]{x}$, kannst du einen invertierten $x^{1/n}$-Exponenten verwenden.
...
Deine `standardDeviation`-Variable sollte die `variance`-Variable verwenden.
