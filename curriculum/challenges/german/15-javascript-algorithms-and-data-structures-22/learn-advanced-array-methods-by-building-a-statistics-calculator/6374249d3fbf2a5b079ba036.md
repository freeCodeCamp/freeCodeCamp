...
Es gibt noch eine letzte Sache, die zu beheben ist. The `.sort()` method <dfn>mutates</dfn> the array it's called on. It is generally bad practice to mutate a function parameter, which `array` is.
