...
Dazu überprüfst du zunächst, ob vor und nach deinem Muster Leerzeichen vorhanden sind. You can do this by using the meta character `\s`, which will match spaces, tabs, and line breaks.
