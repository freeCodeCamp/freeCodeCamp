...
Wenn der `messageInput` leer ist, wird dem Nutzer eine Benachrichtigung mit der Nachricht `Please enter a message.` angezeigt.
...
Deine `if`-Anweisung sollte dem Nutzer eine Benachrichtigung mit der Nachricht `Please enter a message.` senden.
