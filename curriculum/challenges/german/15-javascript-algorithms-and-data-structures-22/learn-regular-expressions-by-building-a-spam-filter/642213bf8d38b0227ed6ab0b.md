...
Dein nächster regulärer Ausdruck wird nach Strings wie `free money` suchen. Start by declaring a `freeRegex` variable and assigning it a regular expression that will match the string `free money`. Remember to make it case-insensitive.
