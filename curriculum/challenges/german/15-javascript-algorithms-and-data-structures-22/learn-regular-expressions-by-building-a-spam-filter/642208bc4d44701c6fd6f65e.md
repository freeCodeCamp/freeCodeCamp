...
Der Dollarwert kann mehr als eine Ziffer betragen. To match this, the `+` quantifier can be used - this matches one or more consecutive occurrence. Der reguläre `/a+/`-Ausdruck stimmt beispielsweise mit einem oder mehreren aufeinanderfolgenden `a`-Zeichen überein.
