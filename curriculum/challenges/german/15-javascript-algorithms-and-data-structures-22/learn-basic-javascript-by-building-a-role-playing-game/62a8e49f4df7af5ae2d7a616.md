...
Setze `monsterHealth` auf `monsterHealth` minus die Stärke der aktuellen Waffe des Spielers. Remember you have the `currentWeapon` variable and the `power` property.
