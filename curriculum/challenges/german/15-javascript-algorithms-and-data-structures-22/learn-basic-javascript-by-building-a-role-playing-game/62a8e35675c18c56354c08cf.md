...
Jetzt kannst du die `attack`-Funktion erstellen. First, update the `text` message to say `"The <monster name> attacks."`, replacing `<monster name>` with the name of the monster. Denke daran, dass du dafür den Verkettungsoperator verwenden kannst.
