...
Was passiert, wenn der Spieler nicht genügend Gold hat, um Gesundheit zu kaufen? You should use an `if` statement to check if the player has enough gold to buy health.
