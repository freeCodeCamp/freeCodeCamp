...
Was passiert, wenn der Spieler nicht genügend Gold hat, um Gesundheit zu kaufen? Wenn du den Code unter bestimmten Bedingungen ausführen möchtest, kannst du die <dfn>if</dfn>-Anweisung verwenden.
...
Hier ist ein Beispiel für eine `if` Anweisung:
