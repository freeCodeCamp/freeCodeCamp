...
Die Erhöhung eines Wertes um 1 oder <dfn>incrementing</dfn> hat einen speziellen Operator im JavaScript: `++`. Wenn du `num` um 1 erhöhen wolltest, könntest du `num++` schreiben.

Change your `currentWeapon` assignment to use the increment operator.

# --hints--

Du solltest den Erhöhungs-Operator verwenden, um `currentWeapon` um `1` zu erhöhen.
