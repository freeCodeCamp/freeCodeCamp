...
You should set the `innerText` property of `monsterName` to be the `name` value of the current monster. Denke daran, dass du das aktuelle Monster mit `monsters[fighting]` erhalten kannst.
