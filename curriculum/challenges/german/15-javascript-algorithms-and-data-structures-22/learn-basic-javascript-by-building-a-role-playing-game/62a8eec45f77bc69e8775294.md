...
Du solltest den Verkettungsoperator verwenden, um den Namen des Monsters am Ende deines Strings hinzuzufügen. You can get this with `monsters[fighting].name`.
