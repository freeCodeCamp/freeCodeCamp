...
Füge eine `else`-Anweisung für deine äußere `if`-Anweisung hinzu. Inside this new `else` statement, set `text.innerText` to `"You already have the most powerful weapon!"`.
