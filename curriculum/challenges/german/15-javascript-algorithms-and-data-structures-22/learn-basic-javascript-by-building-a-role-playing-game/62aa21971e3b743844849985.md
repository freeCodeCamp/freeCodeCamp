...
Der logische Oder-Operator wird den ersten Wert verwenden, wenn er "truthy" ist – das heißt, alles außer `NaN`, `null`, `0`, `-0`, `0n`, `""` und `false`. Andernfalls wird der zweite Wert verwendet.
