...
Aktualisiere schließlich die `text.innerText`-Zuweisung, so dass sie dem `text` des `location`-Objekts entspricht. However, instead of using bracket notation, use <dfn>dot notation</dfn>.
