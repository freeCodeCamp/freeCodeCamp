...
`location["button text"]` ist ein Array mit drei Elementen. Ändere den `button1.innerText`-Auftrag so, dass er stattdessen dem ersten Element dieses Arrays entspricht.

# --hints--

Du solltest auf das erste Element der `button text`-Eigenschaft des `location`-Arguments zugreifen.
