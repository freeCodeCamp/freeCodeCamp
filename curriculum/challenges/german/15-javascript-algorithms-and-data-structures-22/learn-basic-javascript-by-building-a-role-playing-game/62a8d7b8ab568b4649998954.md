...
Verwende eine `else`-Anweisung, die ausgeführt werden soll, wenn die `inventory`-Länge nicht größer als eins ist. Set the `text.innerText` to say `"Don't sell your only weapon!"`.
