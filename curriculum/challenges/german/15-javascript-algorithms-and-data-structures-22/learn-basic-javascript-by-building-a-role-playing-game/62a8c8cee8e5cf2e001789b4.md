...
Nutze innerhalb der `buyWeapon`-Funktion Zuweisungen zum Verbinden, um `1` zu `currentWeapon` zu addieren - der Benutzer kauft die nächste Waffe im `weapons`-Array.
