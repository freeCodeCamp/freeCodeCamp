...
You can access properties in JavaScript a couple of different ways. Die erste Möglichkeit bezieht sich auf die <dfn>Punktnotation</dfn>. Der Zugriff auf die `onclick`-Eigenschaft eines Buttons würde folgendermaßen aussehen:
