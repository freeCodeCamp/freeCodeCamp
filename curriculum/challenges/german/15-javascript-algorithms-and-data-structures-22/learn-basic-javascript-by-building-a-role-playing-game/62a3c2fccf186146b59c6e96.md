...
Du kannst auf Eigenschaften in JavaScript auf verschiedene Weise zugreifen. Die erste Möglichkeit bezieht sich auf die <dfn>Punktnotation</dfn>. Here is an example of using dot notation to set the `onclick` property of a button to a function reference.
