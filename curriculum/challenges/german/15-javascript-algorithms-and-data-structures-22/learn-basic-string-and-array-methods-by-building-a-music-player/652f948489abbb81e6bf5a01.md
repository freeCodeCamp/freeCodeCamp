...
You should assign the `#playlist-songs` element to the variable `playlistSongs`. Denke daran, `const` zu verwenden, um die Variable zu deklarieren.
...
You should assign the `#play` element to the variable `playButton`. Denke daran, `const` zu verwenden, um die Variable zu deklarieren.
...
You should assign the `#pause` element to the variable `pauseButton`. Denke daran, `const` zu verwenden, um die Variable zu deklarieren.
