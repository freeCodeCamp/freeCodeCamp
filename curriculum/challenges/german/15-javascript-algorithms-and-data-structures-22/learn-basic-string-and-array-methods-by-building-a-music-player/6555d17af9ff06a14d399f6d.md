...
You should assign the `#player-song-title` element to the variable `playingSong`. Denke daran, `const` zu verwenden, um die Variable zu deklarieren.
...
You should assign the `#player-song-artist` element to the variable `songArtist`. Denke daran, `const` zu verwenden, um die Variable zu deklarieren.
