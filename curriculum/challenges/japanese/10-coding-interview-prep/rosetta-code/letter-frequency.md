...
`letterFrequency("Not all that Mx. (pronounced "mix") Bennet, however")` は配列を返す必要があります。

```js
assert(Array.isArray(letterFrequency('Not all that Mx. (pronounced "mix") Bennet, however')));
```

`letterFrequency("Not all that Mx. (pronounced "mix") Bennet, however")` は `[[" ", 5], [",", 1], [".", 1], ["B", 1], ["M", 1], ["N", 1], ["a", 2], ["e", 4], ["h", 2], ["l", 2], ["n", 2], ["o", 2], ["r", 2], ["s", 1], ["t", 4], ["v", 1], ["w", 1]]` を返す必要があります。
...
`letterFrequency("distant surmises; but they eluded")` は `[[" ", 4], [";", 1], ["a", 1], ["b", 1], ["d", 3], ["e", 4], ["h", 1], ["i", 2], ["l", 1], ["m", 1], ["n", 1], ["r", 1], ["s", 4], ["t", 3], ["u", 3]]` を返す必要があります。
