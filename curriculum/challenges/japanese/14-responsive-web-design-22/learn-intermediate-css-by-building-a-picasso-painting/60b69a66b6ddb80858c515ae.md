...
`#orange-character` の要素内に、`div` 要素を 4 つ追加してください。 その `id` の値を順に `black-round-hat`、`eyes-div`、`triangles`、`guitar` と設定してください。
