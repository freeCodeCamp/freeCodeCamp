...
クラスセレクターを使用して、`.cat-right-eye` の要素の幅を `30px`、高さを `40px` に設定してください。 また、背景色を `#000` に設定してください。
