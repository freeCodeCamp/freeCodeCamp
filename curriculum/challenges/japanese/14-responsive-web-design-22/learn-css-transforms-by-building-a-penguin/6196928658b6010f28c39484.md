...
`.ground` 要素の `background` に線形グラデーションを設定してください。時計回りに 90 度の角度を付け、`rgb(88, 175, 236)` で始まり `rgb(182, 255, 255)` で終わるようにしてください。

# --hints--

`.ground` の `background` を `linear-gradient(90deg, rgb(88, 175, 236), rgb(182, 255, 255))` に設定する必要があります。
