...
Kipengele cha manukuu ya kielelezo (`figcaption`) kinatumika kuongeza maelezo mafupi kuelezea picha iliyo ndani ya kipengele cha `figure`. Kwa mfano, `<figcaption>A cute cat</figcaption>` huongeza maelezo `A cute cat`.
