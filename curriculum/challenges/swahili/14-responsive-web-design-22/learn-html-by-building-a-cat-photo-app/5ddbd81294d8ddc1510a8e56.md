...
Maandishi ya kiungo lazima yawekwe kati ya vitambulisho vya kufungua na kufunga vya kipengele cha nanga (`a`). Kwa mfano, `<a href="https://www.freecodecamp.org">click here to go to freeCodeCamp.org</a>` ni kiungo chenye maandishi `click here to go to freeCodeCamp.org`.
