...
Ili data ya fomu iweze kufikiwa na eneo lililobainishwa katika sifa ya `action`, lazima upe sehemu ya maandishi sifa ya `name` na uikabidhi thamani ili kuwakilisha data inayowasilishwa. Kwa mfano, unaweza kutumia sintaksia ifuatayo kwa uga wa maandishi wa anwani ya barua pepe: `<input type="text" name="email">`.
