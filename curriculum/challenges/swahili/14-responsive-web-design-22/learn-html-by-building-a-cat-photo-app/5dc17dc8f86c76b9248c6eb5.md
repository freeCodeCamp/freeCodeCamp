...
Kutoa maoni hukuruhusu kuacha ujumbe bila kuathiri onyesho la kivinjari. Pia hukuruhusu kufanya msimbo kutofanya kazi. Maoni katika HTML huanza na `<!--`, yana idadi yoyote ya mistari ya maandishi, na kuishia na `-->`. Kwa mfano, maoni `<!-- TODO: Remove h1 -->` yana maandishi `TODO: Remove h1`.
