...
Vipengele vyote vya `img` vinapaswa kuwa na sifa ya `alt`. Maandishi ya sifa ya `alt` hutumika kwa visoma skrini ili kuboresha ufikivu na huonyeshwa picha ikishindwa kupakiwa. Kwa mfano, `<img src="cat.jpg" alt="A cat">` ina sifa ya `alt` yenye maandishi `A cat`.
