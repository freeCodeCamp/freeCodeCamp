...
Fahamu kwamba maudhui yote ya ukurasa yamewekwa ndani ya kipengele cha `html`. The `html` element is the root element of an HTML page and wraps all content on the page.
