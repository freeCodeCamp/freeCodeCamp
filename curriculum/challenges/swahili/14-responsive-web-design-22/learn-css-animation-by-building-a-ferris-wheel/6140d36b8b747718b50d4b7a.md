...
Weka `.cabin` kuwa na sifa ya `transform-origin` ya `50% 0%`. Hii itaweka mahali pa asili kuwa offset `50%` kutoka kushoto na `0%` kutoka juu, na kuiweka katikati ya ukingo wa juu wa kipengele.
