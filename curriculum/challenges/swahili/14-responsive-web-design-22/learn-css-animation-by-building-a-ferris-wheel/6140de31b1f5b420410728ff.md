...
Sasa ipe sheria ya `@keyframes wheel` kiteuzi cha `100%`. Ndani ya hayo, weka `transform` kuwa `rotate(360deg)`. Kwa kufanya hivi, uhuishaji wako sasa utakamilisha mzunguko kamili.
