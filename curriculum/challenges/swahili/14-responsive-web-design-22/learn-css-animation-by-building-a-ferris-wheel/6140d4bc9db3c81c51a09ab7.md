...
Ukiendelea na mchoro, chagua vipengee vifuatavyo vya `.cabin` na utumie sheria mahususi kwao:

- `.cabin` ya pili inapaswa kuwa na sifa ya `right` iliyowekwa kuwa `17%` na `top` kuwekwa `93.5%`.
