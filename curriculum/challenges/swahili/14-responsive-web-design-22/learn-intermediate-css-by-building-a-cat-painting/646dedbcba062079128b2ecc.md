...
Ni wakati wa kufanyia kazi pua. Katika HTML yako, unda kipengele cha `div` ukitumia darasa la `cat-nose`.
...
Kipengele chako cha `div` kinapaswa kuwa na darasa la `cat-nose`.
