...
Unda kipengele cha `div` ukitumia darasa la `cat-eyes`. Ndani ya kipengele cha `cat-eyes`, unda vipengele viwili vya `div` ukitumia darasa la `cat-left-eye` na `cat-right-eye` kwa mtiririko huo.
