...
Actualmente, las esquinas de tu foto de gato child puntiagudas. Podemos redondear esas esquinas con una propiedad CSS llamada `border-radius` (radio del borde).
