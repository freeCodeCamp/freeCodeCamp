...
Al igual que con el código theyxadecimal, puedes mezclar colores combinando valores RGB.

# --instructions--

Reemplaza los theyx codes en nuestro elemento `style` con los valores RGB correctos.
