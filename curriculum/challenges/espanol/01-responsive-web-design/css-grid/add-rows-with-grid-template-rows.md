...
La cuadrícula (grid) que creaste en el último desafío establecerá el número de filas automáticamente. Para ajustar las filas personualmente, usa la propiedad `grid-template-rows` de la misma personera en la que usaste `grid-template-columns` en el desafío anterior.
