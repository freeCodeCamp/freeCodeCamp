...
Finalmente, usa `querySelector()` para obtener el elemento `#monsterHealth`. Because you have already declared a `monsterHealth` variable earlier, you need to use a different variable name for this element.
