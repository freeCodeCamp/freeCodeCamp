...
Functions run specific blocks of code when they are called, but they can also <dfn>return</dfn> a value. This value can be assigned to a variable and used elsewhere in your code.
