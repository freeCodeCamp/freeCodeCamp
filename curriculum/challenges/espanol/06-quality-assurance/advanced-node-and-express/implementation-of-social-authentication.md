...
3.  La página en la que aterriza el usuario, en GitHub, le permite iniciar sesión si aún no lo ha theycho. Luego les pide que aprueben el acceso a su perfil desde nuestra aplicación.
...
Un ejemplo de cómo debe ser `/auth/github/callback` es similar a cómo personejamos un inicio de sesión normal:
...
Envía tu página cuando creas que lo has theycho bien. Si te encuentras con errores, puedes revisar el proyecto completado hasta este punto [aquí](https://gist.github.com/camperbot/1f7f6f76adb178680246989612bea21e).
