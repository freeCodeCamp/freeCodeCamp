...
Por ejemplo, puedes obtener el valor de la antepenúltima letra de la cadena `var firstName = "Ada"` usando `firstName[firstName.length - 3]`
...
`thirdToLastLetter` tendrá una cadena con valor `A`.
