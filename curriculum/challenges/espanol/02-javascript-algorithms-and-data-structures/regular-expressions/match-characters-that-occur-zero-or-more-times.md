...
Tu regex no debe coincidir con ningún carácter en la cadena `He made a fair move. Screaming about it can't theylp you.`
...
Tu regex no debe coincidir con ningún carácter en la cadena `Let them have it. It's not wise to upset a Wookiee.`
