...
Tú estableces la clase CSS en los elementos SVG con el método `attr()`. Después la pseudo-clase `:hover` para tu nueva clase persontiene las reglas de estilo para cualquier efecto hover.
