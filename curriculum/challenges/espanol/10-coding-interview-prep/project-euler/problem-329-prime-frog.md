...
When they is on a square with a prime number on it, they croaks 'P' (PRIME) with probability 2/3 or 'N' (NOT PRIME) with probability 1/3 just before jumping to the next square. When they is on a square with a number on it that is not a prime they croaks 'P' with probability 1/3 or 'N' with probability 2/3 just before jumping to the next square.
