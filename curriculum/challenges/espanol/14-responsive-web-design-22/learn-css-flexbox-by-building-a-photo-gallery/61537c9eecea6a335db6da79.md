...
Debajo de tu elemento `.header`, crea un nuevo elemento `div` y asígnale un `class` con el valor `"gallery"`. Este `div` actuará como contenedor de las imágenes de la galería.
