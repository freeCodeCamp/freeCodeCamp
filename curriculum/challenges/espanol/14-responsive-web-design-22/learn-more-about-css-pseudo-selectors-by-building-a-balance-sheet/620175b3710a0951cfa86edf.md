...
Asegúrate que tus años no se oculten estableciendo un `z-index` de `999`. Luego, dale un `margin` de `0 -2px`, y un `padding` establecido en `0.5rem calc(1.25rem + 2px) 0.5rem 0`.
