...
La propiedad `clip-path` determina la forma que la propiedad `clip` debe tomar. Set the `clip-path` property to the value of `inset(50%)`, forming the clip-path into a rectangle within the element.
