...
Dale a tu selector de `.calories-info span` un `margin-top` establecido en `-7px`. Esto cambiará su texto `230` a su lugar.

# --hints--

Tu selector de `.calories-info span` debe tener un `margin-top` establecido en `-7px`.
