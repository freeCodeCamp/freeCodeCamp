...
The text `% Daily Value *` should be aligned to the right. Crea un selector `.right` y usa la propiedad `justify-content` para hacerlo.
...
Tu selector `.right` debe tener una propiedad `justify-content` establecida en `flex-end`.
