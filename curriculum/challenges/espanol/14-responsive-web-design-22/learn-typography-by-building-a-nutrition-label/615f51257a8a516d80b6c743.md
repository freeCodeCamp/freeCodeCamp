...
Cree un nuevo `div` debajo de su elemento `.lg` y asígnele un atributo `class` establecido en `calories-info`.
...
Su nuevo `div` debe aparecer después del elemento `.lg`.
