...
Envuelva el texto `2/3 cup (55g)` en un elemento `span` y asígnele un atributo `class` establecido en `right`.
...
Su nuevo elemento `span` debe tener el atributo `class` establecido en `right`.
