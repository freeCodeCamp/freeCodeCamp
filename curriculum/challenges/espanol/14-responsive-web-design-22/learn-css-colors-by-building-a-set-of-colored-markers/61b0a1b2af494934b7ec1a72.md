...
El marcador verde `div` debe contener dos elementos `div`.
...
El elemento `div` de la tapa del marcador verde debe estar antes del elemento `div` de la manga.
...
Su marcador azul `div` debe contener dos elementos `div`.
...
El elemento `div` de la tapa de su marcador azul debe estar antes del elemento `div` de la manga.
