...
Actualiza el selector de clase CSS `.two` de manera que apunte a la nueva clase `green`. De igual manera actualiza el selector `.three` para que apunte a la nueva clase `blue`.
