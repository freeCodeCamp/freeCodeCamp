...
Cada rol `region` requiere una etiqueta visible, que debe ser referenciado por el atributo `aria-labelledby`.

A los elementos `section`, dale los siguientes atributos `aria-labelledby`:
