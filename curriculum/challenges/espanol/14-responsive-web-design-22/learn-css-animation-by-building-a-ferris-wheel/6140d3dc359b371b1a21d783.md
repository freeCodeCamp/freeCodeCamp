...
Es hora de posicionar las cabinas alrededor de la rueda. Selecciona el primer elemento de `.cabin`. Establece la propiedad `right` a `-8.5%` y la propiedad `top` a `50%`.
