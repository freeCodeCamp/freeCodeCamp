...
Puedes añadir imágenes a tu sitio web utilizando el elemento `img`. Los elementos `img` tienen una etiqueta de apertura sin una etiqueta de cierre. An element without a closing tag is known as a <dfn>void element</dfn>.
