...
Para dar estilo al botón de envío, puede utilizar un selector de atributos (_attribute_), que selecciona un elemento basado en el valor del atributo dado. Aquí hay un ejemplo:
