...
Debes utilizar un selector de elementos separado por comas para seleccionar los elementos `input` y `textarea`.
...
Debes dar a los elementos `input` y `textarea` un borde de un `1px`, que sea de estilo `solid` y sea de un color `#0a0a23`.
