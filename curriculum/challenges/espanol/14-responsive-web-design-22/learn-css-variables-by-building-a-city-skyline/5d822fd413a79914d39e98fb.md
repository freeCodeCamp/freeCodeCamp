...
Las transiciones de gradiente a menudo cambian gradualmente de un color a otro. When a more abrupt change is required, the transition can be made with a hard stop like this:
