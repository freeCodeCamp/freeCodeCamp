...
const TRANSLATIONS = [
  ...
  {
    id: 'v127zb',
    text: '检查两个控制台的差异。freeCodeCamp 控制台应该打印两次变量，分别对应这个挑战的每一个测试。浏览器控制台应该只打印一次变量，因为你清除了第一次的打印结果。'
  },
  {
    id: 'ejm0ql',
  ...
  {
    id: 'bfd23c',
    text: '有一个函数（代表茶的种类）和需要几杯茶，下面的函数返回一个数组，包含字符串（每个字符串表示一杯特别种类的茶）。'
  },
  {
    id: 'ead98i',
    text: '全局计数变量：'
  ...
  {
    id: 'qn720a',
    text: '现在，在 console.log() 之前添加 console.clear()，清除浏览器控制台的内容，通过测试。'
  },
  {
    id: 'j86mef',
