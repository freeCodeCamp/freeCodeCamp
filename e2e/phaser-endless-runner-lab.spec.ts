...
const LAB_FILE = path.resolve(
  __dirname,
  '..',
  'curriculum/challenges/english/blocks/lab-endless-runner/66faab00000000000000000c.md'
);

const LAB_URL =
  '/learn/certified-game-developer-with-phaser/lab-endless-runner/lab-endless-runner';
...
test.describe('Phaser Endless Runner Lab', () => {
  test.skip(
  ...
  test('completes the endless-runner lab', async ({ page, browserName }) => {
