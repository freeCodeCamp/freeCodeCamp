...
test.describe('Certification page - Non Microsoft', () => {
  ...
  test('Validate certificate/social/project links', async ({ page }) => {
    ...
    await expect(linkedinLink).toHaveAttribute(
      'href',
      `https://www.linkedin.com/profile/add?startTask=CERTIFICATION_NAME&name=Responsive%20Web%20Design&organizationId=4831032&issueYear=2024&issueMonth=6&certUrl=https://freecodecamp.org/certification/certifieduser/responsive-web-design&certId=certifieduser-rwd`
    );
...
test.describe('Certification page - Microsoft', () => {
  ...
  test('Validate certificate/social/project links', async ({ page }) => {
    ...
    await expect(linkedinLink).toHaveAttribute(
      'href',
      'https://www.linkedin.com/profile/add?startTask=CERTIFICATION_NAME&name=Foundational%20C%23%20with%20Microsoft&organizationId=4831032&issueYear=2024&issueMonth=6&certUrl=https://freecodecamp.org/certification/certifieduser/foundational-c-sharp-with-microsoft&certId=certifieduser-fcswm'
    );
