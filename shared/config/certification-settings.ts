...
export const certTypes = {
  ...
  upcomingFrontendCert: 'isUpcomingFrontendCertV8',
...
export const certIds = {
  ...
  upcomingFrontendCertV8Id: '64afc4e8f3b37856e035b85f',
...
export const completionHours = {
  ...
  [certTypes.upcomingFrontendCert]: 300,
...
export const certSlugTypeMap = {
  ...
  // upcoming
  [Certification.FrontendCert]: certTypes.upcomingFrontendCert
};
...
export const superBlockCertTypeMap = {
  ...
  // upcoming
  [SuperBlocks.FrontendCert]: certTypes.upcomingFrontendCert
};
...
export const certTypeIdMap = {
  ...
  [certTypes.upcomingFrontendCert]: certIds.upcomingFrontendCertV8Id,
...
export const certTypeTitleMap = {
  ...
  [certTypes.upcomingFrontendCert]: 'Upcoming Python',
