...
export const certTypeTitleMap = {
  ...
  [certTypes.dataVis]: 'Legacy Data Visualization V7',
  [certTypes.infosecQa]: 'Legacy Information Security and Quality Assurance',
  [certTypes.fullStack]: 'Legacy Full Stack',
  [certTypes.respWebDesign]: 'Legacy Responsive Web Design',
  [certTypes.respWebDesignV9]: 'Responsive Web Design',
  [certTypes.frontEndDevLibs]: 'Legacy Front End Development Libraries',
  [certTypes.jsAlgoDataStruct]:
    'Legacy JavaScript Algorithms and Data Structures V7',
  [certTypes.dataVis2018]: 'Legacy Data Visualization V8',
  [certTypes.apisMicroservices]: 'Legacy Back End Development and APIs',
  [certTypes.qaV7]: 'Legacy Quality Assurance',
  [certTypes.infosecV7]: 'Legacy Information Security',
  [certTypes.sciCompPyV7]: 'Legacy Scientific Computing with Python',
  [certTypes.dataAnalysisPyV7]: 'Legacy Data Analysis with Python',
  [certTypes.machineLearningPyV7]: 'Legacy Machine Learning with Python',
  [certTypes.relationalDatabaseV8]: 'Legacy Relational Database',
  [certTypes.collegeAlgebraPyV8]: 'Legacy College Algebra with Python',
