...
// thing are the 'id' and 'joinDate', which are generated by the database.
const publicUserData = {
  ...
  partiallyCompletedChallenges: testUserData.partiallyCompletedChallenges,
