...
const _SENTRY_LOGS_DEBUG_SAMPLE_RATE = Number(
  process.env.SENTRY_LOGS_DEBUG_SAMPLE_RATE ?? '0.05'
);
assert.ok(
  _SENTRY_LOGS_DEBUG_SAMPLE_RATE >= 0 && _SENTRY_LOGS_DEBUG_SAMPLE_RATE <= 1,
